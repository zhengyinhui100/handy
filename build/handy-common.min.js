...
show:function(a,b){var e=this;if(e.showed||b&&e.hidden)return!1;if(!a&&e.delayShow)setTimeout(function(){d.prototype.show.call(e,!0)},0);else{e.trigger("beforeShow");e.showed=!0;var c=e.getEl();"visibility"==e.displayMode?c.css({visibility:"visible"}):c.show();e.callChild([null,!0]);e.afterShow()}},afterShow:function(){this.trigger("afterShow")},enable:function(){this.resume();this.getEl().removeClass("hui-disable").find("input,textarea,select").removeAttr("disabled")},disable:function(){this.suspend();
this.getEl().addClass("hui-disable").find("input,textarea,select").attr("disabled","disabled")},listen:function(a){var b=this,e=a.name,c=a.context,f=a.handler;if(a.custom)b.on(e,f,c);else{var m=b._listeners,d=a.el,k=a.method||"bind",s=a.selector,n=a.data,r=a.delegation=function(){if(!0!=b.isSuspend)return f.apply(c||b,arguments)};$H.Browser.mobile()&&"click"==e&&(e="touchend");d=d?"string"==typeof d?b.find(d):d:b.getEl();if(s)if(n)d[k](s,e,n,r);else d[k](s,e,r);else if(n)d[k](e,n,r);else d[k](e,r);
m.push(a)}},unlisten:function(a){var b=a.name,e=a.handler;if(a.custom)this.off(b,e);else{var c=a.el,f="delegate"==a.method?"undelegate":"unbind";a=a.selector;var d;$H.Browser.mobile()&&"click"==b&&(b="touchend");for(var c=c?"string"==typeof c?this.find(c):c:this.getEl(),j=this._listeners.length-1;0<=j;j--){var k=this._listeners[j];if(k.handler==e){d=k.delegation;this._listeners.splice(j,1);break}}if(a)c[f](a,b,d);else c[f](b,d)}},initListeners:function(){if(this.listened)return!1;this.listened=!0;
var a=this._listeners;this._listeners=[];for(var b=a.length-1;0<=b;b--)this.listen(a[b]);this.callChild()},clearListeners:function(){for(var a=this._listeners,b=a.length-1;0<=b;b--)this.unlisten(a[b]);this.off("all");this.callChild()},suspend:function(){if(this.isSuspend)return!1;this.isSuspend=!0;this.callChild()},resume:function(){if(!this.isSuspend)return!1;this.isSuspend=!1;this.callChild()},each:function(a,b){for(var e=this.children,c=e.length,f,d=0;d<c;){f=e[d];f=b?a.apply(f,b):a(d,f);if(!1===
