...
handy.add("Json",function(){function e(b){h.lastIndex=0;h.test(b)&&(b=b.replace(h,function(b){var a=g[b];return"string"===typeof a?a:"\\u"+("0000"+b.charCodeAt(0).toString(16)).slice(-4)}));return'"'+b+'"'}function d(a,h){var g,k,j,l,r=b,q,p=h[a];p&&("object"===typeof p&&"function"===typeof p.toJSON)&&(p=p.toJSON(a));"function"===typeof c&&(p=c.call(h,a,p));switch(typeof p){case "string":return e(p);case "number":return isFinite(p)?String(p):"null";case "boolean":case "null":return String(p);case "object":if(!p)return"null";
b+=f;q=[];if("[object Array]"===Object.prototype.toString.apply(p)){l=p.length;for(g=0;g<l;g+=1)q[g]=d(g,p)||"null";j=0===q.length?"[]":b?"[\n"+b+q.join(",\n"+b)+"\n"+r+"]":"["+q.join(",")+"]";b=r;return j}if(c&&"object"===typeof c){l=c.length;for(g=0;g<l;g+=1)"string"===typeof c[g]&&(k=c[g],(j=d(k,p))&&q.push(e(k)+(b?": ":":")+j))}else for(k in p)Object.prototype.hasOwnProperty.call(p,k)&&(j=d(k,p))&&q.push(e(k)+(b?": ":":")+j);j=0===q.length?"{}":b?"{\n"+b+q.join(",\n"+b)+"\n"+r+"}":"{"+q.join(",")+
"}";b=r;return j}}var a="JSON"in window,c,b,f,h=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},k=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,j=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,s=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,u=/(?:^|:|,)(?:\s*\[)+/g;
return{stringify:function(h,g,e,k){if(a&&!k)return JSON.stringify.apply(null,arguments);var j;f=b="";if("number"===typeof e)for(j=0;j<e;j+=1)f+=" ";else"string"===typeof e&&(f=e);if((c=g)&&"function"!==typeof g&&("object"!==typeof g||"number"!==typeof g.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return d("",{"":h})},parse:function(b,c,f){function d(b,a){var f,h,g=b[a];if(g&&"object"===typeof g)for(f in g)Object.prototype.hasOwnProperty.call(g,
f)&&(h=d(g,f),void 0!==h?g[f]=h:delete g[f]);return c.call(b,a,g)}if(a&&!f)return JSON.parse.apply(null,arguments);var h;b=String(b);k.lastIndex=0;k.test(b)&&(b=b.replace(k,function(b){return"\\u"+("0000"+b.charCodeAt(0).toString(16)).slice(-4)}));if(j.test(b.replace(l,"@").replace(s,"]").replace(u,"")))return h=eval("("+b+")"),"function"===typeof c?d({"":h},""):h;$D.error(new SyntaxError("JSON.parse"))}}});
...
b){var f=b?b.notCover:!1,h=b?b.cover:null;b=b?b.notClone:!1;a=a||{};var g=a.constructor,e=g.$isClass,j;for(j in c)if((!h||d.contains(h,j))&&c.hasOwnProperty(j)){var l=a.hasOwnProperty(j),s=!0===f?l:!1;d.isArray(f)?s=d.contains(f,j)&&l:d.isFunction(f)&&(s=f(j));s||(l=b?c[j]:d.clone(c[j]),e&&d.isFunction(l)&&(l.$name=j,l.$owner=g),a[j]=l)}return a},mix:function(a,c,b){a.superProto||(a.superProto={});for(var f in c)a.superProto[f]=d.isFunction(c[f])?a.superProto[f]?function(b,a){return function(){a.apply(this,
...
h&&(f=h.getVariable("$version").split(" ")[1])}else if(navigator.plugins&&0<navigator.plugins.length&&(h=navigator.plugins["Shockwave Flash"])){var g=h.description.split(" ");c=0;for(var k=g.length;c<k;c++)if(0<parseInt(g[c])){f=g[c];break}}}catch(j){}d.flash=f?f:null;return a});
...
d+" : "+g+"<br/>";f.scrollTop=f.scrollHeight}try{console[d](b)}catch(j){}},log:function(b,a){c.level>c.LOG_LEVEL||c.out(b,!!a,"log")},info:function(b,a){this.level>c.INFO_LEVEL||c.out(b,!!a,"info")},warn:function(b,a){c.level>c.WARN_LEVEL||c.out(b,!!a,"warn")},error:function(b,a){if(!(c.level>c.ERROR_LEVEL)&&(c.out(b,!!a,"error"),b instanceof Error))throw b;},time:function(b,a,d){c.level>c.INFO_LEVEL||(b?("boolean"==typeof a&&(d=a,a=""),c.out((a||"")+((new Date).getTime()-(c.lastTime||0)),!!d)):c.lastTime=
(new Date).getTime())},debug:function(b){if(!(c.level>c.DEBUG_LEVEL)&&!1!==b)debugger}};return c});handy.add("Function",function(e){return{bind:function(d,a,c){var b=Array.prototype.slice.call(arguments,2);return function(){Array.prototype.push.apply(b,arguments);return d.apply(a,b)}},intercept:function(d,a,c,b){return e.Object.isFunction(d)&&e.Object.isFunction(a)?function(){var f=c||this,h={},e=arguments;h.scope=b;h.target=f;h.method=d;return!1!=a.apply(h,e)?d.apply(f,e):!1}:d}}});
handy.add("Class","handy.base.Object",function(e,d){return{createClass:function(a){var c=function(){var b,a;b=this.constructor==c?this:arguments.callee;if(a=b.initialize){for(var d in b)"object"==typeof b[d]&&(b[d]=e.clone(b[d]));return a.apply(b,arguments)}};c.$isClass=!0;c.extend=function(){};c.prototype.callSuper=function(b,a){b&&(!b.$isClass&&void 0!=b.length)&&(a=b,b=null);var c=arguments.callee.caller,d=c.$owner.superProto;b=b?b.prototype:d||this.constructor.superProto;c=c.$name;if(b&&(c=b[c],
e.isFunction(c)))return a?c.apply(this,a):c.call(this)};a&&this.namespace(a,c);return c},inherit:function(a,c,b,f,h){var g=function(){};g.prototype=c.prototype;e.extend(a,c,h);a.prototype=new g;a.prototype.constructor=a;a.superClass=c;a.superProto=c.prototype;if(c._onInherit)try{c._onInherit(a)}catch(k){d.Debug.error(k)}f&&e.extend(a,f);b&&e.extend(a.prototype,b)}}});
handy.add("Loader",["handy.base.Debug","handy.base.Object","handy.base.Function"],function(e,d,a,c){function b(b){function a(b){return/\.(css|js)$/.test(b)?u[b]&&"loaded"==u[b].status:n.urlMap&&n.urlMap[b]?n.urlMap[b].chkExist():d.namespace(b)}if("string"==typeof b)return a(b);for(var c=[],f=0,e=b.length;f<e;f++){var h=a(b[f]);if(h)c.push(h);else return!1}return c}function f(b,a){function c(){c.isCalled||(c.isCalled=!0,clearTimeout(k),a())}if("SCRIPT"===b.nodeName){var f=b,d=c;f.onload=f.onerror=
f.onreadystatechange=function(){/loaded|complete|undefined/.test(f.readyState)&&(f.onload=f.onerror=f.onreadystatechange=null,j.removeChild(f),f=null,setTimeout(d,0))}}else{var g=c;window.hasOwnProperty("attachEvent")?b.attachEvent("onload",g):setTimeout(function(){h(b,g)},0)}var k=setTimeout(function(){e.error("Time is out:"+b.src);c()},n.timeout)}function h(b,a){if(!a.isCalled){var c;if(l)b.sheet&&(c=!0);else if(b.sheet)try{b.sheet.cssRules&&(c=!0)}catch(f){if("SecurityError"===f.name||"NS_ERROR_DOM_SECURITY_ERR"===
f.name)c=!0}setTimeout(function(){c?a():h(b,a)},1)}}function g(b){n.showLoading(!1);u[b].status="loaded";n.traceLog&&e.info("Loader Response: "+b);k()}function k(){for(var a=s.length-1;0<=a;a--){var c=s[a],f=b(c.deps);if(f){s.splice(a,1);c.callback.apply(null,f);k();break}}}var j=document.head||document.getElementsByTagName("head")[0]||document.documentElement,l=navigator.userAgent.indexOf("AppleWebKit"),s=[],u={},n={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(b,
a,c){2==arguments.length&&(c=a,a=[]);n.require(a,function(){var a;if("function"==typeof c)try{a=c.apply(null,arguments),n.traceLog&&e.info("Loader define: "+b)}catch(f){e.error("Loader "+b+":factory define error:"+f.message,f);return}else a=c;d.namespace(b,a);var h=typeof a;if("object"==h||"Function"==h)a.$ns=b})},require:function(d,h){for(var k="string"==typeof d?[d]:d,l=[],v=[],r=!0,q=0,p=k.length;q<p;q++){var m=k[q],t=b(m);t?v.push(t):(l.push(m),r&&(r=!1,s.push({deps:k,callback:h})),n.traceLog&&
e.info("Resource not found: "+m))}if(0==l.length)return h&&h.apply(null,v),0==v.length?v[0]:v;r=!1;k=0;for(v=l.length;k<v;k++)if(q=l[k],!u[q]){r=q;m=n.urlMap&&n.urlMap[r]&&n.urlMap[r].url;if(!m){p="";r=c.Object.alias(r);m=n.rootPath;if("string"==typeof m)p=m;else if("object"==typeof m)for(t in t=void 0,m)0==r.indexOf(t)&&(p=m[t],r=r.replace(t,""));else p="";m=/.css$/.test(r)?0==r.indexOf("/")?r:"/css/"+r:/.js$/.test(r)?r:r.replace(/\./g,"/")+".js";0!=m.indexOf("/")&&(m="/"+m);m=p+m}r=!0;u[q]={id:q,
status:"loading"};p=a.bind(g,null,q);if(/.css$/.test(m))a:{q=m;m=j.getElementsByTagName("link");for(t=0;t<m.length;t++){var w=m[t].href;!n.skinNode&&0<=w.indexOf(n.skinName)&&(n.skinNode=m[t]);if(0<=w.indexOf(q)||0<=q.indexOf(w))break a}m=document.createElement("link");m.rel="stylesheet";m.href=q;f(m,p);j.insertBefore(m,n.skinNode);n.traceLog&&e.info("Loader request:"+q)}else q=m,m=document.createElement("script"),m.async="async",m.src=q,m.type="text/javascript",f(m,p),j.appendChild(m),n.traceLog&&
e.info("Loader request:"+q)}r&&n.showLoading(!0)}};return n});
...
this.isSuspend=!0},resume:function(){if(!this.isSuspend)return!1;this.isSuspend=!1},trigger:function(d,a){function c(a){if(a)for(var c=0,f=a.length;c<f;c++){var d=a[c],e=d.delegation;"number"==typeof d.times&&(1<d.times?d.times--:b.off(j,d.handler));g=e.apply(null,h)}}var b=this,f=$HO.toArray(arguments);f.unshift("trigger");if(!b._parseEvents.apply(b,f)){var f=b._eventCache,h=e.slice.call(arguments,1),g,k;if(0<d.indexOf("."))k=f[d],c(k);else for(var j in f)if(k=d.indexOf("."),j.split(".")[0]==d||
0==k&&0<=j.indexOf(d))k=f[j],c(k);c(f.all);return g}}}});
...
b[h]).slice(-f)));return c},parse:function(a,c){for(var b=(c||"yyyy-MM-dd HH:mm:ss").match(/[a-zA-Z]+/g),f=a.match(/\d+/g),d=new e,g=0;g<f.length;g++){var k=b[g],j=parseInt(f[g]);switch(k){case "yyyy":d.setFullYear(j);break;case "MM":d.setMonth(j-1);break;case "dd":d.setDate(j);break;case "HH":d.setHours(j);break;case "mm":d.setMinutes(j);break;case "ss":d.setSeconds(j);break;case "SS":d.setMilliseconds(j)}}return d},parseObject:function(a){return new e(a.year+1900,a.month,a.date,a.hours,a.minutes,
a.seconds)}};return d});
...
c.split(b.closeTag);1==f.length?d+=b._parseHtml(f[0]):(d+=b._parseScript(f[0]),f[1]&&(d+=b._parseHtml(f[1])))});d+="return "+(c?"$r;":'$r.join("");');return new Function("$data",d)},tmpl:function(a,c){var g,k,j;if("string"==typeof a)g=a;else if(g=a.tmpl,j=a.id)if(d[j])k=d[j];else{var l=document.getElementById(j);l&&(g=(l.value||l.innerHTML).replace(/\s/g,""))}if(!k){if(!g){e.Debug.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}k=b._compile(g);j&&(d[j]=k)}return c?k(c):k}};return b});
handy.add("HashChange",["handy.base.Debug","handy.base.Util"],function(e,d,a){function c(a){if(a==l)return!1;var b=j.contentWindow.document;b.open();b.write("<!doctype html><html><body>"+a+"</body></html>");b.close();l=a;e.log("set:"+j.contentWindow.document.body.innerText)}function b(){var a=d.getHash(),b=j.contentWindow.document.body.innerText;a!=l?(c(a),f(a)):b!=l&&(e.log("update:"+j.contentWindow.document.body.innerText),d.setHash(b))}function f(a){var b=n.listeners,c;for(c in b)b[c](a)}var h,
g=0,k=document,j,l,s=k.documentMode,u="onhashchange"in window&&(void 0===s||7<s),n={delay:50,listen:function(e,l){if(!h&&!h)if(h=!0,n.listeners={},u)$(window).on("hashchange",function(){f(d.getHash())});else j=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(k.body)[0],$(j).one("load",function(){c(d.getHash());setInterval(b,n.delay)});if(l in n.listeners)$D.error(Error("Duplicate name"));else return l=l||a.expando+ ++g,n.listeners[l]=e,l},unListen:function(a){for(var b in n.listeners)(!a||
...
equalTo:"\u8bf7\u8f93\u5165\u76f8\u540c\u7684{name}",min:"{name}\u4e0d\u80fd\u5c0f\u4e8e{0}",max:"{name}\u4e0d\u80fd\u5927\u4e8e{0}",range:"{name}\u8981\u5728{0}\u5230{1}\u4e4b\u95f4",maxlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u8d85\u8fc7{0}",minlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u5c11\u4e8e{0}",rangelength:"{name}\u957f\u5ea6\u8981\u5728{0}\u5230{1}\u4e4b\u95f4"},valid:function(c,b){var d=b.rules,e;for(e in d){var g=d[e],k=("function"==typeof g?g:a[e])(c,g);if(!k)return d=b.error||a.error,e=b.messages&&
b.messages[e]||a.messages[e],e=e.replace(/\{([^\}]+)\}/g,function(a,c){return g[c]||0==c&&g||b[c]||g||""}),d&&d(e),k}return!0},required:function(a){return 0<e.trim(""+a).length},email:function(a){return/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a)},
