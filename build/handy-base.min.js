...
(function(){var f=window.handy,d=window.$,a=window.handy=window.$=function(){};a.version="1.0.0";a.expando="handy"+(a.version+Math.random()).replace(/\D/g,"");a.add=function(b,c,e){e||(e=c,c=null);a.base||(a.base={});var d=[];if(c)if("string"==typeof c)d.push(a.base.Object.namespace(c));else for(var h=0;h<c.length;h++)d.push(a.base.Object.namespace(c[h]));d.push(a);c=e.apply(window,d);a.base[b]=a[b]=c;if(0<="Browser,Class,Collection,Cookie,Events,Function,Json,Object,String,Template,Util".indexOf(b))for(var f in c)"undefined"!=
typeof a[f]&&("console"in window&&!Function[f])&&(console.log(a[f]),console.log(b+"\u547d\u540d\u51b2\u7a81:"+f)),a[f]=c[f]};a.noConflict=function(b){window.$===a&&(window.$=d);b&&window.handy===a&&(window.handy=f);return a};a.noop=function(){}})();
...
return{stringify:function(g,h,f,k){if(a&&!k)return JSON.stringify.apply(null,arguments);var j;e=c="";if("number"===typeof f)for(j=0;j<f;j+=1)e+=" ";else"string"===typeof f&&(e=f);if((b=h)&&"function"!==typeof h&&("object"!==typeof h||"number"!==typeof h.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return d("",{"":g})},parseJson:function(b,e,c){function d(a,b){var c,g,h=a[b];if(h&&"object"===typeof h)for(c in h)Object.prototype.hasOwnProperty.call(h,
c)&&(g=d(h,c),void 0!==g?h[c]=g:delete h[c]);return e.call(a,b,h)}if(a&&!c)return JSON.parse.apply(null,arguments);var g;b=String(b);k.lastIndex=0;k.test(b)&&(b=b.replace(k,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(j.test(b.replace(n,"@").replace(u,"]").replace(q,"")))return g=eval("("+b+")"),"function"===typeof e?d({"":g},""):g;$D.error(new SyntaxError("JSON.parse"))}}});
...
arguments);b[a].apply(this,arguments)}}(e,a.superProto[e]):b[e]:b[e],a[e]||(a[e]=b[e]);c&&d.extend(a,c);b.toString!=b.constructor.prototype.toString&&(a.superProto.toString=function(){b.toString.apply(a,arguments)});return a},isFunction:function(a){return"[object Function]"===window.Object.prototype.toString.call(a)},isArray:function(a){return"[object Array]"===window.Object.prototype.toString.call(a)},isClass:function(a){return d.isFunction(a)&&!0===a.$isClass},equals:function(a,b){if(typeof a==
typeof b){if("object"!=typeof a)return a===b;if(a===b)return!0;if(d.isArray(a)&&d.isArray(b)){if(a.length!=b.length)return!1;for(var c=0,e=a.length;c<e;c++)if(!d.equals(a[c],b[c]))return!1;return!0}if(!d.isArray(a)&&!d.isArray(b)){if(d.count(a)!=d.count(b))return!1;for(c in a)if(void 0==b[c]||!d.equals(a[c],b[c]))return!1;return!0}}return!1},clone:function(a){if(null==a||"object"!=typeof a)return a;var b=a.constructor;if(b!=window.Object&&b!=window.Array)return a;if(b==window.Date||b==window.RegExp||
b==window.Function||b==window.String||b==window.Number||b==window.Boolean)return new b(a);try{var c=new b,e;for(e in a)c[e]=d.clone(a[e]);return c}catch(g){return a}},isEmpty:function(a){if(d.isArray(a))return 0==a.length;for(var b in a)return!1;return!0},each:function(a,b,c){var e,g=0,h=a.length,f=void 0===h||d.isFunction(a);if(c)if(f)for(e in a){if(!1===b.apply(a[e],c))break}else for(;g<h&&!1!==b.apply(a[g],c);)e=a.length,h==e?g++:h=e;else if(f)for(e in a){if(!1===b.call(a[e],e,a[e]))break}else for(;g<
h&&!1!==b.call(a[g],g,a[g]);)e=a.length,h==e?g++:h=e;return a},contains:function(a,b){var c=!1;d.each(a,function(a,g){if(d.equals(g,b))return c=!0,!1});return c},largeThan:function(a,b){if("object"==typeof a&&"object"==typeof b){var c=!0;d.each(b,function(e){if(!d.equals(b[e],a[e]))return c=!1});return c}},count:function(a){if(d.isArray(a))return a.length;var b=0,c;for(c in a)b++;return b},removeUndefined:function(a,b){var c=d.isArray(a);if(b){if(c){var e=[];d.each(a,function(a,b){void 0!==b&&e.push(b)});
return e}return d.extend({},a,{isClone:!0,notCover:function(a,b){return void 0===b}})}d.each(a,function(b,e){void 0===e&&(c?a.splice(b,1):delete a[b])});return a},toArray:f,getSingleton:function(a){a="string"==typeof a?d.namespace(a):a;return a._singleton||(a._singleton=new a)},generateMethod:function(a,b,c){b=d.isArray(b)?b:b.split(",");for(var e=0;e<b.length;e++){var g=b[e];a[g]=c(g)}}};return d});
...
handy.add("Events",function(f){return{_eventCache:{},_parseEvents:function(d,a){var b=/\s+/;if("object"==typeof d){for(var c in d)a([c,d[c]]);return!0}if("string"==typeof d&&b.test(d)){b=d.split(b);c=0;for(var e=b.length;c<e;c++)a([b[c]]);return!0}return!1},_parseCustomEvents:function(d,a,b){var c=this,e=f.toArray(arguments,2);return c._parseEvents(a,function(a){c[d].apply(c,a.concat(e))})},_delegateHandler:function(d,a){var b=this;return function(){if(!0!=b.isSuspend)return d.apply(a||b,arguments)}},
on:function(d,a,b,c){if(!this._parseCustomEvents("on",d,a,b,c)){"number"==typeof b&&(c=b,b=null);var e=this._eventCache,g=e[d];g||(g=e[d]=[]);d=this._delegateHandler(a,b);g.push({times:c,handler:a,context:b,delegation:d})}},once:function(d,a,b){var c=f.toArray(arguments);this.on.apply(this,c.push(1))},off:function(d,a){if("all"==d)return this._eventCache={},!0;if(!this._parseCustomEvents("off",d,a)){var b=this._eventCache,c=d.indexOf(".");if(!a&&0>=c){for(var e in b)(e.split(".")[0]==d||0==c&&0<=
e.indexOf(d))&&delete b[e];return!0}c=b[d];if(!c)return!1;if(a){b=0;for(e=c.length;b<e;b++)if(c[b].handler==a)return c.splice(b,1),!0}else return delete b[d],!0;return!1}},suspend:function(){if(this.isSuspend)return!1;this.isSuspend=!0},resume:function(){if(!this.isSuspend)return!1;this.isSuspend=!1},trigger:function(d,a){function b(a){if(a)for(var b=0,e=a.length;b<e;b++){var d=a[b],f=d.delegation;"number"==typeof d.times&&(1<d.times?d.times--:c.off(j,d.handler));h=f.apply(null,g)}}var c=this,e=f.toArray(arguments);
e.unshift("trigger");if(!c._parseCustomEvents.apply(c,e)){var e=c._eventCache,g=f.toArray(arguments),h,k;if(0<d.indexOf("."))k=e[d],b(k);else for(var j in e)if(k=d.indexOf("."),j.split(".")[0]==d||0==k&&0<=j.indexOf(d))k=e[j],b(k);b(e.all);return h}}}});
...
a,b){if(f.len(d)>a){!0===b?b=2:0<b||(b=0);var c=0,e=0;for(a-=b;e<a;)255<d.charCodeAt(c)?e+=2:e++,c++;d=d.substring(0,c);for(c=0;c<b;c++)d+="."}return d},isNumber:function(d){return 0==d.search(/^\d+$/g)},hasChn:function(d){return/[\u4E00-\u9FA5]+/.test(d)},isChn:function(d){return/^[\u4E00-\u9FA5]+$/.test(d)},addParam:function(d,a){a&&(d+=(-1<d.indexOf("?")?"&":"?")+a);return d}};return f});
