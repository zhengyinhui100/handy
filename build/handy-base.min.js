...
return!0},each:function(b,a,d){if(b){var f,g=0,e=b.length,h=void 0===e||c.isFunc(b);if(d)if(h)for(f in b){if(!1===a.apply(b[f],d))break}else for(;g<e&&!1!==a.apply(b[g],d);)f=b.length,e==f?g++:e=f;else if(h)for(f in b){if(!1===a.call(b[f],f,b[f]))break}else for(;g<e&&!1!==a.call(b[g],g,b[g]);)f=b.length,e==f?g++:e=f;return b}},contains:function(b,a){if(!b)return!1;var d=!1;c.each(b,function(b,g){if(c.equals(g,a))return d=!0,!1});return d},largeThan:function(b,a){if("object"==typeof b&&"object"==typeof a){var d=
...
a=a?a.prototype:c||this.constructor.superProto;d=d.$name;if(a&&(d=a[d],e.isFunc(d)))return d.apply(this,b)};a&&this.ns(a,d);return d},inherit:function(a,b,f,g,j){var h=function(){};h.prototype=b.prototype;e.extend(a,b,j);a.prototype=new h;a.prototype.constructor=a;a.superClass=b;a.superProto=b.prototype;if(b._onInherit)try{b._onInherit(a)}catch(k){c.error(k)}g&&e.extend(a,g);f&&e.extend(a.prototype,f)},getSingleton:function(a){return(a="string"==typeof a?e.ns(a):a)&&(a.$singleton||(a.$singleton=new a))}};
return b});
...
b[0]*Math.PI/180;b=a*Math.PI/180-b[1]*Math.PI/180;b=2*Math.asin(Math.sqrt(Math.pow(Math.sin((j-h)/2),2)+Math.cos(j)*Math.cos(h)*Math.pow(Math.sin(b/2),2)));b=Math.round(63781370*b);if(f){if(isNaN(b))return"\u672a\u77e5";b=1E3<b?(b/1E3).toFixed(1)+"km":b+"m"}return b},result:function(a,b){var c=a[b];return e.isFunc(c)?c():c}}});
