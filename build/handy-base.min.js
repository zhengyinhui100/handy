...
("undefined"!=typeof b[g]&&"console"in window&&!Function[g])&&(console.log(b[g]),console.log(a+"\u547d\u540d\u51b2\u7a81:"+g)),b[g]=d[g]};b.noConflict=function(a){window.$===b&&(window.$=c);a&&window.handy===b&&(window.handy=e);return b};b.noop=function(){}})();
handy.add("Json",function(){function e(a){h.lastIndex=0;h.test(a)&&(a=a.replace(h,function(a){var d=j[a];return"string"===typeof d?d:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function c(b,h){var g,k,j,m,t=d,p,n=h[b];n&&("object"===typeof n&&"function"===typeof n.toJSON)&&(n=n.toJSON(b));"function"===typeof a&&(n=a.call(h,b,n));switch(typeof n){case "string":return e(n);case "number":return isFinite(n)?String(n):"null";case "boolean":case "null":return String(n);case "object":if(!n)return"null";
d+=f;p=[];if("[object Array]"===Object.prototype.toString.apply(n)){m=n.length;for(g=0;g<m;g+=1)p[g]=c(g,n)||"null";j=0===p.length?"[]":d?"[\n"+d+p.join(",\n"+d)+"\n"+t+"]":"["+p.join(",")+"]";d=t;return j}if(a&&"object"===typeof a){m=a.length;for(g=0;g<m;g+=1)"string"===typeof a[g]&&(k=a[g],(j=c(k,n))&&p.push(e(k)+(d?": ":":")+j))}else for(k in n)Object.prototype.hasOwnProperty.call(n,k)&&(j=c(k,n))&&p.push(e(k)+(d?": ":":")+j);j=0===p.length?"{}":d?"{\n"+d+p.join(",\n"+d)+"\n"+t+"}":"{"+p.join(",")+
"}";d=t;return j}}var b="JSON"in window,a,d,f,h=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,j={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},g=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/^[\],:{}\s]*$/,m=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,t=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,p=/(?:^|:|,)(?:\s*\[)+/g;
return{stringify:function(h,g,k,j){if(b&&!j)return JSON.stringify.apply(null,arguments);var e;f=d="";if("number"===typeof k)for(e=0;e<k;e+=1)f+=" ";else"string"===typeof k&&(f=k);if((a=g)&&"function"!==typeof g&&("object"!==typeof g||"number"!==typeof g.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return c("",{"":h})},parseJson:function(a,d,f){function c(a,b){var f,h,g=a[b];if(g&&"object"===typeof g)for(f in g)Object.prototype.hasOwnProperty.call(g,
f)&&(h=c(g,f),void 0!==h?g[f]=h:delete g[f]);return d.call(a,b,g)}if(b&&!f)return JSON.parse.apply(null,arguments);var h;a=String(a);g.lastIndex=0;g.test(a)&&(a=a.replace(g,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(k.test(a.replace(m,"@").replace(t,"]").replace(p,"")))return h=eval("("+a+")"),"function"===typeof d?c({"":h},""):h;$D.error(new SyntaxError("JSON.parse"))}}});
handy.add("Object",function(){var e;e=(e=window.navigator.userAgent.match(/MSIE ([\d.]+)/))&&9>parseInt(e[0])?function(b,a,d){var f=[];if(b.length){a=a||0;for(d=d||b.length;a<d;a++)f.push(b[a])}return f}:function(b,a,d){return Array.prototype.slice.call(b,a||0,d||b.length)};var c={_alias:{B:"handy.base",C:"handy.component",M:"handy.module",CM:"handy.common"},ns:function(b,a){var d=null,f,h,j,g;b=c.alias(b);h=b.split(".");d=h[0];d=(j=2==arguments.length)?eval("(function(){if (typeof "+d+' == "undefined"){'+
d+" = {};}return "+d+";})()"):eval("(function(){if (typeof "+d+' != "undefined")return '+d+";})()");f=1;for(g=h.length;f<g;++f){if(f==g-1&&j)d[h[f]]=a;else if(j||d&&d[h[f]])d[h[f]]=d[h[f]]||{};else return;d=d[h[f]]}return d},alias:function(b,a){var d=c._alias;if(a)d[b]?$D.error("\u522b\u540d\u5df2\u88ab\u4f7f\u7528"+b+":"+d[b]):d[b]=a;else{if(b){var f=b,h=b.length-1;do{if(d[f])return d[f]+b.substring(h);h=f.lastIndexOf(".")}while(0<h&&(f=f.substring(0,h)));return b}return d}},extend:function(b,a,
d){if(!a||c.isStr(a)||c.isNum(a))return b;var f=d?d.notCover:!1,h=d?d.cover:null;d=d?d.IsClone:!1;b=b||{};var j=b.constructor,g=j.$isClass,k,e;for(e in a)if(k=a[e],(!h||c.contains(h,e))&&a.hasOwnProperty(e)){var t=b.hasOwnProperty(e),p=!0===f?t:!1;c.isArr(f)?p=c.contains(f,e)&&t:c.isFunc(f)&&(p=f(e,k));p||(k=d?c.clone(k):k,g&&c.isFunc(k)&&(k.$name=e,k.$owner=j),b[e]=k)}return b},mix:function(b,a,d){b.superProto||(b.superProto={});for(var f in a)b.superProto[f]=c.isFunc(a[f])?b.superProto[f]?function(d,
...
b[d];a[c.name]=c.value}return a},generateMethod:function(b,a,d){a=c.isArr(a)?a:a.split(",");for(var f=0;f<a.length;f++){var h=a[f];b[h]=d(h)}}};return c});
...
if((d=e.match(/AppleWebKit\/([\d.]*)/))&&d[1])if(/ Mobile\//.test(e)&&e.match(/iPad|iPod|iPhone/)){c.mobile="ios";if((d=e.match(/OS ([^\s]*)/))&&d[1])c.ios=d[1].replace("_",".");if((d=e.match(/iPad|iPod|iPhone/))&&d[0])c[d[0].toLowerCase()]=c.ios}else if(/ Android/i.test(e)){if(/Mobile/.test(e)&&(c.mobile="android"),(d=e.match(/Android ([^\s]*);/))&&d[1])c.android=d[1]}else if(d=e.match(/NokiaN[^\/]*|Android \d\.\d|webOS\/\d\.\d/))c.mobile=d[0].toLowerCase();var f;try{if(c.ie){var h=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
...
'<div style="padding-top:5px;height:90%;overflow:auto;"></div>',k.style.position="fixed",k.style.width=g.body.offsetWidth-20+"px",k.style.left=0,k.style.top=0,k.style.right=0,k.style.height="150px",k.style.backgroundColor="#aaa",k.style.fontSize="12px",k.style.padding="10px",k.style.zIndex=9999999999,k.style.opacity=0.8,k.style.filter="alpha(opacity=80)",g.body.appendChild(k));e=k.getElementsByTagName("DIV")[0];g=b.Json.stringify(d,null,"&nbsp;&nbsp;&nbsp;&nbsp;",!0).replace(/\n/g,"<br/>");e.innerHTML+=
c+" : "+g+"<br/>";e.scrollTop=e.scrollHeight}e=arguments.callee.caller;e.$owner||(e=e.caller);try{if(e.$owner)console[c]("["+e.$owner.$ns+"->"+e.$name+"]");console[c](d)}catch(m){}},log:function(d,b){a.level>a.LOG_LEVEL||a.out(d,!!b,"log")},info:function(d,b){this.level>a.INFO_LEVEL||a.out(d,!!b,"info")},warn:function(d,b){a.level>a.WARN_LEVEL||a.out(d,!!b,"warn")},error:function(d,b){if(!(a.level>a.ERROR_LEVEL)&&(a.out(d,!!b,"error"),d instanceof Error))throw d;},time:function(d,b,c){a.level>a.INFO_LEVEL||
...
handy.add("Function",function(e){return{bind:function(c,b,a){var d=Array.prototype.slice.call(arguments,2);return function(){Array.prototype.push.apply(d,arguments);return c.apply(b,d)}},intercept:function(c,b,a,d){return e.Object.isFunc(c)&&e.Object.isFunc(b)?function(){var f=a||this,h={},e=arguments;h.scope=d;h.target=f;h.method=c;return!1!=b.apply(h,e)?c.apply(f,e):!1}:c}}});
handy.add("Class",["B.Object","B.Debug"],function(e,c){var b={createClass:function(a){var d=function(){var a,b,c=arguments;if(this.constructor==d)a=this;else return a=c.callee,b=function(){},b.prototype=a.prototype,b=new b,a.apply(b,c),b;if(b=a.initialize){for(var g in a)"object"==typeof a[g]&&(a[g]=e.clone(a[g]));return b.apply(a,c)}};d.$isClass=!0;d.derive=function(a,d,c){var g=b.createClass();b.inherit(g,this,a,d,c);return g};d.prototype.callSuper=function(a,d){a&&(!a.$isClass&&void 0!=a.length)&&
(d=a,a=null);var b=arguments.callee.caller,c=b.$owner.superProto;d=d||b.arguments;a=a?a.prototype:c||this.constructor.superProto;b=b.$name;if(a&&(b=a[b],e.isFunc(b)))return b.apply(this,d)};a&&this.ns(a,d);return d},inherit:function(a,d,b,h,j){var g=function(){};g.prototype=d.prototype;e.extend(a,d,j);a.prototype=new g;a.prototype.constructor=a;a.superClass=d;a.superProto=d.prototype;if(d._onInherit)try{d._onInherit(a)}catch(k){c.error(k)}h&&e.extend(a,h);b&&e.extend(a.prototype,b)},getSingleton:function(a){return(a=
"string"==typeof a?e.ns(a):a)&&(a.$singleton||(a.$singleton=new a))}};return b});
handy.add("Loader",["B.Debug","B.Object","B.Function"],function(e,c,b,a){function d(a){var d={},b=[];"string"==typeof a&&(a=[a]);for(var f=0,g=a.length;f<g;f++){var e;e=a[f];e=/\.(css|js)$/.test(e)?v[e]&&"loaded"==v[e].status:q.urlMap&&q.urlMap[e]?q.urlMap[e].chkExist():c.ns(e);if(e)b.push(e);else return d.notExist=a[f],d}d.exist=b;return d}function f(a,d){function b(){b.isCalled||(b.isCalled=!0,clearTimeout(k),d())}if("SCRIPT"===a.nodeName){var c=a,f=b;c.onload=c.onerror=c.onreadystatechange=function(){/loaded|complete|undefined/.test(c.readyState)&&
(c.onload=c.onerror=c.onreadystatechange=null,t.removeChild(c),c=null,setTimeout(f,0))}}else{var g=b;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",g):setTimeout(function(){h(a,g)},0)}var k=setTimeout(function(){e.error("Time is out:"+a.src);b()},q.timeout)}function h(a,d){if(!d.isCalled){var b;if(p)a.sheet&&(b=!0);else if(a.sheet)try{a.sheet.cssRules&&(b=!0)}catch(c){if("SecurityError"===c.name||"NS_ERROR_DOM_SECURITY_ERR"===c.name)b=!0}setTimeout(function(){b?d():h(a,d)},1)}}function j(a){q.showLoading(!1);
x--;v[a].status="loaded";q.traceLog&&e.info(k+"Response: "+a);g()}function g(){for(var a=r.length-1;0<=a;a--){var b=r[a],c=d(b.deps);if(c.notExist)0==a&&0==x&&$D.error(m+c.notExist);else{r.splice(a,1);b.callback.apply(null,c.exist);g();break}}}var k="[Handy Loader] ",m=k+"not found: ",t=document.head||document.getElementsByTagName("head")[0]||document.documentElement,p=navigator.userAgent.indexOf("AppleWebKit"),r=[],x=0,v={},q={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(d,
b,f){d=a.Object.alias(d);2==arguments.length&&(f=b,b=[]);q.require(b,function(){var a;if("function"==typeof f)try{a=f.apply(null,arguments),q.traceLog&&e.info(k+"define: "+d)}catch(b){b.message=k+d+":factory define error:"+b.message;e.error(b);return}else a=f;if(a){c.ns(d,a);var g=typeof a;if("object"==g||"function"==g)a.$ns=d}else $D.error(k+"factory no return: "+d)})},require:function(c,g){for(var h="string"==typeof c?[c]:c,p=[],n=[],s=!0,u=0,z=h.length;u<z;u++){var l=h[u],l=a.Object.alias(l),w=
d(l);w.notExist?(p.push(l),s&&(s=!1,r.push({deps:h,callback:g})),q.traceLog&&e.info(m+l)):n.push(w.exist[0])}if(0==p.length)return g&&g.apply(null,n),0==n.length?n[0]:n;s=!1;h=0;for(n=p.length;h<n;h++)if(u=p[h],!v[u]){s=u;l=q.urlMap&&q.urlMap[s]&&q.urlMap[s].url;if(!l){z="";l=q.rootPath;if("string"==typeof l)z=l;else if("object"==typeof l)for(w in w=void 0,l)0==s.indexOf(w)&&(z=l[w],s=s.replace(w,""));else z="";l=/.css$/.test(s)?0==s.indexOf("/")?s:"/css/"+s:/.js$/.test(s)?s:s.replace(/\./g,"/")+
".js";0!=l.indexOf("/")&&(l="/"+l);l=z+l}s=!0;v[u]={id:u,status:"loading"};z=b.bind(j,null,u);if(/.css$/.test(l))a:{u=l;l=t.getElementsByTagName("link");for(w=0;w<l.length;w++){var A=l[w].href;!q.skinNode&&0<=A.indexOf(q.skinName)&&(q.skinNode=l[w]);if(0<=A.indexOf(u)||0<=u.indexOf(A))break a}l=document.createElement("link");l.rel="stylesheet";l.href=u;f(l,z);t.insertBefore(l,q.skinNode);q.traceLog&&e.info(k+"request:"+u)}else u=l,l=document.createElement("script"),l.async="async",l.src=u,l.type=
"text/javascript",f(l,z),t.appendChild(l),q.traceLog&&e.info(k+"request:"+u);x++}s&&q.showLoading(!0)}};return q});
...
!0},resume:function(){if(!this.isSuspend)return!1;this.isSuspend=!1},trigger:function(c,b){function a(a){if(a)for(var b=0,f=a.length;b<f;b++){var g=a[b];g.args=h;g.name=c;d._pushEvent(g)}}var d=this,f=e.toArray(arguments);f.unshift("trigger");if(!d._parseCustomEvents.apply(d,f)){var f=d._eventCache,h=e.toArray(arguments),j;if(0<c.indexOf("."))j=f[c],a(j);else for(var g in f)if(j=c.indexOf("."),g.split(".")[0]==c||0==j&&0<=g.indexOf(c))j=f[g],a(j);a(f.all);return d._execEvents()}}}});
...
a.getFullYear());return Math.ceil((a.getTime()-d.getTime())/864E5)},formatDate:function(a,d){d=d||"yyyy-MM-dd HH:mm:ss";a=a||new e;var b=a.getHours(),h=Math.floor((a.getMonth()+3)/3),b={"y+":a.getFullYear(),"M+":a.getMonth()+1,"d+":a.getDate(),"h+":0==b%12?12:b%12,"H+":b,"m+":a.getMinutes(),"s+":a.getSeconds(),"w+":c.getWeek(a),"q+":h,"Q+":["\u4e00","\u4e8c","\u4e09","\u56db"][h-1],"S+":a.getMilliseconds()},j;for(j in b)RegExp("("+j+")").test(d)&&(h=RegExp.$1.length,d=d.replace(RegExp.$1,1==h?b[j]:
("00"+b[j]).slice(-h)));return d},parseDate:function(a,b){var c=typeof a,h=new e;if("number"==c)return h.setTime(a),h;if("string"!=c)return a;var c=(b||"yyyy-MM-dd HH:mm:ss").match(/[a-zA-Z]+/g),j=a.match(/\d+/g);if(j){for(var g=0;g<j.length;g++){var k=c[g],m=parseInt(j[g]);switch(k){case "yyyy":h.setFullYear(m);break;case "MM":h.setMonth(m-1);break;case "dd":h.setDate(m);break;case "HH":h.setHours(m);break;case "mm":h.setMinutes(m);break;case "ss":h.setSeconds(m);break;case "SS":h.setMilliseconds(m)}}return h}},
...
handy.add("Util","B.Object",function(e,c){var b=0;return{isWindow:function(a){return null!=a&&a==a.window},getUuid:function(){return b++},getHash:function(){return top.location.hash.replace(/\?.*/,"")},setHash:function(a){var b=top.location.hash;0<=b.indexOf("#")&&(a=b.replace(/#[^\?]*/,a));top.location.hash=a},distance:function(a,b,f){function e(a){a.get?a=[a.get("latitude"),a.get("longitude")]:c.isObj(a)&&(a=[a.latitude,a.longitude]);return a}var j;a=e(a);j=a[0];a=a[1];b=e(b);j=j*Math.PI/180;var g=
b[0]*Math.PI/180;b=a*Math.PI/180-b[1]*Math.PI/180;b=2*Math.asin(Math.sqrt(Math.pow(Math.sin((j-g)/2),2)+Math.cos(j)*Math.cos(g)*Math.pow(Math.sin(b/2),2)));b=Math.round(63781370*b);b=(b/1E3).toFixed(2);if(f){if(isNaN(b))return"\u672a\u77e5";b+="km"}return b},result:function(a,b){var c=a[b];return e.isFunc(c)?c():c}}});
handy.add("Array","B.Object",function(e,c){function b(a){return a}function a(a){return function(b){return b[a]}}function d(d){return null==d?b:c.isFunc(d)?d:a(d)}function f(a){return function(b){if(b===a)return!0;for(var d in a)if(a[d]!==b[d])return!1;return!0}}function h(a){return function(b,c,f){var h={};c=d(c);e.each(b,function(d,e){var j=c.call(f,e,d,b);a(h,j,e)});return h}}var j={map:function(a,b,d){var c=[];if(null==a)return c;var f=Array.prototype.map;if(f&&a.map===f)return a.map(b,d);e.each(a,
...
a,e)&&f.push(c)});return f},where:function(a,b){return this.filter(a,f(b))},findWhere:function(a,b){return this.find(a,f(b))},invoke:function(a,b){var d=Array.prototype.slice.call(arguments,2),c=e.isFunc(b);return this.map(a,function(a){return(c?b:a[b]).apply(a,d)})},sortedIndex:function(a,b,c,f){c=d(c);b=c.call(f,b);for(var e=0,h=a.length;e<h;){var j=e+h>>>1;c.call(f,a[j])<b?e=j+1:h=j}return e},sortBy:function(a,b,c){b=d(b);return this.pluck(this.map(a,function(a,d,f){return{value:a,index:d,criteria:b.call(c,
a,d,f)}}).sort(function(a,b){var d=a.criteria,c=b.criteria;if(d!==c){if(d>c||void 0===d)return 1;if(d<c||void 0===c)return-1}return a.index-b.index}),"value")},groupBy:h(function(a,b,d){a[b]?a[b].push(d):a[b]=[d]}),countBy:h(function(a,b){a[b]?a[b]++:a[b]=1})};return j});
handy.add("Template",["B.String","B.Debug"],function(e,c,b){function a(a){return g?"$r+="+a+";\n":"$r.push("+a+");\n"}function d(b){b=b.replace(/("|\\)/g,"\\$1").replace(/\r/g,"\\r").replace(/\n/g,"\\n");return a('"'+b+'"')}var f={openTag:"<%",closeTag:"%>",isEscape:!0,registerHelper:function(a,b){k[a]||(m+=a+"=oHelpers."+a+",");k[a]=b},tmpl:function(e,p){var r,x,v;if("string"==typeof e)r=e;else if(void 0!=e.length)r=e.join("");else if(r=e.tmpl,v=e.id)if(h[v])x=h[v];else if(!r){var q=document.getElementById(v);
q&&(r=(q.value||q.innerHTML).replace(/\s/g,""))}if(!x){if(!r){b.Debug.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}a:{var y=m+"$r="+(g?'""':"[]")+";\n";b.Object.each(r.split(f.openTag),function(b,c){var e=c.split(f.closeTag);if(1==e.length)y+=d(e[0]);else{var h=y,g=e[0],g=g.replace(/this/g,"$data");0==g.indexOf("=")&&(g="("+g.replace(j,"")+")",g=a(g+'==undefined?"":'+g));y=h+(g+"\n");e[1]&&(y+=d(e[1]))}});y+="return "+(g?"$r;":'$r.join("");');try{var B=new Function("$data",y)}catch(C){c.log(y);
c.error(C);x=void 0;break a}B.$helpers=k;x=B}v&&(h[v]=x)}return p?x(p):x}},h={},j=/^=/,g="".trim,k={escape:e.escapeHTML,trim:e.trim},m="var oHelpers=arguments.callee.$helpers,escape=oHelpers.escape,trim=oHelpers.trim,";return f});
handy.add("HashChange",["handy.base.Debug","handy.base.Util"],function(e,c,b){function a(a){if(a==m)return!1;var b=k.contentWindow.document;b.open();b.write("<!doctype html><html><body>"+a+"</body></html>");b.close();m=a;e.log("set:"+k.contentWindow.document.body.innerText)}function d(){var b=c.getHash(),d=k.contentWindow.document.body.innerText;b!=m?(a(b),f(b)):d!=m&&(e.log("update:"+k.contentWindow.document.body.innerText),c.setHash(d))}function f(a){var b=r.listeners,d;for(d in b)b[d](a)}var h,
j=0,g=document,k,m,t=g.documentMode,p="onhashchange"in window&&(void 0===t||7<t),r={delay:50,listen:function(e,m){if(!h&&!h)if(h=!0,r.listeners={},p)$(window).on("hashchange",function(){f(c.getHash())});else k=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(g.body)[0],$(k).one("load",function(){a(c.getHash());setInterval(d,r.delay)});if(m in r.listeners)$D.error(Error("Duplicate name"));else return m=m||b.expando+ ++j,r.listeners[m]=e,m},unListen:function(a){for(var b in r.listeners)(!a||
...
equalTo:"\u8bf7\u8f93\u5165\u76f8\u540c\u7684{name}",min:"{name}\u4e0d\u80fd\u5c0f\u4e8e{0}",max:"{name}\u4e0d\u80fd\u5927\u4e8e{0}",range:"{name}\u8981\u5728{0}\u5230{1}\u4e4b\u95f4",maxlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u8d85\u8fc7{0}",minlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u5c11\u4e8e{0}",rangelength:"{name}\u957f\u5ea6\u8981\u5728{0}\u5230{1}\u4e4b\u95f4"},valid:function(a,d){var c=d.rules,e;for(e in c){var j=c[e],g=("function"==typeof j?j:b[e])(a,j);if(!g)return c=d.error||b.error,e=d.messages&&
...
handy.add("LocalStorage",["B.Browser","B.Events","B.Json"],function(e,c,b){c={_init:function(){!a&&e.ie()&&(f=document.getElementById("LocalStorageUserDataDiv"),f||(f=document.createElement("DIV"),f.style.display="none",f.id="LocalStorageUserDataDiv",f.addBehavior("#default#userData"),document.body.appendChild(f),f.load(h)))},getItem:function(c){c=a?d.getItem(c):f.getAttribute(c);return c=b.parseJson(c)},setItem:function(c,e){e=b.stringify(e);try{a?d.setItem(c,e):(f.setAttribute(c,e),f.save(h))}catch(k){return $D.error(k),
!1}return!0},removeItem:function(b){a?d.removeItem(b):(f.removeAttribute(b),f.save(h))},clear:function(){a?d.clear():f.unload()}};var a=window.localStorage&&window.localStorage.getItem,d=window.localStorage,f,h=document.domain;c._init();return c});(function(e){Hui=H=$H=e.noConflict();$D=$H.Debug;$HD=$H.Date;$Define=$H.Loader.define;$Require=$H.Loader.require;$G={config:{}};e=window.$;e.fn.remove=$H.intercept(e.fn.remove,function(){$H.trigger("removeEl",this.target)})})(handy);
