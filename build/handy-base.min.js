...
(function(){var g=window.handy,b=window.$,e=window.handy=window.$=function(){};e.version="1.0.0";e.expando="handy"+(e.version+Math.random()).replace(/\D/g,"");e.add=function(a,c,d){d||(d=c,c=null);if(!c||!e.Loader){e.base||(e.base={});var b=[];if(c)if("string"==typeof c)b.push(e.base.Object.namespace(c));else for(var f=0;f<c.length;f++)b.push(e.base.Object.namespace(c[f]));b.push(e);c=d.apply(window,b);e.base[a]=e[a]=c;if(0<="Browser,Events,Function,Object,String,Template,Util".indexOf(a)){for(var h in c)"undefined"!=
typeof e[h]&&("console"in window&&!Function[h])&&(console.log(e[h]),console.log(a+"\u547d\u540d\u51b2\u7a81:"+h)),e[h]=c[h];"Events"==a&&(e._eventCache={})}}else e.Loader.require(c,function(){Array.prototype.push.call(arguments,e);e.base[a]=e[a]=d.apply(window,arguments)})};e.noConflict=function(a){window.$===e&&(window.$=b);a&&window.handy===e&&(window.handy=g);return e};e.noop=function(){}})();
handy.add("Json",function(){function g(a){j.lastIndex=0;j.test(a)&&(a=a.replace(j,function(a){var c=f[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function b(e,j){var f,h,k,n,r=c,q,l=j[e];l&&("object"===typeof l&&"function"===typeof l.toJSON)&&(l=l.toJSON(e));"function"===typeof a&&(l=a.call(j,e,l));switch(typeof l){case "string":return g(l);case "number":return isFinite(l)?String(l):"null";case "boolean":case "null":return String(l);case "object":if(!l)return"null";
c+=d;q=[];if("[object Array]"===Object.prototype.toString.apply(l)){n=l.length;for(f=0;f<n;f+=1)q[f]=b(f,l)||"null";k=0===q.length?"[]":c?"[\n"+c+q.join(",\n"+c)+"\n"+r+"]":"["+q.join(",")+"]";c=r;return k}if(a&&"object"===typeof a){n=a.length;for(f=0;f<n;f+=1)"string"===typeof a[f]&&(h=a[f],(k=b(h,l))&&q.push(g(h)+(c?": ":":")+k))}else for(h in l)Object.prototype.hasOwnProperty.call(l,h)&&(k=b(h,l))&&q.push(g(h)+(c?": ":":")+k);k=0===q.length?"{}":c?"{\n"+c+q.join(",\n"+c)+"\n"+r+"}":"{"+q.join(",")+
"}";c=r;return k}}var e="JSON"in window,a,c,d,j=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,f={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},h=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/^[\],:{}\s]*$/,n=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,l=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,s=/(?:^|:|,)(?:\s*\[)+/g;
return{stringify:function(j,f,h,g){if(e&&!g)return JSON.stringify.apply(null,arguments);var k;d=c="";if("number"===typeof h)for(k=0;k<h;k+=1)d+=" ";else"string"===typeof h&&(d=h);if((a=f)&&"function"!==typeof f&&("object"!==typeof f||"number"!==typeof f.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return b("",{"":j})},parse:function(a,c,d){function b(a,d){var e,f,j=a[d];if(j&&"object"===typeof j)for(e in j)Object.prototype.hasOwnProperty.call(j,
e)&&(f=b(j,e),void 0!==f?j[e]=f:delete j[e]);return c.call(a,d,j)}if(e&&!d)return JSON.parse.apply(null,arguments);var f;a=String(a);h.lastIndex=0;h.test(a)&&(a=a.replace(h,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(k.test(a.replace(n,"@").replace(l,"]").replace(s,"")))return f=eval("("+a+")"),"function"===typeof c?b({"":f},""):f;$D.error(new SyntaxError("JSON.parse"))}}});
handy.add("Object",function(g){var b;b=(b=window.navigator.userAgent.match(/MSIE ([\d.]+)/))&&9>parseInt(b[0])?function(a,c,d){var e=[];if(a.length){c=c||0;for(d=d||a.length;c<d;c++)e.push(a[c])}return e}:function(a,c,d){return Array.prototype.slice.call(a,c||0,d||a.length)};var e={_alias:{B:"handy.base",C:"handy.component",M:"handy.module",CM:"handy.common"},namespace:function(a,c){var d=null,b,f,h,g;a=e.alias(a);f=a.split(".");d=f[0];d=(h=2==arguments.length)?eval("(function(){if (typeof "+d+' == "undefined"){'+
d+" = {};}return "+d+";})()"):eval("(function(){if (typeof "+d+' != "undefined")return '+d+";})()");b=1;for(g=f.length;b<g;++b){if(b==g-1&&h)d[f[b]]=c;else if(h||d&&d[f[b]])d[f[b]]=d[f[b]]||{};else return;d=d[f[b]]}return d},alias:function(a,c){var d=e._alias;if(c)d[a]?$D.error("\u522b\u540d\u5df2\u88ab\u4f7f\u7528"+a+":"+d[a]):d[a]=c;else{if(a){var b=a,f=a.length-1;do{if(d[b])return d[b]+a.substring(f);f=b.lastIndexOf(".")}while(0<f&&(b=b.substring(0,f)));return a}return d}},createClass:function(a){var c=
...
d){var b=d?d.notCover:!1,f=d?d.cover:null;d=d?d.notClone:!1;a=a||{};var h=a.constructor,g=h.$isClass,n;for(n in c)if((!f||e.contains(f,n))&&c.hasOwnProperty(n)){var l=a.hasOwnProperty(n),s=!0===b?l:!1;e.isArray(b)?s=e.contains(b,n)&&l:e.isFunction(b)&&(s=b(n));s||(l=d?c[n]:e.clone(c[n]),g&&e.isFunction(l)&&(l.$name=n,l.$owner=h),a[n]=l)}return a},mix:function(a,c,d,b){a.superProto||(a.superProto={});for(var f in c)a.superProto[f]=e.isFunction(c[f])?a.superProto[f]?function(a,d){return function(){d.apply(this,
...
'<div style="padding-top:5px;height:90%;overflow:auto;"></div>',h.style.position="fixed",h.style.width=f.body.offsetWidth-20+"px",h.style.left=0,h.style.top=0,h.style.right=0,h.style.height="150px",h.style.backgroundColor="#aaa",h.style.fontSize="12px",h.style.padding="10px",h.style.zIndex=9999999999,h.style.opacity=0.8,h.style.filter="alpha(opacity=80)",f.body.appendChild(h));d=h.getElementsByTagName("DIV")[0];f=e.Json.stringify(c,null,"&nbsp;&nbsp;&nbsp;&nbsp;",!0).replace(/\n/g,"<br/>");d.innerHTML+=
b+" : "+f+"<br/>";d.scrollTop=d.scrollHeight}try{console[b](c)}catch(g){}},log:function(c,d){a.level>a.LOG_LEVEL||a.out(c,!!d,"log")},info:function(c,d){this.level>a.INFO_LEVEL||a.out(c,!!d,"info")},warn:function(c,d){a.level>a.WARN_LEVEL||a.out(c,!!d,"warn")},error:function(c,d){if(!(a.level>a.ERROR_LEVEL)&&(a.out(c,!!d,"error"),c instanceof Error))throw c;},time:function(c,d,b){a.level>a.INFO_LEVEL||(c?("boolean"==typeof d&&(b=d,d=""),a.out((d||"")+((new Date).getTime()-(a.lastTime||0)),!!b)):a.lastTime=
(new Date).getTime())},debug:function(c){if(!(a.level>a.DEBUG_LEVEL)&&!1!==c)debugger}};return a});handy.add("Function",function(g){return{bind:function(b,e,a){var c=Array.prototype.slice.call(arguments,2);return function(){Array.prototype.push.apply(c,arguments);return b.apply(e,c)}},intercept:function(b,e,a,c){return g.Object.isFunction(b)&&g.Object.isFunction(e)?function(){var d=a||this,j={},f=arguments;j.scope=c;j.target=d;j.method=b;return!1!=e.apply(j,f)?b.apply(d,f):!1}:b}}});
handy.add("Loader",["handy.base.Debug","handy.base.Object","handy.base.Function"],function(g,b,e,a){function c(a){function c(a){return/\.(css|js)$/.test(a)?s[a]&&"loaded"==s[a].status:p.urlMap&&p.urlMap[a]?p.urlMap[a].chkExist():b.namespace(a)}if("string"==typeof a)return c(a);for(var d=[],e=0,f=a.length;e<f;e++){var h=c(a[e]);if(h)d.push(h);else return!1}return d}function d(a,c){function d(){d.isCalled||(d.isCalled=!0,clearTimeout(h),c())}if("SCRIPT"===a.nodeName){var b=a,e=d;b.onload=b.onerror=
b.onreadystatechange=function(){/loaded|complete|undefined/.test(b.readyState)&&(b.onload=b.onerror=b.onreadystatechange=null,k.removeChild(b),b=null,setTimeout(e,0))}}else{var f=d;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",f):setTimeout(function(){j(a,f)},0)}var h=setTimeout(function(){g.error("Time is out:"+a.src);d()},p.timeout)}function j(a,c){if(!c.isCalled){var d;if(n)a.sheet&&(d=!0);else if(a.sheet)try{a.sheet.cssRules&&(d=!0)}catch(b){if("SecurityError"===b.name||"NS_ERROR_DOM_SECURITY_ERR"===
b.name)d=!0}setTimeout(function(){d?c():j(a,c)},1)}}function f(a){p.showLoading(!1);s[a].status="loaded";p.traceLog&&g.info("Loader Response: "+a);h()}function h(){for(var a=l.length-1;0<=a;a--){var d=l[a],b=c(d.deps);if(b){l.splice(a,1);d.callback.apply(null,b);h();break}}}var k=document.head||document.getElementsByTagName("head")[0]||document.documentElement,n=navigator.userAgent.indexOf("AppleWebKit"),l=[],s={},p={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(a,
c,d){2==arguments.length&&(d=c,c=[]);p.require(c,function(){var c;if("function"==typeof d)try{c=d.apply(null,arguments),p.traceLog&&g.info("Loader define: "+a)}catch(e){g.error("Loader "+a+":factory define error:"+e.message,e);return}else c=d;b.namespace(a,c);var f=typeof c;if("object"==f||"Function"==f)c.$ns=a})},require:function(b,h){for(var j="string"==typeof b?[b]:b,n=[],v=[],r=!0,q=0,u=j.length;q<u;q++){var m=j[q],t=c(m);t?v.push(t):(n.push(m),r&&(r=!1,l.push({deps:j,callback:h})),p.traceLog&&
g.info("Resource not found: "+m))}if(0==n.length)return h&&h.apply(null,v),0==v.length?v[0]:v;r=!1;j=0;for(v=n.length;j<v;j++)if(q=n[j],!s[q]){r=q;m=p.urlMap&&p.urlMap[r]&&p.urlMap[r].url;if(!m){u="";r=a.Object.alias(r);m=p.rootPath;if("string"==typeof m)u=m;else if("object"==typeof m)for(t in t=void 0,m)0==r.indexOf(t)&&(u=m[t],r=r.replace(t,""));else u="";m=/.css$/.test(r)?0==r.indexOf("/")?r:"/css/"+r:/.js$/.test(r)?r:r.replace(/\./g,"/")+".js";0!=m.indexOf("/")&&(m="/"+m);m=u+m}r=!0;s[q]={id:q,
status:"loading"};u=e.bind(f,null,q);if(/.css$/.test(m))a:{q=m;m=k.getElementsByTagName("link");for(t=0;t<m.length;t++){var w=m[t].href;!p.skinNode&&0<=w.indexOf(p.skinName)&&(p.skinNode=m[t]);if(0<=w.indexOf(q)||0<=q.indexOf(w))break a}m=document.createElement("link");m.rel="stylesheet";m.href=q;d(m,u);k.insertBefore(m,p.skinNode);p.traceLog&&g.info("Loader request:"+q)}else q=m,m=document.createElement("script"),m.async="async",m.src=q,m.type="text/javascript",d(m,u),k.appendChild(m),p.traceLog&&
g.info("Loader request:"+q)}r&&p.showLoading(!0)}};return p});
...
b.split(c.closeTag);1==d.length?e+=c._parseHtml(d[0]):(e+=c._parseScript(d[0]),d[1]&&(e+=c._parseHtml(d[1])))});e+="return "+(a?"$r;":'$r.join("");');return new Function("$data",e)},tmpl:function(a,e){var f,h,k;if("string"==typeof a)f=a;else if(f=a.tmpl,k=a.id)if(b[k])h=b[k];else{var n=document.getElementById(k);n&&(f=(n.value||n.innerHTML).replace(/\s/g,""))}if(!h){if(!f){g.Debug.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}h=c._compile(f);k&&(b[k]=h)}return e?h(e):h}};return c});
handy.add("HashChange",["handy.base.Debug","handy.base.Util"],function(g,b,e){function a(a){if(a==n)return!1;var b=k.contentWindow.document;b.open();b.write("<!doctype html><html><body>"+a+"</body></html>");b.close();n=a;g.log("set:"+k.contentWindow.document.body.innerText)}function c(){var c=b.getHash(),e=k.contentWindow.document.body.innerText;c!=n?(a(c),d(c)):e!=n&&(g.log("update:"+k.contentWindow.document.body.innerText),b.setHash(e))}function d(a){var b=p.listeners,c;for(c in b)b[c](a)}var j,
f=0,h=document,k,n,l=h.documentMode,s="onhashchange"in window&&(void 0===l||7<l),p={delay:50,listen:function(g,l){if(!j&&!j)if(j=!0,p.listeners={},s)$(window).on("hashchange",function(){d(b.getHash())});else k=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(h.body)[0],$(k).one("load",function(){a(b.getHash());setInterval(c,p.delay)});if(l in p.listeners)$D.error(Error("Duplicate name"));else return l=l||e.expando+ ++f,p.listeners[l]=g,l},unListen:function(a){for(var b in p.listeners)(!a||
a==b)&&delete p.listeners[b]}};return p});handy.add("Support",function(g){var b={mediaQuery:function(){var a;if(g.Browser.mobile())a="hui-mobile";else{a="hui-pc";var b=g.Browser.ie();b&&(a+=" ie"+b)}document.documentElement.className+=" "+a}};b.mediaQuery();if(6==g.Browser.ie())try{document.execCommand("BackgroundImageCache",!1,!0)}catch(e){}return b});
