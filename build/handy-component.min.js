...
this;b.itemXtype&&((b.defItem||(b.defItem={})).xtype=b.itemXtype);var a=b.model;a.each(function(a,c){b.addListItem(c)});b.listenTo(a,{add:function(a,c){b.addListItem(c)},remove:function(a,c){b.removeListItem(c)},reset:function(){b.removeListItem("emptyAll")}});b.hasPullRefresh=b.hasPullRefresh&&window.iScroll;b.hasPullRefresh&&(b.listen({name:"afterRender",handler:function(){var a=this,b=a.getEl();b.css({height:document.body.clientHeight-40});var c=b.find(".hui-list-pulldown"),d=c.find(".js-txt");
a.scroller=new window.iScroll(b[0],{useTransition:!0,topOffset:50,onRefresh:function(){c.hasClass("hui-pd-refresh")&&(c.removeClass("hui-pd-refresh hui-pd-release"),d.html("\u4e0b\u62c9\u53ef\u5237\u65b0"))},onScrollMove:function(){5<this.y&&!c.hasClass("hui-pd-release")?(c.addClass("hui-pd-release"),d.html("\u677e\u5f00\u53ef\u5237\u65b0"),this.minScrollY=0):5>this.y&&c.hasClass("hui-pd-release")&&(c.removeClass("hui-pd-release"),d.html("\u4e0b\u62c9\u53ef\u5237\u65b0"),this.minScrollY=-50)},onScrollEnd:function(){c.hasClass("hui-pd-release")&&
(c.addClass("hui-pd-refresh"),d.html("\u6b63\u5728\u5237\u65b0"),a.refresh())}})}}),b.listenTo(b.model,"sync",function(){b.findEl(".js-pdTime").html($H.formatDate($H.now(),"HH:mm"));setTimeout(function(){b.refreshScroller()},0)}),b.listen({name:"afterShow",handler:function(){b.refreshScroller()}}),b.listen({name:"click",method:"delegate",selector:".hui-list-more",handler:function(){b.getMore()}}))},addListItem:function(a){this.inited&&this.findEl(".js-empty").hide();this.add({model:a,renderTo:">.js-item-container"})},
removeListItem:function(a){"emptyAll"==a?this.remove(this.children):this.remove(function(c){return c.model&&c.model.id==a.id});0==this.children.length&&this.findEl(".js-empty").show()},refreshScroller:function(){this.scroller&&this.getEl()[0].clientHeight&&this.scroller.refresh()},destroy:function(){this.scroller&&(this.scroller.destroy(),this.scroller=null);this.callSuper()}});return a});
