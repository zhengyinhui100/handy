...
if(a=a.action)a=$H.extend({xtype:"Button",radius:null,isInline:!1,xrole:"action"},a),this.add(a)}});return a});$Define("C.List",["C.AbstractComponent","C.ControlGroup"],function(a,b){var c=a.define("List",b);c.extend({cls:"list",tmpl:["<div>",'<div class="hui-list-item">',"</div>","</div>"]});return c});
