...
return d=$H.Validator.valid(a,d)}for(var a=this.children,b=0,c=a.length;b<c;b++)if(d=a[b].valid(),!d)return d;return!0}},{define:function(d,a){var e=$HO.createClass();$HO.inherit(e,a||b,null,null,{notCover:function(d){return"define"==d}});$HO.getSingleton(c).registerType(d,e);return $C[d]=e}});return b});
