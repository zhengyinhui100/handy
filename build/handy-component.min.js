...
$Define("C.ComponentManager",["CM.AbstractManager","CM.ViewManager"],function(c,a){var b=c.extend({type:"component",initialize:function(){var d=$H.getSingleton(a);this._types=d._types;this._all=d._all}});$CM=new b;return b});
$Define("C.AbstractComponent",["CM.ViewManager","CM.View"],function(c,a){$C=$H.namespace("C",{});var b=$H.createClass();$H.inherit(b,a,{xtype:"AbstractComponent",activeCls:"hui-active",hasConfig:function(d,a){if(!a)return!1;if($H.isArray(a))for(var b=0,c=a.length;b<c;b++){if(this.match(d,a[b]))return!0}else if(this.match(d,a))return!0;return!1},doConfig:function(d){this.callSuper([d]);this.cls||(this.cls=this.xtype.toLowerCase());this.extCls=this.getExtCls();this.icon&&this.addItem({xtype:"Icon",
name:this.icon});this.isMini&&(this.defItem=$H.extend({isMini:!0},this.defItem))},getExtCls:function(){var d=["js-component"];this.extCls&&d.push(this.extCls);this.theme&&d.push("hui-"+this.cls+"-"+this.theme);this.radius&&d.push("hui-radius-"+this.radius);this.isMini&&d.push("hui-mini");this.shadow&&d.push("hui-shadow");this.shadowSurround&&d.push("hui-shadow-surround");this.shadowOverlay&&d.push("hui-shadow-overlay");this.shadowInset&&d.push("hui-shadow-inset");this.isActive&&d.push(this.activeCls);
...
return d=$H.Validator.valid(a,d)}for(var a=this.children,b=0,c=a.length;b<c;b++)if(d=a[b].valid(),!d)return d;return!0}},{define:function(d,a){var e=$H.createClass();$H.inherit(e,a||b,null,null,{notCover:function(d){return"define"==d}});$H.getSingleton(c).registerType(d,e);return $C[d]=e}});return b});
...
this.each(function(d,a){a.select($H.contains(b,a.value))})}else return a=this.find("$>[selected=true]"),b=[],$H.each(a,function(a,c){b.push(c.value)}),b.join(",")},onItemClick:function(a,b){this.select(b);this.itemClick&&this.itemClick(this.children[b],b)}});return c});
