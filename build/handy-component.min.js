...
$Define("C.ComponentManager",["CM.AbstractManager","CM.ViewManager"],function(a,b){var c=a.derive({type:"component",initialize:function(){var c=$H.getSingleton(b);this._types=c._types;this._all=c._all}});$CM=new c;return c});
...
this.isMini&&(this.defItem=$H.extend({isMini:!0},this.defItem))},getExtCls:function(){var b=["js-component","hui-"+this.cls];this.extCls&&b.push(this.extCls);this.tType&&b.push("hui-"+this.cls+"-"+this.tType);this.theme&&b.push("hui-"+this.cls+"-"+this.theme);this.radius&&b.push("hui-radius-"+this.radius);this.isMini&&b.push("hui-mini");this.shadow&&b.push("hui-shadow");this.shadowSurround&&b.push("hui-shadow-surround");this.shadowOverlay&&b.push("hui-shadow-overlay");this.shadowInset&&b.push("hui-shadow-inset");
this.isActive&&b.push(this.activeCls);this.isFocus&&b.push("hui-focus");this.isInline&&b.push("hui-inline");return 0<b.length?b.join(" "):""},active:function(){this.getEl().addClass(this.activeCls)},unactive:function(){this.getEl().removeClass(this.activeCls)},txt:function(b){var c=this.findEl(".js-"+this.cls+"-txt");0==c.length&&(c=this.findEl(".hui-"+this.cls+"-txt"));if(void 0!=b)c.text(b);else return c.text()},valid:function(){var b=this.validator;if(b){var c=this.val();b.error||(b.error=function(b){new $C.Tips({text:b,
theme:"error"})});return b=$H.Validator.valid(c,b)}for(var c=this.children,a=0,d=c.length;a<d;a++)if(b=c[a].valid(),!b)return b;return!0}},{define:function(b,f){var e=$H.createClass();$H.inherit(e,f||c,null,null,{notCover:function(b){return"define"==b}});$H.getSingleton(a).registerType(b,e);return $C[b]=e}});return c});
$Define("C.Icon","C.AbstractComponent",function(a){a=a.define("Icon");a.extend({tmpl:'<span class="<%if(this.isAlt){%> hui-alt-icon<%}%> hui-icon-<%=this.name%><%if(!this.noBg){%> hui-icon-bg<%}%>"></span>',doConfig:function(b){$H.isStr(b)&&(b={name:b});this.callSuper([b])}});return a});
...
$Define("C.Panel","C.AbstractComponent",function(a){a=a.define("Panel");a.extend({isLoading:!1,loadingTxt:"\u6b63\u5728\u52a0\u8f7d\u4e2d...",tmpl:'<div><%if(this.isLoading){%><div class="hui-panel-loading"><div class="hui-mask"></div><div class="hui-loading-container"><div class="hui-tips hui-tips-big hui-tips-black hui-radius-little"><span class="hui-icon hui-icon-loading"></span><span class="hui-tips-txt"><%=this.loadingTxt%></span></div></div></div><%}%><%=this.content||this.findHtml(">*")%></div>'});return a});
...
"disabled")}}),this.listeners.push({name:"hide",custom:!0,handler:function(){!0!=$H.Events.trigger("component.popup.hide")&&setTimeout(function(){$("input,textarea,select").removeAttr("disabled")},500)}}))},afterShow:function(){var c=this,a=c.getEl();a.css("z-index",1E3*b+1E3);if(!c.width&&c.parent){var e=c.width=c.parent.getEl().outerWidth();a.css("width",e)}a=c.showPos;if("string"==typeof a)c[a]();else"function"==typeof a&&a.call(c);c.noMask||c.mask();c.timeout&&setTimeout(function(){c.destroyed||
c.hide()},c.timeout)},hide:function(){!1!=this.callSuper()&&(this.noMask||this.unmask(),this.destroyWhenHide&&this.destroy())},top:function(){this.getEl().css({left:"80px",top:"8px",position:"fixed"})},center:function(){var b=this.getEl(),c=this.width||b.outerWidth(),a=this.height||b.outerHeight(),d=document,c=((d.documentElement.offsetWidth||d.body.offsetWidth)-c)/2,a=((d.documentElement.clientHeight||d.body.clientHeight)-a)/2+(d.documentElement.scrollTop||d.body.scrollTop),a=10>a?window.screen.height/
2-200:a;b.css({left:c+"px",top:a-(this.offsetTop||0)+"px"})},followEl:function(b){b=(b||this.parent.getEl()).position();this.getEl().css(b)},mask:function(){c||(c=$('<div class="hui-mask" style="display:none;"></div>').appendTo(document.body));c.css("z-index",1E3*b+998);0==b&&c.show();b++},unmask:function(){b--;0==b?c.hide():c.css("z-index",1E3*(b-1)+998)}});return a});
...
listeners:[{name:"click",handler:function(){this.showOptions()}}],doConfig:function(b){var c=this;c.callSuper();for(var a=b.options,f=!1,e=0,d=a.length;e<d;e++){var h=a[e];if(h.value==b.value){c.text=h.text;f=h.selected=!0;break}}f||delete c.value;c.add({itemClick:function(b){c.val(b.value)},width:c.width,items:a})},showOptions:function(){this.children[0].show()},val:function(b){if(b){if(this.value!=b){var c=this.children[0],a=c.find(">[value="+b+"]");0<a.length&&(this.trigger("change"),a=a[0],this.value=
b,this.findEl("input").attr("value",b),this.txt(a.text),c.select(a))}}else return this.value}});return a});
...
el:".js-input",handler:function(){this.getEl().addClass("hui-focus")}},{name:"blur",el:".js-input",handler:function(){this.getEl().removeClass("hui-focus")}}],doConfig:function(b){var c=this;"search"==b.type&&(c.icon="search");c.callSuper();"textarea"==c.type&&c.listeners.push({name:"input propertychange",el:".js-input",handler:function(){var b=c.findEl(".js-input"),a=b[0].scrollHeight;50<=a&&b.css("height",a)}});c.withClear&&c.add({xtype:"Button",radius:"big",icon:"delete",click:function(){this.parent.findEl("input").val("").focus()}})},
parseItem:function(b){"Icon"==b.xtype?this.hasIcon=!0:"Button"==b.xtype&&(this.hasBtn=!0)},val:function(b){var a=this.findEl("input,textarea");if(b)a.val(b);else return a.val()},focus:function(){this.findEl("input").focus()}});return a});$Define("C.Label","C.AbstractComponent",function(a){a=a.define("Label");a.extend({tmpl:'<label class="<%if(this.color){%> hui-label-<%=this.color%><%}%><%if(this.textAlign){%> c-txt-<%=this.textAlign%><%}%>" for="<%=this.forName%>"><%=this.text%></label>'});return a});
...
"&nbsp;");this.text&&void 0==this.underline&&(this.underline=!0);b.click&&void 0==this.hasArrow&&(this.hasArrow=!0)}});return a});$Define("C.Set","C.AbstractComponent",function(a){a=a.define("Set");a.extend({tmpl:'<div><h1 class="hui-set-title"><%=this.title%></h1><div class="hui-set-content"><%=this.findHtml(">*")%></div></div>'});return a});
$Define("C.Field","C.AbstractComponent",function(a){a=a.define("Field");a.extend({defItem:{xtype:"RowItem",xrole:"content"},tmpl:'<div class="<%if(this.noPadding){%> hui-field-nopadding<%}%>"><div class="hui-field-left"><%=this.findHtml(">[xrole=title]")%></div><div class="hui-field-right"><%=this.findHtml(">[xrole=content]")%></div></div>',doConfig:function(b){this.callSuper();var a=this.title;$H.isSimple(a)&&(a={text:a});a=$H.extend({xtype:"Label",xrole:"title"},a);this.add(a);a=this.content;void 0==
a&&!b.items&&(a="");$H.isSimple(a)&&(a={text:a,underline:!0});a&&(this.noPadding=!0,this.add(a))}});return a});$Define("C.Form","C.AbstractComponent",function(a){a=a.define("Form");a.extend({tmpl:'<div><form action=""><div class="hui-form-tips c-txt-error"></div><%=this.findHtml(">*")%></form></div>'});return a});
...
this.activeType&&(this.defItem.activeType=this.activeType)},layout:function(){var b=this.children.length,a=Math.floor(100/b);this.findEl(".js-tab-btns>li").each(function(c,d){d.style.width=c<b-1?a+"%":100-a*(b-1)+"%"})},setTabContent:function(b,a){a=a||this.getSelected(!0);this.findEl(".js-tab-content").index(a).html(b)}});return a});
$Define("C.Toolbar","C.AbstractComponent",function(a){a=a.define("Toolbar");a.extend({cls:"tbar",defItem:{xtype:"Button",theme:"black"},tmpl:'<div class="<%if(this.type=="header"){%> hui-header<%}else if(this.type=="footer"){%> hui-footer<%}%>"><%=this.findHtml(">*")%><%if(this.title){%><h1 class="hui-tbar-title js-tbar-txt"><%=this.title%></h1><%}%></div>',parseItem:function(b){"Button"==b.xtype&&(b.shadowSurround=!0,"left"==b.pos?b.extCls=(b.extCls||"")+" hui-tbar-btn-left":"right"==b.pos&&(b.extCls=
(b.extCls||"")+" hui-tbar-btn-right"))}});return a});
$Define("C.Tips",["C.AbstractComponent","C.Popup","C.ControlGroup"],function(a,b){var c=a.define("Tips",b);c.extend({cls:"tips",tType:"big",theme:"black",timeout:1E3,radius:"normal",tmpl:'<div class="<%if(!this.text){%> hui-tips-notxt<%}%>"><%=this.findHtml(">*")%><%if(this.text){%><span class="hui-tips-txt"><%=this.text%></span><%}%></div>',doConfig:function(b){"loading"==b.type?$H.extend(this,{text:"\u6b63\u5728\u52a0\u8f7d\u4e2d...",timeout:null,noMask:!0,icon:"loading"}):"miniLoading"==b.type?
$H.extend(this,{showPos:"top",clickHide:!1,destroyWhenHide:!1,timeout:null,delayShow:!1,shadowOverlay:null,theme:null,noMask:!0,tType:"mini",items:{xtype:"Icon",name:"loading-mini",noBg:!0}}):"topTips"==b.type&&$H.extend(this,{showPos:"top",noMask:!0,tType:"mini"});this.callSuper()}});return c});
$Define("C.Dialog",["C.AbstractComponent","C.Popup"],function(a,b){var c=a.define("Dialog",b);$H.extend(c,{alert:function(b){return new c({contentMsg:b,noClose:!0,noCancel:!0})},confirm:function(b,a){return new c({contentMsg:b,noClose:!0,okCall:function(){return a&&a(!0)},cancelCall:function(){return a&&a(!1)}})},prompt:function(b,a,e){e||(e=a,a="");return new c({contentMsg:b,noClose:!0,items:{xtype:"Input",xrole:"dialog-content",value:a},okCall:function(){var b=this.find("Input")[0].val();return e&&
e(b)}})}});c.extend({okTxt:"\u786e\u5b9a",cancelTxt:"\u53d6\u6d88",clickHide:!1,radius:"little",tmpl:'<div><%=this.findHtml(">[xrole=dialog-header]")%><div class="hui-dialog-body"><%if(this.content){%><%=this.content%><%}else{%><div class="hui-body-content"><h1 class="hui-content-title"><%=this.contentTitle%></h1><div class="hui-content-msg"><%=this.contentMsg%></div><%=this.findHtml(">[xrole=dialog-content]")%></div><%}%><%if(!this.noAction){%><div class="hui-body-action"><%=this.findHtml(">[xrole=dialog-action]")%></div><%}%></div></div>',
...
b){b=!1!=b;"dot"==this.markType?(a.selected=b,a.getEl().parent()[!1==b?"removeClass":"addClass"]("hui-item-mark")):"active"==this.markType?c.prototype.selectItem.call(this,a,b):a.selected=b}});return a});
...
b.click&&void 0==this.hasArrow&&(this.hasArrow=!0)}});return a});
...
b.action)b=$H.extend({xtype:"Button",radius:null,isInline:!1,xrole:"action"},b),this.add(b)}});return a});
$Define("C.ModelList","C.AbstractComponent",function(a){a=a.define("ModelList");a.extend({emptyTips:"\u6682\u65e0\u7ed3\u679c",pdText:"\u4e0b\u62c9\u53ef\u5237\u65b0",pdComment:"\u4e0a\u6b21\u5237\u65b0\u65f6\u95f4\uff1a",tmpl:'<div class="hui-list"><div class="hui-list-inner"><div<%if(this.children.length>0){%> style="display:none"<%}%> class="hui-list-empty js-empty"><%=this.emptyTips%></div><%if(this.hasPullRefresh){%><div class="hui-list-pulldown hui-pd-pull c-h-middle-container"><div class="c-h-middle"><span class="hui-icon hui-alt-icon hui-icon-arrow-d hui-light"></span><span class="hui-icon hui-alt-icon hui-icon-loading-mini"></span><div class="hui-pd-txt"><%if(this.pdText){%><div class="js-txt"><%=this.pdText%></div><%}%><%if(this.pdComment){%><div class="js-comment hui-pd-comment"><span class="js-pdComment"><%=this.pdComment%></span><span class="js-pdTime"><%=this.pdTime%></span></div><%}%></div></div></div><%}%><div class="js-item-container"><%=this.findHtml(">*")%></div><%if(this.hasPullRefresh){%><div class="hui-list-more"><a href="javascript:;" hidefocus="true" class="hui-btn hui-btn-gray hui-shadow hui-inline hui-radius-normal"><span class="hui-btn-txt">\u67e5\u770b\u66f4\u591a</span></a></div><%}%></div></div>',init:function(){var b=
this;b.itemXtype&&((b.defItem||(b.defItem={})).xtype=b.itemXtype);var a=b.model;a.each(function(a,c){b.addListItem(c)});b.listenTo(a,{add:function(a,c){b.addListItem(c)},remove:function(a,c){b.removeListItem(c)},reset:function(){b.removeListItem("emptyAll")}});b.hasPullRefresh=b.hasPullRefresh&&window.iScroll;b.hasPullRefresh&&(b.listen({name:"afterRender",handler:function(){var a=this,b=a.getEl(),c=b.find(".hui-list-pulldown"),d=c.find(".js-txt");a.scroller=new window.iScroll(b[0],{useTransition:!0,
topOffset:50,onRefresh:function(){c.hasClass("hui-pd-refresh")&&(c.removeClass("hui-pd-refresh hui-pd-release"),d.html("\u4e0b\u62c9\u53ef\u5237\u65b0"))},onScrollMove:function(){5<this.y&&!c.hasClass("hui-pd-release")?(c.addClass("hui-pd-release"),d.html("\u677e\u5f00\u53ef\u5237\u65b0"),this.minScrollY=0):5>this.y&&c.hasClass("hui-pd-release")&&(c.removeClass("hui-pd-release"),d.html("\u4e0b\u62c9\u53ef\u5237\u65b0"),this.minScrollY=-50)},onScrollEnd:function(){c.hasClass("hui-pd-release")&&(c.addClass("hui-pd-refresh"),
d.html("\u6b63\u5728\u5237\u65b0"),a.refresh())}})}}),b.listenTo(b.model,"sync",function(){b.findEl(".js-pdTime").html($H.formatDate($H.now(),"HH:mm"));setTimeout(function(){b.refreshScroller()},0)}),b.listen({name:"afterShow",handler:function(){b.refreshScroller()}}),b.listen({name:"click",method:"delegate",selector:".hui-list-more",handler:function(){b.getMore()}}))},addListItem:function(a){this.inited&&this.findEl(".js-empty").hide();this.add({model:a,renderTo:">.js-item-container"})},removeListItem:function(a){"emptyAll"==
a?this.remove(this.children):this.remove(function(c){return c.model&&c.model.id==a.id});0==this.children.length&&this.findEl(".js-empty").show()},refreshScroller:function(){this.scroller&&this.getEl()[0].clientHeight&&this.scroller.refresh()},destroy:function(){this.scroller&&(this.scroller.destroy(),this.scroller=null);this.callSuper()}});return a});
