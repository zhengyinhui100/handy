...
c,l},unListen:function(a){for(var e in n.listeners)(!a||a==e)&&delete n.listeners[e]}};return n});
handy.add("Support",function(c){var b={mediaQuery:function(){var a;if(c.Browser.mobile())a="hui-mobile";else{a="hui-pc";var e=c.Browser.ie();e&&(a+=" ie"+e)}document.documentElement.className+=" "+a}};b.mediaQuery();if(6==c.Browser.ie())try{document.execCommand("BackgroundImageCache",!1,!0)}catch(d){}return b})(function(c){Hui=H=$H=c.noConflict();$D=$H.Debug;$HB=$H.Browser;$HC=$H.Cookie;$HD=$H.Date;$HF=$H.Function;$HO=$H.Object;$HS=$H.String;$HU=$H.Util;$HL=$H.Listener;$Define=$H.Loader.define;$Require=
...
$Define("cm.AbstractManager",function(){var c=$HO.createClass(),b={},d={};$HO.extend(c.prototype,{type:"manager",registerType:function(a,e){b[a]=e;e.prototype.xtype=a;$C[a]=e},getClass:function(a){return b[a]},register:function(a){d[a.getId()]=a},unregister:function(a){delete d[a.getId()]},eachInEl:function(a,b){var c=this;a.find(".js-"+c.type).each(function(a,d){d=$(d);var g=d.attr("id");(g=c.get(g))&&b(g)})},generateId:function(a,b){var c=$H.expando+"_"+this.type+"_"+(a||$H.Util.getUuid());if(!0!=
b&&d[c])$D.error("id\u91cd\u590d:"+c);else return c},get:function(a){return d[a]||d[this.generateId(a,!0)]}});return c});
...
a)b.text(a);else return b.text()},initListeners:function(){!1!=this.callSuper()&&this.callChild()},clearListeners:function(){!1!=this.callSuper()&&this.callChild()},suspendListeners:function(){!1!=this.callSuper()&&this.callChild()},resumeListeners:function(){!1!=this.callSuper()&&this.callChild()},each:function(a,b){for(var c=this.children,d=c.length,j,g=0;g<d;){j=c[g];j=b?a.apply(j,b):a(g,j);if(!1===j)break;d==c.length?g++:d=c.length}},match:function(a,b){if("*"==a)return!0;var c=b||this,d,j,g;
a=a.replace(/^([^\[]+)/,'[xtype="$1"]');for(var k=/\[([^=|\!]+)(=|\!=)([^=]+)\]/g;d=k.exec(a);)if(j=d[1],g=d[2],d=eval(d[3]),"="===g?c[j]!=d:c[j]==d)return!1;return!0},find:function(a,b){var c=this;if(0!=a.indexOf("$"))return c.getEl().find(a);b=b||[];if(0<a.indexOf(","))return $HO.each(a.split(","),function(a,d){b=b.concat(c.find(d))}),b;var d=1==a.indexOf(">"),j=a.replace(/^\$>?\s?/,""),g=j.search(/\s|>/),k;0<g&&(k=j.substring(g),j=j.substring(0,g));c.each(function(c,f){f.match(j)&&(k?f.find("$"+
k,b):b.push(f));d||f.find(a,b)});return b},parents:function(a){if(a&&0!=a.indexOf("$"))return this.getEl().parents(a);for(var b=this;b.parent;)if(b=b.parent,a&&this.match(a,b))return b;return a||b===this?null:b},index:function(){var a=this,b=a.parent;if(b){var c;b.each(function(b,e){if(e==a)return c=b,!1});return c}return null},callChild:function(a,b){a&&"string"!=typeof a&&(b=a,a=null);a=a||arguments.callee.caller.$name;this.each(function(c,d){b?d[a].apply(d,b):d[a].call(d)})},add:function(a){this.children.push(a);
a.parent=this},remove:function(a){for(var b=this.children,c=!1,d=0,j=b.length;d<j;d++)b[d]==a&&(b.splice(d,1),a.destroy(),c=!0);return c},addItem:function(a){var b=this.settings,c=b.items;c?$HO.isArray(c)||(b.items=[c]):b.items=[];b.items.push(a)},parseItem:function(){},parseItems:function(){this.icon&&this.addItem({xtype:"Icon",name:this.icon});var a=this.settings.items;if(a)for(var a=a.length?a:[a],b=0,d=a.length;b<d;b++){var h=a[b];this.defItem&&$HO.extend(h,this.defItem,{notCover:!0});this.isMini&&
(h.isMini=!0);this.parseItem(h);var j=c.getClass(h.xtype);j?(h.renderTo||(h.autoRender=!1),h=new j(h),this.add(h)):$D.error("xtype:"+h.xtype+"\u672a\u627e\u5230")}},destroy:function(){if(this.destroyed)return!1;this.callChild();this.callSuper();this.parent&&this.parent.remove(this);c.unregister(this);delete this.params;delete this.settings;delete this._container;delete this.renderTo;delete this._listeners;delete this.children}},{define:function(a,b){var f=$HO.createClass();$HO.inherit(f,b||d,null,
null,{notCover:function(a){return"define"==a}});c.registerType(a,f);return f},extend:function(a){var b=this.prototype;$HO.extend(b,a,{notCover:function(c){if("_customEvents"==c||"listeners"==c)return b[c]=(a[c]||[]).concat(b[c]||[]),!0;if("xtype"==c||"constructor"==c)return!0}})},html:function(a){a.autoRender=!1;return(new this(a)).getHtml()}});return d});
