...
h(c,j,s,w[E],n,q,e))||0===C)&&v.push(C);w=v.join(" ");s?(f&&"value"==s&&(b.value=w),w=(g[1]||"")+w+g[4]):w&&(w=w+'="'+w+'"');w&&l.push(w)}return" "+l.join(" ")+" "}function d(a,b){return!a?a:0==a.indexOf("#")?a.substring(1):e(a,b)}function h(a,b,c,e,g,f,h){var j;b="#"+b;var m=e.indexOf("?"),l=e.indexOf(":");if(0==e.indexOf("this."))return a[e.substring(5)];if(0<m||0<l){f=e.substring(0,0<m?m:l);var k=0>m?"":e.substring(m+1,0<l?l:e.length),n=0>l?"":e.substring(l+1,e.length);j=d(f,h);g&&0!=f.indexOf("#")&&
...
a,b)},each:function(b,d){var c=d.context,e=d.fn,g=j?"":[],f=d.num,h=c.getCid()+"-"+f;if(b){var m;if(b instanceof a)b.each(function(a,b){m=c.wrapMetaMorph(h+"-"+b.uuid,e(b));j?g+=m:g.push(m)}),c.ifBind(f,b)&&(c.listenTo(b,"add",function(a,b,d,g){a=c.wrapMetaMorph(h+"-"+b.uuid,e(b));(g=g.at)?(d=d.at(g-1),$("#metamorph-"+(h+"-"+d.uuid)+"-end").after(a)):$("#metamorph-"+h+"-end").before(a)}),c.listenTo(b,"remove",function(a,b){c.updateMetaMorph(h+"-"+b.uuid,"","remove")}));else if(void 0!==b.length)for(var l=
0,f=b.length;l<f;l++)m=c.wrapMetaMorph(h+"-"+l,e(b[l])),j?g+=m:g.push(m);else for(l in b)m=c.wrapMetaMorph(h+"-"+l,e(b[l])),j?g+=m:g.push(m);return c.wrapMetaMorph(h,j?g:g.join(""))}},getValue:e,parseValue:function(a,b){var d=b.context,c=b.data,e=b.exp,g=f.isEscape,h=b.helpers,j=b.num,m=d.getCid()+"-"+j;d.ifBind(j,c)&&d.listenTo(c,"change:"+e,function(a,b,c){g&&(c=h.escape(c));d.updateMetaMorph(m,c)});g&&(a=h.escape(a));return d.wrapMetaMorph(m,a)},bindAttr:g,input:function(a,b){b.type="input";return"<input "+
...
parseItems:function(){this.startParseItems=!0;var a=this.items;if(a)for(var a=$H.isArr(a)?a:[a],b=0,c=a.length;b<c;b++)this.add(a[b])},beforeUpdate:function(){return this.trigger("beforeUpdate")},fastUpdate:function(a){var b=this.xConfig,c=!0;$H.each(a,function(a){"undefined"==typeof b[a]&&(c=!1)});return c?(this.xmodel.set(a),!0):!1},update:function(a,b){if(!a||!1==this.beforeUpdate())return!1;var c;if(!0===this.fastUpdate(a))c=this;else{c=this.parent;var e=$("<span></span>").insertBefore(this.getEl());
b||(void 0===a.autoRender&&(a.autoRender=!0),a=$H.extend(a,this.initParam,{notCover:!0}));a=$H.extend(a,{xtype:this.xtype,renderBy:"replaceWith",renderTo:e},{notCover:["xtype"]});if(!a.cid||a.cid==this.cid)a._id=this._id;if(c){var g=this.index();if(!1==c.remove(this))return e.remove(),!1;c=c.add(a,g)}else{if(!1==this.destroy())return e.remove(),!1;c=new this.constructor(a)}}this.trigger("update",c);this.afterUpdate(c);return c},replace:function(a){return this.update(a,!0)},afterUpdate:function(a){this.trigger("afterUpdate",
...
{extend:function(a){var b=this.prototype;$H.extend(b,a,{notCover:function(c){if("_customEvents"==c||"listeners"==c)return b[c]=(a[c]||[]).concat(b[c]||[]),!0;if("xtype"==c||"constructor"==c)return!0;if("xConfig"==c)return b[c]=$H.extendIf(a[c],b[c]),!0}})},html:function(a){return(new this($H.extend({autoRender:!1},a))).getHtml()}});a.registerHelper("ModelView",{placeItem:function(a,b){var c=b.context,e=b.num,g=c.getCid()+"-"+e,f=c.findHtml(a);if(c.ifBind(e))c.on("add",function(b,e){e.match(a)&&(c.updateMetaMorph(g,
e.getHtml(),"append"),e.afterRender())});return c.wrapMetaMorph(g,f)}});e=/[^<]*(<[a-zA-Z]+)/;return g});$Define("C.ComponentManager",["CM.AbstractManager","CM.ViewManager"],function(f,b){var c=f.derive({type:"component",initialize:function(){var a=$H.getSingleton(b);this._types=a._types;this._all=a._all}});$CM=new c;return c});
