...
handy.add("Json",function(){function g(a){f.lastIndex=0;f.test(a)&&(a=a.replace(f,function(a){var f=h[a];return"string"===typeof f?f:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function b(f,h){var e,j,k,l,n=c,z,m=h[f];m&&("object"===typeof m&&"function"===typeof m.toJSON)&&(m=m.toJSON(f));"function"===typeof a&&(m=a.call(h,f,m));switch(typeof m){case "undefined":return"undefined";case "string":return g(m);case "number":return isFinite(m)?String(m):"null";case "boolean":case "null":return String(m);
case "object":if(!m)return"null";c+=d;z=[];if("[object Array]"===Object.prototype.toString.apply(m)){l=m.length;for(e=0;e<l;e+=1)z[e]=b(e,m)||"null";k=0===z.length?"[]":c?"[\n"+c+z.join(",\n"+c)+"\n"+n+"]":"["+z.join(",")+"]";c=n;return k}if(a&&"object"===typeof a){l=a.length;for(e=0;e<l;e+=1)"string"===typeof a[e]&&(j=a[e],(k=b(j,m))&&z.push(g(j)+(c?": ":":")+k))}else for(j in m)Object.prototype.hasOwnProperty.call(m,j)&&(k=b(j,m))&&z.push(g(j)+(c?": ":":")+k);k=0===z.length?"{}":c?"{\n"+c+z.join(",\n"+
c)+"\n"+n+"}":"{"+z.join(",")+"}";c=n;return k}}var e="JSON"in window,a,c,d,f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},j=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
d){if(!c||b.isStr(c)||b.isNum(c))return a;var f=d?d.notCover:!1,h=d?d.cover:null;d=d?d.IsClone:!1;a=a||{};var e=a.constructor,g=e.$isClass,l,m;for(m in c)if(l=c[m],(!h||b.contains(h,m))&&c.hasOwnProperty(m)){var n=a.hasOwnProperty(m),p=!0===f?n:!1;b.isArr(f)?p=b.contains(f,m)&&n:b.isFunc(f)&&(p=f(m,l));p||(l=d?b.clone(l):l,g&&(b.isFunc(l)&&!l.$name)&&(l.$name=m,l.$owner=e),a[m]=l)}return a},extendIf:function(a,c){return b.extend(a,c,{notCover:!0})},mix:function(a,c,d){a.superProto||(a.superProto=
...
handy.add("Loader",["B.Debug","B.Object","B.Function"],function(g,b,e,a){function c(a){var f={},c=[];"string"==typeof a&&(a=[a]);for(var d=0,e=a.length;d<e;d++){var h;h=a[d];h=/\.(css|js)$/.test(h)?t[h]&&"loaded"==t[h].status:q.urlMap&&q.urlMap[h]?q.urlMap[h].chkExist():b.ns(h);if(h)c.push(h);else return f.notExist=a[d],f}f.exist=c;return f}function d(a,c){function d(){d.isCalled||(d.isCalled=!0,clearTimeout(l),c())}if("SCRIPT"===a.nodeName){var b=a,e=d,h=function(){/loaded|complete|undefined/.test(b.readyState)&&(b.onload=
b.onerror=b.onreadystatechange=null,m.removeChild(b),b=null,setTimeout(e,0))};b.onload=b.onreadystatechange=h;b.onerror=function(){g.error(k+"load script error:\n"+b.src);h()}}else{var j=d;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",j):setTimeout(function(){f(a,j)},0)}var l=setTimeout(function(){g.error("Time is out:"+a.src);d()},q.timeout)}function f(a,c){if(!c.isCalled){var d;if(n)a.sheet&&(d=!0);else if(a.sheet)try{a.sheet.cssRules&&(d=!0)}catch(b){if("SecurityError"===b.name||
"NS_ERROR_DOM_SECURITY_ERR"===b.name)d=!0}setTimeout(function(){d?c():f(a,c)},1)}}function h(a){q.showLoading(!1);s--;t[a].status="loaded";q.traceLog&&g.log(k+"Response:\n"+a);j()}function j(){for(var a=p.length-1;0<=a;a--){var f=p[a],d=c(f.deps);if(d.notExist)0==a&&0==s&&g.error(l+d.notExist);else{p.splice(a,1);f.callback.apply(null,d.exist);j();break}}}var k="[Handy Loader] ",l=k+"not found: ",m=document.head||document.getElementsByTagName("head")[0]||document.documentElement,n=navigator.userAgent.indexOf("AppleWebKit"),
...
if("object"==e||"function"==e)a.$ns=f}else g.warn(k+"factory no return:\n"+f)})},require:function(f,b){for(var j="string"==typeof f?[f]:f,n=[],y=[],u=!0,w=0,v=j.length;w<v;w++){var r=j[w],r=a.Object.alias(r),x=c(r);x.notExist?(n.push(r),u&&(u=!1,p.push({deps:j,callback:b})),q.traceLog&&g.log(l+r)):y.push(x.exist[0])}if(0==n.length)return b&&b.apply(null,y),1==y.length?y[0]:y;u=!1;j=0;for(y=n.length;j<y;j++)if(w=n[j],!t[w]){u=w;r=q.urlMap&&q.urlMap[u]&&q.urlMap[u].url;if(!r){v="";r=q.rootPath;if("string"==
typeof r)v=r;else if("object"==typeof r)for(x in x=void 0,r)0==u.indexOf(x)&&(v=r[x],u=u.replace(x,""));else v="";r=/.css$/.test(u)?0==u.indexOf("/")?u:"/css/"+u:/.js$/.test(u)?u:u.replace(/\./g,"/")+".js";r=v.replace(/\/$/,"")+"/"+r.replace(/^\//,"")}u=!0;t[w]={id:w,status:"loading"};v=e.bind(h,null,w);q.traceLog&&g.log(k+"request:\n"+r);if(/.css$/.test(r))a:{w=r;r=m.getElementsByTagName("link");for(x=0;x<r.length;x++){var A=r[x].href;!q.skinNode&&0<=A.indexOf(q.skinName)&&(q.skinNode=r[x]);if(0<=
A.indexOf(w)||0<=w.indexOf(A))break a}r=document.createElement("link");r.rel="stylesheet";r.href=w;d(r,v);q.skinNode?m.insertBefore(r,q.skinNode):m.appendChild(r)}else w=r,r=document.createElement("script"),r.async="async",r.src=w,r.type="text/javascript",d(r,v),m.appendChild(r);s++}u&&q.showLoading(!0)}};return q});
...
break;case "mm":f.setMinutes(l);break;case "ss":f.setSeconds(l);break;case "SS":f.setMilliseconds(l)}}return f}},now:function(a){var c=new g;if(a&&!0!==a)"number"!=typeof a&&(a=b.parseDate(a).getTime()),e=a-c.getTime();else return c.setTime(c.getTime()+e),a&&(c=b.formatDate(c)),c},howLong:function(a,c){if(a){a=b.parseDate(a);var d=b.now().getTime()-a.getTime();if(!1!=c){var f;if(60>(d/=6E4))f="\u5206\u949f",d=d||1;else if(24>(d/=60))f="\u5c0f\u65f6";else if(30>(d/=24))f="\u5929";else return"30\u5929\u524d";
...
"\\r").replace(/\n/g,"\\n");return p?"$r+="+('"'+a+'"')+";":"$r.push("+('"'+a+'"')+");"}function h(a,f){f=f||{};var c=a.exp.replace(/"/g,"'"),c=b.trim(c).replace(/\s{2,}/g," "),d=f.helpers,e=d&&d.parseValue,h=a.blockName,g=a.children,j=a.num,q,m="\nif($tmp||$tmp===0){"+(p?"$r+=$tmp;":"$r.push($tmp);")+"}";q=(a.inverse?"inverse:true,":"")+"num:"+j+',context:$me,exp:"'+c+'",helpers:$helpers,data:$data}';d=d&&d.getValue?'$helpers.getValue.call($me,"'+c+'",$data,{'+q+")":"($data&&$data."+c+")";h?(c="$program"+
j,q='$tmp = $helpers["'+h+'"].call($me,'+d+", {fn:"+c+","+q+");"+m,g&&(m=k(g,f),m=t[0]+"\n"+m.join("\n")+"\n"+t[1],n.splice(2,0,"\nfunction "+c+"($data){\n"+m+"\n}\n"))):((g=c.match(/([^\s]+)\s([^\n]+)/))?(c=g[1],q="if (helper = $helpers."+c+') {\n$tmp = helper.call($me,"'+g[2]+'",{'+q+'); \n}else{$tmp="";}'):(q="if (helper = $helpers."+c+') {\n$tmp = helper.call($me,"",{'+q+"); \n}else{\nhelper = "+d+"; $tmp = typeof helper === functionType ? helper.call($me,{"+q+") : helper;\n"+(e?"\n$tmp=$helpers.parseValue.call($me,$tmp,{"+
q+");":"")+"}",l.isEscape?"\n$tmp=escape($tmp);":""),q+=m);return q}function j(a,f){if(a){var c=f||{},d=l.openTag,b=l.closeTag,h,g;c.children?g=c.children:c.children=g=[];if(0<=(h=a.indexOf(d))){var k=a.substring(0,h);k&&g.push({html:k});a=a.substring(h+d.length);if(0==a.indexOf("#"))if(a=a.substring(1),k=a.match(/^[a-z]+/)){var q=k[0];h=a.indexOf(b);k=a.substring(q.length+1,h);a=a.substring(h+b.length);k={num:++s,blockName:q,exp:k};g.push(k);var m=d+"/"+q+b;a:{h=a;for(var b=RegExp(d+"[#/]"+q+"((?!"+
b+").)*"+b,"ig"),n=0;d=b.exec(h);)if(d[0]==m)if(0==n){h=d.index;break a}else n--;else n++;h=-1}if(-1==h){e.error("\u672a\u627e\u5230\u5757\u7ed3\u675f\u4f4d\u7f6e:"+m);return}d=a.substring(0,h);a=a.substring(h+m.length);j(d,k);if("if"==q){q=k.children;m=0;for(d=q.length;m<d;m++)b=q[m],"else"==b.exp&&(b.exp=k.exp,b.blockName="if",b.num=++s,b.inverse=!0,b.children=q.slice(m+1),g.push(b),k.children=q.slice(0,m))}}else{e.error("\u627e\u4e0d\u5230\u8f85\u52a9\u51fd\u6570:"+a);return}else h=a.indexOf(b),
g.push({num:++s,exp:a.substring(0,h)}),a=a.substring(h+b.length);j(a,c)}else a&&g.push({html:a});return c}}function k(a,c){var d=[];if(a)for(var b=0,e=a.length;b<e;b++){var g=a[b];g.html?d.push(f(g.html)):g.exp&&d.push(h(g,c))}return d}var l={openTag:"{{",closeTag:"}}",isTrim:!0,isEscape:!1,getIfPlusJoin:function(){return p},registerHelper:function(a,f,c){g.isObj(f)?(q[a]||(q[a]={}),g.extend(q[a],f)):q[a][f]=c},tmpl:function(a,f,c){var d,b,h;if("string"==typeof a)d=a;else if(void 0!==a.length)d=a.join("");
else if(d=a.tmpl,h=a.id)if(m[h])b=m[h];else if(!d){var p=document.getElementById(h);p&&(d=(p.value||p.innerHTML).replace(/\s/g,""))}if(!b){if(!d){e.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}a:{var p=l.openTag,v=l.closeTag;d=d.replace(RegExp(p+"!((?!"+v+").)*"+v,"ig"),"");l.isTrim&&(d=d.replace(/^[\s\n]+/,"").replace(/[\s\n]+$/,"").replace(RegExp("("+v+"|\\>)(\\s|\\n)+(?=("+p+"|<))","ig"),"$1").replace(RegExp(v+"[\\s\\n]+([^\\n]+)[\\s\\n]+(?=("+p+"|<))","ig"),v+"$1"));n=[t[0]];n.push('var escape=$helpers.escape,functionType="function",$me=this;');
var p=a&&a.ns,r;p?(r=g.extend({},q["default"]),r=g.extend(r,q[p])):r=q["default"];a.helpers=r;d=j(d);s=0;a=k(d.children,a);n=n.concat(a);n.push(t[1]);a=n.join("\n");try{var x=window.Function.apply(null,["$T","$helpers","$data",a]);b=function(a,f){return x.call(f||a,l,r,a)};break a}catch(A){e.log(a),e.error(A)}b=void 0}h&&(m[h]=b)}if(f)try{return b(f,c)}catch(J){e.log(b.toString()),e.error(J)}else return b}},m={},n,p="".trim,s=0,t=["var $r="+(p?'""':"[]")+",$tmp,helper;","return "+(p?"$r;":'$r.join("");')],
q={"default":{"if":function(a,f){var c=f.data;g.isFunc(a)&&(a=a.call(c));if(a&&!f.inverse||!a&&f.inverse)return f.fn(c)},unless:function(a,f){f.inverse=!0;return f.helpers["if"].call(this,a,f)},each:p?c:d,escape:function(f){return b.encodeHTML(a(f))},trim:b.trim}};return l});
...
h=0,j=document,k,l,m=j.documentMode,n="onhashchange"in window&&(void 0===m||7<m),p={delay:50,listen:function(g,l){if(!f&&!f)if(f=!0,p.listeners={},n)$(window).on("hashchange",function(){d(b.getHash())});else k=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(j.body)[0],$(k).one("load",function(){a(b.getHash());setInterval(c,p.delay)});if(l in p.listeners)$D.error(Error("Duplicate name"));else return l=l||e.expando+ ++h,p.listeners[l]=g,l},unListen:function(a){for(var f in p.listeners)(!a||
...
$Define("CM.Model",["CM.AbstractDao","CM.AbstractEvents","CM.DataStore"],function(g,b){var e=b.derive({idAttribute:"id",_pending:!1,_validate:function(a,c){if(!c.validate||!this.validate)return!0;a=$H.extend({},this._attributes,a);var d=this.validationError=this.validate(a,c)||null;if(!d)return!0;this.trigger("invalid",this,d,$H.extend(c,{validationError:d}));return!1},_doDepends:function(a,c){var d=this.fields,f,b,e={},g,l;for(l in d)if((f=d[l])&&(b=f.depends))for(f=0;f<b.length;f++)if(a.hasOwnProperty(b[f])){e[l]=
void 0;g=!0;break}g&&this.set(e,null,{silent:c})},_parseFields:function(a){var c;if(!(c=this.fields))return a;var d,f,b,e,g={},l;for(l in a){f=a[l];if(d=c[l]){b=d.type;e=d.options;if(d=d.parse)f=d.apply(this,[f,a]);$H.isStr(b)&&("Date"==b?f=$H.parseDate(f):0<b.indexOf(".")&&(b=$H.ns(b)));$H.isClass(b)&&!(f instanceof b)&&(b.get?(d={},(f=b.get(f,e,d))&&(f._changedTmp=d.changed)):(d=this.get(l))?(b=d.set(f),f=d,f._changedTmp=b.changed):(f=new b(f,e),f._changedTmp=!0))}g[l]=f}return g},_onAttrEvent:function(a,
c,b){if(!("invalid"==c||"sync"==c||0==c.indexOf("change:"))&&!("add"==c&&b instanceof e))c=this.get(a),this.trigger("change:"+a,this,c),this.trigger("change",this),b={},b[a]=c,this._doDepends(b)},initialize:function(a,c){this.callSuper();this.uuid=$H.uuid();this.dao=this.dao||$H.getSingleton(g);var b=a||{};c||(c={});this.cid=$H.Util.uuid();this._attributes={};c.collection&&(this.collection=c.collection);c.parse&&(b=this.parse(b,c)||{});b=$H.extendIf(b,this.getDefaults());this.set(b,c);this._changed=
{}},getDefaults:function(){var a={},c;if(c=this.fields)for(var b in c){var f=c[b];a[b]=f&&$H.isObj(f)?f.def:f}return a},toJSON:function(){return $H.clone(this._attributes)},sync:function(a,c,b){this.lastSyncTime=$H.now();return this.dao.sync(a,c,b)},get:function(a){return this._attributes[a]},escape:function(a){return $H.String.escapeHTML(this.get(a))},has:function(a){a=this.get(a);return null!==a&&void 0!==a},set:function(a,c,b){var f,h={result:this};"object"===typeof a?(f=a,b=c):(f={})[a]=c;b||
(b={});f instanceof e&&(f=f._attributes);f=this._parseFields(f);if(!this._validate(f,b))return h.invalid=!0,h;var g=b.unset;a=b.silent;var k={};c=this._changing;this._changing=!0;c||(this._previousAttributes=$H.Object.clone(this._attributes),this._changed={});var l=this._attributes,m=this._previousAttributes;this.idAttribute in f&&(this.id=f[this.idAttribute]);for(var n in f){c=f[n];var p=l[n],s=p&&$H.isInstance(p),t=c&&$H.isInstance(c);if(s||t){if(g)delete l[n],p&&this.unlistenTo(p,"all");else if(l[n]=
c,!p||p.id!=c.id)c._changedTmp=!0,p&&this.unlistenTo(p,"all"),this.listenTo(c,"all",$H.bind(this._onAttrEvent,this,n));if(g||c._changedTmp)k[n]=c;delete c._changedTmp}else $H.equals(l[n],c)||(k[n]=c),$H.equals(m[n],c)?delete this._changed[n]:this._changed[n]=c,g?delete l[n]:l[n]=c}f=!$H.isEmpty(k);if(!a){f&&(this._pending=b);for(var q in k)this.trigger("change:"+q,this,l[q],b)}if(!a)for(;this._pending;)b=this._pending,this._pending=!1,this.trigger("change",this,b);this._changing=this._pending=!1;
f&&this._doDepends(k,a);h.changed=f;return h},unset:function(a,b){b=b||{};b.unset=!0;return this.set(a,void 0,b)},clear:function(a){var b={},d;for(d in this._attributes)b[d]=void 0;a=a||{};a.unset=!0;return this.set(b,a)},each:function(a){$H.each(this._attributes,a)},hasChanged:function(a){var b=this._changed;return null==a?!$H.isEmpty(b):$H.contains(b,a)},changedAttrbutes:function(a){if(!a)return this.hasChanged()?$H.clone(this._changed):!1;var b,d=!1,f=this._changing?this._previousAttributes:this._attributes,
e;for(e in a)if(!$H.equals(f[e],b=a[e]))(d||(d={}))[e]=b;return d},previous:function(a){return null==a||!this._previousAttributes?null:this._previousAttributes[a]},fetch:function(a){var b=this;b.fetching=!0;a=a?$H.clone(a):{};void 0===a.parse&&(a.parse=!0);var d=a.success,f=a.beforeSet;a.success=function(e){b.fetching=!1;e=b.parse(e,a);if(!(f&&!1==f(b,e,a))){if(b.set(e,a).invalid)return!1;d&&d(b,e,a);b.trigger("sync",b,e,a)}};b.sync("read",b,a)},save:function(a,b,d){var f=this,e;null==a||"object"===
typeof a?(e=a,d=b):(e={})[a]=b;$H.isFunc(d)&&(d={success:d});d=$H.extend({validate:!0},d);if(e&&d.now){if(f.set(e,d).invalid)return!1}else if(!f._validate(e,d))return!1;void 0===d.parse&&(d.parse=!0);var g=d.success;d.success=function(a){var b=f.parse(a,d);d.now||(b=$H.extend(e||{},b));if($H.isObj(b)&&f.set(b,d).invalid)return!1;g&&g(f,a,d);f.trigger("sync",f,a,d)};a=f.isNew()?"create":d.update?"update":"patch";if("patch"===a){if(b=f.changedAttrbutes(e),!b){g&&g(f,d);return}}else b=$H.extend({},f._attributes),
b=$H.extend(b,e);for(var k in b)$H.isInstance(b[k])&&delete b[k];d.attrs=b;f.sync(a,f,d)},destroy:function(a){var b=this;a=a?$H.clone(a):{};var d=a.success,f=function(){b.trigger("destroy",b,b.collection,a);b.off("all")};a.success=function(e){(!a.now||b.isNew())&&f();d&&d(b,e,a);b.isNew()||b.trigger("sync",b,e,a)};if(b.isNew())return a.success(),!1;b.sync("delete",b,a);a.now&&f()},getUrl:function(){var a=$H.result(this,"url")||$H.result(this.collection,"url");a||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));
return this.isNew()?a:a.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(a){return a.code&&a.data?a.data:a},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0===this.id},isValid:function(a){return this._validate({},$H.extend(a||{},{validate:!0}))}},{get:function(a,b,d){if(a){var f,e;e=!1;if(e=a[this.prototype.idAttribute])f=$S.get(this,e);f?e=f.set(a).changed:(f=new this(a,b),(b=$S.get(f,f.id))?(e=b.set(a).changed,f=b):(e=!0,$S.push(f)));
d&&(d.changed=e);return f}}});return e});
$Define("CM.Collection",["CM.AbstractDao","CM.AbstractEvents","CM.Model","CM.DataStore"],function(g,b,e){var a=b.derive({model:e,_getIterator:function(a){return $H.isFunc(a)?a:function(f){return f.get(a)}},_reset:function(){this.length=0;this._models=[];this._byId={}},_prepareModel:function(a,f){if(a instanceof e)return a;f=f?$H.clone(f):{};f.collection=this;var b=this.model.get(a,f);if(!b.validationError)return b;this.trigger("invalid",this,b.validationError,f);return!1},_addReference:function(a){this._byId[a.cid]=
...
remove:!1,merge:!1},b);return this.set(a,b).result},remove:function(a,b){var c=!$H.isArr(a);a=c?[a]:$H.clone(a);b||(b={});var e,g,l,m;e=0;for(g=a.length;e<g;e++)if(m=a[e]=this.get(a[e]))delete this._byId[m.id],delete this._byId[m.cid],l=this.indexOf(m),this._models.splice(l,1),this.length--,b.silent||(b.index=l,m.trigger("remove",m,this,b)),this._removeReference(m,b);return c?a[0]:a},set:function(b,f){if(!b)return{result:this};f=$H.extend({add:!0,remove:!1,merge:!0},f);b instanceof a&&(b=b._models);
f.parse&&(b=this.parse(b,f));var c=!$H.isArr(b)?b?[b]:[]:$H.clone(b),g=this._models,k,l,m,n,p,s,t=f.at,q=this.model,F=this.comparator&&null==t&&!1!==f.sort,G=f.add,I=f.merge,z=f.remove,y=!1;k=0;for(l=c.length;k<l;k++)if(p=c[k]||{},m=p instanceof e?n=p:p[q.prototype.idAttribute||"id"],s=this.get(m))z&&(this.remove(s,f),y=!0),I&&(p=p===n?n.attributes:p,f.parse&&(p=s.parse(p,f)),m=s.set(p,f).changed,y=y||m),c[k]=s;else if(G&&(f.id=m,n=c[k]=this._prepareModel(p,f)))this._addReference(n,f),F&&(t=this.sortedIndex(n)),
null!=t?g.splice(t,0,n):g.push(n),this.length+=1,f.silent||n.trigger("add",n,this,f,t),y=!0;return{changed:y,result:this}},each:function(a){$H.each(this._models,a)},reset:function(a,b){b||(b={});for(var c=0,e=this._models.length;c<e;c++)this._removeReference(this._models[c],b);b.previousModels=this._models;this._reset();a&&(a=this.add(a,$H.extend({silent:!0},b)).result);b.silent||this.trigger("reset",this,b);return a},push:function(a,b){return this.add(a,$H.extend({at:this.length},b)).result},pop:function(a){var b=
this.at(this.length-1);this.remove(b,a);return b},unshift:function(a,b){return this.add(a,$H.extend({at:0},b)).result},shift:function(a){var b=this.at(0);this.remove(b,a);return b},slice:function(){return Array.prototype.slice.apply(this._models,arguments)},get:function(a){return null==a?void 0:this._byId[a]||this._byId[a.id]||this._byId[a.cid]},size:function(){return this.length},at:function(a){return this._models[a]},where:function(a,b){return $H.isEmpty(a)?b?void 0:[]:this[b?"find":"filter"](function(b){for(var f in a)if(a[f]!==
b.get(f))return!1;return!0})},findWhere:function(a){return this.where(a,!0)},sort:function(a){this.comparator||$D.error(Error("\u6ca1\u6709\u6bd4\u8f83\u5668"));a||(a={});"string"==typeof this.comparator||1===this.comparator.length?this._models=this.sortBy(this.comparator,this,a.desc):this._models.sort($H.Function.bind(this.comparator,this));a.silent||this.trigger("sort",this,a);return this},sortItem:function(a,b){void 0===b&&(b=this.sortedIndex(a));var c=this.indexOf(a),e=this._models;e.splice(c,
1);e.splice(b,0,a);this.trigger("sortItem",a,b,c,this)},pluck:function(a){return $H.invoke(this._models,"get",a)},getUrl:function(){return this.url},fetch:function(a){var b=this;a=a?$H.clone(a):{};var c=a.success,e=a.beforeSet;a.success=function(g){g=b.parse(g,a);e&&!1==e(b,g,a)||(b[a.reset?"reset":a.add?"add":"set"](g,a),c&&c(b,g,a),b.trigger("sync",b,g,a))};return b.sync("read",b,a)},create:function(a,b){var c=this;b=b?$H.clone(b):{};if(!(a=c._prepareModel(a,b)))return!1;b.now&&c.add(a,b);var e=
b.success;b.success=function(a,d){b.now||c.add(a,b);e&&e(a,d,b)};a.save(null,b);return a},parse:function(a){return a.data},clone:function(){return new this.constructor(this._models)}}),c=$H.Array;$H.each("map some every find filter invoke indexOf".split(" "),function(b,f){a.prototype[f]=function(){var a=Array.prototype.slice.call(arguments);a.unshift(this._models);return c[f].apply(c,a)}});a.prototype.sortedIndex=function(a,b,e){var g=this._getIterator(this.comparator);e=this.desc||e;return c.sortedIndex(this._models,
a,g,b,e)};$H.each(["sortBy","groupBy","countBy"],function(b,f){a.prototype[f]=function(a,b,d){a=this._getIterator(a);d=this.desc||d;return c[f](this._models,a,b,d)}});return a});
...
{};this._bindElNums={};this.callSuper()},doConfig:function(){this.callSuper();var a=this.modelClass||e;this.model||(this.model=new a(this.data));this.xmodel=this.model},preTmpl:function(){var a=this.tmpl;$H.isArr(a)&&(a=a.join(""));var b=m.test(a),c="#js-"+this.manager.type+" #js-"+this.xtype;if(b){if(b=a.match(n)[1])s.test(a)||(b=b.replace(/([^\s]+)/g,"#$1")),c+=" "+b;a=a.replace(n,"")}c=' id=this._id class="'+c+'"';this.tmpl=a=p.test(a)?a.replace(t,"$1"+c):a.replace(l,"$1 {{bindAttr"+c+"}}")},getTmplFn:function(){var a=
...
a)},bindAttr:d,input:function(a,b){b.type="input";return"<input "+d(a,b)+"/>"},textarea:function(a,b){b.type="textarea";return"<textarea "+d(a,b)+">"+b.value+"</textarea>"}});var j=g.getIfPlusJoin(),k=/((\w+)=['"]?)?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/g,l=/[^<]*(<[a-zA-Z]+)/,m=/^[^>]+class=/,n=/class=['"]?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/,p=/^[^>]+{{bindAttr/,s=/^[^>]+{{bindAttr((?!}}).)class=/,t=/({{bindAttr)/;return b});
...
this.children;c?e.push(a):e.splice(b,0,a);this.trigger("add",a,b);return a}e=this.items;c?e.push(a):e.splice(b,0,a)}},remove:function(a){if(!this._applyArray()){var b=this.children,c=!1,e;if($H.isNum(a))e=a,a=b[e];else if($H.isStr(a)||$H.isFunc(a)){a=this.find(a);for(var g=0,m=a.length;g<m;g++){if(!1==this.remove(a[g]))return!1;c=!0}}else if(a instanceof d)if(a.parent==this){g=0;for(m=b.length;g<m;g++)if(b[g]==a){e=g;break}}else return a.parent.remove(a);void 0!==e&&!1!=a.destroy(!0)&&(b.splice(e,
...
$Define("C.Hcard","C.AbstractComponent",function(g){g=g.define("Hcard");g.extend({xConfig:{cls:"hcard",image:"",title:"",titleDesc:"",hasArrow:!1,newsNum:0,newsNumTxt:{depends:["newsNum"],parse:function(){var b=this.get("newsNum");return b?9<b?"9+":b:0}}},defItem:{xtype:"Desc",xrole:"desc"},tmpl:'<div {{bindAttr class="image?hui-hcard-hasimg"}}>{{#if image}}<div class="hui-hcard-img js-img"><img {{bindAttr src="image"}}></div>{{/if}}<div class="hui-hcard-content js-content"><div class="hui-content-title">{{title}}<span class="hui-title-desc">{{titleDesc}}</span></div>{{placeItem > [xrole=desc]}}</div>{{placeItem > [xrole!=desc]}}{{#if newsNumTxt}}<span class="hui-news-tips">{{newsNumTxt}}</span>{{else}}{{#if hasArrow}}<a href="javascript:;" hidefocus="true" class="hui-click-arrow" title="\u8be6\u60c5"><span class="hui-icon hui-alt-icon hui-icon-carat-r hui-light"></span></a>{{/if}}{{/if}}</div>',doConfig:function(b){var e=
...
doConfig:function(){var b=this;b.callSuper();b.set("pdTxt",b.pullTxt);b.itemXtype&&((b.defItem||(b.defItem={})).xtype=b.itemXtype);var e=b.model,a=!1;e.each(function(c,d){b.addListItem(d);a=!0});a||b.set("isEmpty",!0);b.listenTo(e,{add:function(a,d){b.addListItem(d)},remove:function(a,d){b.removeListItem(d)},sortItem:function(a,d,f){a=b.find(function(a){return a.model&&a.model.id==d.id});a=a[0];a=a.getEl();a.parent().children("div").eq(f).before(a)},reset:function(){b.removeListItem("emptyAll")}});
e=b.hasPullRefresh&&window.iScroll&&!$H.ie();b.set("hasPullRefresh",e);e&&(b.listen({name:"afterRender",handler:function(){var a=this,b=a.getEl(),f=b.find(".hui-list-pulldown");a.scroller=new window.iScroll(b[0],{useTransition:!0,topOffset:50,onRefresh:function(){f.hasClass("hui-pd-refresh")&&(f.removeClass("hui-pd-refresh hui-pd-release"),a.set("pdTxt",a.pullTxt))},onScrollMove:function(){5<this.y&&!f.hasClass("hui-pd-release")?(f.addClass("hui-pd-release"),a.set("pdTxt",a.flipTxt),this.minScrollY=
0):5>this.y&&f.hasClass("hui-pd-release")&&(f.removeClass("hui-pd-release"),a.set("pdTxt",a.pullTxt),this.minScrollY=-50)},onScrollEnd:function(){f.hasClass("hui-pd-release")&&(f.addClass("hui-pd-refresh"),a.set("pdTxt",a.releaseTxt),a.refresh())}})}}),b.listenTo(b.model,"sync",function(){b.set("pdTime",$H.formatDate($H.now(),"HH:mm"));setTimeout(function(){b.refreshScroller()},0)}),b.listen({name:"afterShow",handler:function(){b.refreshScroller();"bottom"==b.scrollPos&&b.scrollTo("bottom")}}),b.listen({name:"click",
method:"delegate",selector:".hui-list-more",handler:function(){b.getMore()}}))},addListItem:function(b){this.set("isEmpty",!1);this.add({model:b},this.model.indexOf(b));this.refreshScroller()},removeListItem:function(b){"emptyAll"==b?this.remove(this.children):this.remove(function(e){return e.model&&e.model.id==b.id});0==this.children.length&&this.set("isEmpty",!0);this.refreshScroller()},refreshScroller:function(){this.scroller&&this.getEl()[0].clientHeight&&this.scroller.refresh()},scrollTo:function(b,
e){var a=this.scroller;if($H.isStr(b))if("top"==b)a.scrollTo(0,0);else{if("bottom"==b){var c=this.findEl(".hui-list-inner")[0].clientHeight;a.scrollTo(0,-c)}}else a.scrollTo(b,e)},destroy:function(){this.scroller&&(this.scroller.destroy(),this.scroller=null);this.callSuper()}});return g});
...
$Define("M.History","handy.base.HashChange",function(g){var b=$H.createClass(),e=0;$H.extend(b.prototype,{initialize:function(a,b){"function"==typeof a&&(b=a,a=null);this.error=b||$H.noop;this.key=a||"handy";this.states=[];g.listen($H.Function.bind(this.stateChange,this))},stateChange:function(){var a=this.getHashParam(),b=a.hKey,d=this.currentKey,f=this.states,e=f[d];if(b==d)return!1;(f=f[b])?a=f.onStateChange(f.param,!0):($D.warn("hisory state not found"),a=this.error("stateNotFound",a));!0!=a?
(a={hKey:d,param:e.param},this.saveHash(a)):this.currentKey=b},saveState:function(a){var b=this.currentKey=this.key+ ++e;this.states.push(b);this.states[b]=a;a=a.param;this.saveHash({hKey:b,modName:a&&a.modName})},saveHash:function(a){$H.setHash("#"+$H.Json.stringify(a))},getHashParam:function(){try{var a=$H.getHash().replace("#","");return $H.parseJson(a)}catch(b){$H.Debug.warn("History.getCurrentState:parse hash error:"+b.message)}},getCurrentState:function(){try{var a=this.getHashParam();return this.states[a.hKey]}catch(b){$H.Debug.warn("History.getCurrentState:parse hash error:"+
b.message)}},getPreState:function(){try{for(var a=this.getHashParam().hKey,b=this.states,d=b.length,f=0;f++;f<d)if(b[f]==a)return 0<f?b[b[--f]]:null}catch(e){$H.Debug.error("History.getPreState error:"+e.message,e)}},back:function(){var a=this.getPreState();if(a)a.onStateChange(a.param)}});return b});
