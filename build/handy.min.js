...
handy.add("Json",function(){function g(a){f.lastIndex=0;f.test(a)&&(a=a.replace(f,function(a){var f=h[a];return"string"===typeof f?f:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function b(f,e){var h,j,k,l,n=c,y,m=e[f];m&&("object"===typeof m&&"function"===typeof m.toJSON)&&(m=m.toJSON(f));"function"===typeof a&&(m=a.call(e,f,m));switch(typeof m){case "undefined":return"undefined";case "string":return g(m);case "number":return isFinite(m)?String(m):"null";case "boolean":case "null":return String(m);
case "object":if(!m)return"null";c+=d;y=[];if("[object Array]"===Object.prototype.toString.apply(m)){l=m.length;for(h=0;h<l;h+=1)y[h]=b(h,m)||"null";k=0===y.length?"[]":c?"[\n"+c+y.join(",\n"+c)+"\n"+n+"]":"["+y.join(",")+"]";c=n;return k}if(a&&"object"===typeof a){l=a.length;for(h=0;h<l;h+=1)"string"===typeof a[h]&&(j=a[h],(k=b(j,m))&&y.push(g(j)+(c?": ":":")+k))}else for(j in m)Object.prototype.hasOwnProperty.call(m,j)&&(k=b(j,m))&&y.push(g(j)+(c?": ":":")+k);k=0===y.length?"{}":c?"{\n"+c+y.join(",\n"+
c)+"\n"+n+"}":"{"+y.join(",")+"}";c=n;return k}}var e="JSON"in window,a,c,d,f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},j=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,n=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
m=/(?:^|:|,)(?:\s*\[)+/g;return{stringify:function(f,h,j,g){if(e&&!g)return JSON.stringify.apply(null,arguments);var k;d=c="";if("number"===typeof j)for(k=0;k<j;k+=1)d+=" ";else"string"===typeof j&&(d=j);if((a=h)&&"function"!==typeof h&&("object"!==typeof h||"number"!==typeof h.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return b("",{"":f})},parseJson:function(a,f,c){function d(a,c){var b,e,h=a[c];if(h&&"object"===typeof h)for(b in h)Object.prototype.hasOwnProperty.call(h,
b)&&(e=d(h,b),void 0!==e?h[b]=e:delete h[b]);return f.call(a,c,h)}if(e&&!c)return JSON.parse.apply(null,arguments);var b;a=String(a);j.lastIndex=0;j.test(a)&&(a=a.replace(j,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(k.test(a.replace(l,"@").replace(n,"]").replace(m,"")))return b=eval("("+a+")"),"function"===typeof f?d({"":b},""):b;$D.error(new SyntaxError("JSON.parse"))}}});
handy.add("Object",function(){var g;g=(g=window.navigator.userAgent.match(/MSIE ([\d.]+)/))&&9>parseInt(g[0])?function(a,c,d){var f=[];if(a.length){c=c||0;for(d=d||a.length;c<d;c++)f.push(a[c])}return f}:function(a,c,d){return Array.prototype.slice.call(a,c||0,d||a.length)};var b={_alias:{B:"handy.base",C:"handy.component",M:"handy.module",CM:"handy.common"},ns:function(a,c){var d=null,f,e,j,g;a=b.alias(a);e=a.split(".");d=e[0];d=(j=2==arguments.length)?eval("(function(){if (typeof "+d+' == "undefined"){'+
d+" = {};}return "+d+";})()"):eval("(function(){if (typeof "+d+' != "undefined")return '+d+";})()");f=1;for(g=e.length;f<g;++f){if(f==g-1&&j)d[e[f]]=c;else if(j||d&&d[e[f]])d[e[f]]=d[e[f]]||{};else return;d=d[e[f]]}return d},alias:function(a,c){var d=b._alias;if(c)d[a]?$D.error("\u522b\u540d\u5df2\u88ab\u4f7f\u7528"+a+":"+d[a]):d[a]=c;else{if(a){var f=a,e=a.length-1;do{if(d[f])return d[f]+a.substring(e);e=f.lastIndexOf(".")}while(0<e&&(f=f.substring(0,e)));return a}return d}},extend:function(a,c,
d){if(!c||b.isStr(c)||b.isNum(c))return a;var f=d?d.notCover:!1,e=d?d.cover:null;d=d?d.IsClone:!1;a=a||{};var j=a.constructor,g=j.$isClass,l,n;for(n in c)if(l=c[n],(!e||b.contains(e,n))&&c.hasOwnProperty(n)){var m=a.hasOwnProperty(n),q=!0===f?m:!1;b.isArr(f)?q=b.contains(f,n)&&m:b.isFunc(f)&&(q=f(n,l));q||(l=d?b.clone(l):l,g&&(b.isFunc(l)&&!l.$name)&&(l.$name=n,l.$owner=j),a[n]=l)}return a},extendIf:function(a,c){return b.extend(a,c,{notCover:!0})},mix:function(a,c,d){a.superProto||(a.superProto=
...
handy.add("Loader",["B.Debug","B.Object","B.Function"],function(g,b,e,a){function c(a){var f={},c=[];"string"==typeof a&&(a=[a]);for(var d=0,e=a.length;d<e;d++){var h;h=a[d];h=/\.(css|js)$/.test(h)?t[h]&&"loaded"==t[h].status:p.urlMap&&p.urlMap[h]?p.urlMap[h].chkExist():b.ns(h);if(h)c.push(h);else return f.notExist=a[d],f}f.exist=c;return f}function d(a,c){function d(){d.isCalled||(d.isCalled=!0,clearTimeout(l),c())}if("SCRIPT"===a.nodeName){var b=a,e=d,h=function(){/loaded|complete|undefined/.test(b.readyState)&&(b.onload=
b.onerror=b.onreadystatechange=null,n.removeChild(b),b=null,setTimeout(e,0))};b.onload=b.onreadystatechange=h;b.onerror=function(){g.error(k+"load script error:\n"+b.src);h()}}else{var j=d;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",j):setTimeout(function(){f(a,j)},0)}var l=setTimeout(function(){g.error("Time is out:"+a.src);d()},p.timeout)}function f(a,c){if(!c.isCalled){var d;if(m)a.sheet&&(d=!0);else if(a.sheet)try{a.sheet.cssRules&&(d=!0)}catch(b){if("SecurityError"===b.name||
"NS_ERROR_DOM_SECURITY_ERR"===b.name)d=!0}setTimeout(function(){d?c():f(a,c)},1)}}function h(a){p.showLoading(!1);r--;t[a].status="loaded";p.traceLog&&g.log(k+"Response:\n"+a);j()}function j(){for(var a=q.length-1;0<=a;a--){var f=q[a],d=c(f.deps);if(d.notExist)0==a&&0==r&&g.error(l+d.notExist);else{q.splice(a,1);f.callback.apply(null,d.exist);j();break}}}var k="[Handy Loader] ",l=k+"not found: ",n=document.head||document.getElementsByTagName("head")[0]||document.documentElement,m=navigator.userAgent.indexOf("AppleWebKit"),
q=[],r=0,t={},p={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(f,c,d){f=a.Object.alias(f);2==arguments.length&&(d=c,c=[]);if(b.isFunc(d))for(var e,h=d.toString(),j=/\$Require\s*\(\s*['"]([^'"]+)['"]\s*\)/g;e=j.exec(h);)c.push(e[1]);p.require(c,function(){var a;if("function"==typeof d)try{p.traceLog&&g.log(k+"define:\n"+f),a=d.apply(null,arguments)}catch(c){c.message=k+f+":\nfactory define error:\n"+c.message;g.error(c);return}else a=d;if(a){b.ns(f,a);var e=typeof a;
if("object"==e||"function"==e)a.$ns=f}else g.warn(k+"factory no return:\n"+f)})},require:function(f,b){for(var j="string"==typeof f?[f]:f,m=[],z=[],u=!0,w=0,v=j.length;w<v;w++){var s=j[w],s=a.Object.alias(s),x=c(s);x.notExist?(m.push(s),u&&(u=!1,q.push({deps:j,callback:b})),p.traceLog&&g.log(l+s)):z.push(x.exist[0])}if(0==m.length)return b&&b.apply(null,z),1==z.length?z[0]:z;u=!1;j=0;for(z=m.length;j<z;j++)if(w=m[j],!t[w]){u=w;s=p.urlMap&&p.urlMap[u]&&p.urlMap[u].url;if(!s){v="";s=p.rootPath;if("string"==
typeof s)v=s;else if("object"==typeof s)for(x in x=void 0,s)0==u.indexOf(x)&&(v=s[x],u=u.replace(x,""));else v="";s=/.css$/.test(u)?0==u.indexOf("/")?u:"/css/"+u:/.js$/.test(u)?u:u.replace(/\./g,"/")+".js";s=v.replace(/\/$/,"")+"/"+s.replace(/^\//,"")}u=!0;t[w]={id:w,status:"loading"};v=e.bind(h,null,w);p.traceLog&&g.log(k+"request:\n"+s);if(/.css$/.test(s))a:{w=s;s=n.getElementsByTagName("link");for(x=0;x<s.length;x++){var A=s[x].href;!p.skinNode&&0<=A.indexOf(p.skinName)&&(p.skinNode=s[x]);if(0<=
A.indexOf(w)||0<=w.indexOf(A))break a}s=document.createElement("link");s.rel="stylesheet";s.href=w;d(s,v);p.skinNode?n.insertBefore(s,p.skinNode):n.appendChild(s)}else w=s,s=document.createElement("script"),s.async="async",s.src=w,s.type="text/javascript",d(s,v),n.appendChild(s);r++}u&&p.showLoading(!0)}};return p});
...
1==f?d[e]:("00"+d[e]).slice(-f)));return c},parseDate:function(a,c){var d=typeof a,f=new g;if("number"==d)return f.setTime(a),f;if("string"!=d)return a;var d=(c||"yyyy-MM-dd HH:mm:ss").match(/[a-zA-Z]+/g),e=a.match(/\d+/g);if(e){f.setDate(1);for(var j=0;j<e.length;j++){var k=d[j],l=parseInt(e[j]);switch(k){case "yyyy":f.setFullYear(l);break;case "MM":f.setMonth(l-1);break;case "dd":k=b.getDaysInMonth(f);l>k&&(l=k);f.setDate(l);break;case "HH":f.setHours(l);break;case "mm":f.setMinutes(l);break;case "ss":f.setSeconds(l);
break;case "SS":f.setMilliseconds(l)}}return f}},now:function(a){var c=new g;if(a&&!0!==a)"number"!=typeof a&&(a=b.parseDate(a).getTime()),e=a-c.getTime();else return c.setTime(c.getTime()+e),a&&(c=b.formatDate(c)),c},howLong:function(a,c){if(a){a=b.parseDate(a);var d=b.now().getTime()-a.getTime();if(!1!=c){var f;if(60>(d/=6E4))f="\u5206\u949f",d=d||1;else if(24>(d/=60))f="\u5c0f\u65f6";else if(30>(d/=24))f="\u5929";else return"30\u5929\u524d";d=(Math.floor(0<d?d:1)||1)+f+"\u524d"}return d}}},e=0;
return b});
...
a,e)&&d.push(b)});return d},where:function(a,f){return this.filter(a,d(f))},findWhere:function(a,f){return this.find(a,d(f))},invoke:function(a,f){var c=Array.prototype.slice.call(arguments,2),d=g.isFunc(f);return this.map(a,function(a){return(d?f:a[f]).apply(a,c)})},sortedIndex:function(a,f,d,b){d=c(d);f=d.call(b,f);for(var e=0,h=a.length;e<h;){var g=e+h>>>1;d.call(b,a[g])<f?e=g+1:h=g}return e},sortBy:function(a,f,d,b){f=c(f);return this.pluck(this.map(a,function(a,c,b){return{value:a,index:c,criteria:f.call(d,
a,c,b)}}).sort(function(a,f){var c=a.criteria,d=f.criteria;if(c!==d){if(c>d||void 0===c)return b?-1:1;if(c<d||void 0===d)return b?1:-1}return a.index-f.index}),"value")},groupBy:f(function(a,f,c){a[f]?a[f].push(c):a[f]=[c]}),countBy:f(function(a,f){a[f]?a[f]++:a[f]=1})};return h});
...
"\\r").replace(/\n/g,"\\n");return q?"$r+="+('"'+a+'"')+";":"$r.push("+('"'+a+'"')+");"}function h(a,f){f=f||{};var c=a.exp.replace(/"/g,"'"),c=b.trim(c).replace(/\s{2,}/g," "),d=f.helpers,e=d&&d.parseValue,h=a.blockName,g=a.children,j=a.num,p,n="\nif($tmp||$tmp===0){"+(q?"$r+=$tmp;":"$r.push($tmp);")+"}";p=(a.inverse?"inverse:true,":"")+"num:"+j+',context:$me,exp:"'+c+'",helpers:$helpers,data:$data}';d=d&&d.getValue?'$helpers.getValue.call($me,"'+c+'",$data,{'+p+")":"($data&&$data."+c+")";h?(c="$program"+
j,p='$tmp = $helpers["'+h+'"].call($me,'+d+", {fn:"+c+","+p+");"+n,g&&(n=k(g,f),n=t[0]+"\n"+n.join("\n")+"\n"+t[1],m.splice(2,0,"\nfunction "+c+"($data){\n"+n+"\n}\n"))):((g=c.match(/([^\s]+)\s([^\n]+)/))?(c=g[1],p="if (helper = $helpers."+c+') {\n$tmp = helper.call($me,"'+g[2]+'",{'+p+'); \n}else{$tmp="";}'):(p="if (helper = $helpers."+c+') {\n$tmp = helper.call($me,"",{'+p+"); \n}else{\nhelper = "+d+"; $tmp = typeof helper === functionType ? helper.call($me,{"+p+") : helper;\n"+(e?"\n$tmp=$helpers.parseValue.call($me,$tmp,{"+
p+");":"")+"}",l.isEscape?"\n$tmp=escape($tmp);":""),p+=n);return p}function j(a,f){if(a){var c=f||{},d=l.openTag,b=l.closeTag,h,g;c.children?g=c.children:c.children=g=[];if(0<=(h=a.indexOf(d))){var k=a.substring(0,h);k&&g.push({html:k});a=a.substring(h+d.length);if(0==a.indexOf("#"))if(a=a.substring(1),k=a.match(/^[a-z]+/)){var p=k[0];h=a.indexOf(b);k=a.substring(p.length+1,h);a=a.substring(h+b.length);k={num:++r,blockName:p,exp:k};g.push(k);var m=d+"/"+p+b;a:{h=a;for(var b=RegExp(d+"[#/]"+p+"((?!"+
b+").)*"+b,"ig"),n=0;d=b.exec(h);)if(d[0]==m)if(0==n){h=d.index;break a}else n--;else n++;h=-1}if(-1==h){e.error("\u672a\u627e\u5230\u5757\u7ed3\u675f\u4f4d\u7f6e:"+m);return}d=a.substring(0,h);a=a.substring(h+m.length);j(d,k);if("if"==p){p=k.children;m=0;for(d=p.length;m<d;m++)b=p[m],"else"==b.exp&&(b.exp=k.exp,b.blockName="if",b.num=++r,b.inverse=!0,b.children=p.slice(m+1),g.push(b),k.children=p.slice(0,m))}}else{e.error("\u627e\u4e0d\u5230\u8f85\u52a9\u51fd\u6570:"+a);return}else h=a.indexOf(b),
g.push({num:++r,exp:a.substring(0,h)}),a=a.substring(h+b.length);j(a,c)}else a&&g.push({html:a});return c}}function k(a,c){var d=[];if(a)for(var b=0,e=a.length;b<e;b++){var g=a[b];g.html?d.push(f(g.html)):g.exp&&d.push(h(g,c))}return d}var l={openTag:"{{",closeTag:"}}",isTrim:!0,isEscape:!1,getIfPlusJoin:function(){return q},registerHelper:function(a,f,c){g.isObj(f)?(p[a]||(p[a]={}),g.extend(p[a],f)):p[a][f]=c},tmpl:function(a,f,c){var d,b,h;if("string"==typeof a)d=a;else if(void 0!==a.length)d=a.join("");
else if(d=a.tmpl,h=a.id)if(n[h])b=n[h];else if(!d){var q=document.getElementById(h);q&&(d=(q.value||q.innerHTML).replace(/\s/g,""))}if(!b){if(!d){e.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}a:{var q=l.openTag,v=l.closeTag;d=d.replace(RegExp(q+"!((?!"+v+").)*"+v,"ig"),"");l.isTrim&&(d=d.replace(/^[\s\n]+/,"").replace(/[\s\n]+$/,"").replace(RegExp("("+v+"|\\>)(\\s|\\n)+(?=("+q+"|<))","ig"),"$1").replace(RegExp(v+"[\\s\\n]+([^\\n]+)[\\s\\n]+(?=("+q+"|<))","ig"),v+"$1"));m=[t[0]];m.push('var escape=$helpers.escape,functionType="function",$me=this;');
var q=a&&a.ns,s;q?(s=g.extend({},p["default"]),s=g.extend(s,p[q])):s=p["default"];a.helpers=s;d=j(d);r=0;a=k(d.children,a);m=m.concat(a);m.push(t[1]);a=m.join("\n");try{var x=window.Function.apply(null,["$T","$helpers","$data",a]);b=function(a,f){return x.call(f||a,l,s,a)};break a}catch(A){e.log(a),e.error(A)}b=void 0}h&&(n[h]=b)}if(f)try{return b(f,c)}catch(J){e.log(b.toString()),e.error(J)}else return b}},n={},m,q="".trim,r=0,t=["var $r="+(q?'""':"[]")+",$tmp,helper;","return "+(q?"$r;":'$r.join("");')],
p={"default":{"if":function(a,f){var c=f.data;g.isFunc(a)&&(a=a.call(c));if(a&&!f.inverse||!a&&f.inverse)return f.fn(c)},unless:function(a,f){f.inverse=!0;return f.helpers["if"].call(this,a,f)},each:q?c:d,escape:function(f){return b.encodeHTML(a(f))},trim:b.trim}};return l});
handy.add("HashChange",["handy.base.Debug","handy.base.Util"],function(g,b,e){function a(a){if(a==l)return!1;var f=k.contentWindow.document;f.open();f.write("<!doctype html><html><body>"+a+"</body></html>");f.close();l=a;g.log("set:"+k.contentWindow.document.body.innerText)}function c(){var f=b.getHash(),c=k.contentWindow.document.body.innerText;f!=l?(a(f),d(f)):c!=l&&(g.log("update:"+k.contentWindow.document.body.innerText),b.setHash(c))}function d(a){var f=q.listeners,c;for(c in f)f[c](a)}var f,
h=0,j=document,k,l,n=j.documentMode,m="onhashchange"in window&&(void 0===n||7<n),q={delay:50,listen:function(g,l){if(!f&&!f)if(f=!0,q.listeners={},m)$(window).on("hashchange",function(){d(b.getHash())});else k=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(j.body)[0],$(k).one("load",function(){a(b.getHash());setInterval(c,q.delay)});if(l in q.listeners)$D.error(Error("Duplicate name"));else return l=l||e.expando+ ++h,q.listeners[l]=g,l},unListen:function(a){for(var f in q.listeners)(!a||
a==f)&&delete q.listeners[f]}};return q});handy.add("Support","B.Browser",function(g){var b={mediaQuery:function(){var a;if(g.mobile())a="hui-mobile";else{a="hui-pc";var c=g.ie();c&&(a+=" ie"+c)}document.documentElement.className+=" "+a}};b.mediaQuery();if(6==g.ie())try{document.execCommand("BackgroundImageCache",!1,!0)}catch(e){}return b});
...
$Define("CM.DataStore",function(){var g=$H.createClass();$H.extend(g.prototype,{get:function(e,a){var c;e=$H.isClass(e)?e.$ns:$H.isInstance()?e.constructor.$ns:$H.alias(e);if(c=b[e])return a?$H.where(c,a):c},find:function(){},push:function(e,a){"string"!=typeof e&&(a=e,e=null);var c=a.constructor.$ns;(b[c]||(b[c]=[])).push(a);e&&(b[e]||(b[e]=a))}});var b={};$S=$H.getSingleton(g);return g});
...
void 0;break}this.set(h,null,{silent:a})},_parseFields:function(b){var a;if(!(a=this.fields))return b;var c,d,f,h={},g;for(g in b){d=b[g];if(c=a[g]){f=c.type;if(c=c.parse)d=c.apply(this,[d,b]);$H.isStr(f)&&("Date"==f?d=$H.parseDate(d):0<f.indexOf(".")&&(f=$H.ns(f)));if($H.isClass(f)&&!(d instanceof f)&&!this.get(g)){var k;d&&d.id&&(k=(k=$S.get(f.$ns,{id:d.id}))&&k[0])&&k.set(d);d=k||new f(d);d.on("all",$H.bind(this._onAttrEvent,this,g));this._onAttrEvent(g,"change",d)}}h[g]=d}return h},_onAttrEvent:function(b,
a){if(!("invalid"==a||"sync"==a)){var c=this.get(b);this.trigger("change:"+b,this,c);this.trigger("change",this);var d={};d[b]=c;this._doDepends(d)}},initialize:function(b,a){this.callSuper();this.uuid=$H.uuid();this.dao=this.dao||$H.getSingleton(g);var c=b||{};a||(a={});this.cid=$H.Util.uuid();this._attributes={};a.collection&&(this.collection=a.collection);a.parse&&(c=this.parse(c,a)||{});c=$H.extendIf(c,this.getDefaults());this.set(c,a);this._changed={};$S.push(this)},getDefaults:function(){var b=
{},a;if(a=this.fields)for(var c in a){var d=a[c];b[c]=d&&$H.isObj(d)?d.def:d}return b},toJSON:function(){return $H.clone(this._attributes)},sync:function(b,a,c){this.lastSyncTime=$H.now();return this.dao.sync(b,a,c)},get:function(b){return this._attributes[b]},escape:function(b){return $H.String.escapeHTML(this.get(b))},has:function(b){b=this.get(b);return null!==b&&void 0!==b},set:function(b,a,c){var d;"object"===typeof b?(d=b,c=a):(d={})[b]=a;c||(c={});d=this._parseFields(d);if(!this._validate(d,
c))return!1;var f=c.unset;b=c.silent;var h={},g=this._changing;this._changing=!0;g||(this._previousAttributes=$H.Object.clone(this._attributes),this._changed={});var k=this._attributes,l=this._previousAttributes;this.idAttribute in d&&(this.id=d[this.idAttribute]);for(var n in d){a=d[n];var m=k[n];m&&$H.isInstance(m)?f?m.reset():m.set(a):($H.equals(k[n],a)||(h[n]=a),$H.equals(l[n],a)?delete this._changed[n]:this._changed[n]=a,f?delete k[n]:k[n]=a)}a=!$H.isEmpty(h);if(!b){a&&(this._pending=c);for(var q in h)this.trigger("change:"+
q,this,k[q],c)}if(g)return this;if(!b)for(;this._pending;)c=this._pending,this._pending=!1,this.trigger("change",this,c);this._changing=this._pending=!1;a&&this._doDepends(h,b);return this},unset:function(b,a){a=a||{};a.unset=!0;return this.set(b,void 0,a)},clear:function(b){var a={},c;for(c in this._attributes)a[c]=void 0;b=b||{};b.unset=!0;return this.set(a,b)},each:function(b){$H.each(this._attributes,b)},hasChanged:function(b){var a=this._changed;return null==b?!$H.isEmpty(a):$H.contains(a,b)},
changedAttrbutes:function(b){if(!b)return this.hasChanged()?$H.clone(this._changed):!1;var a,c=!1,d=this._changing?this._previousAttributes:this._attributes,f;for(f in b)if(!$H.equals(d[f],a=b[f]))(c||(c={}))[f]=a;return c},previous:function(b){return null==b||!this._previousAttributes?null:this._previousAttributes[b]},fetch:function(b){var a=this;a.fetching=!0;b=b?$H.clone(b):{};void 0===b.parse&&(b.parse=!0);var c=b.success,d=b.beforeSet;b.success=function(f){a.fetching=!1;f=a.parse(f,b);if(!(d&&
!1==d(a,f,b))){if(!a.set(f,b))return!1;c&&c(a,f,b);a.trigger("sync",a,f,b)}};a.sync("read",a,b)},save:function(b,a,c){var d=this,f;null==b||"object"===typeof b?(f=b,c=a):(f={})[b]=a;$H.isFunc(c)&&(c={success:c});c=$H.extend({validate:!0},c);if(f&&c.now){if(!d.set(f,c))return!1}else if(!d._validate(f,c))return!1;void 0===c.parse&&(c.parse=!0);var h=c.success;c.success=function(a){var b=d.parse(a,c);c.now||(b=$H.extend(f||{},b));if($H.isObj(b)&&!d.set(b,c))return!1;h&&h(d,a,c);d.trigger("sync",d,a,
c)};b=d.isNew()?"create":c.update?"update":"patch";if("patch"===b){if(a=d.changedAttrbutes(f),!a){h&&h(d,c);return}}else a=$H.extend({},d._attributes),a=$H.extend(a,f);for(var g in a)$H.isInstance(a[g])&&delete a[g];c.attrs=a;d.sync(b,d,c)},destroy:function(b){var a=this;b=b?$H.clone(b):{};var c=b.success,d=function(){a.trigger("destroy",a,a.collection,b);a.off("all")};b.success=function(f){(!b.now||a.isNew())&&d();c&&c(a,f,b);a.isNew()||a.trigger("sync",a,f,b)};if(a.isNew())return b.success(),!1;
a.sync("delete",a,b);b.now&&d()},getUrl:function(){var b=$H.result(this,"url")||$H.result(this.collection,"url");b||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));return this.isNew()?b:b.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(b){return b.code&&b.data?b.data:b},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0===this.id},isValid:function(b){return this._validate({},$H.extend(b||
{},{validate:!0}))}})});
$Define("CM.Collection",["CM.AbstractDao","CM.AbstractEvents","CM.Model","CM.DataStore"],function(g,b,e){var a=b.derive({model:e,_getIterator:function(a){return $H.isFunc(a)?a:function(b){return b.get(a)}},_reset:function(){this.length=0;this._models=[];this._byId={}},_prepareModel:function(a,b){if(a instanceof e)return a;b=b?$H.clone(b):{};b.collection=this;var c;if(b.id&&(c=(c=$S.get(this.model.$ns,{id:b.id}))&&c[0]))return c.set(a,b),c;c=new this.model(a,b);if(!c.validationError)return c;this.trigger("invalid",
this,c.validationError,b);return!1},_addReference:function(a){this._byId[a.cid]=a;null!=a.id&&(this._byId[a.id]=a);a.collection||(a.collection=this);a.on("all",this._onModelEvent,this)},_removeReference:function(a){this===a.collection&&delete a.collection;a.off("all",this._onModelEvent,this)},_onModelEvent:function(a,b,c,e){("add"===a||"remove"===a)&&c!==this||("destroy"===a&&this.remove(b,e),b&&a==="change:"+b.idAttribute&&(delete this._byId[b.previous(b.idAttribute)],null!=b.id&&(this._byId[b.id]=
b)),this.trigger.apply(this,arguments))},initialize:function(a,b){this.callSuper();this.dao=this.dao||$H.getSingleton(g);b||(b={});b.model&&(this.model=b.model);b.url&&(this.url=b.url);void 0!==b.comparator&&(this.comparator=b.comparator);this._reset();a&&this.reset(a,$H.extend({silent:!0},b))},toJSON:function(a){return $H.map(this._models,function(b){return b.toJSON(a)})},sync:function(a,b,c){this.lastSyncTime=$H.now();return this.dao.sync(a,b,c)},add:function(a,b){b=$H.extend({add:!0,remove:!1,
merge:!1},b);return this.set(a,b)},remove:function(a,b){var c=!$H.isArr(a);a=c?[a]:$H.clone(a);b||(b={});var e,g,l,n;e=0;for(g=a.length;e<g;e++)if(n=a[e]=this.get(a[e]))delete this._byId[n.id],delete this._byId[n.cid],l=this.indexOf(n),this._models.splice(l,1),this.length--,b.silent||(b.index=l,n.trigger("remove",n,this,b)),this._removeReference(n,b);return c?a[0]:a},set:function(a,b){if(a){b=$H.extend({add:!0,remove:!0,merge:!0},b);b.parse&&(a=this.parse(a,b));var c=!$H.isArr(a),g=c?a?[a]:[]:$H.clone(a),
k=this._models,l,n,m,q,r,t,p=b.at,F=this.model,G=this.comparator&&null==p&&!1!==b.sort,I=b.add,y=b.merge,z=b.remove;l=0;for(n=g.length;l<n;l++)if(r=g[l]||{},m=r instanceof e?q=r:r[F.prototype.idAttribute||"id"],t=this.get(m))z&&this.remove(t,b),y&&(r=r===q?q.attributes:r,b.parse&&(r=t.parse(r,b)),t.set(r,b)),g[l]=t;else if(I&&(b.id=m,q=g[l]=this._prepareModel(r,b)))this._addReference(q,b),this.length+=1,G&&(p=this.sortedIndex(q)),null!=p?k.splice(p,0,q):k.push(q),b.silent||q.trigger("add",q,this,
b,p);return c?g[0]:g}},each:function(a){$H.each(this._models,a)},reset:function(a,b){b||(b={});for(var c=0,e=this._models.length;c<e;c++)this._removeReference(this._models[c],b);b.previousModels=this._models;this._reset();a&&(a=this.add(a,$H.extend({silent:!0},b)));b.silent||this.trigger("reset",this,b);return a},push:function(a,b){return this.add(a,$H.extend({at:this.length},b))},pop:function(a){var b=this.at(this.length-1);this.remove(b,a);return b},unshift:function(a,b){return this.add(a,$H.extend({at:0},
b))},shift:function(a){var b=this.at(0);this.remove(b,a);return b},slice:function(){return Array.prototype.slice.apply(this._models,arguments)},get:function(a){return null==a?void 0:this._byId[a]||this._byId[a.id]||this._byId[a.cid]},size:function(){return this.length},at:function(a){return this._models[a]},where:function(a,b){return $H.isEmpty(a)?b?void 0:[]:this[b?"find":"filter"](function(b){for(var c in a)if(a[c]!==b.get(c))return!1;return!0})},findWhere:function(a){return this.where(a,!0)},sort:function(a){this.comparator||
$D.error(Error("\u6ca1\u6709\u6bd4\u8f83\u5668"));a||(a={});"string"==typeof this.comparator||1===this.comparator.length?this._models=this.sortBy(this.comparator,this,a.desc):this._models.sort($H.Function.bind(this.comparator,this));a.silent||this.trigger("sort",this,a);return this},pluck:function(a){return $H.invoke(this._models,"get",a)},getUrl:function(){return this.url},fetch:function(a){var b=this;a=a?$H.clone(a):{};void 0===a.parse&&(a.parse=!0);var c=a.success,e=a.beforeSet;a.success=function(g){e&&
!1==e(b,g,a)||(b[a.reset?"reset":a.add?"add":"set"](g,a),c&&c(b,g,a),b.trigger("sync",b,g,a))};return b.sync("read",b,a)},create:function(a,b){var c=this;b=b?$H.clone(b):{};if(!(a=c._prepareModel(a,b)))return!1;b.now&&c.add(a,b);var e=b.success;b.success=function(a,d){b.now||c.add(a,b);e&&e(a,d,b)};a.save(null,b);return a},parse:function(a){return a.data},clone:function(){return new this.constructor(this._models)}}),c=$H.Array;$H.each("map some every find filter invoke indexOf".split(" "),function(b,
f){a.prototype[f]=function(){var a=Array.prototype.slice.call(arguments);a.unshift(this._models);return c[f].apply(c,a)}});a.prototype.sortedIndex=function(a,b){var e=this._getIterator(this.comparator);return c.sortedIndex(this._models,a,e,b)};$H.each(["sortBy","groupBy","countBy"],function(b,f){a.prototype[f]=function(a,b,d){a=this._getIterator(a);return c[f](this._models,a,b,d)}});return a});
...
$Define("CM.ModelView",["B.Template","CM.AbstractView","CM.Model","CM.Collection"],function(g,b,e,a){function c(a,b){return b.get?b.get(a):b[a]}function d(a,b){for(var c=b.context,d=b.data,e=b.num,g=b.type,j="bindAttr-"+(c.getCid()+"-"+e),l=[],m=[],n=c.ifBind(e,d),q=g&&c.ifBind(e,d,!0);e=k.exec(a);)"id"==e[2]?j=0==e[3].indexOf("this.")?c[e[3].substring(5)]:f(e[3],d):m.push(e);l.push('id="'+j+'"');for(var r,t,B,C,D=0,K=m.length;D<K;D++){e=m[D];t=e[2];r=e[3];r=r.split(" ");B=[];for(var E=0;E<r.length;E++)((C=
h(c,j,t,r[E],n,q,d))||0===C)&&B.push(C);r=B.join(" ");t?(g&&"value"==t&&(b.value=r),r=(e[1]||"")+r+e[4]):r&&(r=r+'="'+r+'"');r&&l.push(r)}return" "+l.join(" ")+" "}function f(a,b){return!a?a:0==a.indexOf("#")?a.substring(1):c(a,b)}function h(a,b,c,d,e,g,h){var j;b="#"+b;var k=d.indexOf("?"),l=d.indexOf(":");if(0==d.indexOf("this."))return a[d.substring(5)];if(0<k||0<l){g=d.substring(0,0<k?k:l);var m=0>k?"":d.substring(k+1,0<l?l:d.length),n=0>l?"":d.substring(l+1,d.length);j=f(g,h);e&&0!=g.indexOf("#")&&
a.listenTo(h,"change:"+g,function(a,f,d){a=$(b);c?"class"==c?d?(n&&a.removeClass(n),m&&a.addClass(m)):(m&&a.removeClass(m),n&&a.addClass(n)):a.attr(c,d?m:n):d?a.prop(m,!0):a.prop(m,!1)});return j?m:n}j=f(d,h);0!=d.indexOf("#")&&(e&&a.listenTo(h,"change:"+d,function(a,f,d){a=$(b);"class"==c?(a.removeClass(j),a.addClass(d),j=d):a.attr(c,d||"")}),"value"==c&&g&&a.listen({name:"input propertychange",el:b,handler:function(a){h.set(d,a.target.value)}}));return j}b=b.derive({bindType:"both",initialize:function(){this._bindModelNums=
{};this._bindElNums={};this.callSuper()},doConfig:function(){this.callSuper();var a=this.modelClass||e;this.model||(this.model=new a(this.data));this.xmodel=this.model},preTmpl:function(){var a=this.tmpl;$H.isArr(a)&&(a=a.join(""));var b=n.test(a),c="#js-"+this.manager.type+" #js-"+this.xtype;if(b){if(b=a.match(m)[1])r.test(a)||(b=b.replace(/([^\s]+)/g,"#$1")),c+=" "+b;a=a.replace(m,"")}c=' id=this._id class="'+c+'"';this.tmpl=a=q.test(a)?a.replace(t,"$1"+c):a.replace(l,"$1 {{bindAttr"+c+"}}")},getTmplFn:function(){var a=
this.tmpl,b=this.constructor;if(!$H.isFunc(a)&&!$H.isFunc(a=b.tmpl))this.preTmpl(),a=b.tmpl=$H.tmpl({tmpl:this.tmpl,ns:"ModelView"});return this.tmpl=a},getHtml:function(){return this.html?this.html:this.html=this.getTmplFn()(this.xmodel,this)},ifBind:function(b,c,f){if(!f&&"el"==this.bindType||f&&"model"==this.bindType)return!1;f=f?this._bindElNums:this._bindModelNums;c=!f[b]&&(c&&(c instanceof e||c instanceof a)||!c);f[b]=1;return c},getMetaMorph:function(a,b){return $("#metamorph-"+a+(b?"-end":
"-start"))},updateMetaMorph:function(a,b,c){if("append"==c)this.getMetaMorph(a,!0).before(b);else{var f=this.getMetaMorph(a);if(0!=f.length){a="metamorph-"+a+"-end";for(var d=f[0].nextSibling,e;d&&d.id!=a;)e=$(d),d=d.nextSibling,e.remove();void 0!==b&&f.after(b);"remove"==c&&(f.remove(),$(d).remove())}}},wrapMetaMorph:function(a,b){return'<script id="metamorph-'+a+'-start" type="text/x-placeholder">\x3c/script>'+(void 0===b?"":b)+'<script id="metamorph-'+a+'-end" type="text/x-placeholder">\x3c/script>'},
get:function(a){return this.xmodel.get(a)},set:function(a,b){this.xmodel.set(a,b)},update:function(a){this.xmodel.set(a)},getXmodel:function(){return this.xmodel}});g.registerHelper("ModelView",{"if":function(a,b){var c=b.context,f=b.data,d=b.exp;$H.isFunc(a)&&(a=a.call(f));var e;if(a&&!b.inverse||!a&&b.inverse)e=b.fn(f);var g=b.num,h=c.getCid()+"-"+g;c.ifBind(g,f)&&c.listenTo(f,"change:"+d,function(a,f,e){var g;if(e&&!b.inverse||!e&&b.inverse)a={},a[d]=e,g=b.fn(a);c.updateMetaMorph(h,g)});return c.wrapMetaMorph(h,
e)},unless:function(a,b){b.inverse=!0;return b.helpers["if"].call(this,a,b)},each:function(b,c){var f=c.context,d=c.fn,e=j?"":[],g=c.num,h=f.getCid()+"-"+g;if(b){var k;if(b instanceof a)b.each(function(a,b){k=f.wrapMetaMorph(h+"-"+b.uuid,d(b));j?e+=k:e.push(k)}),f.ifBind(g,b)&&(f.listenTo(b,"add",function(a,b,c,e){a=f.wrapMetaMorph(h+"-"+b.uuid,d(b));(e=e.at)?(c=c.at(e-1),$("#metamorph-"+(h+"-"+c.uuid)+"-end").after(a)):$("#metamorph-"+h+"-end").before(a)}),f.listenTo(b,"remove",function(a,b){f.updateMetaMorph(h+
"-"+b.uuid,"","remove")}));else if(void 0!==b.length)for(var l=0,g=b.length;l<g;l++)k=f.wrapMetaMorph(h+"-"+l,d(b[l])),j?e+=k:e.push(k);else for(l in b)k=f.wrapMetaMorph(h+"-"+l,d(b[l])),j?e+=k:e.push(k);return f.wrapMetaMorph(h,j?e:e.join(""))}},getValue:c,parseValue:function(a,b){var c=b.context,f=b.data,d=b.exp,e=g.isEscape,h=b.helpers,j=b.num,k=c.getCid()+"-"+j;c.ifBind(j,f)&&c.listenTo(f,"change:"+d,function(a,b,f){e&&(f=h.escape(f));c.updateMetaMorph(k,f)});e&&(a=h.escape(a));return c.wrapMetaMorph(k,
a)},bindAttr:d,input:function(a,b){b.type="input";return"<input "+d(a,b)+"/>"},textarea:function(a,b){b.type="textarea";return"<textarea "+d(a,b)+">"+b.value+"</textarea>"}});var j=g.getIfPlusJoin(),k=/((\w+)=['"]?)?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/g,l=/[^<]*(<[a-zA-Z]+)/,n=/^[^>]+class=/,m=/class=['"]?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/,q=/^[^>]+{{bindAttr/,r=/^[^>]+{{bindAttr((?!}}).)class=/,t=/({{bindAttr)/;return b});
...
get:function(a){var b=this.xConfig,c=this.xmodel;return c&&void 0!==b[a]?c.get(a):this[a]},set:function(a,b){var c=this.xConfig,d=this.xmodel;d&&void 0!==c[a]?d.set(a,b):this[a]=b},getRefModel:function(){var a;if(a=this.refModel||this.model)return a;for(var b=this.parent;b;){if(a=b.refModel||b.model)return this.refModel=a;if(b.parent)b=b.parent;else return b.model}},bindRefModel:function(){function a(d,f){("both"==c||"bindRef"==c)&&b.listenTo(e,"change:"+d,function(a,c,d){b.set(f,d)});("both"==c||
"bindXmodel"==c)&&b.listenTo(g,"change:"+f,function(a,b,c){e.set(d,c)})}var b=this,c=b.bindRefType,d=b.refModelAttrs;if(c&&d){var e=b.getRefModel(),g=b.xmodel,m;for(m in d)a(m,d[m])}},each:function(a,b){for(var c=this.children,d=c.length,e,g=0;g<d;){e=c[g];e=b?a.apply(e,b):a(g,e);if(!1===e)break;d==c.length?g++:d=c.length}},match:function(a,b){if("*"==a)return!0;b=b||this;var c,d,e;a=a.replace(/^#([^\s,\[]+)/,"[cid=$1]");a=a.replace(/^\.([^\s,\[]+)/,"[cClass=$1]");a=a.replace(/^([^\[]+)/,"[xtype=$1]");
for(var g=/\[([^=|\!]+)(=|\!=)([^=]+)\]/g;c=g.exec(a);){d=c[1];e=c[2];c=c[3];if("false"==c||"true"==c)c=eval(c);d=b.get?b.get(d):b[d];if("="===e?d!=c:d==c)return!1}return!0},find:function(a,b){var c=this;b=b||[];if(a)if($H.isNum(a))b.push(c.children[a]);else if($H.isStr(a)){if(0<a.indexOf(","))return $H.each(a.split(","),function(a,d){b=b.concat(c.find(d))}),b;var d=0==a.indexOf(">"),e=a.replace(/^>?\s?/,""),g=e.search(/\s/),m;0<g&&(m=e.substring(g+1),e=e.substring(0,g));c.each(function(c,g){g.match(e)&&
(m?g.find(m,b):b.push(g));d||g.find(a,b)})}else{if($H.isFunc(a)){var q=$H.isClass(a);c.each(function(c,d){(q&&d instanceof a||!q&&a(d))&&b.push(d);d.find(a,b)})}}else b=b.concat(c.children);return b},parents:function(a){for(var b=this;b.parent;)if(b=b.parent,a&&this.match(a,b))return b;return a||b===this?null:b},index:function(){var a=this,b=a.parent;if(b){var c;b.each(function(b,d){if(d==a)return c=b,!1});return c}return null},callChild:function(a,b){0!=this.children.length&&(a&&"string"!=typeof a&&
...
this.children;c?e.push(a):e.splice(b,0,a);this.trigger("add",a,b);return a}e=this.items;c?e.push(a):e.splice(b,0,a)}},remove:function(a){if(!this._applyArray()){var b=this.children,c=!1,e;if($H.isNum(a))e=a,a=b[e];else if($H.isStr(a)||$H.isFunc(a)){a=this.find(a);for(var g=0,n=a.length;g<n;g++){if(!1==this.remove(a[g]))return!1;c=!0}}else if(a instanceof d)if(a.parent==this){g=0;for(n=b.length;g<n;g++)if(b[g]==a){e=g;break}}else return a.parent.remove(a);void 0!==e&&!1!=a.destroy(!0)&&(b.splice(e,
1),c=!0);this.trigger("remove",a);return c}},parseItem:function(){},parseItems:function(){this.startParseItems=!0;var a=this.items;if(a)for(var a=$H.isArr(a)?a:[a],b=0,c=a.length;b<c;b++)this.add(a[b])},beforeUpdate:function(){return this.trigger("beforeUpdate")},fastUpdate:function(a){var b=this.xConfig,c=!0;$H.each(a,function(a){b.hasOwnProperty(a)||(c=!1)});return c?(this.xmodel.set(a),!0):!1},update:function(a,b){if(!a||!1==this.beforeUpdate())return!1;var c;if(!0===this.fastUpdate(a))c=this;
...
b){var c=b.context,d=b.num,e=c.getCid()+"-"+d,g=c.findHtml(a);if(c.ifBind(d))c.on("add",function(b,d,g){if(d.match(a)){if(void 0!==g){b=c.getMetaMorph(e);for(var h=0;h<g;h++)b=b.next();b.after(d.getHtml())}else c.updateMetaMorph(e,d.getHtml(),"append");d.afterRender()}});return c.wrapMetaMorph(e,g)}});c=/[^<]*(<[a-zA-Z]+)/;return d});
...
listeners:[{name:"focus",el:".js-input",handler:function(){this.getEl().addClass("hui-focus")}},{name:"blur",el:".js-input",handler:function(){this.getEl().removeClass("hui-focus")}}],doConfig:function(b){var e=this;"search"==b.type&&(e.icon="search");e.callSuper();b.isTextarea&&e.listeners.push({name:"input propertychange",el:".js-input",handler:function(){e.getEl().height("auto");var a=e.findEl(".js-input"),b=a[0].scrollHeight;50<=b&&a.css("height",b)}});e.withClear&&e.add({xtype:"Button",radius:"big",
icon:"delete",click:function(){this.parent.findEl("input").val("").focus()}});if(b.inputHeight)e.on("afterRender",function(){e.findEl("input,textarea").css("height",b.inputHeight)})},parseItem:function(b){"Icon"==b.xtype?this.get("iconPos")||this.set("iconPos","left"):"Button"==b.xtype&&(this.get("btnPos")||this.set("btnPos","right"))},fastUpdate:function(b){b.inputHeight&&this.findEl("input,textarea").css("height",b.inputHeight);return this.callSuper()},val:function(b){var e=this.findEl("input,textarea");
if(void 0!==b)e.val(b);else return e.val()},focus:function(){this.findEl("input").focus()}});return g});
...
$Define("C.DatePicker",["C.AbstractComponent","C.Dialog"],function(g,b){function e(a,b,f,e,g){for(a={xtype:"Select",xrole:"dialog-content",name:"dialogSelect",value:a,width:50,cClass:e,optionWidth:100,iconPos:"bottom",extCls:"hui-dp-"+e,options:[],defItem:{showPos:"center"},change:function(){var a=this.parent,b=a.val(!0);if("month"==this.cClass){var b=$H.getDaysInMonth(b),c=a.find(".date > Menu")[0],d=c.find();c.val()>b&&c.val(b);for(c=28;31>c;c++)d[c].hidden=c<b?!1:!0}b=a.val();a.val(b);a.trigger("change")}};b<=
f;b++)a.options.push({text:"minute"==e&&10>b?"0"+b:b,value:b,hidden:g&&b>g});return a}var a=g.define("DatePicker",b);a.getInstance=function(b){var d,f=b.formator||"default",e=a.instance||(a.instance={});(d=e[f])?(d.host!=b.host&&(d.host=b.host,d.off("change confirm"),b.change&&d.on("change",b.change),b.confirm&&d.on("confirm",b.confirm),b.date&&d.val(b.date)),d.show()):d=e[f]=new a($H.extend(b,{destroyWhenHide:!1}));return d};a.extend({xConfig:{cls:"dp"},extCls:"hui-dialog",_customEvents:["change",
"confirm"],doConfig:function(a){var b=this;a=a||{};var f=a.date;$H.isStr(f)&&(f=$H.parseDate(f));for(var f=f||$H.now(),g=a.formator||(a.formator="yyyy-MM-dd HH:mm"),j=$H.formatDate(f,g),k=[],l=$H.getDaysInMonth(f),g=g.match(/[a-zA-Z]+/g),n=j.match(/\d+/g),m=0;m<g.length;m++){var q=g[m],r=parseInt(n[m]);switch(q){case "yyyy":k.push(e(r,r,r+10,"year"));break;case "MM":k.push(e(r,1,12,"month"));break;case "dd":k.push(e(r,1,31,"date",l));break;case "HH":k.push(e(r,0,24,"hour"));break;case "mm":k.push(e(r,
0,60,"minute"))}}$H.extend(a,{contentTitle:j+" \u661f\u671f"+$H.getWeek(f),items:k,okCall:function(){return b.trigger("confirm")}});b.callSuper([a])},val:function(a){var b=this.find("Select"),e=this.formator;if(!a||$H.isBool(a)){for(var g="",j=0;j<b.length;j++)1==j||2==j?g+="-":3==j?g+=" ":4==j&&(g+=":"),g+=b[j].val();b=$H.parseDate(g);return a?b:$H.formatDate(b,e)}var k=g=a;$H.isStr(a)?k=$H.parseDate(a,e):g=$H.formatDate(a,e);a=g.match(/\d+/g);for(j=0;j<b.length;j++)b[j].val(a[j]);this.set("contentTitle",
...
$Define("C.Conversation","C.AbstractComponent",function(g){g=g.define("Conversation");g.extend({xConfig:{cls:"conversation",theme:"left",time:"",image:"",content:""},tmpl:'<div class="c-clear"><div class="hui-conver-time">{{time}}</div><div class="hui-conver-img"><img {{bindAttr src="image"}}></div><div class="hui-conver-content">{{content}}<div class="hui-triangle"><div class="hui-triangle hui-triangle-inner"></div></div></div></div>'});return g});
...
releaseTxt:"\u6b63\u5728\u5237\u65b0",scrollPos:"top",tmpl:'<div class="hui-list"><div class="hui-list-inner">{{#if hasPullRefresh}}<div class="hui-list-pulldown hui-pd-pull c-h-middle-container"><div class="c-h-middle"><span class="hui-icon hui-alt-icon hui-icon-arrow-d hui-light"></span><span class="hui-icon hui-alt-icon hui-icon-loading-mini"></span><div class="hui-pd-txt">{{#if pdTxt}}<div class="js-txt">{{pdTxt}}</div>{{/if}}{{#if pdComment}}<div class="js-comment hui-pd-comment"><span class="js-pdComment">{{pdComment}}</span><span class="js-pdTime">{{pdTime}}</span></div>{{/if}}</div></div></div>{{/if}}{{#if isEmpty}}<div class="hui-list-empty js-empty">{{emptyTips}}</div>{{/if}}<div class="js-item-container">{{placeItem}}</div>{{#if hasMoreBtn}}<div {{bindAttr class="#hui-list-more showMoreBtn:hui-hidden"}}><a href="javascript:;" hidefocus="true" class="hui-btn hui-btn-gray hui-shadow hui-inline hui-radius-little"><span class="hui-btn-txt">{{moreBtnTxt}}</span></a></div>{{/if}}</div></div>',
doConfig:function(){var b=this;b.callSuper();b.set("pdTxt",b.pullTxt);b.itemXtype&&((b.defItem||(b.defItem={})).xtype=b.itemXtype);var e=b.model,a=!1;e.each(function(c,d){b.addListItem(d);a=!0});a||b.set("isEmpty",!0);b.listenTo(e,{add:function(a,d){b.addListItem(d)},remove:function(a,d){b.removeListItem(d)},reset:function(){b.removeListItem("emptyAll")}});e=b.hasPullRefresh&&window.iScroll&&!$H.ie();b.set("hasPullRefresh",e);e&&(b.listen({name:"afterRender",handler:function(){var a=this,b=a.getEl(),
e=b.find(".hui-list-pulldown");a.scroller=new window.iScroll(b[0],{useTransition:!0,topOffset:50,onRefresh:function(){e.hasClass("hui-pd-refresh")&&(e.removeClass("hui-pd-refresh hui-pd-release"),a.set("pdTxt",a.pullTxt))},onScrollMove:function(){5<this.y&&!e.hasClass("hui-pd-release")?(e.addClass("hui-pd-release"),a.set("pdTxt",a.flipTxt),this.minScrollY=0):5>this.y&&e.hasClass("hui-pd-release")&&(e.removeClass("hui-pd-release"),a.set("pdTxt",a.pullTxt),this.minScrollY=-50)},onScrollEnd:function(){e.hasClass("hui-pd-release")&&
(e.addClass("hui-pd-refresh"),a.set("pdTxt",a.releaseTxt),a.refresh())}})}}),b.listenTo(b.model,"sync",function(){b.set("pdTime",$H.formatDate($H.now(),"HH:mm"));setTimeout(function(){b.refreshScroller()},0)}),b.listen({name:"afterShow",handler:function(){b.refreshScroller();"bottom"==b.scrollPos&&b.scrollTo("bottom")}}),b.listen({name:"click",method:"delegate",selector:".hui-list-more",handler:function(){b.getMore()}}))},addListItem:function(b){this.set("isEmpty",!1);this.add({model:b},this.model.indexOf(b));
this.refreshScroller()},removeListItem:function(b){"emptyAll"==b?this.remove(this.children):this.remove(function(e){return e.model&&e.model.id==b.id});0==this.children.length&&this.set("isEmpty",!0);this.refreshScroller()},refreshScroller:function(){this.scroller&&this.getEl()[0].clientHeight&&this.scroller.refresh()},scrollTo:function(b,e){var a=this.scroller;if($H.isStr(b))if("top"==b)a.scrollTo(0,0);else{if("bottom"==b){var c=this.findEl(".hui-list-inner")[0].clientHeight;a.scrollTo(0,-c)}}else a.scrollTo(b,
e)},destroy:function(){this.scroller&&(this.scroller.destroy(),this.scroller=null);this.callSuper()}});return g});$Define("M.AbstractModule","CM.View",function(g){var b=$H.createClass();$H.inherit(b,g,{useCache:$H.noop,cache:$H.noop,init:$H.noop,reset:$H.noop,exit:function(){return!0},cleanCache:function(){this.clearCache=!0}});return b});$Define("M.AbstractNavigator","handy.base.Object",function(g){var b=$H.createClass();g.extend(b.prototype,{navigate:function(){}});return b});
