...
handy.add("Json",function(){function e(a){g.lastIndex=0;g.test(a)&&(a=a.replace(g,function(a){var g=h[a];return"string"===typeof g?g:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function c(g,b){var h,j,l,m,n=d,w,k=b[g];k&&("object"===typeof k&&"function"===typeof k.toJSON)&&(k=k.toJSON(g));"function"===typeof a&&(k=a.call(b,g,k));switch(typeof k){case "undefined":return"undefined";case "string":return e(k);case "number":return isFinite(k)?String(k):"null";case "boolean":case "null":return String(k);
case "object":if(!k)return"null";d+=f;w=[];if("[object Array]"===Object.prototype.toString.apply(k)){m=k.length;for(h=0;h<m;h+=1)w[h]=c(h,k)||"null";l=0===w.length?"[]":d?"[\n"+d+w.join(",\n"+d)+"\n"+n+"]":"["+w.join(",")+"]";d=n;return l}if(a&&"object"===typeof a){m=a.length;for(h=0;h<m;h+=1)"string"===typeof a[h]&&(j=a[h],(l=c(j,k))&&w.push(e(j)+(d?": ":":")+l))}else for(j in k)Object.prototype.hasOwnProperty.call(k,j)&&(l=c(j,k))&&w.push(e(j)+(d?": ":":")+l);l=0===w.length?"{}":d?"{\n"+d+w.join(",\n"+
d)+"\n"+n+"}":"{"+w.join(",")+"}";d=n;return l}}var b="JSON"in window,a,d,f,g=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},j=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,l=/^[\],:{}\s]*$/,m=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,n=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
k=/(?:^|:|,)(?:\s*\[)+/g;return{stringify:function(g,h,j,l){if(b&&!l)return JSON.stringify.apply(null,arguments);var e;f=d="";if("number"===typeof j)for(e=0;e<j;e+=1)f+=" ";else"string"===typeof j&&(f=j);if((a=h)&&"function"!==typeof h&&("object"!==typeof h||"number"!==typeof h.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return c("",{"":g})},parseJson:function(a,g,d){function f(a,b){var d,c,h=a[b];if(h&&"object"===typeof h)for(d in h)Object.prototype.hasOwnProperty.call(h,
d)&&(c=f(h,d),void 0!==c?h[d]=c:delete h[d]);return g.call(a,b,h)}if(b&&!d)return JSON.parse.apply(null,arguments);var c;a=String(a);j.lastIndex=0;j.test(a)&&(a=a.replace(j,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(l.test(a.replace(m,"@").replace(n,"]").replace(k,"")))return c=eval("("+a+")"),"function"===typeof g?f({"":c},""):c;$D.error(new SyntaxError("JSON.parse"))}}});
...
d){if(!a||c.isStr(a)||c.isNum(a))return b;var f=d?d.notCover:!1,g=d?d.cover:null;d=d?d.IsClone:!1;b=b||{};var h=b.constructor,j=h.$isClass,l,e;for(e in a)if(l=a[e],(!g||c.contains(g,e))&&a.hasOwnProperty(e)){var n=b.hasOwnProperty(e),k=!0===f?n:!1;c.isArr(f)?k=c.contains(f,e)&&n:c.isFunc(f)&&(k=f(e,l));k||(l=d?c.clone(l):l,j&&c.isFunc(l)&&(l.$name=e,l.$owner=h),b[e]=l)}return b},mix:function(b,a,d){b.superProto||(b.superProto={});for(var f in a)b.superProto[f]=c.isFunc(a[f])?b.superProto[f]?function(g,
b){return function(){b.apply(this,arguments);a[g].apply(this,arguments)}}(f,b.superProto[f]):a[f]:a[f],b[f]||(b[f]=a[f]);d&&c.extend(b,d);a.toString!=a.constructor.prototype.toString&&(b.superProto.toString=function(){a.toString.apply(b,arguments)});return b},isNum:function(b){return"number"==typeof b},isStr:function(b){return"string"==typeof b},isBool:function(b){return"boolean"==typeof b},isSimple:function(b){return c.isStr(b)||c.isNum(b)||c.isBool(b)},isUndef:function(b){return"undefined"==typeof b},
...
!0;c.each(a,function(f){if(!c.equals(a[f],b[f]))return d=!1});return d}},count:function(b){if(c.isArr(b))return b.length;var a=0,d;for(d in b)a++;return a},removeUndefined:function(b,a){var d=c.isArr(b);if(a){if(d){var f=[];c.each(b,function(a,b){void 0!==b&&f.push(b)});return f}return c.extend({},b,{isClone:!0,notCover:function(a,b){return void 0===b}})}c.each(b,function(a,f){void 0===f&&(d?b.splice(a,1):delete b[a])});return b},toArray:e,fromArray:function(b){for(var a={},d=0,f=b.length;d<f;d++){var g=
...
g&&(f=g.getVariable("$version").split(" ")[1])}else if(navigator.plugins&&0<navigator.plugins.length&&(g=navigator.plugins["Shockwave Flash"])){var h=g.description.split(" ");a=0;for(var j=h.length;a<j;a++)if(0<parseInt(h[a])){f=h[a];break}}}catch(l){}c.flash=f?f:null;return b});
handy.add("Debug",["handy.base.Json","handy.base.Browser"],function(e,c,b){var a={level:b.isDebug?0:5,LOG_LEVEL:1,DEBUG_LEVEL:2,INFO_LEVEL:3,WARN_LEVEL:4,ERROR_LEVEL:5,showInPage:!("console"in window)||!!c.mobile(),out:function(d,f,g){g=g||"log";if(f||a.showInPage){var c=b.expando+"debugDiv",j=top.document,e=j.getElementById(c);e?e.style.display="block":(e=j.createElement("DIV"),e.id=c,e.innerHTML=['<a href="javascript:void(0)" onclick="this.parentNode.style.display=\'none\'">\u5173\u95ed</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="this.parentNode.getElementsByTagName(\'DIV\')[0].innerHTML=\'\';">\u6e05\u7a7a</a>',
...
'<div style="padding-top:5px;height:90%;overflow:auto;"></div>',e.style.position="fixed",e.style.width="100%",e.style.left=0,e.style.top=0,e.style.right=0,e.style.height="100%",e.style.backgroundColor="#aaa",e.style.fontSize="12px",e.style.padding="10px",e.style.zIndex=9999999999,e.style.opacity=0.95,e.style.filter="alpha(opacity=95)",j.body.appendChild(e));c=e.getElementsByTagName("DIV")[0];j="string"==typeof d?d:b.Json.stringify(d,null,"&nbsp;&nbsp;&nbsp;&nbsp;",!0);j=j.replace(/\n|\\n/g,"<br/>");
c.innerHTML+="<div"+("log"==g?"":' style="color:'+("error"==g?"red":"info"==g?"green":"yellow"))+'">'+g+":<br/>"+j+"</div><br/><br/>";c.scrollTop=c.scrollHeight}c=arguments.callee.caller;c.$owner||(c=c.caller);try{if(c.$owner)console[g]("["+c.$owner.$ns+"->"+c.$name+"]");console[g](d)}catch(m){}},log:function(b,f){a.level>a.LOG_LEVEL||a.out(b,!!f,"log")},info:function(b,f){this.level>a.INFO_LEVEL||a.out(b,!!f,"info")},warn:function(b,f){a.level>a.WARN_LEVEL||a.out(b,!!f,"warn")},error:function(b,
f){if(!(a.level>a.ERROR_LEVEL)&&(a.out(b,!!f,"error"),b instanceof Error))throw b;},time:function(b,f,g){a.level>a.INFO_LEVEL||(b?("boolean"==typeof f&&(g=f,f=""),a.out((f||"")+((new Date).getTime()-(a.lastTime||0)),!!g)):a.lastTime=(new Date).getTime())},debug:function(b){if(!(a.level>a.DEBUG_LEVEL)&&!1!==b)debugger}};return a});
handy.add("Function",function(e){return{bind:function(c,b,a){var d=Array.prototype.slice.call(arguments,2);return function(){var a=d.slice();Array.prototype.push.apply(a,arguments);return c.apply(b,a)}},intercept:function(c,b,a,d){return e.Object.isFunc(c)&&e.Object.isFunc(b)?function(){var f=a||this,g={},h=arguments;g.scope=d;g.target=f;g.method=c;return!1!=b.apply(g,h)?c.apply(f,h):!1}:c}}});
...
(b=a,a=null);var d=arguments.callee.caller,c=d.$owner.superProto;b=b||d.arguments;a=a?a.prototype:c||this.constructor.superProto;d=d.$name;if(a&&(d=a[d],e.isFunc(d)))return d.apply(this,b)};a&&this.ns(a,d);return d},inherit:function(a,b,f,g,h){var j=function(){};j.prototype=b.prototype;e.extend(a,b,h);a.prototype=new j;a.prototype.constructor=a;a.superClass=b;a.superProto=b.prototype;if(b._onInherit)try{b._onInherit(a)}catch(l){c.error(l)}g&&e.extend(a,g);f&&e.extend(a.prototype,f)},getSingleton:function(a){return(a=
"string"==typeof a?e.ns(a):a)&&(a.$singleton||(a.$singleton=new a))}};return b});
handy.add("Loader",["B.Debug","B.Object","B.Function"],function(e,c,b,a){function d(a){var b={},g=[];"string"==typeof a&&(a=[a]);for(var d=0,f=a.length;d<f;d++){var h;h=a[d];h=/\.(css|js)$/.test(h)?v[h]&&"loaded"==v[h].status:r.urlMap&&r.urlMap[h]?r.urlMap[h].chkExist():c.ns(h);if(h)g.push(h);else return b.notExist=a[d],b}b.exist=g;return b}function f(a,b){function d(){d.isCalled||(d.isCalled=!0,clearTimeout(m),b())}if("SCRIPT"===a.nodeName){var c=a,f=d,h=function(){/loaded|complete|undefined/.test(c.readyState)&&
(c.onload=c.onerror=c.onreadystatechange=null,n.removeChild(c),c=null,setTimeout(f,0))};c.onload=c.onreadystatechange=h;c.onerror=function(){e.error(l+"load script error:\n"+c.src);h()}}else{var j=d;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",j):setTimeout(function(){g(a,j)},0)}var m=setTimeout(function(){e.error("Time is out:"+a.src);d()},r.timeout)}function g(a,b){if(!b.isCalled){var d;if(k)a.sheet&&(d=!0);else if(a.sheet)try{a.sheet.cssRules&&(d=!0)}catch(c){if("SecurityError"===
c.name||"NS_ERROR_DOM_SECURITY_ERR"===c.name)d=!0}setTimeout(function(){d?b():g(a,b)},1)}}function h(a){r.showLoading(!1);s--;v[a].status="loaded";r.traceLog&&e.log(l+"Response:\n"+a);j()}function j(){for(var a=p.length-1;0<=a;a--){var b=p[a],g=d(b.deps);if(g.notExist)0==a&&0==s&&e.error(m+g.notExist);else{p.splice(a,1);b.callback.apply(null,g.exist);j();break}}}var l="[Handy Loader] ",m=l+"not found: ",n=document.head||document.getElementsByTagName("head")[0]||document.documentElement,k=navigator.userAgent.indexOf("AppleWebKit"),
p=[],s=0,v={},r={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(b,g,d){b=a.Object.alias(b);2==arguments.length&&(d=g,g=[]);r.require(g,function(){var a;if("function"==typeof d)try{r.traceLog&&e.log(l+"define:\n"+b),a=d.apply(null,arguments)}catch(g){g.message=l+b+":\nfactory define error:\n"+g.message;e.error(g);return}else a=d;if(a){c.ns(b,a);var f=typeof a;if("object"==f||"function"==f)a.$ns=b}else e.error(l+"factory no return:\n"+b)})},require:function(g,c){for(var j=
"string"==typeof g?[g]:g,k=[],y=[],t=!0,x=0,z=j.length;x<z;x++){var q=j[x],q=a.Object.alias(q),u=d(q);u.notExist?(k.push(q),t&&(t=!1,p.push({deps:j,callback:c})),r.traceLog&&e.log(m+q)):y.push(u.exist[0])}if(0==k.length)return c&&c.apply(null,y),0==y.length?y[0]:y;t=!1;j=0;for(y=k.length;j<y;j++)if(x=k[j],!v[x]){t=x;q=r.urlMap&&r.urlMap[t]&&r.urlMap[t].url;if(!q){z="";q=r.rootPath;if("string"==typeof q)z=q;else if("object"==typeof q)for(u in u=void 0,q)0==t.indexOf(u)&&(z=q[u],t=t.replace(u,""));
else z="";q=/.css$/.test(t)?0==t.indexOf("/")?t:"/css/"+t:/.js$/.test(t)?t:t.replace(/\./g,"/")+".js";q=z.replace(/\/$/,"")+"/"+q.replace(/^\//,"")}t=!0;v[x]={id:x,status:"loading"};z=b.bind(h,null,x);r.traceLog&&e.log(l+"request:\n"+q);if(/.css$/.test(q))a:{x=q;q=n.getElementsByTagName("link");for(u=0;u<q.length;u++){var B=q[u].href;!r.skinNode&&0<=B.indexOf(r.skinName)&&(r.skinNode=q[u]);if(0<=B.indexOf(x)||0<=x.indexOf(B))break a}q=document.createElement("link");q.rel="stylesheet";q.href=x;f(q,
z);r.skinNode?n.insertBefore(q,r.skinNode):n.appendChild(q)}else x=q,q=document.createElement("script"),q.async="async",q.src=x,q.type="text/javascript",f(q,z),n.appendChild(q);s++}t&&r.showLoading(!0)}};return r});
...
a,arguments)}},_pushEvent:function(c){this._execEvtCache.push(c)},_execEvents:function(){var c=this,b,a=c._execEvtCache;e.each(a,function(d,f){a.splice(d,1);var g=f.delegation;"number"==typeof f.times&&(1<f.times?f.times--:c.off(f.name,f.handler));b=g.apply(c,f.args)});return b},on:function(c,b,a,d){if(!this._parseCustomEvents("on",c,b,a,d)){"number"==typeof a&&(d=a,a=null);var f=this._eventCache,g=f[c];g||(g=f[c]=[]);c=this._delegateHandler(b,a);g.push({times:d,handler:b,context:a,delegation:c})}},
once:function(c,b,a){var d=e.toArray(arguments);d.push(1);this.on.apply(this,d)},off:function(c,b){if("all"==c)return this._eventCache={},!0;if(!this._parseCustomEvents("off",c,b)){var a=this._eventCache,d=c.indexOf(".");if(!b&&0>=d){for(var f in a)(f.split(".")[0]==c||0==d&&0<=f.indexOf(c))&&delete a[f];return!0}d=a[c];if(!d)return!1;if(b){a=0;for(f=d.length;a<f;a++)if(d[a].handler==b)return d.splice(a,1),!0}else return delete a[c],!0;return!1}},suspend:function(){if(this.isSuspend)return!1;this.isSuspend=
...
a.getFullYear());return Math.ceil((a.getTime()-b.getTime())/864E5)},formatDate:function(a,b){b=b||"yyyy-MM-dd HH:mm:ss";var f=a.getHours(),g=Math.floor((a.getMonth()+3)/3),f={"y+":a.getFullYear(),"M+":a.getMonth()+1,"d+":a.getDate(),"h+":0==f%12?12:f%12,"H+":f,"m+":a.getMinutes(),"s+":a.getSeconds(),"w+":c.getWeek(a),"q+":g,"Q+":["\u4e00","\u4e8c","\u4e09","\u56db"][g-1],"S+":a.getMilliseconds()},h;for(h in f)RegExp("("+h+")").test(b)&&(g=RegExp.$1.length,b=b.replace(RegExp.$1,1==g?f[h]:("00"+f[h]).slice(-g)));
return b},parseDate:function(a,b){var c=typeof a,g=new e;if("number"==c)return g.setTime(a),g;if("string"!=c)return a;var c=(b||"yyyy-MM-dd HH:mm:ss").match(/[a-zA-Z]+/g),h=a.match(/\d+/g);if(h){for(var j=0;j<h.length;j++){var l=c[j],m=parseInt(h[j]);switch(l){case "yyyy":g.setFullYear(m);break;case "MM":g.setMonth(m-1);break;case "dd":g.setDate(m);break;case "HH":g.setHours(m);break;case "mm":g.setMinutes(m);break;case "ss":g.setSeconds(m);break;case "SS":g.setMilliseconds(m)}}return g}},now:function(a){var d=
new e;if(a)"number"!=typeof a&&(a=c.parseDate(a).getTime()),b=a-d.getTime();else return d.setTime(d.getTime()+b),d},howLong:function(a,b){if(a){var f=c.now().getTime()-a.getTime();if(!1!=b){var g;if(60>(f/=6E4))g="\u5206\u949f",f=f||1;else if(24>(f/=60))g="\u5c0f\u65f6";else if(30>(f/=24))g="\u5929";else return"30\u5929\u524d";f=(Math.floor(f)||1)+g+"\u524d"}return f}}},b=0;return c});
...
delCookie:function(e){var c=new Date;c.setTime(c.getTime()-1);document.cookie=e+"=;expires="+c.toGMTString()}}});handy.add("Util","B.Object",function(e){var c=0;return{isWindow:function(b){return null!=b&&b==b.window},getUuid:function(){return c++},getHash:function(){return top.location.hash.replace(/\?.*/,"")},setHash:function(b){var a=top.location.hash;0<=a.indexOf("#")&&(b=a.replace(/#[^\?]*/,b));top.location.hash=b},result:function(b,a){var d=b[a];return e.isFunc(d)?d():d}}});
...
handy.add("Geo",function(e){return{distance:function(c,b,a){function d(a){a.get?a=[a.get("latitude"),a.get("longitude")]:e.isObj(a)&&(a=[a.latitude,a.longitude]);return a}var f,g;c=d(c);f=c[0];c=c[1];b=d(b);g=b[0];b=b[1];f=f*Math.PI/180;g=g*Math.PI/180;c=6371*Math.acos(Math.cos(g)*Math.cos(f)*Math.cos(c*Math.PI/180-b*Math.PI/180)+Math.sin(g)*Math.sin(f));c=c.toFixed(2);if(!1!=a){if(isNaN(c))return"\u672a\u77e5";c+="km"}return c}}});
handy.add("Template",["B.Object","B.String","B.Debug","B.Function"],function(e,c,b,a,d){function f(a,b){var g=b.fn,d="";if(a){if(void 0!=a.length)for(var c=0,f=a.length;c<f;c++)d+=g(a[c]);else for(c in a)d+=g(a[c]);return d}}function g(a,b){var g=b.fn,d=[];if(a){if(void 0!=a.length)for(var c=0,f=a.length;c<f;c++)d.push(g(a[c]));else for(c in a)d.push(g(a[c]));return d.join("")}}function h(a){a=a.replace(/("|\\)/g,"\\$1").replace(/\r/g,"\\r").replace(/\n/g,"\\n");return s?"$r+="+('"'+a+'"')+";":"$r.push("+
('"'+a+'"')+");"}function j(a){var b=a.exp,g=a.helper,d=a.children,c=a.num,f="\nif($tmp||$tmp===0){"+(s?"$r+=$tmp;":"$r.push($tmp);")+"}";g?(c="$program"+c,a="$tmp = $helpers."+g+".call($data, ($data && $data."+b+"), {fn:"+c+(a.inverse?",inverse:true":"")+"});"+f,d&&(d=m(d),d=v[0]+"\n"+d.join("\n")+"\n"+v[1],p.splice(2,0,"\nfunction "+c+"($data){\n"+d+"\n}\n"))):a="if (helper = $helpers."+b+") {\n$tmp = helper.call($data); \n}else{\nhelper = ($data && $data."+b+"); $tmp = typeof helper === functionType ? helper.call($data) : helper;\n}"+
f;return a}function l(a,g,d){if(a){g=g||{};d=d||0;var c=n.openTag,f=n.closeTag,h,e;g.children?e=g.children:g.children=e=[];if(0<=(h=a.indexOf(c))){var j=a.substring(0,h);j&&e.push({html:j});a=a.substring(h+c.length);if(0==a.indexOf("#"))if(a=a.substring(1),j=a.match(/^[a-z]+/)){var m=j[0];if(r[m]){h=a.indexOf(f);j=a.substring(m.length+1,h);a=a.substring(h+f.length);j={num:++d,helper:m,exp:j};e.push(j);var k=c+"/"+m+f;a:{h=a;for(var f=RegExp(c+"[#/]"+m+f,"ig"),v=0;c=f.exec(h);)if(c[0]==k)if(0==v){h=
c.index;break a}else v--;else v++;h=-1}if(-1==h){b.error("\u672a\u627e\u5230\u5757\u7ed3\u675f\u4f4d\u7f6e:"+k);return}c=a.substring(0,h);a=a.substring(h+k.length);l(c,j,++d);if("if"==m){m=j.children;k=0;for(c=m.length;k<c;k++)f=m[k],"else"==f.exp&&(f.exp=j.exp,f.helper="if",f.num=d,f.inverse=!0,f.children=m.slice(k+1),e.push(f),j.children=m.slice(0,k))}}else{b.error("\u8f85\u52a9\u51fd\u6570\u2018"+m+"\u2019\u672a\u5b9a\u4e49");return}}else{b.error("\u627e\u4e0d\u5230\u8f85\u52a9\u51fd\u6570:"+a);
return}else h=a.indexOf(f),e.push({exp:a.substring(0,h)}),a=a.substring(h+f.length);l(a,g,++d)}else a&&e.push({html:a});return g}}function m(a){var b=[];if(a)for(var g=0,d=a.length;g<d;g++){var c=a[g];c.html?b.push(h(c.html)):c.exp&&b.push(j(c))}return b}var n={openTag:"{{",closeTag:"}}",isTrim:!0,isEscape:!0,registerHelper:function(a,b){r[a]=b},tmpl:function(a,g){var c,f,h;if("string"==typeof a)c=a;else if(void 0!=a.length)c=a.join("");else if(c=a.tmpl,h=a.id)if(k[h])f=k[h];else if(!c){var e=document.getElementById(h);
e&&(c=(e.value||e.innerHTML).replace(/\s/g,""))}if(!f){if(!c){d.Debug.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}a:{if(n.isTrim){var e=n.openTag,j=n.closeTag;c=c.replace(/^[\s\n]+/,"").replace(/[\s\n]+$/,"").replace(RegExp("("+j+"|\\>)(\\s|\\n)+(?=("+e+"|<))","ig"),"$1").replace(RegExp(j+"[\\s\\n]+([^\\n]+)[\\s\\n]+(?=("+e+"|<))","ig"),j+"$1")}p=[v[0]];p.push('var escape=$helpers.escape,functionType="function";');c=l(c);c=m(c.children);p=p.concat(c);p.push(v[1]);c=p.join("\n");try{var s=window.Function.apply(null,
["$T","$helpers","$data",c]);b.log(s);b.log("\n\n\n\n\n\n\n\n\n\n");f=function(a){return s.call(null,n,r,a)};break a}catch(q){b.log(c),b.error(q)}f=void 0}h&&(k[h]=f)}if(g)try{return f(g)}catch(u){b.log(f.toString()),b.error(u)}else return f}},k={},p,s="".trim,v=["var $r="+(s?'""':"[]")+",$tmp,helper;","return "+(s?"$r;":'$r.join("");')],r={"if":function(a,b){e.isFunc(a)&&(a=a.call(this));if(a||!a&&b.inverse)return b.fn(this)},unless:function(a,b){b.inverse=!0;return r["if"].call(this,a,b)},each:s?
f:g,escape:c.escapeHTML,trim:c.trim};return n});
handy.add("HashChange",["handy.base.Debug","handy.base.Util"],function(e,c,b){function a(a){if(a==m)return!1;var b=l.contentWindow.document;b.open();b.write("<!doctype html><html><body>"+a+"</body></html>");b.close();m=a;e.log("set:"+l.contentWindow.document.body.innerText)}function d(){var b=c.getHash(),g=l.contentWindow.document.body.innerText;b!=m?(a(b),f(b)):g!=m&&(e.log("update:"+l.contentWindow.document.body.innerText),c.setHash(g))}function f(a){var b=p.listeners,g;for(g in b)b[g](a)}var g,
h=0,j=document,l,m,n=j.documentMode,k="onhashchange"in window&&(void 0===n||7<n),p={delay:50,listen:function(e,m){if(!g&&!g)if(g=!0,p.listeners={},k)$(window).on("hashchange",function(){f(c.getHash())});else l=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(j.body)[0],$(l).one("load",function(){a(c.getHash());setInterval(d,p.delay)});if(m in p.listeners)$D.error(Error("Duplicate name"));else return m=m||b.expando+ ++h,p.listeners[m]=e,m},unListen:function(a){for(var b in p.listeners)(!a||
a==b)&&delete p.listeners[b]}};return p});handy.add("Support","B.Browser",function(e){var c={mediaQuery:function(){var a;if(e.mobile())a="hui-mobile";else{a="hui-pc";var b=e.ie();b&&(a+=" ie"+b)}document.documentElement.className+=" "+a}};c.mediaQuery();if(6==e.ie())try{document.execCommand("BackgroundImageCache",!1,!0)}catch(b){}return c});
...
equalTo:"\u8bf7\u8f93\u5165\u76f8\u540c\u7684{name}",min:"{name}\u4e0d\u80fd\u5c0f\u4e8e{0}",max:"{name}\u4e0d\u80fd\u5927\u4e8e{0}",range:"{name}\u8981\u5728{0}\u5230{1}\u4e4b\u95f4",maxlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u8d85\u8fc7{0}",minlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u5c11\u4e8e{0}",rangelength:"{name}\u957f\u5ea6\u8981\u5728{0}\u5230{1}\u4e4b\u95f4"},valid:function(a,c){var f=c.rules,g;for(g in f){var h=f[g],e=("function"==typeof h?h:b[g])(a,h);if(!e)return f=c.error||b.error,g=c.messages&&
c.messages[g]||b.messages[g],g=g.replace(/\{([^\}]+)\}/g,function(a,b){return h[b]||0==b&&h||c[b]||h||""}),f&&f(g),e}return!0},required:function(a){return 0<e.trim(""+a).length},email:function(a){return/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a)},
...
_defaultEvents:"mousedown mouseup mouseover mousemove mouseenter mouseleave dragstart drag dragenter dragleave dragover drop dragend touchstart touchmove touchend touchcancel keydown keyup keypress click dblclick focus focusin focusout contextmenu change submit".split(" "),_applyArray:function(a,b){var c=this,d=arguments,f=d.callee.caller,e=f.$owner.prototype;0==d.length?(d=f.arguments,d=$H.toArray(d),a=f.$name,b=d.shift()):d=$H.toArray(d,2);return $H.isArr(b)?($H.each(b,function(b,f){e[a].apply(c,
[f].concat(d))}),!0):!1},_parseListenEvents:function(a,b){var c=this;return c._parseEvents(b.name,function(d){b.name=d[0];2==d.length&&(b.handler=d[1]);c[a].call(c,b)})},initialize:function(a){if(!this.inited){this.manager=this.constructor.manager||$H.getSingleton(e);var b=this.tmpl;$H.isFunc(b)||(this.tmpl=this.constructor.prototype.tmpl=$H.tmpl(b));this.doConfig(a);this.init&&this.init(a);this.parseItems();!1!=this.autoRender&&this.render();this.manager.register(this);this.inited=!0}},doConfig:function(a){var b=
this;b.initParam=a;"string"==typeof a&&(a={text:a});var c=a||{};$H.extend(b,c,{notCover:function(a,g){var d=$H.contains(b._customEvents,a);if($H.contains(b._defaultEvents,a))return b.listeners.push({name:a,handler:c[a]}),!0;if(d)return b.on(a,c[a]),!0;if("defItem"==a)return b[a]=$H.extend(b[a],g),!0;if("listener"==a)return b.listeners=b.listeners.concat($H.isArr(g)?g:[g]),!0;if("items"==a)return b.add(g),!0;if("extCls"==a&&b[a])return b[a]+=" "+g,!0;if("xtype"==a)return"View"==b[a]&&(b[a]="string"==
typeof g?g:g.$ns),!0}});if(a=c.renderTo){if($H.isFunc(a))a=a.call(b);else if($H.isStr(a)&&0==a.indexOf(">")){var d=b.parent;a=d.inited&&d.findEl(a.substring(1))}else a=$(a);b.renderTo=a}else b.renderTo=$(document.body)},getEl:function(){return this._container},getId:function(){return this._id||(this._id=this.manager.generateId(this.cid))},initHtml:function(){return this.tmpl(this)},getHtml:function(){var g=this.getId(),c;c="visibility"==this.displayMode?"visibility:hidden;":"display:none;";var f=
this.initHtml(),e=a.test(f),m="js-"+this.manager.type+" js-"+this.xtype+" "+this.extCls+" ";e&&(f=f.replace(d,"$1"+m));return f=f.replace(b,'$1 id="'+g+'" style="'+c+'"'+(e?"":' class="'+m+'"'))},findHtml:function(a){a=this.find(a);for(var b=[],c=0;c<a.length;c++)b.push(a[c].getHtml());return b.join("")},initStyle:function(){var a=this.getEl(),b=this.style||{};void 0!=this.width&&(b.width=this.width);void 0!=this.height&&(b.height=this.height);a.css(b)},beforeRender:function(){return this.trigger("beforeRender")},
...
c.beforeShow()||c.showed||b&&c.hidden)return!1;if(!a&&c.delayShow)setTimeout(function(){f.prototype.show.call(c,!0)},0);else{c.trigger("show");c.showed=!0;var d=c.getEl();"visibility"==c.displayMode?d.css({visibility:"visible"}):d.show();c.callChild([null,!0]);c.afterShow()}},afterShow:function(){var a=this;setTimeout(function(){a.trigger("afterShow")},0)},beforeHide:function(){return this.trigger("beforeHide")},hide:function(){if(!1==this.beforeHide()||!this.showed)return!1;this.showed=!1;var a=
...
a?b.children:b.getEl().html()},setContent:function(a,b){if(b)return!b instanceof f&&(b=this.find(b)[0]),b.setContent(a);var c=this.getEl();c.contents().remove();if("string"==typeof a)c.html(a);else return this.add(a)},listen:function(a){if(!this._parseListenEvents("listen",a)){var b=a.name,c=a.context,d=a.times,f=a.target,e=a.custom||f||$H.contains(this._customEvents,b),k=a.handler;$H.isFunc(f)&&(f=f.call(this));if(e)a=$H.removeUndefined([f,b,k,c,d]),this[f?"listenTo":"on"].apply(this,a);else if(this.listened){var f=
this._listeners,d=a.el,e=a.method||"bind",p=a.selector,s=a.data,c=a.delegation=this._delegateHandler(k,c);$H.isFunc(d)&&(d=d.call(this));d=d?"string"==typeof d?this.findEl(d):d:this.getEl();if(p)if(s)d[e](p,b,s,c);else d[e](p,b,c);else if(s)d[e](b,s,c);else d[e](b,c);f.push(a)}else this.listeners.push(a)}},unlisten:function(a){if(!this._parseListenEvents("unlisten",a)){var b=a.name,c=a.handler;if(a.custom)this.off(b,c);else{var d=a.el,f="delegate"==a.method?"undelegate":"unbind";a=a.selector;for(var e,
d=d?"string"==typeof d?this.findEl(d):d:this.getEl(),k=this._listeners.length-1;0<=k;k--){var p=this._listeners[k];if(p.handler==c){e=p.delegation;this._listeners.splice(k,1);break}}if(a)d[f](a,b,e);else d[f](b,e)}}},initListeners:function(){if(this.listened)return!1;this.listened=!0;var a=this.listeners;this._listeners=[];for(var b=a.length-1;0<=b;b--)this.listen(a[b]);this.callChild()},clearListeners:function(){for(var a=this._listeners,b=a.length-1;0<=b;b--)this.unlisten(a[b]);this.off("all");
this.unlistenTo("all");this.callChild()},suspend:function(){if(this.isSuspend)return!1;this.isSuspend=!0;this.callChild()},resume:function(){if(!this.isSuspend)return!1;this.isSuspend=!1;this.callChild()},findEl:function(a){return this.getEl().find(a)},parentsEl:function(a){return this.getEl().parents(a)},each:function(a,b){for(var c=this.children,d=c.length,f,e=0;e<d;){f=c[e];f=b?a.apply(f,b):a(e,f);if(!1===f)break;d==c.length?e++:d=c.length}},match:function(a,b){if("*"==a)return!0;var c=b||this,
d,f,e;a=a.replace(/^#([^\s,\[]+)/,"[cid=$1]");a=a.replace(/^\.([^\s,\[]+)/,"[cClass=$1]");a=a.replace(/^([^\[]+)/,"[xtype=$1]");for(var k=/\[([^=|\!]+)(=|\!=)([^=]+)\]/g;d=k.exec(a);){f=d[1];e=d[2];d=d[3];if("false"==d||"true"==d)d=eval(d);if("="===e?c[f]!=d:c[f]==d)return!1}return!0},find:function(a,b){var c=this;b=b||[];if($H.isNum(a))b.push(c.children[a]);else if($H.isStr(a)){if(0<a.indexOf(","))return $H.each(a.split(","),function(a,d){b=b.concat(c.find(d))}),b;var d=0==a.indexOf(">"),f=a.replace(/^>?\s?/,
""),e=f.search(/\s|>/),k;0<e&&(k=f.substring(e),f=f.substring(0,e));c.each(function(c,e){e.match(f)&&(k?e.find(k,b):b.push(e));d||e.find(a,b)})}else if($H.isFunc(a)){var p=$H.isClass(a);c.each(function(c,d){(p&&d instanceof a||!p&&a(d))&&b.push(d);d.find(a,b)})}return b},parents:function(a){for(var b=this;b.parent;)if(b=b.parent,a&&this.match(a,b))return b;return a||b===this?null:b},index:function(){var a=this,b=a.parent;if(b){var c;b.each(function(b,d){if(d==a)return c=b,!1});return c}return null},
callChild:function(a,b){0!=this.children.length&&(a&&"string"!=typeof a&&(b=a,a=null),a=a||arguments.callee.caller.$name,this.each(function(c,d){b?d[a].apply(d,b):d[a].call(d)}))},add:function(a,b){if(!this._applyArray()){var c=void 0==b;if(this.startParseItems){if(a instanceof f)a.parent=this;else{this.defItem&&$H.extend(a,this.defItem,{notCover:!0});this.parseItem(a);var d=this.manager.getClass(a.xtype);if(d){var e=a.renderTo;!this.inited&&($H.isStr(e)&&0==e.indexOf(">"))&&(e=null);e||(this.inited?
a.renderTo=this.getEl():a.autoRender=!1);a.parent=this;a=new d(a)}else $D.error("xtype:"+a.xtype+"\u672a\u627e\u5230")}d=this.children;c?d.push(a):d.splice(b,0,a);this.trigger("add",a);return a}d=this.items;c?d.push(a):d.splice(b,0,a)}},remove:function(a){if(!this._applyArray()){var b=this.children,c=!1,d;if($H.isNum(a))d=a,a=b[d];else if($H.isStr(a)||$H.isFunc(a)){a=this.find(a);for(var e=0,n=a.length;e<n;e++){if(!1==this.remove(a[e]))return!1;c=!0}}else if(a instanceof f)if(a.parent==this){e=0;
for(n=b.length;e<n;e++)if(b[e]==a){d=e;break}}else return a.parent.remove(a);void 0!=d&&!1!=a.destroy(!0)&&(b.splice(d,1),c=!0);this.trigger("remove",a);return c}},parseItem:function(){},parseItems:function(){this.startParseItems=!0;var a=this.items;if(a)for(var a=$H.isArr(a)?a:[a],b=0,c=a.length;b<c;b++)this.add(a[b])},beforeUpdate:function(){return this.trigger("beforeUpdate")},update:function(a,b){if(!1==this.beforeUpdate())return!1;a=a||{};var c=this.parent,d=$("<span></span>").insertBefore(this.getEl());
b||(void 0==a.autoRender&&(a.autoRender=!0),a=$H.extend(a,this.initParam,{notCover:!0}));a=$H.extend(a,{xtype:this.xtype,renderBy:"replaceWith",renderTo:d},{notCover:["xtype"]});if(!a.cid||a.cid==this.cid)a._id=this._id;if(c){var f=this.index();if(!1==c.remove(this))return d.remove(),!1;c=c.add(a,f)}else{if(!1==this.destroy())return d.remove(),!1;c=new this.constructor(a)}this.trigger("update",c);this.afterUpdate(c);return c},replace:function(a){return this.update(a,!0)},afterUpdate:function(a){this.trigger("afterUpdate",
...
{extend:function(a){var b=this.prototype;$H.extend(b,a,{notCover:function(c){if($H.contains(["_customEvents","listeners"],c))return b[c]=(a[c]||[]).concat(b[c]||[]),!0;if("xtype"==c||"constructor"==c)return!0}})},html:function(a){return(new this($H.extend({autoRender:!1},a))).getHtml()}});return f});
$Define("CM.Model",["CM.AbstractDao","CM.AbstractEvents","CM.DataStore"],function(e,c){return c.derive({idAttribute:"id",_pending:!1,_validate:function(b,a){if(!a.validate||!this.validate)return!0;b=$H.extend({},this._attributes,b);var c=this.validationError=this.validate(b,a)||null;if(!c)return!0;this.trigger("invalid",this,c,$H.extend(a,{validationError:c}));return!1},_initDepFields:function(){var b=this.fields,a,c;for(c in b)if(a=b[c],a=a.depends)for(var f=0;f<a.length;f++)this.on("change:"+a[f],
$H.bind(this.set,this,c,null,null))},_parseFields:function(b){var a;if(!(a=this.fields))return b;var c,f,g,e={},j;for(j in b){f=b[j];if(c=a[j]){g=$H.isObj(c)?c.type:c;if(c=c.parse)f=c.apply(this,[f,b]);$H.isStr(g)&&("Date"==g?f=$H.parseDate(f):0<g.indexOf(".")&&(g=$H.ns(g)));$H.isClass(g)&&!(f instanceof g)&&(f=new g(f),f.on("all",$H.bind(this._onAttrEvent,this,j)))}e[j]=f}return e},_onAttrEvent:function(b,a){if(!("invalid"==a||"sync"==a)){var c=this.get(b);0!=a.indexOf("change:")&&(this.trigger("change:"+
b,this,c),this.trigger("change",this))}},initialize:function(b,a){this.dao=this.dao||$H.getSingleton(e);this._initDepFields();var c=b||{};a||(a={});this.cid=$H.Util.getUuid();this._attributes={};a.collection&&(this.collection=a.collection);a.parse&&(c=this.parse(c,a)||{});c=$H.extend(c,$H.Util.result(this,"defaults"),{notCover:!0});this.set(c,a);this._changed={};$S.push(this)},toJSON:function(){return $H.clone(this._attributes)},sync:function(b,a,c){return this.dao.sync(b,a,c)},get:function(b){return this._attributes[b]},
escape:function(b){return $H.String.escapeHTML(this.get(b))},has:function(b){b=this.get(b);return null!=b&&void 0!=b},set:function(b,a,c){var f;"object"===typeof b?(f=b,c=a):(f={})[b]=a;c||(c={});f=this._parseFields(f);if(!this._validate(f,c))return!1;var g=c.unset;b=c.silent;var e=[],j=this._changing;this._changing=!0;j||(this._previousAttributes=$H.Object.clone(this._attributes),this._changed={});var l=this._attributes,m=this._previousAttributes;this.idAttribute in f&&(this.id=f[this.idAttribute]);
for(var n in f)a=f[n],$H.equals(l[n],a)||e.push(n),$H.equals(m[n],a)?delete this._changed[n]:this._changed[n]=a,g?delete l[n]:l[n]=a;if(!b){e.length&&(this._pending=c);a=0;for(f=e.length;a<f;a++)this.trigger("change:"+e[a],this,l[e[a]],c)}if(j)return this;if(!b)for(;this._pending;)c=this._pending,this._pending=!1,this.trigger("change",this,c);this._changing=this._pending=!1;return this},unset:function(b,a){a=a||{};a.unset=!0;return this.set(b,void 0,a)},clear:function(b){var a={},c;for(c in this._attributes)a[c]=
void 0;b=b||{};b.unset=!0;return this.set(a,b)},hasChanged:function(b){var a=this._changed;return null==b?!$H.isEmpty(a):$H.contains(a,b)},changedAttrbutes:function(b){if(!b)return this.hasChanged()?$H.clone(this._changed):!1;var a,c=!1,f=this._changing?this._previousAttributes:this._attributes,g;for(g in b)if(!$H.equals(f[g],a=b[g]))(c||(c={}))[g]=a;return c},previous:function(b){return null==b||!this._previousAttributes?null:this._previousAttributes[b]},fetch:function(b){var a=this;b=b?$H.clone(b):
{};void 0===b.parse&&(b.parse=!0);var c=b.success,f=b.beforeSet;b.success=function(g){if(!(f&&!1==f(a,g,b))){if(!a.set(a.parse(g,b),b))return!1;c&&c(a,g,b);a.trigger("sync",a,g,b)}};a.sync("read",a,b)},save:function(b,a,c){var f=this,g;null==b||"object"===typeof b?(g=b,c=a):(g={})[b]=a;$H.isFunc(c)&&(c={success:c});c=$H.extend({validate:!0},c);if(g&&c.now){if(!f.set(g,c))return!1}else if(!f._validate(g,c))return!1;void 0===c.parse&&(c.parse=!0);var e=c.success;c.success=function(a){var b=f.parse(a,
c);c.now||(b=$H.extend(g||{},b));if($H.isObj(b)&&!f.set(b,c))return!1;e&&e(f,a,c);f.trigger("sync",f,a,c)};b=f.isNew()?"create":c.update?"update":"patch";if("patch"===b){a=f.changedAttrbutes(g);if(!a){e&&e(f,c);return}c.attrs=a}else a=$H.extend({},f._attributes),c.attrs=$H.extend(a,g);f.sync(b,f,c)},destroy:function(b){var a=this;b=b?$H.clone(b):{};var c=b.success,f=function(){a.trigger("destroy",a,a.collection,b);a.off("all")};b.success=function(g){(!b.now||a.isNew())&&f();c&&c(a,g,b);a.isNew()||
a.trigger("sync",a,g,b)};if(a.isNew())return b.success(),!1;a.sync("delete",a,b);b.now&&f()},getUrl:function(){var b=$H.result(this,"url")||$H.result(this.collection,"url");b||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));return this.isNew()?b:b.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(b){return b.code&&b.data?b.data:b},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0==this.id},
isValid:function(b){return this._validate({},$H.extend(b||{},{validate:!0}))}})});
$Define("CM.Collection",["CM.AbstractDao","CM.AbstractEvents","CM.Model","CM.DataStore"],function(e,c,b){var a=c.derive({_reset:function(){this.length=0;this._models=[];this._byId={}},_prepareModel:function(a,c){if(a instanceof b)return a;c=c?$H.clone(c):{};c.collection=this;var d=$S.get(this.model.$ns,{id:c.id});if(d=d&&d[0])return d.set(a,c),d;d=new this.model(a,c);if(!d.validationError)return d;this.trigger("invalid",this,d.validationError,c);return!1},_addReference:function(a){this._byId[a.cid]=
...
$H.getSingleton(e);b||(b={});b.model&&(this.model=b.model);b.url&&(this.url=b.url);void 0!==b.comparator&&(this.comparator=b.comparator);this._reset();a&&this.reset(a,$H.extend({silent:!0},b))},toJSON:function(a){return $H.map(this._models,function(b){return b.toJSON(a)})},sync:function(a,b,c){return this.dao.sync(a,b,c)},add:function(a,b){b=$H.extend({add:!0,remove:!1,merge:!1},b);return this.set(a,b)},remove:function(a,b){var c=!$H.isArr(a);a=c?[a]:$H.clone(a);b||(b={});var d,e,m,n;d=0;for(e=a.length;d<
e;d++)if(n=a[d]=this.get(a[d]))delete this._byId[n.id],delete this._byId[n.cid],m=this.indexOf(n),this._models.splice(m,1),this.length--,b.silent||(b.index=m,n.trigger("remove",n,this,b)),this._removeReference(n,b);return c?a[0]:a},set:function(a,c){if(a){c=$H.extend({add:!0,remove:!0,merge:!0},c);c.parse&&(a=this.parse(a,c));var d=!$H.isArr(a),e=d?a?[a]:[]:$H.clone(a),l,m,n,k,p,s,v,r=c.at,C=this.model,A=this.comparator&&null==r&&!1!==c.sort,D="string"==typeof this.comparator?this.comparator:null,
w=[],y=[],t={},x=c.add,z=c.merge,q=c.remove,u=!A&&x&&q?[]:!1;l=0;for(m=e.length;l<m;l++){p=e[l]||{};n=p instanceof b?k=p:p[C.prototype.idAttribute||"id"];if(s=this.get(n))q&&(t[s.cid]=!0),z&&(p=p===k?k.attributes:p,c.parse&&(p=s.parse(p,c)),s.set(p,c),A&&(!v&&s.hasChanged(D))&&(v=!0)),e[l]=s;else if(x){c.id=n;k=e[l]=this._prepareModel(p,c);if(!k)continue;w.push(k);this._addReference(k,c)}k=s||k;u&&(k.isNew()||!t[k.id])&&u.push(k);t[k.id]=!0}if(q){l=0;for(m=this.length;l<m;++l)t[(k=this._models[l]).cid]||
y.push(k);y.length&&this.remove(y,c)}if(w.length||u&&u.length)if(A&&(v=!0),this.length+=w.length,null!=r){l=0;for(m=w.length;l<m;l++)this._models.splice(r+l,0,w[l])}else{u&&(this._models.length=0);n=u||w;l=0;for(m=n.length;l<m;l++)this._models.push(n[l])}v&&this.sort({silent:!0});if(!c.silent){l=0;for(m=w.length;l<m;l++)(k=w[l]).trigger("add",k,this,c);(v||u&&u.length)&&this.trigger("sort",this,c)}return d?e[0]:e}},each:function(a){$H.each(this._models,a)},reset:function(a,b){b||(b={});for(var c=
...
this._models=this.sortBy(this.comparator,this):this._models.sort($H.Function.bind(this.comparator,this));a.silent||this.trigger("sort",this,a);return this},pluck:function(a){return $H.invoke(this._models,"get",a)},getUrl:function(){return this.url},fetch:function(a){var b=this;a=a?$H.clone(a):{};void 0===a.parse&&(a.parse=!0);var c=a.success,d=a.beforeSet;a.success=function(e){d&&!1==d(b,e,a)||(b[a.reset?"reset":a.add?"add":"set"](e,a),c&&c(b,e,a),b.trigger("sync",b,e,a))};return b.sync("read",b,
a)},create:function(a,b){var c=this;b=b?$H.clone(b):{};if(!(a=c._prepareModel(a,b)))return!1;b.now&&c.add(a,b);var d=b.success;b.success=function(a,f){b.now||c.add(a,b);d&&d(a,f,b)};a.save(null,b);return a},parse:function(a){return a.data},clone:function(){return new this.constructor(this._models)}}),d=$H.Array;$H.each("map some every find filter invoke indexOf".split(" "),function(b,c){a.prototype[c]=function(){var a=Array.prototype.slice.call(arguments);a.unshift(this._models);return d[c].apply(d,
a)}});$H.each(["sortBy","groupBy","countBy"],function(b){a.prototype[b]=function(a,c){var e=$H.isFunc(a)?a:function(b){return b.get(a)};return d[b](this._models,e,c)}});return a});
$Define("CM.ModelView",["CM.AbstractEvents","CM.Model","B.Template"],function(e,c,b){b.registerHelper("set",function(a,b,c){a=a.helper.escape;return'<script id="metamorph-'+c+'-start" type="text/x-placeholder">\x3c/script>'+a(b)+'<script id="metamorph-'+c+'-end" type="text/x-placeholder">\x3c/script>'});return e.derive({initialize:function(a){this._config=new c;this.html=b.tmpl(a.tmpl,a.data)},update:function(){}})});
$Define("C.ComponentManager",["CM.AbstractManager","CM.ViewManager"],function(e,c){var b=e.derive({type:"component",initialize:function(){var a=$H.getSingleton(c);this._types=a._types;this._all=a._all}});$CM=new b;return b});
...
theme:"error"})});return a=$H.Validator.valid(b,a)}for(var b=this.children,c=0,e=b.length;c<e;c++)if(a=b[c].valid(),!a)return a;return!0}},{define:function(a,c){var f=$H.createClass();$H.inherit(f,c||b,null,null,{notCover:function(a){return"define"==a}});$H.getSingleton(e).registerType(a,f);return $C[a]=f}});return b});
$Define("C.Icon","C.AbstractComponent",function(e){e=e.define("Icon");e.extend({tmpl:'<span class="<%if(this.isAlt){%> hui-alt-icon<%}%> hui-icon-<%=this.name%><%if(!this.noBg){%> hui-icon-bg<%}%>"></span>',doConfig:function(c){$H.isStr(c)&&(c={name:c});this.callSuper([c])}});return e});
...
$Define("C.Panel","C.AbstractComponent",function(e){e=e.define("Panel");e.extend({isLoading:!1,loadingTxt:"\u6b63\u5728\u52a0\u8f7d\u4e2d...",tmpl:'<div><%if(this.isLoading){%><div class="hui-panel-loading"><div class="hui-mask"></div><div class="hui-loading-container"><div class="hui-tips hui-tips-big hui-tips-black hui-radius-little"><span class="hui-icon hui-icon-loading"></span><span class="hui-tips-txt"><%=this.loadingTxt%></span></div></div></div><%}%><%=this.content||this.findHtml(">*")%></div>'});return e});
...
a.hide()},a.timeout)},hide:function(){!1!=this.callSuper()&&(this.noMask||this.unmask(),this.destroyWhenHide&&this.destroy())},top:function(){this.getEl().css({left:"80px",top:"8px",position:"fixed"})},center:function(){var a=this.getEl(),b=this.width||a.outerWidth(),c=this.height||a.outerHeight(),e=document,b=((e.documentElement.offsetWidth||e.body.offsetWidth)-b)/2,c=((e.documentElement.clientHeight||e.body.clientHeight)-c)/2+(e.documentElement.scrollTop||e.body.scrollTop),c=10>c?window.screen.height/
2-200:c;a.css({left:b+"px",top:c-(this.offsetTop||0)+"px"})},followEl:function(a){a=(a||this.parent.getEl()).position();this.getEl().css(a)},mask:function(){b||(b=$('<div class="hui-mask" style="display:none;"></div>').appendTo(document.body));b.css("z-index",1E3*c+998);0==c&&b.show();c++},unmask:function(){c--;0==c?b.hide():b.css("z-index",1E3*(c-1)+998)}});return e});
...
el:".js-input",handler:function(){this.getEl().addClass("hui-focus")}},{name:"blur",el:".js-input",handler:function(){this.getEl().removeClass("hui-focus")}}],doConfig:function(c){var b=this;"search"==c.type&&(b.icon="search");b.callSuper();"textarea"==b.type&&b.listeners.push({name:"input propertychange",el:".js-input",handler:function(){var a=b.findEl(".js-input"),c=a[0].scrollHeight;50<=c&&a.css("height",c)}});b.withClear&&b.add({xtype:"Button",radius:"big",icon:"delete",click:function(){this.parent.findEl("input").val("").focus()}})},
parseItem:function(c){"Icon"==c.xtype?this.hasIcon=!0:"Button"==c.xtype&&(this.hasBtn=!0)},val:function(c){var b=this.findEl("input,textarea");if(c)b.val(c);else return b.val()},focus:function(){this.findEl("input").focus()}});return e});$Define("C.Label","C.AbstractComponent",function(e){e=e.define("Label");e.extend({tmpl:'<label class="<%if(this.color){%> hui-label-<%=this.color%><%}%><%if(this.textAlign){%> c-txt-<%=this.textAlign%><%}%>" for="<%=this.forName%>"><%=this.text%></label>'});return e});
$Define("C.RowItem","C.AbstractComponent",function(e){e=e.define("RowItem");e.extend({cls:"rowitem",tmpl:'<div class="<%if(this.text){%> hui-rowitem-txt<%}%><%if(this.underline){%> hui-rowitem-underline<%}%>"><%=this.text%><%=this.findHtml(">*")%><%if(this.hasArrow){%><a href="javascript:;" hidefocus="true" class="hui-click-arrow" title="\u8be6\u60c5"><span class="hui-icon hui-alt-icon hui-icon-carat-r hui-light"></span></a><%}%></div>',doConfig:function(c){this.callSuper();this.text||(this.text=
"&nbsp;");this.text&&void 0==this.underline&&(this.underline=!0);c.click&&void 0==this.hasArrow&&(this.hasArrow=!0)}});return e});$Define("C.Set","C.AbstractComponent",function(e){e=e.define("Set");e.extend({tmpl:'<div><h1 class="hui-set-title"><%=this.title%></h1><div class="hui-set-content"><%=this.findHtml(">*")%></div></div>'});return e});
$Define("C.Field","C.AbstractComponent",function(e){e=e.define("Field");e.extend({defItem:{xtype:"RowItem",xrole:"content"},tmpl:'<div class="<%if(this.noPadding){%> hui-field-nopadding<%}%>"><div class="hui-field-left"><%=this.findHtml(">[xrole=title]")%></div><div class="hui-field-right"><%=this.findHtml(">[xrole=content]")%></div></div>',doConfig:function(c){this.callSuper();var b=this.title;$H.isSimple(b)&&(b={text:b});b=$H.extend({xtype:"Label",xrole:"title"},b);this.add(b);b=this.content;void 0==
b&&!c.items&&(b="");$H.isSimple(b)&&(b={text:b,underline:!0});b&&(this.noPadding=!0,this.add(b))}});return e});$Define("C.Form","C.AbstractComponent",function(e){e=e.define("Form");e.extend({tmpl:'<div><form action=""><div class="hui-form-tips c-txt-error"></div><%=this.findHtml(">*")%></form></div>'});return e});
...
this.activeType&&(this.defItem.activeType=this.activeType)},layout:function(){var a=this.children.length,b=Math.floor(100/a);this.findEl(".js-tab-btns>li").each(function(c,e){e.style.width=c<a-1?b+"%":100-b*(a-1)+"%"})},setTabContent:function(a,b){b=b||this.getSelected(!0);this.findEl(".js-tab-content").index(b).html(a)}});return e});
$Define("C.Toolbar","C.AbstractComponent",function(e){e=e.define("Toolbar");e.extend({cls:"tbar",defItem:{xtype:"Button",theme:"black"},tmpl:'<div class="<%if(this.type=="header"){%> hui-header<%}else if(this.type=="footer"){%> hui-footer<%}%>"><%=this.findHtml(">*")%><%if(this.title){%><h1 class="hui-tbar-title js-tbar-txt"><%=this.title%></h1><%}%></div>',parseItem:function(c){"Button"==c.xtype&&(c.shadowSurround=!0,"left"==c.pos?c.extCls=(c.extCls||"")+" hui-tbar-btn-left":"right"==c.pos&&(c.extCls=
(c.extCls||"")+" hui-tbar-btn-right"))}});return e});
$Define("C.Tips",["C.AbstractComponent","C.Popup","C.ControlGroup"],function(e,c){var b=e.define("Tips",c);b.extend({cls:"tips",tType:"big",theme:"black",timeout:1E3,radius:"normal",tmpl:'<div class="<%if(!this.text){%> hui-tips-notxt<%}%>"><%=this.findHtml(">*")%><%if(this.text){%><span class="hui-tips-txt"><%=this.text%></span><%}%></div>',doConfig:function(a){"loading"==a.type?$H.extend(this,{text:"\u6b63\u5728\u52a0\u8f7d\u4e2d...",timeout:null,noMask:!0,icon:"loading"}):"miniLoading"==a.type?
$H.extend(this,{showPos:"top",clickHide:!1,destroyWhenHide:!1,timeout:null,delayShow:!1,shadowOverlay:null,theme:null,noMask:!0,tType:"mini",items:{xtype:"Icon",name:"loading-mini",noBg:!0}}):"topTips"==a.type&&$H.extend(this,{showPos:"top",noMask:!0,tType:"mini"});this.callSuper()}});return b});
...
f(a)}})}});b.extend({okTxt:"\u786e\u5b9a",cancelTxt:"\u53d6\u6d88",clickHide:!1,radius:"little",tmpl:'<div><%=this.findHtml(">[xrole=dialog-header]")%><div class="hui-dialog-body"><%if(this.content){%><%=this.content%><%}else{%><div class="hui-body-content"><h1 class="hui-content-title"><%=this.contentTitle%></h1><div class="hui-content-msg"><%=this.contentMsg%></div><%=this.findHtml(">[xrole=dialog-content]")%></div><%}%><%if(!this.noAction){%><div class="hui-body-action"><%=this.findHtml(">[xrole=dialog-action]")%></div><%}%></div></div>',
...
c){c=!1!=c;"dot"==this.markType?(a.selected=c,a.getEl().parent()[!1==c?"removeClass":"addClass"]("hui-item-mark")):"active"==this.markType?b.prototype.selectItem.call(this,a,c):a.selected=c}});return e});
$Define("C.Hcard","C.AbstractComponent",function(e){e=e.define("Hcard");e.extend({tmpl:'<div class="hui-hcard<%if(this.image){%> hui-hcard-hasimg"><div class="hui-hcard-img"><img src="<%=this.image%>"></div><%}else{%>"><%}%><div class="hui-hcard-content"><div class="hui-content-title"><%=this.title%></div><%var aDesc=this.desc;aDesc=$H.isArr(aDesc)?aDesc:[aDesc];for(var i=0;i<aDesc.length;i++){%><div class="hui-content-desc"><%var icon;if(icon=aDesc[i].icon){%><span class="hui-icon hui-mini hui-alt-icon hui-icon-<%=icon%> hui-light"></span><%}%><%=aDesc[i].text%></div><%}%></div><%=this.findHtml(">*")%><%if(this.hasArrow){%><a href="javascript:;" hidefocus="true" class="hui-click-arrow" title="\u8be6\u60c5"><span class="hui-icon hui-alt-icon hui-icon-carat-r hui-light"></span></a><%}%></div>',doConfig:function(c){this.callSuper();
c.click&&void 0==this.hasArrow&&(this.hasArrow=!0)}});return e});
$Define("C.Vcard","C.AbstractComponent",function(e){e=e.define("Vcard");e.extend({tmpl:'<div class="hui-vcard"><div class="hui-vcard-title hui-title-hasimg c-clear"><div class="hui-title-img"><img alt="" src="<%=this.image%>"></div><div class="hui-title-txt"><%=this.title%></div><div class="hui-title-extra"><%=this.extraTitle%></div></div><%=this.findHtml(">[xrole!=action]")%><div class="hui-vcard-action"><%=this.findHtml(">[xrole=action]")%></div></div>',doConfig:function(c){this.callSuper();if(c=
c.action)c=$H.extend({xtype:"Button",radius:null,isInline:!1,xrole:"action"},c),this.add(c)}});return e});
$Define("C.ModelList","C.AbstractComponent",function(e){e=e.define("ModelList");e.extend({emptyTips:"\u6682\u65e0\u7ed3\u679c",pdText:"\u4e0b\u62c9\u53ef\u5237\u65b0",pdComment:"\u4e0a\u6b21\u5237\u65b0\u65f6\u95f4\uff1a",tmpl:'<div class="hui-list"><div class="hui-list-inner"><div<%if(this.children.length>0){%> style="display:none"<%}%> class="hui-list-empty js-empty"><%=this.emptyTips%></div><%if(this.hasPullRefresh){%><div class="hui-list-pulldown hui-pd-pull c-h-middle-container"><div class="c-h-middle"><span class="hui-icon hui-alt-icon hui-icon-arrow-d hui-light"></span><span class="hui-icon hui-alt-icon hui-icon-loading-mini"></span><div class="hui-pd-txt"><%if(this.pdText){%><div class="js-txt"><%=this.pdText%></div><%}%><%if(this.pdComment){%><div class="js-comment hui-pd-comment"><span class="js-pdComment"><%=this.pdComment%></span><span class="js-pdTime"><%=this.pdTime%></span></div><%}%></div></div></div><%}%><div class="js-item-container"><%=this.findHtml(">*")%></div><%if(this.hasPullRefresh){%><div class="hui-list-more"><a href="javascript:;" hidefocus="true" class="hui-btn hui-btn-gray hui-shadow hui-inline hui-radius-normal"><span class="hui-btn-txt">\u67e5\u770b\u66f4\u591a</span></a></div><%}%></div></div>',init:function(){var c=
this;c.itemXtype&&((c.defItem||(c.defItem={})).xtype=c.itemXtype);var b=c.model;b.each(function(a,b){c.addListItem(b)});c.listenTo(b,{add:function(a,b){c.addListItem(b)},remove:function(a,b){c.removeListItem(b)},reset:function(){c.removeListItem("emptyAll")}});c.hasPullRefresh=c.hasPullRefresh&&window.iScroll;c.hasPullRefresh&&(c.listen({name:"afterRender",handler:function(){var a=this,b=a.getEl(),c=b.find(".hui-list-pulldown"),e=c.find(".js-txt");a.scroller=new window.iScroll(b[0],{useTransition:!0,
topOffset:50,onRefresh:function(){c.hasClass("hui-pd-refresh")&&(c.removeClass("hui-pd-refresh hui-pd-release"),e.html("\u4e0b\u62c9\u53ef\u5237\u65b0"))},onScrollMove:function(){5<this.y&&!c.hasClass("hui-pd-release")?(c.addClass("hui-pd-release"),e.html("\u677e\u5f00\u53ef\u5237\u65b0"),this.minScrollY=0):5>this.y&&c.hasClass("hui-pd-release")&&(c.removeClass("hui-pd-release"),e.html("\u4e0b\u62c9\u53ef\u5237\u65b0"),this.minScrollY=-50)},onScrollEnd:function(){c.hasClass("hui-pd-release")&&(c.addClass("hui-pd-refresh"),
e.html("\u6b63\u5728\u5237\u65b0"),a.refresh())}})}}),c.listenTo(c.model,"sync",function(){c.findEl(".js-pdTime").html($H.formatDate($H.now(),"HH:mm"));setTimeout(function(){c.refreshScroller()},0)}),c.listen({name:"afterShow",handler:function(){c.refreshScroller()}}),c.listen({name:"click",method:"delegate",selector:".hui-list-more",handler:function(){c.getMore()}}))},addListItem:function(c){this.inited&&this.findEl(".js-empty").hide();this.add({model:c,renderTo:">.js-item-container"})},removeListItem:function(c){"emptyAll"==
c?this.remove(this.children):this.remove(function(b){return b.model&&b.model.id==c.id});0==this.children.length&&this.findEl(".js-empty").show()},refreshScroller:function(){this.scroller&&this.getEl()[0].clientHeight&&this.scroller.refresh()},destroy:function(){this.scroller&&(this.scroller.destroy(),this.scroller=null);this.callSuper()}});return e});
...
c.getEl()));return c},clearCache:function(a){a.notCache=!0},back:function(a){a&&(this.modules[this.currentMod]._forceExit=!0);history.back()}});return b});
