...
'<div style="padding-top:5px;height:90%;overflow:auto;"></div>',k.style.position="fixed",k.style.width="100%",k.style.left=0,k.style.top=0,k.style.right=0,k.style.height="100%",k.style.backgroundColor="#aaa",k.style.fontSize="12px",k.style.padding="10px",k.style.zIndex=9999999999,k.style.opacity=0.95,k.style.filter="alpha(opacity=95)",j.body.appendChild(k));c=k.getElementsByTagName("DIV")[0];j="string"==typeof d?d:b.Json.stringify(d,null,"&nbsp;&nbsp;&nbsp;&nbsp;",!0);j=j.replace(/\n|\\n/g,"<br/>");
c.innerHTML+="<div"+("log"==g?"":' style="color:'+("error"==g?"red":"info"==g?"green":"yellow"))+'">'+g+":<br/>"+j+"</div><br/><br/>";c.scrollTop=c.scrollHeight}c=arguments.callee.caller;c.$owner||(c=c.caller);try{if(c.$owner)console[g]("["+c.$owner.$ns+"->"+c.$name+"]");console[g](d)}catch(e){}},log:function(b,f){a.level>a.LOG_LEVEL||a.out(b,!!f,"log")},info:function(b,f){this.level>a.INFO_LEVEL||a.out(b,!!f,"info")},warn:function(b,f){a.level>a.WARN_LEVEL||a.out(b,!!f,"warn")},error:function(b,
...
now:function(a){var d=new e;if(a)"number"!=typeof a&&(a=c.parseDate(a).getTime()),b=a-d.getTime();else return d.setTime(d.getTime()+b),d},howLong:function(a,b){if(a){var f=c.now().getTime()-a.getTime();if(!1!=b){var g;if(60>(f/=6E4))g="\u5206\u949f",f=f||1;else if(24>(f/=60))g="\u5c0f\u65f6";else if(30>(f/=24))g="\u5929";else return"30\u5929\u524d";f=(Math.floor(f)||1)+g+"\u524d"}return f}}},b=0;return c});
...
set:function(){},remove:function(){},sync:function(b,a,c){c=c||{};var f=c.storeType||"remote",g={type:"POST",dataType:"json"};c.url||(g.url=a.getUrl());if(null==c.data&&a&&("create"===b||"update"===b||"patch"===b))g.data=c.attrs||a.toJSON(c);if("remote"==f)g.url+="/"+b+".do",$H.extend(g,c),this.ajax(g);else e[this._localMethodMap[b]](g);a.trigger("request",a,c)}});return c});
...
typeof g?g:g.$ns),!0}});(a=c.renderTo)?(a=$H.isFunc(a)?a.call(b):$H.isStr(a)&&0==a.indexOf(">")?b.parent.findEl(a.substring(1)):$(a),b.renderTo=a):b.renderTo=$(document.body)},getEl:function(){return this._container},getId:function(){return this._id||(this._id=this.manager.generateId(this.cid))},initHtml:function(){return this.tmpl(this)},getHtml:function(){var g=this.getId(),c;c="visibility"==this.displayMode?"visibility:hidden;":"display:none;";var f=this.initHtml(),e=a.test(f),m="js-"+this.manager.type+
" js-"+this.xtype+" "+this.extCls+" ";e&&(f=f.replace(d,"$1"+m));return f=f.replace(b,'$1 id="'+g+'" style="'+c+'"'+(e?"":' class="'+m+'"'))},findHtml:function(a){a=this.find(a);for(var b=[],c=0;c<a.length;c++)b.push(a[c].getHtml());return b.join("")},initStyle:function(){var a=this.getEl(),b=this.style||{};void 0!=this.width&&(b.width=this.width);void 0!=this.height&&(b.height=this.height);a.css(b)},beforeRender:function(){return this.trigger("beforeRender")},render:function(){if(!1==this.beforeRender())return!1;
...
b.setContent(a);var c=this.getEl();c.contents().remove();if("string"==typeof a)c.html(a);else return this.add(a)},listen:function(a){if(!this._parseListenEvents("listen",a))if(this.listened){var b=a.name,c=a.context,d=a.times,f=a.target,e=a.custom||f||$H.contains(this._customEvents,b),l=a.handler;$H.isFunc(f)&&(f=f.call(this));if(e)a=$H.removeUndefined([f,b,l,c,d]),this[f?"listenTo":"on"].apply(this,a);else{var f=this._listeners,d=a.el,e=a.method||"bind",p=a.selector,t=a.data,c=a.delegation=this._delegateHandler(l,
c);$H.isFunc(d)&&(d=d.call(this));d=d?"string"==typeof d?this.findEl(d):d:this.getEl();if(p)if(t)d[e](p,b,t,c);else d[e](p,b,c);else if(t)d[e](b,t,c);else d[e](b,c);f.push(a)}}else this.listeners.push(a)},unlisten:function(a){if(!this._parseListenEvents("unlisten",a)){var b=a.name,c=a.handler;if(a.custom)this.off(b,c);else{var d=a.el,f="delegate"==a.method?"undelegate":"unbind";a=a.selector;for(var e,d=d?"string"==typeof d?this.findEl(d):d:this.getEl(),l=this._listeners.length-1;0<=l;l--){var p=this._listeners[l];
...
hide:function(){!1!=this.callSuper()&&(this.noMask||this.unmask(),this.notDestroy||this.destroy())},top:function(){this.getEl().css({left:"100px",top:"8px",position:"fixed"})},center:function(){var a=this.getEl(),b=this.width||a.width(),c=this.height||a.height(),e=document,b=((e.documentElement.offsetWidth||e.body.offsetWidth)-b)/2,c=((e.documentElement.clientHeight||e.body.clientHeight)-c)/2+(e.documentElement.scrollTop||e.body.scrollTop),c=10>c?window.screen.height/2-200:c;a.css({left:b+"px",top:c-
(this.offsetTop||0)+"px"})},followEl:function(a){a=(a||this.parent.getEl()).position();this.getEl().css(a)},mask:function(){b||(b=$('<div class="hui-mask" style="display:none;"></div>').appendTo(document.body));b.css("z-index",1E3*c+998);0==c&&b.show();c++},unmask:function(){c--;0==c?b.hide():b.css("z-index",1E3*(c-1)+998)}});return e});
...
(this.text="&nbsp;");this.text&&void 0==this.underline&&(this.underline=!0);c.click&&void 0==this.hasArrow&&(this.hasArrow=!0)}});return e});$Define("C.Set","C.AbstractComponent",function(e){e=e.define("Set");e.extend({tmpl:'<div>;<h1 class="hui-set-title"><%=this.title%></h1>;<div class="hui-set-content">;<%=this.findHtml(">*")%>;</div>;</div>'.split(";")});return e});
...
b=this.content;void 0==b&&!c.items&&(b="");$H.isSimple(b)&&(b={text:b,underline:!0});b&&(this.noPadding=!0,this.add(b))}});return e});$Define("C.Form","C.AbstractComponent",function(e){e=e.define("Form");e.extend({tmpl:'<div>;<form action="">;<div class="hui-form-tips c-txt-error"></div>;<%=this.findHtml(">*")%>;</form>;</div>'.split(";")});return e});
...
c.pos&&(c.extCls=(c.extCls||"")+" hui-tbar-btn-right"))}});return e});
...
if(c=c.action)c=$H.extend({xtype:"Button",radius:null,isInline:!1,xrole:"action"},c),this.add(c)}});return e});
...
this;c.itemXtype&&((c.defItem||(c.defItem={})).xtype=c.itemXtype);var b=c.model;b.each(function(a,b){c.addListItem(b)});c.listenTo(b,{add:function(a,b){c.addListItem(b)},remove:function(a,b){c.removeListItem(b)},reset:function(){c.removeListItem("emptyAll")}});c.hasPullRefresh&&(c.listeners=c.listeners.concat([{name:"afterRender",handler:function(){var a=this,b=a.getEl();b.css({height:document.body.clientHeight-40});var c=b.find(".hui-list-pulldown"),e=c.find(".js-txt");a.scroller=new window.iScroll(b[0],
{useTransition:!0,topOffset:50,onRefresh:function(){c.hasClass("hui-pd-refresh")&&(c.removeClass("hui-pd-refresh hui-pd-release"),e.html("\u4e0b\u62c9\u53ef\u5237\u65b0"))},onScrollMove:function(){5<this.y&&!c.hasClass("hui-pd-release")?(c.addClass("hui-pd-release"),e.html("\u677e\u5f00\u53ef\u5237\u65b0"),this.minScrollY=0):5>this.y&&c.hasClass("hui-pd-release")&&(c.removeClass("hui-pd-release"),e.html("\u4e0b\u62c9\u53ef\u5237\u65b0"),this.minScrollY=-50)},onScrollEnd:function(){c.hasClass("hui-pd-release")&&
(c.addClass("hui-pd-refresh"),e.html("\u6b63\u5728\u5237\u65b0"),a.refresh())}});a.listenTo(a.model,"sync",function(){setTimeout(function(){b[0].clientHeight&&a.scroller.refresh()},0)})}},{name:"click",method:"delegate",selector:".hui-list-more",handler:function(){c.getMore()}}]))},addListItem:function(c){this.inited&&this.findEl(".js-empty").hide();this.add({model:c,renderTo:">.js-item-container"})},removeListItem:function(c){"emptyAll"==c?this.remove(this.children):this.remove(function(b){return b.model&&
b.model.id==c.id});0==this.children.length&&this.findEl(".js-empty").show()},destroy:function(){this.scroller&&(this.scroller.destroy(),this.scroller=null);this.callSuper()}});return e});$Define("M.AbstractModule","CM.View",function(e){var c=$H.createClass();$H.inherit(c,e,{useCache:$H.noop,cache:$H.noop,init:$H.noop,reset:$H.noop,exit:function(){return!0},cleanCache:function(){this.clearCache=!0}});return c});
$Define("M.AbstractNavigator","handy.base.Object",function(e){var c=$H.createClass();e.extend(c.prototype,{navigate:function(){}});return c});
