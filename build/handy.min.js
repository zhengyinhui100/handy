...
(b=a,a=null);var d=arguments.callee.caller,c=d.$owner.superProto;b=b||d.arguments;a=a?a.prototype:c||this.constructor.superProto;d=d.$name;if(a&&(d=a[d],e.isFunc(d)))return d.apply(this,b)};a&&this.ns(a,d);return d},inherit:function(a,d,b,g,h){var j=function(){};j.prototype=d.prototype;e.extend(a,d,h);a.prototype=new j;a.prototype.constructor=a;a.superClass=d;a.superProto=d.prototype;if(d._onInherit)try{d._onInherit(a)}catch(k){c.error(k)}g&&e.extend(a,g);b&&e.extend(a.prototype,b)},getSingleton:function(a){return(a=
"string"==typeof a?e.ns(a):a)&&(a.$singleton||(a.$singleton=new a))}};return b});
handy.add("Loader",["B.Debug","B.Object","B.Function"],function(e,c,b,a){function d(a){var d={},b=[];"string"==typeof a&&(a=[a]);for(var g=0,f=a.length;g<f;g++){var h;h=a[g];h=/\.(css|js)$/.test(h)?x[h]&&"loaded"==x[h].status:s.urlMap&&s.urlMap[h]?s.urlMap[h].chkExist():c.ns(h);if(h)b.push(h);else return d.notExist=a[g],d}d.exist=b;return d}function f(a,d){function b(){b.isCalled||(b.isCalled=!0,clearTimeout(j),d())}if("SCRIPT"===a.nodeName){var c=a,f=b;c.onload=c.onerror=c.onreadystatechange=function(){/loaded|complete|undefined/.test(c.readyState)&&
(c.onload=c.onerror=c.onreadystatechange=null,n.removeChild(c),c=null,setTimeout(f,0))}}else{var h=b;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",h):setTimeout(function(){g(a,h)},0)}var j=setTimeout(function(){e.error("Time is out:"+a.src);b()},s.timeout)}function g(a,b){if(!b.isCalled){var d;if(l)a.sheet&&(d=!0);else if(a.sheet)try{a.sheet.cssRules&&(d=!0)}catch(c){if("SecurityError"===c.name||"NS_ERROR_DOM_SECURITY_ERR"===c.name)d=!0}setTimeout(function(){d?b():g(a,b)},1)}}function h(a){s.showLoading(!1);
...
handy.add("Array","B.Object",function(e,c){function b(a){return a}function a(a){return function(b){return b[a]}}function d(d){return null==d?b:c.isFunc(d)?d:a(d)}function f(a){return function(b){if(b===a)return!0;for(var d in a)if(a[d]!==b[d])return!1;return!0}}function g(a){return function(b,g,c){var f={};g=d(g);e.each(b,function(d,h){var e=g.call(c,h,d,b);a(f,e,h)});return f}}var h={map:function(a,b,d){var g=[];if(null==a)return g;var c=Array.prototype.map;if(c&&a.map===c)return a.map(b,d);e.each(a,
function(a,c){g.push(b.call(d,c,a))});return g},pluck:function(b,d){return this.map(b,a(d))},some:function(a,b,d){var g=!1;if(null==a||!b)return g;var f=Array.prototype.some;if(f&&a.some===f)return a.some(b,d);c.each(a,function(a,c,f){if(g||(g=b.call(d,c,a,f)))return!1});return!!g},every:function(a,b,d){var g=!0;if(null==a||!b)return g;var f=Array.prototype.every;if(f&&a.every===f)return a.every(b,d);c.each(a,function(a,c,f){if(!(g=b.call(d,c,a,f)))return!1});return!!g},indexOf:function(a,b,d){if(null==
a)return-1;var g=0,c=a.length;if(d)if("number"==typeof d)g=0>d?Math.max(0,c+d):d;else return g=h.sortedIndex(a,b),a[g]===b?g:-1;var f=Array.prototype.indexOf;if(f&&a.indexOf===f)return a.indexOf(b,d);for(;g<c;g++)if(a[g]===b)return g;return-1},find:function(a,b,d){var g;this.some(a,function(a,c,f){if(b.call(d,a,c,f))return g=a,!0});return g},filter:function(a,b,d){var g=[];if(null==a)return g;var f=Array.prototype.filter;if(f&&a.filter===f)return a.filter(b,d);c.each(a,function(a,c,f){b.call(d,c,
a,f)&&g.push(c)});return g},where:function(a,b){return this.filter(a,f(b))},findWhere:function(a,b){return this.find(a,f(b))},invoke:function(a,b){var d=Array.prototype.slice.call(arguments,2),g=e.isFunc(b);return this.map(a,function(a){return(g?b:a[b]).apply(a,d)})},sortedIndex:function(a,b,g,c){g=d(g);b=g.call(c,b);for(var f=0,h=a.length;f<h;){var e=f+h>>>1;g.call(c,a[e])<b?f=e+1:h=e}return f},sortBy:function(a,b,g){b=d(b);return this.pluck(this.map(a,function(a,d,c){return{value:a,index:d,criteria:b.call(g,
a,d,c)}}).sort(function(a,b){var d=a.criteria,g=b.criteria;if(d!==g){if(d>g||void 0===d)return 1;if(d<g||void 0===g)return-1}return a.index-b.index}),"value")},groupBy:g(function(a,b,d){a[b]?a[b].push(d):a[b]=[d]}),countBy:g(function(a,b){a[b]?a[b]++:a[b]=1})};return h});
...
handy.add("HashChange",["handy.base.Debug","handy.base.Util"],function(e,c,b){function a(a){if(a==m)return!1;var b=k.contentWindow.document;b.open();b.write("<!doctype html><html><body>"+a+"</body></html>");b.close();m=a;e.log("set:"+k.contentWindow.document.body.innerText)}function d(){var b=c.getHash(),d=k.contentWindow.document.body.innerText;b!=m?(a(b),f(b)):d!=m&&(e.log("update:"+k.contentWindow.document.body.innerText),c.setHash(d))}function f(a){var b=q.listeners,d;for(d in b)b[d](a)}var g,
...
b),b))return!1;c&&c(a,f,b);a.trigger("sync",a,f,b)};a.sync("read",a,b)},save:function(b,a,c){var f=this,g;null==b||"object"===typeof b?(g=b,c=a):(g={})[b]=a;$H.isFunc(c)&&(c={success:c});c=$H.extend({validate:!0},c);if(g&&c.now){if(!f.set(g,c))return!1}else if(!f._validate(g,c))return!1;void 0===c.parse&&(c.parse=!0);var e=c.success;c.success=function(a){var b=f.parse(a,c);c.now||(b=$H.extend(g||{},b));if($H.isObj(b)&&!f.set(b,c))return!1;e&&e(f,a,c);f.trigger("sync",f,a,c)};b=f.isNew()?"create":
c.update?"update":"patch";if("patch"===b){a=f.changedAttrbutes(g);if(!a){e&&e(f,c);return}c.attrs=a}else a=$H.extend({},f._attributes),c.attrs=$H.extend(a,g);f.sync(b,f,c)},destroy:function(b){var a=this;b=b?$H.clone(b):{};var c=b.success,f=function(){a.trigger("destroy",a,a.collection,b);a.off("all")};b.success=function(g){(!b.now||a.isNew())&&f();c&&c(a,g,b);a.isNew()||a.trigger("sync",a,g,b)};if(a.isNew())return b.success(),!1;a.sync("delete",a,b);b.now&&f()},getUrl:function(){var b=$H.result(this,
"url")||$H.result(this.collection,"url");b||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));return this.isNew()?b:b.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(b){return b.code&&b.data?b.data:b},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return!this.has(this.idAttribute)},isValid:function(b){return this._validate({},$H.extend(b||{},{validate:!0}))}})});
...
this.listeners.push({name:"hide",custom:!0,handler:function(){!0!=$H.Events.trigger("component.popup.hide")&&setTimeout(function(){$("input,textarea,select").removeAttr("disabled")},500)}}))},afterShow:function(){var a=this,b=a.getEl();b.css("z-index",1E3*c+1E3);if(!a.width&&a.parent){var e=a.width=a.parent.getEl().outerWidth();b.css("width",e)}b=a.showPos;if("string"==typeof b)a[b]();else"function"==typeof b&&b.call(a);a.noMask||a.mask();a.timeout&&setTimeout(function(){a.destroyed||a.hide()},a.timeout)},
...
if(c=c.action)c=$H.extend({xtype:"Button",radius:null,isInline:!1,xrole:"action"},c),this.add(c)}});return e});$Define("C.List",["C.AbstractComponent","C.ControlGroup"],function(e,c){var b=e.define("List",c);b.extend({cls:"list",tmpl:["<div>",'<div class="hui-list-item">',"</div>","</div>"]});return b});
