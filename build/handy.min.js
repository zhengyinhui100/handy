...
p=[],s=0,t={},q={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(f,c,d){f=a.Object.alias(f);2==arguments.length&&(d=c,c=[]);q.require(c,function(){var a;if("function"==typeof d)try{q.traceLog&&g.log(k+"define:\n"+f),a=d.apply(null,arguments)}catch(c){c.message=k+f+":\nfactory define error:\n"+c.message;g.error(c);return}else a=d;if(a){b.ns(f,a);var e=typeof a;if("object"==e||"function"==e)a.$ns=f}else g.error(k+"factory no return:\n"+f)})},require:function(f,b){for(var j=
"string"==typeof f?[f]:f,l=[],z=[],u=!0,x=0,y=j.length;x<y;x++){var r=j[x],r=a.Object.alias(r),v=c(r);v.notExist?(l.push(r),u&&(u=!1,p.push({deps:j,callback:b})),q.traceLog&&g.log(m+r)):z.push(v.exist[0])}if(0==l.length)return b&&b.apply(null,z),1==z.length?z[0]:z;u=!1;j=0;for(z=l.length;j<z;j++)if(x=l[j],!t[x]){u=x;r=q.urlMap&&q.urlMap[u]&&q.urlMap[u].url;if(!r){y="";r=q.rootPath;if("string"==typeof r)y=r;else if("object"==typeof r)for(v in v=void 0,r)0==u.indexOf(v)&&(y=r[v],u=u.replace(v,""));
else y="";r=/.css$/.test(u)?0==u.indexOf("/")?u:"/css/"+u:/.js$/.test(u)?u:u.replace(/\./g,"/")+".js";r=y.replace(/\/$/,"")+"/"+r.replace(/^\//,"")}u=!0;t[x]={id:x,status:"loading"};y=e.bind(h,null,x);q.traceLog&&g.log(k+"request:\n"+r);if(/.css$/.test(r))a:{x=r;r=n.getElementsByTagName("link");for(v=0;v<r.length;v++){var A=r[v].href;!q.skinNode&&0<=A.indexOf(q.skinName)&&(q.skinNode=r[v]);if(0<=A.indexOf(x)||0<=x.indexOf(A))break a}r=document.createElement("link");r.rel="stylesheet";r.href=x;d(r,
y);q.skinNode?n.insertBefore(r,q.skinNode):n.appendChild(r)}else x=r,r=document.createElement("script"),r.async="async",r.src=x,r.type="text/javascript",d(r,y),n.appendChild(r);s++}u&&q.showLoading(!0)}};return q});
