...
f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g,k,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},j;"function"!==typeof e.stringify&&(e.stringify=function(c,a,b){var f;k=g="";if("number"===typeof b)for(f=0;f<b;f+=1)k+=" ";else"string"===typeof b&&(k=b);if((j=a)&&"function"!==typeof a&&("object"!==typeof a||"number"!==typeof a.length))throw Error("JSON.stringify");return d("",{"":c})});"function"!==
typeof e.parse&&(e.parse=function(a,b){function f(c,a){var d,g,e=c[a];if(e&&"object"===typeof e)for(d in e)Object.prototype.hasOwnProperty.call(e,d)&&(g=f(e,d),void 0!==g?e[d]=g:delete e[d]);return b.call(c,a,e)}var d;a=String(a);c.lastIndex=0;c.test(a)&&(a=a.replace(c,function(c){return"\\u"+("0000"+c.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
"")))return d=eval("("+a+")"),"function"===typeof b?f({"":d},""):d;throw new SyntaxError("JSON.parse");})})();return e});
handy.add("Object",function(){function e(){var a=window.navigator.userAgent.match(/MSIE ([\d.]+)/);return a&&9>parseInt(a[0])?function(a,c,b){var g=[];if(a.length){c=c||0;for(b=b||a.length;c<b;c++)g.push(a[c])}return g}:function(a,c,b){return Array.prototype.slice.call(a,c||0,b||a.length)}}var b={namespace:function(a,b){var c=null,f,g,e,h;g=a.split(".");c=g[0];c=(e=2==arguments.length)?eval("(function(){if (typeof "+c+' == "undefined"){'+c+" = {};}return "+c+";})()"):eval("(function(){if (typeof "+
...
"var $r="+(d?'""':"[]")+";\n";e.Object.each(a.split(c.openTag),function(a,d){var f=d.split(c.closeTag);1==f.length?b+=c._parseHtml(f[0]):(b+=c._parseScript(f[0]),f[1]&&(b+=c._parseHtml(f[1])))});b+="return "+(d?"$r;":'$r.join("");');return new Function("$data",b)},tmpl:function(a,d){var k,h,j;if("string"==typeof a)k=a;else if(k=a.tmpl,j=a.id)if(b[j])h=b[j];else{var q=document.getElementById(j);q&&(k=(q.value||q.innerHTML).replace(/\s/g,""))}if(!h){if(!k){e.Debug.error("\u6a21\u677f\u672a\u5b9a\u4e49");
return}h=c._compile(k);j&&(b[j]=h)}return d?h(d):h}};return c});
...
c==a)&&delete v.listeners[a]}};return v});handy.add("Support",function(e){if(6==e.Browser.ie())try{document.execCommand("BackgroundImageCache",!1,!0)}catch(b){}return{}})(function(e){$H=e.noConflict();$D=$H.Debug;$HB=$H.Browser;$HC=$H.Cookie;$HD=$H.Date;$HF=$H.Function;$HO=$H.Object;$HS=$H.String;$HU=$H.Util;$Define=$H.Loader.define;$Require=$H.Loader.require;$G={config:{}}})(handy);
...
activeCls:"w-active",radius:null,shadow:!1,shadowInset:!1,shadowSurround:!1,isMini:!1,isActive:!1,isFocus:!1,isInline:!1,html:null,isSuspend:!1,_customEvents:["beforeRender","afterRender","show","hide","destroy"],_defaultEvents:["click","mouseover","focus"],initialize:function(c){this.doConfig(c);this.parseItems();c=$H.Template.tmpl({id:this.xtype,tmpl:this.tmplStr||(this.tmplStr=this.tmpl.join(""))},this);var b=this.getId();c=c.replace(a,'$1 id="'+b+'"');c=this.html=c.replace(d,"$1"+this.getExtCls());
this.fire("beforeRender");!1!=this.autoRender&&(this.renderTo[this.renderBy](c),this.afterRender());e.register(this)},doConfig:function(c){var a=this;a.params=c;var b=a.listeners||[];a._listeners=c.listeners?b.concat(c.listeners):b.concat();$HO.extend(a,c,{notCover:function(b){var d=a[b],e=$HO.contain(a._customEvents,b),g=$HO.contain(a._defaultEvents,b);(e||g)&&a._listeners.push({type:b,notEl:e,handler:c[b]});if(null!=d&&"object"==typeof d||$HO.isFunction(d))return!0}});a.renderTo=c.renderTo?$(c.renderTo):
$(document.body);a.children=[]},getId:function(){return this._id||(this._id=e.generateId(this.cid))},getEl:function(){return this._container},getHtml:function(){return this.html},getChildrenHtml:function(){for(var c=this.children,a=[],b=0;b<c.length;b++)a.push(c[b].getHtml());return a.join("")},getExtCls:function(){var a=[];this.extCls&&a.push(this.extCls);this.disabled&&a.push("w-disable");this.radius&&a.push("w-radius-"+this.radius);this.isMini&&a.push("w-mini");this.shadow&&a.push("w-shadow");
this.shadowSurround&&a.push("w-shadow-surround");this.shadowInset&&a.push("w-shadow-inset");this.isActive&&a.push(this.activeCls);this.isFocus&&a.push("w-focus");this.isInline&&a.push("w-inline");return 0<a.length?a.join(" ")+" ":""},afterRender:function(){this._container=$("#"+this.getId());this.rendered=!0;!0!=this.notListen&&this.initListeners();this.disabled&&this.suspendListeners();this.fire("afterRender");delete this.html},find:function(a){return this.getEl().find(a)},hide:function(){this.getEl().hide();
this.fire("hide")},show:function(){this.getEl().show();this.fire("show")},enable:function(){this.resumeListeners();this.getEl().removeClass("w-disable")},disable:function(){this.suspendListeners();this.getEl().addClass("w-disable")},active:function(){this.getEl().addClass(this.activeCls)},unactive:function(){this.getEl().removeClass(this.activeCls)},fire:function(a){for(var b=this._listeners.length-1;0<=b;b--){var d=this._listeners[b];if(d.type==a){var e=d.delegation;e({obj:this,data:d.data})}}},
listen:function(a){var b=this,d=a.type,e=b._listeners,h=a.el,j=a.method||"bind",q=a.selector,m=a.data,w=a.delegation=function(){if(!0!=b.isSuspend)return a.handler.apply(a.scope||b,arguments)},h=h?"string"==typeof h?b.find(h):h:b.getEl();if(!a.notEl)if(q)if(m)h[j](q,d,m,w);else h[j](q,d,w);else if(m)h[j](d,m,w);else h[j](d,w);e.push(a)},unlisten:function(a){for(var b=a.type,d=a.el||this.getEl(),e="delegate"==a.method?"undelegate":"unbind",h=a.selector,j,q=this._listeners.length-1;0<=q;q--){var m=
this._listeners[q];if(m.handler==a.handler){j=m.delegation;this._listeners.splice(q,1);break}}if(!a.notEl)if(h)d[e](h,b,j);else d[e](b,j)},initListeners:function(){this._container=this._container||$("#"+this._id);var a=this._listeners;this._listeners=[];for(var b=a.length-1;0<=b;b--)this.listen(a[b]);this.callChild("initListeners")},clearListeners:function(){for(var a=this._listeners,b=a.length-1;0<=b;b--)this.unlisten(a[b]);this.callChild("clearListeners")},suspendListeners:function(){this.isSuspend=
!0;this.callChild("suspendListeners")},resumeListeners:function(){this.isSuspend=!1;this.callChild("resumeListeners")},each:function(a,b){$HO.each(this.children,a,b)},index:function(){var a=this,b=a.parent;if(b){var d;b.each(function(b,e){if(e==a)return d=b,!1});return d}return null},callChild:function(a){for(var b=this.children,d=0,e=b.length;d<e;d++)b[d][a]()},add:function(a){this.children.push(a);a.parent=this},remove:function(a){for(var b=this.children,d=!1,e=0,h=b.length;e<h;e++)b[e]==a&&(b.splice(e,
1),a.destroy(),d=!0);return d},parseItem:function(){},parseItems:function(){var a=this.params.items;if(a)for(var a=a.length?a:[a],b=0,d=a.length;b<d;b++){var k=a[b];this.defItem&&$HO.extend(k,this.defItem,{notCover:!0});this.parseItem(k);var h=e.getClass(k.xtype);k.autoRender=!1;k=new h(k);this.add(k)}},destroy:function(){e.unregister(this);this.fire("destroy");this.clearListeners();this.callChild("destroy");this.getEl().remove();delete this._listeners;delete this._contianer;delete this.children}});
return b});$Define("handy.component.Icon","handy.component.AbstractComponent",function(e){e=e.define("Icon");$HO.extend(e.prototype,{hasBg:!0,tmpl:['<span class="w-icon w-icon-<%=this.name%><%if(this.hasBg){%> w-icon-bg<%}%>"></span>']});return e});
$Define("handy.component.Button","handy.component.AbstractComponent",function(e){e=e.define("Button");$HO.extend(e.prototype,{text:"",color:null,isActive:!1,iconPos:"left",activeCls:"w-btn-blue",defItem:{xtype:"Icon",hasBg:!0},radius:"normal",shadow:!0,isInline:!0,tmpl:'<a class="w-btn<%if(this.color){%> w-btn-<%=this.color%><%};if(!this.text){%> w-btn-icon-notxt<%};if(this.hasIcon&&this.text){%> w-btn-icon-<%=this.iconPos%><%}%>">;<span class="w-btn-txt"><%=this.text%></span>;<%=this.getChildrenHtml()%>;</a>'.split(";"),
parseItem:function(b){"Icon"==b.xtype&&(this.hasIcon=!0)}});return e});
$Define("handy.component.Input","handy.component.AbstractComponent",function(e){e=e.define("Input");$HO.extend(e.prototype,{type:"",radius:"normal",iconPos:"left",btnPos:"right",tmpl:['<div class="w-input<%if(this.hasIcon){%> w-input-icon-<%=this.iconPos%><%}%>','<%if(this.hasBtn){%> w-input-btn-<%=this.btnPos%><%}%>">',"<%=this.getChildrenHtml()%>",'<input type="text" class="js-input w-input-txt"<%if(this.placeholder){%> placeholder="<%=this.placeholder%><%}%>"/>',"</div>"],listeners:[{type:"focus",
...
"<%=this.children[i].content%>","</div>","<%}%>","</div>"],listeners:[{type:"click",selector:".js-tab-item",method:"delegate",handler:function(b){b=$(b.currentTarget);this.callChild("unactive");b=b.index();this.children[b].active();this.find(".js-tab-content").hide().eq(b).show()}}]});return e});
$Define("handy.component.Dialog","handy.component.AbstractComponent",function(e){e=e.define("Dialog");$HO.extend(e,{alert:function(){},confirm:function(){},prompt:function(){}});$HO.extend(e.prototype,{tmpl:'<div class="w-dialog w-overlay-shadow">;<div class="w-dialog-header w-tbar w-tbar-gray">;<a class="w-btn w-shadow w-inline w-btn-icon-notxt w-radius-big w-tbar-btn-left">;<span class="w-icon w-icon-bg w-icon-del"></span>;</a>;<h1 class="w-tbar-title"><%=this.title%></h1>;</div>;<div class="w-dialog-body">;<div class="w-body-content">;<h1 class="w-content-title"><%=this.contentTitle%></h1>;<div class="w-content-msg"><%=this.contentMsg%></div>;</div>;<div class="w-body-action">;</div>;</div>;</div>'.split(";")});return e});
$Define("handy.module.AbstractModule","handy.base.Object",function(e){var b=e.createClass();e.extend(b.prototype,{isLoaded:!1,isActived:!1,useCache:!0,cache:function(){},init:function(){},beforeRender:function(){},render:function(){},afterRender:function(){},reset:function(){},exit:function(){return!0},initialize:function(a){this.conf=a}});return b});$Define("handy.module.AbstractNavigator","handy.base.Object",function(e){var b=e.createClass();e.extend(b.prototype,{navigate:function(){}});return b});
