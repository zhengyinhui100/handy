...
g+" : "+j+"<br/>";c.scrollTop=c.scrollHeight}c=arguments.callee.caller;c.$owner||(c=c.caller);try{if(c.$owner)console[g]("["+c.$owner.$ns+"->"+c.$name+"]");console[g](d)}catch(e){}},log:function(b,f){a.level>a.LOG_LEVEL||a.out(b,!!f,"log")},info:function(b,f){this.level>a.INFO_LEVEL||a.out(b,!!f,"info")},warn:function(b,f){a.level>a.WARN_LEVEL||a.out(b,!!f,"warn")},error:function(b,f){if(!(a.level>a.ERROR_LEVEL)&&(a.out(b,!!f,"error"),b instanceof Error))throw b;},time:function(b,f,g){a.level>a.INFO_LEVEL||
(b?("boolean"==typeof f&&(g=f,f=""),a.out((f||"")+((new Date).getTime()-(a.lastTime||0)),!!g)):a.lastTime=(new Date).getTime())},debug:function(b){if(!(a.level>a.DEBUG_LEVEL)&&!1!==b)debugger}};return a});
...
handy.add("Loader",["B.Debug","B.Object","B.Function"],function(e,c,b,a){function d(a){var b={},g=[];"string"==typeof a&&(a=[a]);for(var d=0,f=a.length;d<f;d++){var h;h=a[d];h=/\.(css|js)$/.test(h)?x[h]&&"loaded"==x[h].status:s.urlMap&&s.urlMap[h]?s.urlMap[h].chkExist():c.ns(h);if(h)g.push(h);else return b.notExist=a[d],b}b.exist=g;return b}function f(a,b){function d(){d.isCalled||(d.isCalled=!0,clearTimeout(j),b())}if("SCRIPT"===a.nodeName){var c=a,f=d;c.onload=c.onerror=c.onreadystatechange=function(){/loaded|complete|undefined/.test(c.readyState)&&
...
t--;x[a].status="loaded";s.traceLog&&e.info(k+"Response: "+a);j()}function j(){for(var a=p.length-1;0<=a;a--){var b=p[a],g=d(b.deps);if(g.notExist)0==a&&0==t&&$D.error(m+g.notExist);else{p.splice(a,1);b.callback.apply(null,g.exist);j();break}}}var k="[Handy Loader] ",m=k+"not found: ",n=document.head||document.getElementsByTagName("head")[0]||document.documentElement,l=navigator.userAgent.indexOf("AppleWebKit"),p=[],t=0,x={},s={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(b,
g,d){b=a.Object.alias(b);2==arguments.length&&(d=g,g=[]);s.require(g,function(){var a;if("function"==typeof d)try{a=d.apply(null,arguments),s.traceLog&&e.info(k+"define: "+b)}catch(g){g.message=k+b+":factory define error:"+g.message;e.error(g);return}else a=d;if(a){c.ns(b,a);var f=typeof a;if("object"==f||"function"==f)a.$ns=b}else $D.error(k+"factory no return: "+b)})},require:function(g,c){for(var j="string"==typeof g?[g]:g,l=[],r=[],u=!0,w=0,z=j.length;w<z;w++){var q=j[w],q=a.Object.alias(q),v=
d(q);v.notExist?(l.push(q),u&&(u=!1,p.push({deps:j,callback:c})),s.traceLog&&e.info(m+q)):r.push(v.exist[0])}if(0==l.length)return c&&c.apply(null,r),0==r.length?r[0]:r;u=!1;j=0;for(r=l.length;j<r;j++)if(w=l[j],!x[w]){u=w;q=s.urlMap&&s.urlMap[u]&&s.urlMap[u].url;if(!q){z="";q=s.rootPath;if("string"==typeof q)z=q;else if("object"==typeof q)for(v in v=void 0,q)0==u.indexOf(v)&&(z=q[v],u=u.replace(v,""));else z="";q=/.css$/.test(u)?0==u.indexOf("/")?u:"/css/"+u:/.js$/.test(u)?u:u.replace(/\./g,"/")+
".js";0!=q.indexOf("/")&&(q="/"+q);q=z+q}u=!0;x[w]={id:w,status:"loading"};z=b.bind(h,null,w);if(/.css$/.test(q))a:{w=q;q=n.getElementsByTagName("link");for(v=0;v<q.length;v++){var D=q[v].href;!s.skinNode&&0<=D.indexOf(s.skinName)&&(s.skinNode=q[v]);if(0<=D.indexOf(w)||0<=w.indexOf(D))break a}q=document.createElement("link");q.rel="stylesheet";q.href=w;f(q,z);n.insertBefore(q,s.skinNode);s.traceLog&&e.info(k+"request:"+w)}else w=q,q=document.createElement("script"),q.async="async",q.src=w,q.type=
"text/javascript",f(q,z),n.appendChild(q),s.traceLog&&e.info(k+"request:"+w);t++}u&&s.showLoading(!0)}};return s});
...
handy.add("Template",["B.String","B.Debug"],function(e,c,b){function a(a){return j?"$r+="+a+";\n":"$r.push("+a+");\n"}function d(b){b=b.replace(/("|\\)/g,"\\$1").replace(/\r/g,"\\r").replace(/\n/g,"\\n");return a('"'+b+'"')}var f={openTag:"<%",closeTag:"%>",isEscape:!0,registerHelper:function(a,b){k[a]||(m+=a+"=oHelpers."+a+",");k[a]=b},tmpl:function(e,l){var p,t,x;if("string"==typeof e)p=e;else if(void 0!=e.length)p=e.join("");else if(p=e.tmpl,x=e.id)if(g[x])t=g[x];else if(!p){var s=document.getElementById(x);
...
b.setContent(a);var c=this.getEl();c.contents().remove();if("string"==typeof a)c.html(a);else return this.add(a)},listen:function(a){if(!this._parseListenEvents("listen",a))if(this.listened){var b=a.name,c=a.context,d=a.times,f=a.target,e=a.custom,l=a.handler;$H.isFunc(f)&&(f=f.call(this));if(f||e)a=$H.removeUndefined([f,b,l,c,d]),this[e?"on":"listenTo"].apply(this,a);else{var e=this._listeners,d=a.el,f=a.method||"bind",p=a.selector,t=a.data,c=a.delegation=this._delegateHandler(l,c);$H.isFunc(d)&&
(d=d.call(this));$H.mobile()&&"click"==b&&(b="touchend");d=d?"string"==typeof d?this.findEl(d):d:this.getEl();if(p)if(t)d[f](p,b,t,c);else d[f](p,b,c);else if(t)d[f](b,t,c);else d[f](b,c);e.push(a)}}else this.listeners.push(a)},unlisten:function(a){if(!this._parseListenEvents("unlisten",a)){var b=a.name,c=a.handler;if(a.custom)this.off(b,c);else{var d=a.el,f="delegate"==a.method?"undelegate":"unbind";a=a.selector;var e;$H.mobile()&&"click"==b&&(b="touchend");for(var d=d?"string"==typeof d?this.findEl(d):
d:this.getEl(),l=this._listeners.length-1;0<=l;l--){var p=this._listeners[l];if(p.handler==c){e=p.delegation;this._listeners.splice(l,1);break}}if(a)d[f](a,b,e);else d[f](b,e)}}},initListeners:function(){if(this.listened)return!1;this.listened=!0;var a=this.listeners;this._listeners=[];for(var b=a.length-1;0<=b;b--)this.listen(a[b]);this.callChild()},clearListeners:function(){for(var a=this._listeners,b=a.length-1;0<=b;b--)this.unlisten(a[b]);this.off("all");this.unlistenTo("all");this.callChild()},
...
$Define("CM.Collection",["CM.AbstractDao","CM.AbstractEvents","CM.Model"],function(e,c,b){var a=c.derive({_reset:function(){this.length=0;this._models=[];this._byId={}},_prepareModel:function(a,c){if(a instanceof b)return a;c=c?$H.clone(c):{};c.collection=this;var d=$S.get(this.model.$ns,{id:c.id});if(d=d&&d[0])return d.set(a,c),d;d=new this.model(a,c);if(!d.validationError)return d;this.trigger("invalid",this,d.validationError,c);return!1},_addReference:function(a){this._byId[a.cid]=a;null!=a.id&&
(this._byId[a.id]=a);a.collection||(a.collection=this);a.on("all",this._onModelEvent,this)},_removeReference:function(a){this===a.collection&&delete a.collection;a.off("all",this._onModelEvent,this)},_onModelEvent:function(a,b,c,d){("add"===a||"remove"===a)&&c!==this||("destroy"===a&&this.remove(b,d),b&&a==="change:"+b.idAttribute&&(delete this._byId[b.previous(b.idAttribute)],null!=b.id&&(this._byId[b.id]=b)),this.trigger.apply(this,arguments))},initialize:function(a,b){this.dao=this.dao||$H.getSingleton(e);
b||(b={});b.model&&(this.model=b.model);b.url&&(this.url=b.url);void 0!==b.comparator&&(this.comparator=b.comparator);this._reset();a&&this.reset(a,$H.extend({silent:!0},b))},toJSON:function(a){return $H.map(this._models,function(b){return b.toJSON(a)})},sync:function(a,b,c){return this.dao.sync(a,b,c)},add:function(a,b){b=$H.extend({add:!0,remove:!1,merge:!1},b);return this.set(a,b)},remove:function(a,b){var c=!$H.isArr(a);a=c?[a]:$H.clone(a);b||(b={});var d,e,m,n;d=0;for(e=a.length;d<e;d++)if(n=
a[d]=this.get(a[d]))delete this._byId[n.id],delete this._byId[n.cid],m=this.indexOf(n),this._models.splice(m,1),this.length--,b.silent||(b.index=m,n.trigger("remove",n,this,b)),this._removeReference(n,b);return c?a[0]:a},set:function(a,c){if(a){c=$H.extend({add:!0,remove:!0,merge:!0},c);c.parse&&(a=this.parse(a,c));var d=!$H.isArr(a),e=d?a?[a]:[]:$H.clone(a),k,m,n,l,p,t,x,s=c.at,y=this.model,B=this.comparator&&null==s&&!1!==c.sort,C="string"==typeof this.comparator?this.comparator:null,A=[],r=[],
u={},w=c.add,z=c.merge,q=c.remove,v=!B&&w&&q?[]:!1;k=0;for(m=e.length;k<m;k++){p=e[k]||{};n=p instanceof b?l=p:p[y.prototype.idAttribute||"id"];if(t=this.get(n))q&&(u[t.cid]=!0),z&&(p=p===l?l.attributes:p,c.parse&&(p=t.parse(p,c)),t.set(p,c),B&&(!x&&t.hasChanged(C))&&(x=!0)),e[k]=t;else if(w){c.id=n;l=e[k]=this._prepareModel(p,c);if(!l)continue;A.push(l);this._addReference(l,c)}l=t||l;v&&(l.isNew()||!u[l.id])&&v.push(l);u[l.id]=!0}if(q){k=0;for(m=this.length;k<m;++k)u[(l=this._models[k]).cid]||r.push(l);
r.length&&this.remove(r,c)}if(A.length||v&&v.length)if(B&&(x=!0),this.length+=A.length,null!=s){k=0;for(m=A.length;k<m;k++)this._models.splice(s+k,0,A[k])}else{v&&(this._models.length=0);n=v||A;k=0;for(m=n.length;k<m;k++)this._models.push(n[k])}x&&this.sort({silent:!0});if(!c.silent){k=0;for(m=A.length;k<m;k++)(l=A[k]).trigger("add",l,this,c);(x||v&&v.length)&&this.trigger("sort",this,c)}return d?e[0]:e}},each:function(a){$H.each(this._models,a)},reset:function(a,b){b||(b={});for(var c=0,d=this._models.length;c<
d;c++)this._removeReference(this._models[c],b);b.previousModels=this._models;this._reset();a&&(a=this.add(a,$H.extend({silent:!0},b)));b.silent||this.trigger("reset",this,b);return a},push:function(a,b){return this.add(a,$H.extend({at:this.length},b))},pop:function(a){var b=this.at(this.length-1);this.remove(b,a);return b},unshift:function(a,b){return this.add(a,$H.extend({at:0},b))},shift:function(a){var b=this.at(0);this.remove(b,a);return b},slice:function(){return Array.prototype.slice.apply(this._models,
...
$Define("C.ModelList","C.AbstractComponent",function(e){e=e.define("ModelList");e.extend({emptyTips:"\u7a7a",tmpl:['<div class="hui-list">','<div id="emptyContent"<%if(this.children.length>0){%> style="display:none"<%}%> class="hui-list-empty"><%=this.emptyTips%></div>',"</div>"],init:function(){var c=this;c.listenTo(c.model,{add:function(b,a){c.addListItem(a)},remove:function(b,a){c.removeListItem(a)},reset:function(){c.removeListItem("emptyAll")}})},addListItem:function(c){this.inited&&this.findEl("#emptyContent").hide();
this.add({model:c})},removeListItem:function(c){"emptyAll"==c?this.remove(this.children):this.remove(function(b){return b.model&&b.model.id==c.id});0==this.children.length&&this.findEl("#emptyContent").show()}});return e});$Define("M.AbstractModule","CM.View",function(e){var c=$H.createClass();$H.inherit(c,e,{useCache:$H.noop,cache:$H.noop,init:$H.noop,reset:$H.noop,exit:function(){return!0},cleanCache:function(){this.clearCache=!0}});return c});
