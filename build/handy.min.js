...
$Define("CM.Model",["CM.AbstractDao","CM.AbstractEvents","CM.DataStore"],function(g,b){var e=b.derive({idAttribute:"id",_pending:!1,_validate:function(a,c){if(!c.validate||!this.validate)return!0;a=$H.extend({},this._attributes,a);var b=this.validationError=this.validate(a,c)||null;if(!b)return!0;this.trigger("invalid",this,b,$H.extend(c,{validationError:b}));return!1},_doDepends:function(a,c){var b=this.fields,f,e,g={},k,l;for(l in b)if((f=b[l])&&(e=f.depends))for(f=0;f<e.length;f++)if(a.hasOwnProperty(e[f])){g[l]=
void 0;k=!0;break}k&&this.set(g,null,{silent:c})},_parseFields:function(a){var c;if(!(c=this.fields))return a;var b,f,e,g,k={},l;for(l in a){f=a[l];if(b=c[l]){e=b.type;g=b.options;if(b=b.parse)f=b.apply(this,[f,a]);$H.isStr(e)&&("Date"==e?f=$H.parseDate(f):0<e.indexOf(".")&&(e=$H.ns(e)));$H.isClass(e)&&!(f instanceof e)&&(e.get?(b={},(f=e.get(f,g,b))&&(f._changedTmp=b.changed)):(b=this.get(l))?(e=b.set(f),f=b,f._changedTmp=e.changed):(f=new e(f,g),f._changedTmp=!0))}k[l]=f}return k},_onAttrEvent:function(a,
b,d,f){if(!("invalid"==b||"sync"==b||"request"==b||0==b.indexOf("change:")))if("add"!=b||$H.isInstance(f)){var e=this.get(a);this.trigger("change:"+a,this,e);this.trigger("change",this);this.trigger.apply(this,arguments);this._attrEvts[a]=1;var g={};g[a]=e;this._doDepends(g)}},initialize:function(a,b){this.callSuper();this.uuid=$H.uuid();this.dao=this.dao||$H.getSingleton(g);var d=a||{};b||(b={});this.cid=$H.Util.uuid();this._attributes={};this._attrEvts={};b.collection&&(this.collection=b.collection);
b.parse&&(d=this.parse(d,b)||{});d=$H.extendIf(d,this.getDefaults());this.init&&this.init();this.set(d,b);this._changed={}},getDefaults:function(){var a={},b;if(b=this.fields)for(var d in b){var f=b[d];a[d]=f&&$H.isObj(f)?f.def:f}return a},toJSON:function(){return $H.clone(this._attributes)},sync:function(a,b,d){this.lastSyncTime=$H.now();return this.dao.sync(a,b,d)},get:function(a){return this._attributes[a]},escape:function(a){return $H.String.escapeHTML(this.get(a))},has:function(a){a=this.get(a);
return null!==a&&void 0!==a},set:function(a,b,d){var f,h={result:this};"object"===typeof a?(f=a,d=b):(f={})[a]=b;d||(d={});f instanceof e&&(f=f._attributes);f=this._parseFields(f);if(!this._validate(f,d))return h.invalid=!0,h;var g=d.unset;a=d.silent;var k={};b=this._changing;this._changing=!0;b||(this._previousAttributes=$H.Object.clone(this._attributes),this._changed={});var l=this._attributes,m=this._previousAttributes;this.idAttribute in f&&(this.id=f[this.idAttribute]);for(var n in f){b=f[n];
var p=l[n],s=p&&$H.isInstance(p),t=b&&$H.isInstance(b);if(s||t){if(g)delete l[n],p&&this.unlistenTo(p,"all");else if(l[n]=b,!p||p.id!=b.id)b._changedTmp=!0,p&&this.unlistenTo(p,"all"),this.listenTo(b,"all",$H.bind(this._onAttrEvent,this,n));if(g||b._changedTmp)k[n]=b;delete b._changedTmp}else $H.equals(l[n],b)||(k[n]=b),$H.equals(m[n],b)?delete this._changed[n]:this._changed[n]=b,g?delete l[n]:l[n]=b}f=!$H.isEmpty(k);if(!a){f&&(this._pending=d);for(var q in k)this._attrEvts[q]||this.trigger("change:"+
q,this,l[q],d)}if(!a)for(;this._pending;)d=this._pending,this._pending=!1,this.trigger("change",this,d);this._changing=this._pending=!1;f&&this._doDepends(k,a);h.changed=f;this._attrEvts={};return h},unset:function(a,b){b=b||{};b.unset=!0;return this.set(a,void 0,b)},clear:function(a){var b={},d;for(d in this._attributes)b[d]=void 0;a=a||{};a.unset=!0;return this.set(b,a)},each:function(a){$H.each(this._attributes,a)},hasChanged:function(a){var b=this._changed;return null==a?!$H.isEmpty(b):$H.contains(b,
a)},changedAttrbutes:function(a){if(!a)return this.hasChanged()?$H.clone(this._changed):!1;var b,d=!1,f=this._changing?this._previousAttributes:this._attributes,e;for(e in a)if(!$H.equals(f[e],b=a[e]))(d||(d={}))[e]=b;return d},previous:function(a){return null==a||!this._previousAttributes?null:this._previousAttributes[a]},fetch:function(a){var b=this;b.fetching=!0;a=a?$H.clone(a):{};void 0===a.parse&&(a.parse=!0);var d=a.success,f=a.beforeSet;a.success=function(e){b.fetching=!1;e=b.parse(e,a);if(!(f&&
!1==f(b,e,a))){if(b.set(e,a).invalid)return!1;d&&d(b,e,a);b.trigger("sync",b,e,a)}};b.sync("read",b,a)},save:function(a,b,d){var f=this,e;null==a||"object"===typeof a?(e=a,d=b):(e={})[a]=b;$H.isFunc(d)&&(d={success:d});d=$H.extend({validate:!0},d);if(e&&d.now){if(f.set(e,d).invalid)return!1}else if(!f._validate(e,d))return!1;void 0===d.parse&&(d.parse=!0);var g=d.success;d.success=function(a){var b=f.parse(a,d);d.now||(b=$H.extend(e||{},b));if($H.isObj(b)&&f.set(b,d).invalid)return!1;g&&g(f,a,d);
f.trigger("sync",f,a,d)};a=f.isNew()?"create":d.update?"update":"patch";if("patch"===a){if(b=f.changedAttrbutes(e),!b){g&&g(f,d);return}}else b=$H.extend({},f._attributes),b=$H.extend(b,e);for(var k in b)$H.isInstance(b[k])&&delete b[k];d.attrs=b;f.sync(a,f,d)},destroy:function(a){var b=this;a=a?$H.clone(a):{};var d=a.success,f=function(){b.trigger("destroy",b,b.collection,a);b.off("all")};a.success=function(e){(!a.now||b.isNew())&&f();d&&d(b,e,a);b.isNew()||b.trigger("sync",b,e,a)};if(b.isNew())return a.success(),
!1;b.sync("delete",b,a);a.now&&f()},getUrl:function(){var a=$H.result(this,"url")||$H.result(this.collection,"url");a||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));return this.isNew()?a:a.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(a){return a.code&&a.data?a.data:a},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0===this.id},isValid:function(a){return this._validate({},$H.extend(a||
...
sortItem:function(a,b){void 0===b&&(b=this.sortedIndex(a));var c=this.indexOf(a),e=this._models;e.splice(c,1);e.splice(b,0,a);this.trigger("sortItem",a,b,c,this)},pluck:function(a){return $H.invoke(this._models,"get",a)},getUrl:function(){return this.url},fetch:function(a){var b=this;a=a?$H.clone(a):{};var c=a.success,e=a.beforeSet;a.success=function(g){g=b.parse(g,a);e&&!1==e(b,g,a)||(b[a.reset?"reset":a.add?"add":"set"](g,a),c&&c(b,g,a),b.trigger("sync",b,g,a))};return b.sync("read",b,a)},create:function(a,
b){var c=this;b=b?$H.clone(b):{};if(!(a=c._prepareModel(a,b)))return!1;b.now&&c.add(a,b);var e=b.success;b.success=function(a,d){b.now||c.add(a,b);e&&e(a,d,b)};a.save(null,b);return a},parse:function(a){return a.data},clone:function(){return new this.constructor(this._models)}}),c=$H.Array;$H.each("map some every find filter invoke indexOf".split(" "),function(b,f){a.prototype[f]=function(){var a=Array.prototype.slice.call(arguments);a.unshift(this._models);return c[f].apply(c,a)}});a.prototype.sortedIndex=
function(a,b,e){var g=this._getIterator(this.comparator);e=this.desc||e;return c.sortedIndex(this._models,a,g,b,e)};$H.each(["sortBy","groupBy","countBy"],function(b,f){a.prototype[f]=function(a,b,d){a=this._getIterator(a);d=this.desc||d;return c[f](this._models,a,b,d)}});return a});
...
{};this._bindElNums={};this.callSuper()},doConfig:function(){this.callSuper();var a=this.modelClass||e;this.model||(this.model=new a(this.data));this.xmodel=this.model},preTmpl:function(){var a=this.tmpl;$H.isArr(a)&&(a=a.join(""));var b=m.test(a),f="#js-"+this.manager.type+" #js-"+this.xtype;if(b){if(b=a.match(n)[1])s.test(a)||(b=b.replace(/([^\s]+)/g,"#$1")),f+=" "+b;a=a.replace(n,"")}f=' id=this._id class="'+f+'"';this.tmpl=a=p.test(a)?a.replace(t,"$1"+f):a.replace(l,"$1 {{bindAttr"+f+"}}")},getTmplFn:function(){var a=
...
"-"+b.uuid,"","remove")}));else if(void 0!==b.length)for(var l=0,g=b.length;l<g;l++)k=c.wrapMetaMorph(h+"-"+l,d(b[l])),j?e+=k:e.push(k);else for(l in b)k=c.wrapMetaMorph(h+"-"+l,d(b[l])),j?e+=k:e.push(k);return c.wrapMetaMorph(h,j?e:e.join(""))}},getValue:c,parseValue:function(a,b){var f=b.context,c=b.data,d=b.exp,e=g.isEscape,h=b.helpers,j=b.num,k=f.getCid()+"-"+j;f.ifBind(j,c)&&f.listenTo(c,"change:"+d,function(a,b,c){e&&(c=h.escape(c));f.updateMetaMorph(k,c)});e&&(a=h.escape(a));return f.wrapMetaMorph(k,
