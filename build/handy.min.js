...
$H.clone(this._changed):!1;var b,d=!1,f=this._changing?this._previousAttributes:this._attributes,e;for(e in a)if(!$H.equals(f[e],b=a[e]))(d||(d={}))[e]=b;return d},previous:function(a){return null==a||!this._previousAttributes?null:this._previousAttributes[a]},fetch:function(a){var b=this;b.set("fetching",!0);a=a?$H.clone(a):{};void 0===a.parse&&(a.parse=!0);var d=a.success,f=a.beforeSet;a.success=function(e){b.set("fetching",!1);e=b.parse(e,a);if(!(f&&!1==f(b,e,a))){if(b.set(e,a).invalid)return!1;
d&&d(b,e,a);b.trigger("sync",b,e,a)}};b.sync("read",b,a)},save:function(a,b,d){var f=this,e;null==a||"object"===typeof a?(e=a,d=b):(e={})[a]=b;$H.isFunc(d)&&(d={success:d});d=$H.extend({validate:!0},d);if(e&&d.now){if(f.set(e,d).invalid)return!1}else if(!f._validate(e,d))return!1;void 0===d.parse&&(d.parse=!0);var g=d.success;d.success=function(a){var b=f.parse(a,d);d.now||(b=$H.extend(e||{},b));if($H.isObj(b)&&f.set(b,d).invalid)return!1;g&&g(f,a,d);f.trigger("sync",f,a,d)};a=f.isNew()?"create":
d.update?"update":"patch";if("patch"===a){if(b=f.changedAttrbutes(e),!b){g&&g(f,d);return}}else b=$H.extend({},f._attributes),b=$H.extend(b,e);for(var k in b)$H.isInstance(b[k])&&delete b[k];d.attrs=b;f.sync(a,f,d)},destroy:function(a){var b=this;a=a?$H.clone(a):{};var d=a.success,f=function(){b.trigger("destroy",b,b.collection,a);b.off("all")};a.success=function(e){(!a.now||b.isNew())&&f();d&&d(b,e,a);b.isNew()||b.trigger("sync",b,e,a)};if(b.isNew())return a.success(),!1;b.sync("delete",b,a);a.now&&
f()},getUrl:function(){var a=$H.result(this,"url")||$H.result(this.collection,"url");a||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));return this.isNew()?a:a.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(a){return a.code?a.data:a},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0===this.id},isValid:function(a){return this._validate({},$H.extend(a||{},{validate:!0}))}},{get:function(a,
b,d){if(a){var f,e;e=!1;if(e=a[this.prototype.idAttribute])f=$S.get(this,e);f?e=f.set(a).changed:(f=new this(a,b),(b=$S.get(f,f.id))?(e=b.set(a).changed,f=b):(e=!0,$S.push(f)));d&&(d.changed=e);return f}}});return e});
...
a)}});a.prototype.sortedIndex=function(a,b,e){var g=this._getIterator(this.comparator);e=this.desc||e;return c.sortedIndex(this._models,a,g,b,e)};$H.each(["sortBy","groupBy","countBy"],function(b,f){a.prototype[f]=function(a,b,d){a=this._getIterator(a);d=this.desc||d;return c[f](this._models,a,b,d)}});return a});
...
"confirm"],doConfig:function(a){var b=this;a=a||{};var f=a.date;$H.isStr(f)&&(f=$H.parseDate(f));for(var f=f||$H.now(),g=a.formator||(a.formator="yyyy-MM-dd HH:mm"),j=$H.formatDate(f,g),k=[],m=$H.getDaysInMonth(f),g=g.match(/[a-zA-Z]+/g),n=j.match(/\d+/g),l=0;l<g.length;l++){var p=g[l],s=parseInt(n[l]);switch(p){case "yyyy":k.push(e(s,s,s+10,"year"));break;case "MM":k.push(e(s,1,12,"month"));break;case "dd":k.push(e(s,1,31,"date",m));break;case "HH":k.push(e(s,0,23,"hour"));break;case "mm":k.push(e(s,
