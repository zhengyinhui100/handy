...
handy.add("Json",function(){function g(a){f.lastIndex=0;f.test(a)&&(a=a.replace(f,function(a){var f=h[a];return"string"===typeof f?f:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function b(f,h){var e,j,k,m,n=c,z,l=h[f];l&&("object"===typeof l&&"function"===typeof l.toJSON)&&(l=l.toJSON(f));"function"===typeof a&&(l=a.call(h,f,l));switch(typeof l){case "undefined":return"undefined";case "string":return g(l);case "number":return isFinite(l)?String(l):"null";case "boolean":case "null":return String(l);
case "object":if(!l)return"null";c+=d;z=[];if("[object Array]"===Object.prototype.toString.apply(l)){m=l.length;for(e=0;e<m;e+=1)z[e]=b(e,l)||"null";k=0===z.length?"[]":c?"[\n"+c+z.join(",\n"+c)+"\n"+n+"]":"["+z.join(",")+"]";c=n;return k}if(a&&"object"===typeof a){m=a.length;for(e=0;e<m;e+=1)"string"===typeof a[e]&&(j=a[e],(k=b(j,l))&&z.push(g(j)+(c?": ":":")+k))}else for(j in l)Object.prototype.hasOwnProperty.call(l,j)&&(k=b(j,l))&&z.push(g(j)+(c?": ":":")+k);k=0===z.length?"{}":c?"{\n"+c+z.join(",\n"+
...
if("object"==e||"function"==e)a.$ns=f}else g.warn(k+"factory no return:\n"+f)})},require:function(f,b){for(var j="string"==typeof f?[f]:f,l=[],y=[],u=!0,w=0,v=j.length;w<v;w++){var r=j[w],r=a.Object.alias(r),x=c(r);x.notExist?(l.push(r),u&&(u=!1,p.push({deps:j,callback:b})),q.traceLog&&g.log(m+r)):y.push(x.exist[0])}if(0==l.length)return b&&b.apply(null,y),1==y.length?y[0]:y;u=!1;j=0;for(y=l.length;j<y;j++)if(w=l[j],!t[w]){u=w;r=q.urlMap&&q.urlMap[u]&&q.urlMap[u].url;if(!r){v="";r=q.rootPath;if("string"==
typeof r)v=r;else if("object"==typeof r)for(x in x=void 0,r)0==u.indexOf(x)&&(v=r[x],u=u.replace(x,""));else v="";r=/.css$/.test(u)?0==u.indexOf("/")?u:"/css/"+u:/.js$/.test(u)?u:u.replace(/\./g,"/")+".js";r=v.replace(/\/$/,"")+"/"+r.replace(/^\//,"")}u=!0;t[w]={id:w,status:"loading"};v=e.bind(h,null,w);q.traceLog&&g.log(k+"request:\n"+r);if(/.css$/.test(r))a:{w=r;r=n.getElementsByTagName("link");for(x=0;x<r.length;x++){var A=r[x].href;!q.skinNode&&0<=A.indexOf(q.skinName)&&(q.skinNode=r[x]);if(0<=
A.indexOf(w)||0<=w.indexOf(A))break a}r=document.createElement("link");r.rel="stylesheet";r.href=w;d(r,v);q.skinNode?n.insertBefore(r,q.skinNode):n.appendChild(r)}else w=r,r=document.createElement("script"),r.async="async",r.src=w,r.type="text/javascript",d(r,v),n.appendChild(r);s++}u&&q.showLoading(!0)}};return q});
...
q+");":"")+"}",m.isEscape?"\n$tmp=escape($tmp);":""),q+=n);return q}function j(a,f){if(a){var c=f||{},d=m.openTag,b=m.closeTag,h,g;c.children?g=c.children:c.children=g=[];if(0<=(h=a.indexOf(d))){var k=a.substring(0,h);k&&g.push({html:k});a=a.substring(h+d.length);if(0==a.indexOf("#"))if(a=a.substring(1),k=a.match(/^[a-z]+/)){var q=k[0];h=a.indexOf(b);k=a.substring(q.length+1,h);a=a.substring(h+b.length);k={num:++s,blockName:q,exp:k};g.push(k);var n=d+"/"+q+b;a:{h=a;for(var b=RegExp(d+"[#/]"+q+"((?!"+
b+").)*"+b,"ig"),l=0;d=b.exec(h);)if(d[0]==n)if(0==l){h=d.index;break a}else l--;else l++;h=-1}if(-1==h){e.error("\u672a\u627e\u5230\u5757\u7ed3\u675f\u4f4d\u7f6e:"+n);return}d=a.substring(0,h);a=a.substring(h+n.length);j(d,k);if("if"==q){q=k.children;n=0;for(d=q.length;n<d;n++)b=q[n],"else"==b.exp&&(b.exp=k.exp,b.blockName="if",b.num=++s,b.inverse=!0,b.children=q.slice(n+1),g.push(b),k.children=q.slice(0,n))}}else{e.error("\u627e\u4e0d\u5230\u8f85\u52a9\u51fd\u6570:"+a);return}else h=a.indexOf(b),
...
else if(d=a.tmpl,h=a.id)if(n[h])b=n[h];else if(!d){var p=document.getElementById(h);p&&(d=(p.value||p.innerHTML).replace(/\s/g,""))}if(!b){if(!d){e.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}a:{var p=m.openTag,v=m.closeTag;d=d.replace(RegExp(p+"!((?!"+v+").)*"+v,"ig"),"");m.isTrim&&(d=d.replace(/^[\s\n]+/,"").replace(/[\s\n]+$/,"").replace(RegExp("("+v+"|\\>)(\\s|\\n)+(?=("+p+"|<))","ig"),"$1").replace(RegExp(v+"[\\s\\n]+([^\\n]+)[\\s\\n]+(?=("+p+"|<))","ig"),v+"$1"));l=[t[0]];l.push('var escape=$helpers.escape,functionType="function",$me=this;');
var p=a&&a.ns,r;p?(r=g.extend({},q["default"]),r=g.extend(r,q[p])):r=q["default"];a.helpers=r;d=j(d);s=0;a=k(d.children,a);l=l.concat(a);l.push(t[1]);a=l.join("\n");try{var x=window.Function.apply(null,["$T","$helpers","$data",a]);b=function(a,f){return x.call(f||a,m,r,a)};break a}catch(A){e.log(a),e.error(A)}b=void 0}h&&(n[h]=b)}if(f)try{return b(f,c)}catch(J){e.log(b.toString()),e.error(J)}else return b}},n={},l,p="".trim,s=0,t=["var $r="+(p?'""':"[]")+",$tmp,helper;","return "+(p?"$r;":'$r.join("");')],
...
b,d,f){if(!("invalid"==b||"sync"==b||"request"==b||0==b.indexOf("change:")))if("add"!=b||$H.isInstance(f))b=this.get(a),this.trigger("change:"+a,this,b),this.trigger("change",this),this._attrEvts[a]=1,d={},d[a]=b,this._doDepends(d)},initialize:function(a,b){this.callSuper();this.uuid=$H.uuid();this.dao=this.dao||$H.getSingleton(g);var d=a||{};b||(b={});this.cid=$H.Util.uuid();this._attributes={};this._attrEvts={};b.collection&&(this.collection=b.collection);b.parse&&(d=this.parse(d,b)||{});d=$H.extendIf(d,
this.getDefaults());this.init&&this.init();this.set(d,b);this._changed={}},getDefaults:function(){var a={},b;if(b=this.fields)for(var d in b){var f=b[d];a[d]=f&&$H.isObj(f)?f.def:f}return a},toJSON:function(){return $H.clone(this._attributes)},sync:function(a,b,d){this.lastSyncTime=$H.now();return this.dao.sync(a,b,d)},get:function(a){return this._attributes[a]},escape:function(a){return $H.String.escapeHTML(this.get(a))},has:function(a){a=this.get(a);return null!==a&&void 0!==a},set:function(a,b,
d){var f,h={result:this};"object"===typeof a?(f=a,d=b):(f={})[a]=b;d||(d={});f instanceof e&&(f=f._attributes);f=this._parseFields(f);if(!this._validate(f,d))return h.invalid=!0,h;var g=d.unset;a=d.silent;var k={};b=this._changing;this._changing=!0;b||(this._previousAttributes=$H.Object.clone(this._attributes),this._changed={});var m=this._attributes,n=this._previousAttributes;this.idAttribute in f&&(this.id=f[this.idAttribute]);for(var l in f){b=f[l];var p=m[l],s=p&&$H.isInstance(p),t=b&&$H.isInstance(b);
if(s||t){if(g)delete m[l],p&&this.unlistenTo(p,"all");else if(m[l]=b,!p||p.id!=b.id)b._changedTmp=!0,p&&this.unlistenTo(p,"all"),this.listenTo(b,"all",$H.bind(this._onAttrEvent,this,l));if(g||b._changedTmp)k[l]=b;delete b._changedTmp}else $H.equals(m[l],b)||(k[l]=b),$H.equals(n[l],b)?delete this._changed[l]:this._changed[l]=b,g?delete m[l]:m[l]=b}f=!$H.isEmpty(k);if(!a){f&&(this._pending=d);for(var q in k)this._attrEvts[q]||this.trigger("change:"+q,this,m[q],d)}if(!a)for(;this._pending;)d=this._pending,
this._pending=!1,this.trigger("change",this,d);this._changing=this._pending=!1;f&&this._doDepends(k,a);h.changed=f;this._attrEvts={};return h},unset:function(a,b){b=b||{};b.unset=!0;return this.set(a,void 0,b)},clear:function(a){var b={},d;for(d in this._attributes)b[d]=void 0;a=a||{};a.unset=!0;return this.set(b,a)},each:function(a){$H.each(this._attributes,a)},hasChanged:function(a){var b=this._changed;return null==a?!$H.isEmpty(b):$H.contains(b,a)},changedAttrbutes:function(a){if(!a)return this.hasChanged()?
$H.clone(this._changed):!1;var b,d=!1,f=this._changing?this._previousAttributes:this._attributes,e;for(e in a)if(!$H.equals(f[e],b=a[e]))(d||(d={}))[e]=b;return d},previous:function(a){return null==a||!this._previousAttributes?null:this._previousAttributes[a]},fetch:function(a){var b=this;b.fetching=!0;a=a?$H.clone(a):{};void 0===a.parse&&(a.parse=!0);var d=a.success,f=a.beforeSet;a.success=function(e){b.fetching=!1;e=b.parse(e,a);if(!(f&&!1==f(b,e,a))){if(b.set(e,a).invalid)return!1;d&&d(b,e,a);
b.trigger("sync",b,e,a)}};b.sync("read",b,a)},save:function(a,b,d){var f=this,e;null==a||"object"===typeof a?(e=a,d=b):(e={})[a]=b;$H.isFunc(d)&&(d={success:d});d=$H.extend({validate:!0},d);if(e&&d.now){if(f.set(e,d).invalid)return!1}else if(!f._validate(e,d))return!1;void 0===d.parse&&(d.parse=!0);var g=d.success;d.success=function(a){var b=f.parse(a,d);d.now||(b=$H.extend(e||{},b));if($H.isObj(b)&&f.set(b,d).invalid)return!1;g&&g(f,a,d);f.trigger("sync",f,a,d)};a=f.isNew()?"create":d.update?"update":
"patch";if("patch"===a){if(b=f.changedAttrbutes(e),!b){g&&g(f,d);return}}else b=$H.extend({},f._attributes),b=$H.extend(b,e);for(var k in b)$H.isInstance(b[k])&&delete b[k];d.attrs=b;f.sync(a,f,d)},destroy:function(a){var b=this;a=a?$H.clone(a):{};var d=a.success,f=function(){b.trigger("destroy",b,b.collection,a);b.off("all")};a.success=function(e){(!a.now||b.isNew())&&f();d&&d(b,e,a);b.isNew()||b.trigger("sync",b,e,a)};if(b.isNew())return a.success(),!1;b.sync("delete",b,a);a.now&&f()},getUrl:function(){var a=
$H.result(this,"url")||$H.result(this.collection,"url");a||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));return this.isNew()?a:a.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(a){return a.code?a.data:a},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0===this.id},isValid:function(a){return this._validate({},$H.extend(a||{},{validate:!0}))}},{get:function(a,b,d){if(a){var f,e;e=!1;if(e=
a[this.prototype.idAttribute])f=$S.get(this,e);f?e=f.set(a).changed:(f=new this(a,b),(b=$S.get(f,f.id))?(e=b.set(a).changed,f=b):(e=!0,$S.push(f)));d&&(d.changed=e);return f}}});return e});
...
remove:!1,merge:!1},b);return this.set(a,b).result},remove:function(a,b){var c=!$H.isArr(a);a=c?[a]:$H.clone(a);b||(b={});var e,g,m,n;e=0;for(g=a.length;e<g;e++)if(n=a[e]=this.get(a[e]))delete this._byId[n.id],delete this._byId[n.cid],m=this.indexOf(n),this._models.splice(m,1),this.length--,b.silent||(b.index=m,n.trigger("remove",n,this,b)),this._removeReference(n,b);return c?a[0]:a},set:function(b,f){if(!b)return{result:this};f=$H.extend({add:!0,remove:!1,merge:!0},f);b instanceof a&&(b=b._models);
f.parse&&(b=this.parse(b,f));var c=!$H.isArr(b)?b?[b]:[]:$H.clone(b),g=this._models,k,m,n,l,p,s,t=f.at,q=this.model,F=this.comparator&&null==t&&!1!==f.sort,G=f.add,I=f.merge,z=f.remove,y=!1;k=0;for(m=c.length;k<m;k++)if(p=c[k]||{},n=p instanceof e?l=p:p[q.prototype.idAttribute||"id"],s=this.get(n))z&&(this.remove(s,f),y=!0),I&&(p=p===l?l.attributes:p,f.parse&&(p=s.parse(p,f)),n=s.set(p,f).changed,y=y||n),c[k]=s;else if(G&&(f.id=n,l=c[k]=this._prepareModel(p,f)))this._addReference(l,f),F&&(t=this.sortedIndex(l)),
null!=t?g.splice(t,0,l):g.push(l),this.length+=1,f.silent||l.trigger("add",l,this,f,t),y=!0;return{changed:y,result:this}},each:function(a){$H.each(this._models,a)},eachDesc:function(a){for(var b=this._models,c=b.length-1;0<=c;c--)a(c,b[c])},reset:function(a,b){b||(b={});for(var c=0,e=this._models.length;c<e;c++)this._removeReference(this._models[c],b);b.previousModels=this._models;this._reset();a&&(a=this.add(a,$H.extend({silent:!0},b)).result);b.silent||this.trigger("reset",this,b);return a},push:function(a,
...
$Define("CM.ModelView",["B.Template","CM.AbstractView","CM.Model","CM.Collection"],function(g,b,e,a){function c(a,b){return b.get?b.get(a):b[a]}function d(a,b){for(var c=b.context,d=b.data,e=b.num,g=b.type,j="bindAttr-"+(c.getCid()+"-"+e),m=[],n=[],l=c.ifBind(e,d),p=g&&c.ifBind(e,d,!0);e=k.exec(a);)"id"==e[2]?j=0==e[3].indexOf("this.")?c[e[3].substring(5)]:f(e[3],d):n.push(e);m.push('id="'+j+'"');for(var s,t,B,C,D=0,K=n.length;D<K;D++){e=n[D];t=e[2];s=e[3];s=s.split(" ");B=[];for(var E=0;E<s.length;E++)((C=
h(c,j,t,s[E],l,p,d))||0===C)&&B.push(C);s=B.join(" ");t?(g&&"value"==t&&(b.value=s),s=(e[1]||"")+s+e[4]):s&&(s=s+'="'+s+'"');s&&m.push(s)}return" "+m.join(" ")+" "}function f(a,b){return!a?a:0==a.indexOf("#")?a.substring(1):c(a,b)}function h(a,b,c,d,e,g,h){var j;b="#"+b;var k=d.indexOf("?"),m=d.indexOf(":");if(0==d.indexOf("this."))return a[d.substring(5)];if(0<k||0<m){g=d.substring(0,0<k?k:m);var n=0>k?"":d.substring(k+1,0<m?m:d.length),l=0>m?"":d.substring(m+1,d.length);j=f(g,h);e&&0!=g.indexOf("#")&&
a.listenTo(h,"change:"+g,function(a,f,d){a=$(b);c?"class"==c?d?(l&&a.removeClass(l),n&&a.addClass(n)):(n&&a.removeClass(n),l&&a.addClass(l)):a.attr(c,d?n:l):d?a.prop(n,!0):a.prop(n,!1)});return j?n:l}j=f(d,h);0!=d.indexOf("#")&&(e&&a.listenTo(h,"change:"+d,function(a,f,d){a=$(b);"class"==c?(a.removeClass(j),a.addClass(d),j=d):a.attr(c,d||"")}),"value"==c&&g&&a.listen({name:"input propertychange",el:b,handler:function(a){h.set(d,a.target.value)}}));return j}b=b.derive({bindType:"both",initialize:function(){this._bindModelNums=
{};this._bindElNums={};this.callSuper()},doConfig:function(){this.callSuper();var a=this.modelClass||e;this.model||(this.model=new a(this.data));this.xmodel=this.model},preTmpl:function(){var a=this.tmpl;$H.isArr(a)&&(a=a.join(""));var b=n.test(a),f="#js-"+this.manager.type+" #js-"+this.xtype;if(b){if(b=a.match(l)[1])s.test(a)||(b=b.replace(/([^\s]+)/g,"#$1")),f+=" "+b;a=a.replace(l,"")}f=' id=this._id class="'+f+'"';this.tmpl=a=p.test(a)?a.replace(t,"$1"+f):a.replace(m,"$1 {{bindAttr"+f+"}}")},getTmplFn:function(){var a=
...
a)},bindAttr:d,input:function(a,b){b.type="input";return"<input "+d(a,b)+"/>"},textarea:function(a,b){b.type="textarea";return"<textarea "+d(a,b)+">"+b.value+"</textarea>"}});var j=g.getIfPlusJoin(),k=/((\w+)=['"]?)?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/g,m=/[^<]*(<[a-zA-Z]+)/,n=/^[^>]+class=/,l=/class=['"]?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/,p=/^[^>]+{{bindAttr/,s=/^[^>]+{{bindAttr((?!}}).)class=/,t=/({{bindAttr)/;return b});
...
{};c[a]=b;this.fastUpdate(c)||(this[a]=b)},getRefModel:function(){var a;if(a=this.refModel||this.model)return a;for(var b=this.parent;b;){if(a=b.refModel||b.model)return this.refModel=a;if(b.parent)b=b.parent;else return b.model}},bindRefModel:function(){function a(f,d){var k;if(0<d.indexOf(".")){var l=d.split(".");d=l[0];k=l[1]}("both"==c||"bindRef"==c)&&b.listenTo(e,"change:"+d,function(a,c,d){k&&(d=d&&d.get(k));b.set(f,d)});("both"==c||"bindXmodel"==c)&&b.listenTo(g,"change:"+f,function(a,b,c){k?
...
0,a);this.trigger("add",a,b);return a}e=this.items;c?e.push(a):e.splice(b,0,a)}},remove:function(a){if(!this._applyArray()){var b=this.children,c=!1,e;if($H.isNum(a))e=a,a=b[e];else if($H.isStr(a)||$H.isFunc(a)){a=this.find(a);for(var g=0,n=a.length;g<n;g++){if(!1==this.remove(a[g]))return!1;c=!0}}else if(a instanceof d)if(a.parent==this){g=0;for(n=b.length;g<n;g++)if(b[g]==a){e=g;break}}else return a.parent.remove(a);void 0!==e&&!1!=a.destroy(!0)&&(b.splice(e,1),c=!0);this.trigger("remove",a);return c}},
parseItem:function(){},parseItems:function(){this.startParseItems=!0;var a=this.items;if(a)for(var a=$H.isArr(a)?a:[a],b=0,c=a.length;b<c;b++)this.add(a[b])},beforeUpdate:function(){return this.trigger("beforeUpdate")},fastUpdate:function(a){var b=this,c=b.xmodel;if(!c)return!1;var d=b.xConfig,e=b.fastUpdateMethod,g=!0,l={};$H.each(a,function(a,b){d.hasOwnProperty(a)||(e[a]?l[a]=b:g=!1)});return g?(c.set(a),$H.each(l,function(a,c){e[a].call(b,c)}),!0):!1},update:function(a,b){if(!a||!1==this.beforeUpdate())return!1;
...
"confirm"],doConfig:function(a){var b=this;a=a||{};var f=a.date;$H.isStr(f)&&(f=$H.parseDate(f));for(var f=f||$H.now(),g=a.formator||(a.formator="yyyy-MM-dd HH:mm"),j=$H.formatDate(f,g),k=[],m=$H.getDaysInMonth(f),g=g.match(/[a-zA-Z]+/g),n=j.match(/\d+/g),l=0;l<g.length;l++){var p=g[l],s=parseInt(n[l]);switch(p){case "yyyy":k.push(e(s,s,s+10,"year"));break;case "MM":k.push(e(s,1,12,"month"));break;case "dd":k.push(e(s,1,31,"date",m));break;case "HH":k.push(e(s,0,24,"hour"));break;case "mm":k.push(e(s,
