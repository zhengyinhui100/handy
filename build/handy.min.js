...
b.onerror=b.onreadystatechange=null,n.removeChild(b),b=null,setTimeout(e,0))};b.onload=b.onreadystatechange=h;b.onerror=function(){g.error(k+"load script error:\n"+b.src);h()}}else{var j=d;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",j):setTimeout(function(){f(a,j)},0)}var m=setTimeout(function(){g.error("Time is out:"+a.src);d()},q.timeout)}function f(a,c){if(!c.isCalled){var d;if(l)a.sheet&&(d=!0);else if(a.sheet)try{a.sheet.cssRules&&(d=!0)}catch(b){if("SecurityError"===b.name||
"NS_ERROR_DOM_SECURITY_ERR"===b.name)d=!0}setTimeout(function(){d?c():f(a,c)},1)}}function h(a){q.showLoading(!1);s--;t[a].status="loaded";q.traceLog&&g.log(k+"Response:\n"+a);j()}function j(){for(var a=p.length-1;0<=a;a--){var f=p[a],d=c(f.deps);if(d.notExist)0==a&&0==s&&g.error(m+d.notExist);else{p.splice(a,1);f.callback.apply(null,d.exist);j();break}}}var k="[Handy Loader] ",m=k+"not found: ",n=document.head||document.getElementsByTagName("head")[0]||document.documentElement,l=navigator.userAgent.indexOf("AppleWebKit"),
...
q+");":m.isEscape?"\n$tmp=escape($tmp);":""),q+=n);return q}function j(a,f){if(a){var c=f||{},d=m.openTag,b=m.closeTag,h,g;c.children?g=c.children:c.children=g=[];if(0<=(h=a.indexOf(d))){var k=a.substring(0,h);k&&g.push({html:k});a=a.substring(h+d.length);if(0==a.indexOf("#"))if(a=a.substring(1),k=a.match(/^[a-z]+/)){var q=k[0];h=a.indexOf(b);k=a.substring(q.length+1,h);a=a.substring(h+b.length);k={num:++s,blockName:q,exp:k};g.push(k);var l=d+"/"+q+b;a:{h=a;for(var b=RegExp(d+"[#/]"+q+"((?!"+b+").)*"+
b,"ig"),n=0;d=b.exec(h);)if(d[0]==l)if(0==n){h=d.index;break a}else n--;else n++;h=-1}if(-1==h){e.error("\u672a\u627e\u5230\u5757\u7ed3\u675f\u4f4d\u7f6e:"+l);return}d=a.substring(0,h);a=a.substring(h+l.length);j(d,k);if("if"==q){q=k.children;l=0;for(d=q.length;l<d;l++)b=q[l],"else"==b.exp&&(b.exp=k.exp,b.blockName="if",b.num=++s,b.inverse=!0,b.children=q.slice(l+1),g.push(b),k.children=q.slice(0,l))}}else{e.error("\u627e\u4e0d\u5230\u8f85\u52a9\u51fd\u6570:"+a);return}else h=a.indexOf(b),g.push({num:++s,
exp:a.substring(0,h)}),a=a.substring(h+b.length);j(a,c)}else a&&g.push({html:a});return c}}function k(a,c){var d=[];if(a)for(var b=0,e=a.length;b<e;b++){var g=a[b];g.html?d.push(f(g.html)):g.exp&&d.push(h(g,c))}return d}var m={openTag:"{{",closeTag:"}}",isTrim:!0,isEscape:!1,getIfPlusJoin:function(){return p},registerHelper:function(a,f,c){g.isObj(f)?(q[a]||(q[a]={}),g.extend(q[a],f)):q[a][f]=c},tmpl:function(a,f,c){var d,b,h;if("string"==typeof a)d=a;else if(void 0!==a.length)d=a.join("");else if(d=
a.tmpl,h=a.id)if(n[h])b=n[h];else if(!d){var p=document.getElementById(h);p&&(d=(p.value||p.innerHTML).replace(/\s/g,""))}if(!b){if(!d){e.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}a:{var p=m.openTag,y=m.closeTag;d=d.replace(RegExp(p+"!((?!"+y+").)*"+y,"ig"),"");m.isTrim&&(d=d.replace(/^[\s\n]+/,"").replace(/[\s\n]+$/,"").replace(RegExp("("+y+"|\\>)(\\s|\\n)+(?=("+p+"|<))","ig"),"$1").replace(RegExp(y+"[\\s\\n]+([^\\n]+)[\\s\\n]+(?=("+p+"|<))","ig"),y+"$1"));l=[t[0]];l.push('var escape=$helpers.escape,functionType="function",$me=this;');
var p=a&&a.ns,r;p?(r=g.extend({},q["default"]),r=g.extend(r,q[p])):r=q["default"];a.helpers=r;d=j(d);s=0;a=k(d.children,a);l=l.concat(a);l.push(t[1]);a=l.join("\n");try{var v=window.Function.apply(null,["$T","$helpers","$data",a]);b=function(a,f){return v.call(f||a,m,r,a)};break a}catch(A){e.log(a),e.error(A)}b=void 0}h&&(n[h]=b)}if(f)try{return b(f,c)}catch(J){e.log(b.toString()),e.error(J)}else return b}},n={},l,p="".trim,s=0,t=["var $r="+(p?'""':"[]")+",$tmp,helper;","return "+(p?"$r;":'$r.join("");')],
...
d}return b},toJSON:function(){return $H.clone(this._attributes)},sync:function(b,a,c){return this.dao.sync(b,a,c)},get:function(b){return this._attributes[b]},escape:function(b){return $H.String.escapeHTML(this.get(b))},has:function(b){b=this.get(b);return null!==b&&void 0!==b},set:function(b,a,c){var d;"object"===typeof b?(d=b,c=a):(d={})[b]=a;c||(c={});d=this._parseFields(d);if(!this._validate(d,c))return!1;var f=c.unset;b=c.silent;var h={},g=this._changing;this._changing=!0;g||(this._previousAttributes=
$H.Object.clone(this._attributes),this._changed={});var k=this._attributes,m=this._previousAttributes;this.idAttribute in d&&(this.id=d[this.idAttribute]);for(var n in d){a=d[n];var l=k[n];l&&$H.isInstance(l)?f?l.reset():l.set(a):($H.equals(k[n],a)||(h[n]=a),$H.equals(m[n],a)?delete this._changed[n]:this._changed[n]=a,f?delete k[n]:k[n]=a)}a=!$H.isEmpty(h);if(!b){a&&(this._pending=c);for(var p in h)this.trigger("change:"+p,this,k[p],c)}if(g)return this;if(!b)for(;this._pending;)c=this._pending,this._pending=
!1,this.trigger("change",this,c);this._changing=this._pending=!1;a&&this._doDepends(h,b);return this},unset:function(b,a){a=a||{};a.unset=!0;return this.set(b,void 0,a)},clear:function(b){var a={},c;for(c in this._attributes)a[c]=void 0;b=b||{};b.unset=!0;return this.set(a,b)},each:function(b){$H.each(this._attributes,b)},hasChanged:function(b){var a=this._changed;return null==b?!$H.isEmpty(a):$H.contains(a,b)},changedAttrbutes:function(b){if(!b)return this.hasChanged()?$H.clone(this._changed):!1;
var a,c=!1,d=this._changing?this._previousAttributes:this._attributes,f;for(f in b)if(!$H.equals(d[f],a=b[f]))(c||(c={}))[f]=a;return c},previous:function(b){return null==b||!this._previousAttributes?null:this._previousAttributes[b]},fetch:function(b){var a=this;a.fetching=!0;b=b?$H.clone(b):{};void 0===b.parse&&(b.parse=!0);var c=b.success,d=b.beforeSet;b.success=function(f){a.fetching=!1;if(!(d&&!1==d(a,f,b))){if(!a.set(a.parse(f,b),b))return!1;c&&c(a,f,b);a.trigger("sync",a,f,b)}};a.sync("read",
a,b)},save:function(b,a,c){var d=this,f;null==b||"object"===typeof b?(f=b,c=a):(f={})[b]=a;$H.isFunc(c)&&(c={success:c});c=$H.extend({validate:!0},c);if(f&&c.now){if(!d.set(f,c))return!1}else if(!d._validate(f,c))return!1;void 0===c.parse&&(c.parse=!0);var h=c.success;c.success=function(a){var b=d.parse(a,c);c.now||(b=$H.extend(f||{},b));if($H.isObj(b)&&!d.set(b,c))return!1;h&&h(d,a,c);d.trigger("sync",d,a,c)};b=d.isNew()?"create":c.update?"update":"patch";if("patch"===b){if(a=d.changedAttrbutes(f),
!a){h&&h(d,c);return}}else a=$H.extend({},d._attributes),a=$H.extend(a,f);for(var g in a)$H.isInstance(a[g])&&delete a[g];c.attrs=a;d.sync(b,d,c)},destroy:function(b){var a=this;b=b?$H.clone(b):{};var c=b.success,d=function(){a.trigger("destroy",a,a.collection,b);a.off("all")};b.success=function(f){(!b.now||a.isNew())&&d();c&&c(a,f,b);a.isNew()||a.trigger("sync",a,f,b)};if(a.isNew())return b.success(),!1;a.sync("delete",a,b);b.now&&d()},getUrl:function(){var b=$H.result(this,"url")||$H.result(this.collection,
"url");b||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));return this.isNew()?b:b.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(b){return b.code&&b.data?b.data:b},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0===this.id},isValid:function(b){return this._validate({},$H.extend(b||{},{validate:!0}))}})});
...
a:c)});return 0<e.length?this.multi?e:e[0]:null},selectItem:function(b,e){(e=!1!=e)?b.select?b.select():b.active():b.select?b.select(e):b.unactive()},val:function(b){var e=this;if(b){var a=(""+b).split(",");e.each(function(b,d){$H.contains(a,d.get("value"))?e.selectItem(d,!0):e.selectItem(d,!1)})}else return a=[],e.each(function(b,d){d.get("selected")&&a.push(d.value)}),a.join(",")},onItemClick:function(b,e){this.select(e);this.itemClick&&this.itemClick(this.children[e],e)}});return g});
