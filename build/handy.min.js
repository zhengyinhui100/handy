...
handy.add("Json",function(){function g(a){f.lastIndex=0;f.test(a)&&(a=a.replace(f,function(a){var f=h[a];return"string"===typeof f?f:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function b(f,e){var h,j,k,m,n=c,w,l=e[f];l&&("object"===typeof l&&"function"===typeof l.toJSON)&&(l=l.toJSON(f));"function"===typeof a&&(l=a.call(e,f,l));switch(typeof l){case "undefined":return"undefined";case "string":return g(l);case "number":return isFinite(l)?String(l):"null";case "boolean":case "null":return String(l);
case "object":if(!l)return"null";c+=d;w=[];if("[object Array]"===Object.prototype.toString.apply(l)){m=l.length;for(h=0;h<m;h+=1)w[h]=b(h,l)||"null";k=0===w.length?"[]":c?"[\n"+c+w.join(",\n"+c)+"\n"+n+"]":"["+w.join(",")+"]";c=n;return k}if(a&&"object"===typeof a){m=a.length;for(h=0;h<m;h+=1)"string"===typeof a[h]&&(j=a[h],(k=b(j,l))&&w.push(g(j)+(c?": ":":")+k))}else for(j in l)Object.prototype.hasOwnProperty.call(l,j)&&(k=b(j,l))&&w.push(g(j)+(c?": ":":")+k);k=0===w.length?"{}":c?"{\n"+c+w.join(",\n"+
c)+"\n"+n+"}":"{"+w.join(",")+"}";c=n;return k}}var e="JSON"in window,a,c,d,f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},j=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/^[\],:{}\s]*$/,m=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,n=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
l=/(?:^|:|,)(?:\s*\[)+/g;return{stringify:function(f,h,j,k){if(e&&!k)return JSON.stringify.apply(null,arguments);var g;d=c="";if("number"===typeof j)for(g=0;g<j;g+=1)d+=" ";else"string"===typeof j&&(d=j);if((a=h)&&"function"!==typeof h&&("object"!==typeof h||"number"!==typeof h.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return b("",{"":f})},parseJson:function(a,f,c){function d(a,c){var b,e,h=a[c];if(h&&"object"===typeof h)for(b in h)Object.prototype.hasOwnProperty.call(h,
b)&&(e=d(h,b),void 0!==e?h[b]=e:delete h[b]);return f.call(a,c,h)}if(e&&!c)return JSON.parse.apply(null,arguments);var b;a=String(a);j.lastIndex=0;j.test(a)&&(a=a.replace(j,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(k.test(a.replace(m,"@").replace(n,"]").replace(l,"")))return b=eval("("+a+")"),"function"===typeof f?d({"":b},""):b;$D.error(new SyntaxError("JSON.parse"))}}});
handy.add("Object",function(){var g;g=(g=window.navigator.userAgent.match(/MSIE ([\d.]+)/))&&9>parseInt(g[0])?function(a,c,d){var f=[];if(a.length){c=c||0;for(d=d||a.length;c<d;c++)f.push(a[c])}return f}:function(a,c,d){return Array.prototype.slice.call(a,c||0,d||a.length)};var b={_alias:{B:"handy.base",C:"handy.component",M:"handy.module",CM:"handy.common"},ns:function(a,c){var d=null,f,e,j,k;a=b.alias(a);e=a.split(".");d=e[0];d=(j=2==arguments.length)?eval("(function(){if (typeof "+d+' == "undefined"){'+
d+" = {};}return "+d+";})()"):eval("(function(){if (typeof "+d+' != "undefined")return '+d+";})()");f=1;for(k=e.length;f<k;++f){if(f==k-1&&j)d[e[f]]=c;else if(j||d&&d[e[f]])d[e[f]]=d[e[f]]||{};else return;d=d[e[f]]}return d},alias:function(a,c){var d=b._alias;if(c)d[a]?$D.error("\u522b\u540d\u5df2\u88ab\u4f7f\u7528"+a+":"+d[a]):d[a]=c;else{if(a){var f=a,e=a.length-1;do{if(d[f])return d[f]+a.substring(e);e=f.lastIndexOf(".")}while(0<e&&(f=f.substring(0,e)));return a}return d}},extend:function(a,c,
d){if(!c||b.isStr(c)||b.isNum(c))return a;var f=d?d.notCover:!1,e=d?d.cover:null;d=d?d.IsClone:!1;a=a||{};var j=a.constructor,k=j.$isClass,g,n;for(n in c)if(g=c[n],(!e||b.contains(e,n))&&c.hasOwnProperty(n)){var l=a.hasOwnProperty(n),p=!0===f?l:!1;b.isArr(f)?p=b.contains(f,n)&&l:b.isFunc(f)&&(p=f(n,g));p||(g=d?b.clone(g):g,k&&(b.isFunc(g)&&!g.$name)&&(g.$name=n,g.$owner=j),a[n]=g)}return a},extendIf:function(a,c){return b.extend(a,c,{notCover:!0})},mix:function(a,c,d){a.superProto||(a.superProto=
...
try{var d=new c,f;for(f in a)d[f]=b.clone(a[f]);return d}catch(h){return a}},isEmpty:function(a){if(b.isArr(a))return 0==a.length;for(var c in a)return!1;return!0},each:function(a,c,d){if(a){var f,e=0,j=a.length,g=void 0===j||b.isFunc(a);if(d)if(g)for(f in a){if(!1===c.apply(a[f],d))break}else for(;e<j&&!1!==c.apply(a[e],d);)f=a.length,j==f?e++:j=f;else if(g)for(f in a){if(!1===c.call(a[f],f,a[f]))break}else for(;e<j&&!1!==c.call(a[e],e,a[e]);)f=a.length,j==f?e++:j=f;return a}},contains:function(a,
c){if(!a)return!1;var d=!1;b.each(a,function(a,e){if(b.equals(e,c))return d=!0,!1});return d},largeThan:function(a,c){if("object"==typeof a&&"object"==typeof c){var d=!0;b.each(c,function(f){if(!b.equals(c[f],a[f]))return d=!1});return d}},count:function(a){if(b.isArr(a))return a.length;var c=0,d;for(d in a)c++;return c},removeUndefined:function(a,c){var d=b.isArr(a);if(c){if(d){var f=[];b.each(a,function(a,c){void 0!==c&&f.push(c)});return f}return b.extend({},a,{isClone:!0,notCover:function(a,f){return void 0===
f}})}b.each(a,function(f,c){void 0===c&&(d?a.splice(f,1):delete a[f])});return a},toArray:g,fromArray:function(a){for(var c={},d=0,f=a.length;d<f;d++){var e=a[d];c[e.name]=e.value}return c},generateMethod:function(a,c,d){c=b.isArr(c)?c:c.split(",");for(var f=0;f<c.length;f++){var e=c[f];a[e]=d(e)}}},e=window.Object;return b});
...
'<div style="padding-top:5px;height:90%;overflow:auto;"></div>',g.style.position="fixed",g.style.width="100%",g.style.left=0,g.style.top=0,g.style.right=0,g.style.height="100%",g.style.backgroundColor="#aaa",g.style.fontSize="12px",g.style.padding="10px",g.style.zIndex=9999999999,g.style.opacity=0.95,g.style.filter="alpha(opacity=95)",j.body.appendChild(g));b=g.getElementsByTagName("DIV")[0];j="string"==typeof c?c:e.Json.stringify(c,null,"&nbsp;&nbsp;&nbsp;&nbsp;",!0);j=j.replace(/\n|\\n/g,"<br/>");
b.innerHTML+="<div"+("log"==f?"":' style="color:'+("error"==f?"red":"info"==f?"green":"yellow"))+'">'+f+":<br/>"+j+"</div><br/><br/>";b.scrollTop=b.scrollHeight}b=arguments.callee.caller;b.$owner||(b=b.caller);try{if(b.$owner)console[f]("["+b.$owner.$ns+"->"+b.$name+"]");console[f](c)}catch(m){}},log:function(c,d){a.level>a.LOG_LEVEL||a.out(c,!!d,"log")},info:function(c,d){this.level>a.INFO_LEVEL||a.out(c,!!d,"info")},warn:function(c,d){a.level>a.WARN_LEVEL||a.out(c,!!d,"warn")},error:function(c,
d){if(!(a.level>a.ERROR_LEVEL)&&(a.out(c,!!d,"error"),c instanceof Error))throw c;},time:function(c,d,f){a.level>a.INFO_LEVEL||(c?("boolean"==typeof d&&(f=d,d=""),a.out((d||"")+((new Date).getTime()-(a.lastTime||0)),!!f)):a.lastTime=(new Date).getTime())},debug:function(c){if(!(a.level>a.DEBUG_LEVEL)&&!1!==c)debugger}};return a});
...
handy.add("Loader",["B.Debug","B.Object","B.Function"],function(g,b,e,a){function c(a){var f={},c=[];"string"==typeof a&&(a=[a]);for(var d=0,e=a.length;d<e;d++){var h;h=a[d];h=/\.(css|js)$/.test(h)?t[h]&&"loaded"==t[h].status:q.urlMap&&q.urlMap[h]?q.urlMap[h].chkExist():b.ns(h);if(h)c.push(h);else return f.notExist=a[d],f}f.exist=c;return f}function d(a,c){function d(){d.isCalled||(d.isCalled=!0,clearTimeout(m),c())}if("SCRIPT"===a.nodeName){var b=a,e=d,h=function(){/loaded|complete|undefined/.test(b.readyState)&&(b.onload=
b.onerror=b.onreadystatechange=null,n.removeChild(b),b=null,setTimeout(e,0))};b.onload=b.onreadystatechange=h;b.onerror=function(){g.error(k+"load script error:\n"+b.src);h()}}else{var j=d;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",j):setTimeout(function(){f(a,j)},0)}var m=setTimeout(function(){g.error("Time is out:"+a.src);d()},q.timeout)}function f(a,c){if(!c.isCalled){var b;if(l)a.sheet&&(b=!0);else if(a.sheet)try{a.sheet.cssRules&&(b=!0)}catch(d){if("SecurityError"===d.name||
"NS_ERROR_DOM_SECURITY_ERR"===d.name)b=!0}setTimeout(function(){b?c():f(a,c)},1)}}function h(a){q.showLoading(!1);s--;t[a].status="loaded";q.traceLog&&g.log(k+"Response:\n"+a);j()}function j(){for(var a=p.length-1;0<=a;a--){var f=p[a],b=c(f.deps);if(b.notExist)0==a&&0==s&&g.error(m+b.notExist);else{p.splice(a,1);f.callback.apply(null,b.exist);j();break}}}var k="[Handy Loader] ",m=k+"not found: ",n=document.head||document.getElementsByTagName("head")[0]||document.documentElement,l=navigator.userAgent.indexOf("AppleWebKit"),
p=[],s=0,t={},q={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(f,c,d){f=a.Object.alias(f);2==arguments.length&&(d=c,c=[]);if(b.isFunc(d))for(var e,h=d.toString(),j=/\$Require\s*\(\s*['"]([^'"]+)['"]\s*\)/g;e=j.exec(h);)c.push(e[1]);q.require(c,function(){var a;if("function"==typeof d)try{q.traceLog&&g.log(k+"define:\n"+f),a=d.apply(null,arguments)}catch(c){c.message=k+f+":\nfactory define error:\n"+c.message;g.error(c);return}else a=d;if(a){b.ns(f,a);var e=typeof a;
if("object"==e||"function"==e)a.$ns=f}else g.warn(k+"factory no return:\n"+f)})},require:function(f,b){for(var j="string"==typeof f?[f]:f,l=[],z=[],u=!0,x=0,y=j.length;x<y;x++){var r=j[x],r=a.Object.alias(r),v=c(r);v.notExist?(l.push(r),u&&(u=!1,p.push({deps:j,callback:b})),q.traceLog&&g.log(m+r)):z.push(v.exist[0])}if(0==l.length)return b&&b.apply(null,z),1==z.length?z[0]:z;u=!1;j=0;for(z=l.length;j<z;j++)if(x=l[j],!t[x]){u=x;r=q.urlMap&&q.urlMap[u]&&q.urlMap[u].url;if(!r){y="";r=q.rootPath;if("string"==
typeof r)y=r;else if("object"==typeof r)for(v in v=void 0,r)0==u.indexOf(v)&&(y=r[v],u=u.replace(v,""));else y="";r=/.css$/.test(u)?0==u.indexOf("/")?u:"/css/"+u:/.js$/.test(u)?u:u.replace(/\./g,"/")+".js";r=y.replace(/\/$/,"")+"/"+r.replace(/^\//,"")}u=!0;t[x]={id:x,status:"loading"};y=e.bind(h,null,x);q.traceLog&&g.log(k+"request:\n"+r);if(/.css$/.test(r))a:{x=r;r=n.getElementsByTagName("link");for(v=0;v<r.length;v++){var A=r[v].href;!q.skinNode&&0<=A.indexOf(q.skinName)&&(q.skinNode=r[v]);if(0<=
A.indexOf(x)||0<=x.indexOf(A))break a}r=document.createElement("link");r.rel="stylesheet";r.href=x;d(r,y);q.skinNode?n.insertBefore(r,q.skinNode):n.appendChild(r)}else x=r,r=document.createElement("script"),r.async="async",r.src=x,r.type="text/javascript",d(r,y),n.appendChild(r);s++}u&&q.showLoading(!0)}};return q});
handy.add("Events",function(g){return{_eventCache:{},_execEvtCache:[],_parseEvents:function(b,e){var a=/\s+/;if("object"==typeof b){for(var c in b)e([c,b[c]]);return!0}if("string"==typeof b&&a.test(b)){a=b.split(a);c=0;for(var d=a.length;c<d;c++)e([a[c]]);return!0}return!1},_parseCustomEvents:function(b,e,a){var c=this,d=g.toArray(arguments,2);return c._parseEvents(e,function(a){c[b].apply(c,a.concat(d))})},_delegateHandler:function(b,e){var a=this;return function(){if(!0!=a.isSuspend)return b.apply(e||
...
handy.add("Date",function(){var g=window.Date,b={getWeek:function(a,c){var b=a.getDay();c&&(b=(b+(c%7+7))%7);return"\u65e5\u4e00\u4e8c\u4e09\u56db\u4e94\u516d".split("")[b]},isWeeken:function(a){return 0==a.getDay()||6==a.getDay()},getDaysInMonth:function(a){a=new g(a.getFullYear(),a.getMonth()+1,0);return a.getDate()},getDaysInYear:function(a){var c=new g(a.getFullYear(),0,0);a=new g(a.getFullYear()+1,0,0);return Math.floor((a.getTime()-c.getTime())/864E5)},getDayIndexOfYear:function(a){var c=new g("1/1/"+
a.getFullYear());return Math.ceil((a.getTime()-c.getTime())/864E5)},formatDate:function(a,c){if("object"!=typeof a)return a;c=c||"yyyy-MM-dd HH:mm:ss";var d=a.getHours(),f=Math.floor((a.getMonth()+3)/3),d={"y+":a.getFullYear(),"M+":a.getMonth()+1,"d+":a.getDate(),"h+":0==d%12?12:d%12,"H+":d,"m+":a.getMinutes(),"s+":a.getSeconds(),"w+":b.getWeek(a),"q+":f,"Q+":["\u4e00","\u4e8c","\u4e09","\u56db"][f-1],"S+":a.getMilliseconds()},e;for(e in d)RegExp("("+e+")").test(c)&&(f=RegExp.$1.length,c=c.replace(RegExp.$1,
1==f?d[e]:("00"+d[e]).slice(-f)));return c},parseDate:function(a,c){var d=typeof a,f=new g;if("number"==d)return f.setTime(a),f;if("string"!=d)return a;var d=(c||"yyyy-MM-dd HH:mm:ss").match(/[a-zA-Z]+/g),e=a.match(/\d+/g);if(e){f.setDate(1);for(var j=0;j<e.length;j++){var k=d[j],m=parseInt(e[j]);switch(k){case "yyyy":f.setFullYear(m);break;case "MM":f.setMonth(m-1);break;case "dd":k=b.getDaysInMonth(f);m>k&&(m=k);f.setDate(m);break;case "HH":f.setHours(m);break;case "mm":f.setMinutes(m);break;case "ss":f.setSeconds(m);
break;case "SS":f.setMilliseconds(m)}}return f}},now:function(a){var c=new g;if(a)"number"!=typeof a&&(a=b.parseDate(a).getTime()),e=a-c.getTime();else return c.setTime(c.getTime()+e),c},howLong:function(a,c){if(a){a=b.parseDate(a);var d=b.now().getTime()-a.getTime();if(!1!=c){var f;if(60>(d/=6E4))f="\u5206\u949f",d=d||1;else if(24>(d/=60))f="\u5c0f\u65f6";else if(30>(d/=24))f="\u5929";else return"30\u5929\u524d";d=(Math.floor(d)||1)+f+"\u524d"}return d}}},e=0;return b});
...
a)return-1;var b=0,d=a.length;if(c)if("number"==typeof c)b=0>c?Math.max(0,d+c):c;else return b=h.sortedIndex(a,f),a[b]===f?b:-1;var e=Array.prototype.indexOf;if(e&&a.indexOf===e)return a.indexOf(f,c);for(;b<d;b++)if(a[b]===f)return b;return-1},find:function(a,f,c){var b;this.some(a,function(a,d,e){if(f.call(c,a,d,e))return b=a,!0});return b},filter:function(a,f,c){var d=[];if(null==a)return d;var e=Array.prototype.filter;if(e&&a.filter===e)return a.filter(f,c);b.each(a,function(a,b,e){f.call(c,b,
a,e)&&d.push(b)});return d},where:function(a,f){return this.filter(a,d(f))},findWhere:function(a,f){return this.find(a,d(f))},invoke:function(a,f){var c=Array.prototype.slice.call(arguments,2),b=g.isFunc(f);return this.map(a,function(a){return(b?f:a[f]).apply(a,c)})},sortedIndex:function(a,f,b,d){b=c(b);f=b.call(d,f);for(var e=0,h=a.length;e<h;){var g=e+h>>>1;b.call(d,a[g])<f?e=g+1:h=g}return e},sortBy:function(a,f,b){f=c(f);return this.pluck(this.map(a,function(a,c,d){return{value:a,index:c,criteria:f.call(b,
a,c,d)}}).sort(function(a,f){var c=a.criteria,b=f.criteria;if(c!==b){if(c>b||void 0===c)return 1;if(c<b||void 0===b)return-1}return a.index-f.index}),"value")},groupBy:f(function(a,f,c){a[f]?a[f].push(c):a[f]=[c]}),countBy:f(function(a,f){a[f]?a[f]++:a[f]=1})};return h});
...
handy.add("Template",["B.Object","B.String","B.Debug","B.Function"],function(g,b,e){function a(a){var f=typeof a;"string"!==f&&(a="number"===f?a+"":"");return a}function c(a,f){var c=f.fn,b="";if(a){if(void 0!==a.length)for(var d=0,e=a.length;d<e;d++)b+=c(a[d]);else for(d in a)b+=c(a[d]);return b}}function d(a,f){var c=f.fn,b=[];if(a){if(void 0!==a.length)for(var d=0,e=a.length;d<e;d++)b.push(c(a[d]));else for(d in a)b.push(c(a[d]));return b.join("")}}function f(a){a=a.replace(/("|\\)/g,"\\$1").replace(/\r/g,
"\\r").replace(/\n/g,"\\n");return p?"$r+="+('"'+a+'"')+";":"$r.push("+('"'+a+'"')+");"}function h(a,f){f=f||{};var c=a.exp.replace(/"/g,"'"),c=b.trim(c).replace(/\s{2,}/g," "),d=f.helpers,e=d&&d.parseValue,h=a.blockName,g=a.children,j=a.num,q,n="\nif($tmp||$tmp===0){"+(p?"$r+=$tmp;":"$r.push($tmp);")+"}";q=(a.inverse?"inverse:true,":"")+"num:"+j+',context:$me,exp:"'+c+'",helpers:$helpers,data:$data}';d=d&&d.getValue?'$helpers.getValue.call($me,"'+c+'",$data,{'+q+")":"($data&&$data."+c+")";h?(c="$program"+
j,q='$tmp = $helpers["'+h+'"].call($me,'+d+", {fn:"+c+","+q+");"+n,g&&(n=k(g,f),n=t[0]+"\n"+n.join("\n")+"\n"+t[1],l.splice(2,0,"\nfunction "+c+"($data){\n"+n+"\n}\n"))):((g=c.match(/([^\s]+)\s([^\n]+)/))?(c=g[1],q="if (helper = $helpers."+c+') {\n$tmp = helper.call($me,"'+g[2]+'",{'+q+'); \n}else{$tmp="";}'):q="if (helper = $helpers."+c+') {\n$tmp = helper.call($me,"",{'+q+"); \n}else{\nhelper = "+d+"; $tmp = typeof helper === functionType ? helper.call($me,{"+q+") : helper;\n}"+(e?"\n$tmp=$helpers.parseValue.call($me,$tmp,{"+
q+");":m.isEscape?"\n$tmp=escape($tmp);":""),q+=n);return q}function j(a,f){if(a){var c=f||{},b=m.openTag,d=m.closeTag,h,g;c.children?g=c.children:c.children=g=[];if(0<=(h=a.indexOf(b))){var k=a.substring(0,h);k&&g.push({html:k});a=a.substring(h+b.length);if(0==a.indexOf("#"))if(a=a.substring(1),k=a.match(/^[a-z]+/)){var q=k[0];h=a.indexOf(d);k=a.substring(q.length+1,h);a=a.substring(h+d.length);k={num:++s,blockName:q,exp:k};g.push(k);var l=b+"/"+q+d;a:{h=a;for(var d=RegExp(b+"[#/]"+q+"((?!"+d+").)*"+
d,"ig"),n=0;b=d.exec(h);)if(b[0]==l)if(0==n){h=b.index;break a}else n--;else n++;h=-1}if(-1==h){e.error("\u672a\u627e\u5230\u5757\u7ed3\u675f\u4f4d\u7f6e:"+l);return}b=a.substring(0,h);a=a.substring(h+l.length);j(b,k);if("if"==q){q=k.children;l=0;for(b=q.length;l<b;l++)d=q[l],"else"==d.exp&&(d.exp=k.exp,d.blockName="if",d.num=++s,d.inverse=!0,d.children=q.slice(l+1),g.push(d),k.children=q.slice(0,l))}}else{e.error("\u627e\u4e0d\u5230\u8f85\u52a9\u51fd\u6570:"+a);return}else h=a.indexOf(d),g.push({num:++s,
exp:a.substring(0,h)}),a=a.substring(h+d.length);j(a,c)}else a&&g.push({html:a});return c}}function k(a,c){var b=[];if(a)for(var d=0,e=a.length;d<e;d++){var g=a[d];g.html?b.push(f(g.html)):g.exp&&b.push(h(g,c))}return b}var m={openTag:"{{",closeTag:"}}",isTrim:!0,isEscape:!1,getIfPlusJoin:function(){return p},registerHelper:function(a,f,c){g.isObj(f)?(q[a]||(q[a]={}),g.extend(q[a],f)):q[a][f]=c},tmpl:function(a,f,c){var b,d,h;if("string"==typeof a)b=a;else if(void 0!==a.length)b=a.join("");else if(b=
a.tmpl,h=a.id)if(n[h])d=n[h];else if(!b){var p=document.getElementById(h);p&&(b=(p.value||p.innerHTML).replace(/\s/g,""))}if(!d){if(!b){e.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}a:{var p=m.openTag,y=m.closeTag;b=b.replace(RegExp(p+"!((?!"+y+").)*"+y,"ig"),"");m.isTrim&&(b=b.replace(/^[\s\n]+/,"").replace(/[\s\n]+$/,"").replace(RegExp("("+y+"|\\>)(\\s|\\n)+(?=("+p+"|<))","ig"),"$1").replace(RegExp(y+"[\\s\\n]+([^\\n]+)[\\s\\n]+(?=("+p+"|<))","ig"),y+"$1"));l=[t[0]];l.push('var escape=$helpers.escape,functionType="function",$me=this;');
var p=a&&a.ns,r;p?(r=g.extend({},q["default"]),r=g.extend(r,q[p])):r=q["default"];a.helpers=r;b=j(b);s=0;a=k(b.children,a);l=l.concat(a);l.push(t[1]);a=l.join("\n");try{var v=window.Function.apply(null,["$T","$helpers","$data",a]);d=function(a,f){return v.call(f||a,m,r,a)};break a}catch(A){e.log(a),e.error(A)}d=void 0}h&&(n[h]=d)}if(f)try{return d(f,c)}catch(J){e.log(d.toString()),e.error(J)}else return d}},n={},l,p="".trim,s=0,t=["var $r="+(p?'""':"[]")+",$tmp,helper;","return "+(p?"$r;":'$r.join("");')],
q={"default":{"if":function(a,f){var c=f.data;g.isFunc(a)&&(a=a.call(c));if(a&&!f.inverse||!a&&f.inverse)return f.fn(c)},unless:function(a,f){f.inverse=!0;return f.helpers["if"].call(this,a,f)},each:p?c:d,escape:function(f){return b.encodeHTML(a(f))},trim:b.trim}};return m});
...
h=0,j=document,k,m,n=j.documentMode,l="onhashchange"in window&&(void 0===n||7<n),p={delay:50,listen:function(g,m){if(!f&&!f)if(f=!0,p.listeners={},l)$(window).on("hashchange",function(){d(b.getHash())});else k=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(j.body)[0],$(k).one("load",function(){a(b.getHash());setInterval(c,p.delay)});if(m in p.listeners)$D.error(Error("Duplicate name"));else return m=m||e.expando+ ++h,p.listeners[m]=g,m},unListen:function(a){for(var f in p.listeners)(!a||
...
equalTo:"\u8bf7\u8f93\u5165\u76f8\u540c\u7684{name}",min:"{name}\u4e0d\u80fd\u5c0f\u4e8e{0}",max:"{name}\u4e0d\u80fd\u5927\u4e8e{0}",range:"{name}\u8981\u5728{0}\u5230{1}\u4e4b\u95f4",maxlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u8d85\u8fc7{0}",minlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u5c11\u4e8e{0}",rangelength:"{name}\u957f\u5ea6\u8981\u5728{0}\u5230{1}\u4e4b\u95f4"},valid:function(a,c){var b=c.rules,f;for(f in b){var h=b[f],g=("function"==typeof h?h:e[f])(a,h);if(!g)return b=c.error||e.error,f=c.messages&&
c.messages[f]||e.messages[f],f=f.replace(/\{([^\}]+)\}/g,function(a,f){return h[f]||0==f&&h||c[f]||h||""}),b&&b(f),g}return!0},required:function(a){return 0<g.trim(""+a).length},email:function(a){return/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a)},
...
$Define("CM.DataStore",function(){var g=$H.createClass();$H.extend(g.prototype,{get:function(e,a){var c;if(c=b[e])return a?$H.where(c,a):c},push:function(e,a){"string"!=typeof e&&(a=e,e=null);var c=a.constructor.$ns;(b[c]||(b[c]=[])).push(a);e&&(b[e]||(b[e]=a))}});var b={};$S=$H.getSingleton(g);return g});
...
$Define("CM.Model",["CM.AbstractDao","CM.AbstractEvents","CM.DataStore"],function(g,b){return b.derive({idAttribute:"id",_pending:!1,_validate:function(b,a){if(!a.validate||!this.validate)return!0;b=$H.extend({},this._attributes,b);var c=this.validationError=this.validate(b,a)||null;if(!c)return!0;this.trigger("invalid",this,c,$H.extend(a,{validationError:c}));return!1},_doDepends:function(b,a){var c=this.fields,d,f,h={},g;for(g in c)if((d=c[g])&&(f=d.depends))for(d=0;d<f.length;d++)if(b.hasOwnProperty(f[d])){h[g]=
0;break}this.set(h,null,{silent:a})},_parseFields:function(b){var a;if(!(a=this.fields))return b;var c,d,f,h={},g;for(g in b){d=b[g];if(c=a[g]){f=c.type;if(c=c.parse)d=c.apply(this,[d,b]);$H.isStr(f)&&("Date"==f?d=$H.parseDate(d):0<f.indexOf(".")&&(f=$H.ns(f)));$H.isClass(f)&&(!(d instanceof f)&&!this.get(g))&&(d=new f(d),d.on("all",$H.bind(this._onAttrEvent,this,g)))}h[g]=d}return h},_onAttrEvent:function(b,a){if(!("invalid"==a||"sync"==a)){var c=this.get(b);0!=a.indexOf("change:")&&(this.trigger("change:"+
b,this,c),this.trigger("change",this))}},initialize:function(b,a){this.callSuper();this.uuid=$H.uuid();this.dao=this.dao||$H.getSingleton(g);var c=b||{};a||(a={});this.cid=$H.Util.uuid();this._attributes={};a.collection&&(this.collection=a.collection);a.parse&&(c=this.parse(c,a)||{});c=$H.extendIf(c,this.getDefaults());this.set(c,a);this._changed={};$S.push(this)},getDefaults:function(){var b={},a;if(a=this.fields)for(var c in a){var d=a[c];b[c]=d&&$H.isObj(d)?d.def:d}return b},toJSON:function(){return $H.clone(this._attributes)},
sync:function(b,a,c){return this.dao.sync(b,a,c)},get:function(b){return this._attributes[b]},escape:function(b){return $H.String.escapeHTML(this.get(b))},has:function(b){b=this.get(b);return null!==b&&void 0!==b},set:function(b,a,c){var d;"object"===typeof b?(d=b,c=a):(d={})[b]=a;c||(c={});d=this._parseFields(d);if(!this._validate(d,c))return!1;var f=c.unset;b=c.silent;var h={},g=this._changing;this._changing=!0;g||(this._previousAttributes=$H.Object.clone(this._attributes),this._changed={});var k=
this._attributes,m=this._previousAttributes;this.idAttribute in d&&(this.id=d[this.idAttribute]);for(var n in d){a=d[n];var l=k[n];l&&$H.isInstance(l)?f?l.reset():l.set(a):($H.equals(k[n],a)||(h[n]=a),$H.equals(m[n],a)?delete this._changed[n]:this._changed[n]=a,f?delete k[n]:k[n]=a)}a=!$H.isEmpty(h);if(!b){a&&(this._pending=c);for(var p in h)this.trigger("change:"+p,this,k[p],c)}if(g)return this;if(!b)for(;this._pending;)c=this._pending,this._pending=!1,this.trigger("change",this,c);this._changing=
this._pending=!1;a&&this._doDepends(h,b);return this},unset:function(b,a){a=a||{};a.unset=!0;return this.set(b,void 0,a)},clear:function(b){var a={},c;for(c in this._attributes)a[c]=void 0;b=b||{};b.unset=!0;return this.set(a,b)},each:function(b){$H.each(this._attributes,b)},hasChanged:function(b){var a=this._changed;return null==b?!$H.isEmpty(a):$H.contains(a,b)},changedAttrbutes:function(b){if(!b)return this.hasChanged()?$H.clone(this._changed):!1;var a,c=!1,d=this._changing?this._previousAttributes:
this._attributes,f;for(f in b)if(!$H.equals(d[f],a=b[f]))(c||(c={}))[f]=a;return c},previous:function(b){return null==b||!this._previousAttributes?null:this._previousAttributes[b]},fetch:function(b){var a=this;a.fetching=!0;b=b?$H.clone(b):{};void 0===b.parse&&(b.parse=!0);var c=b.success,d=b.beforeSet;b.success=function(f){a.fetching=!1;if(!(d&&!1==d(a,f,b))){if(!a.set(a.parse(f,b),b))return!1;c&&c(a,f,b);a.trigger("sync",a,f,b)}};a.sync("read",a,b)},save:function(b,a,c){var d=this,f;null==b||"object"===
typeof b?(f=b,c=a):(f={})[b]=a;$H.isFunc(c)&&(c={success:c});c=$H.extend({validate:!0},c);if(f&&c.now){if(!d.set(f,c))return!1}else if(!d._validate(f,c))return!1;void 0===c.parse&&(c.parse=!0);var h=c.success;c.success=function(a){var b=d.parse(a,c);c.now||(b=$H.extend(f||{},b));if($H.isObj(b)&&!d.set(b,c))return!1;h&&h(d,a,c);d.trigger("sync",d,a,c)};b=d.isNew()?"create":c.update?"update":"patch";if("patch"===b){if(a=d.changedAttrbutes(f),!a){h&&h(d,c);return}}else a=$H.extend({},d._attributes),
a=$H.extend(a,f);for(var g in a)$H.isInstance(a[g])&&delete a[g];c.attrs=a;d.sync(b,d,c)},destroy:function(b){var a=this;b=b?$H.clone(b):{};var c=b.success,d=function(){a.trigger("destroy",a,a.collection,b);a.off("all")};b.success=function(f){(!b.now||a.isNew())&&d();c&&c(a,f,b);a.isNew()||a.trigger("sync",a,f,b)};if(a.isNew())return b.success(),!1;a.sync("delete",a,b);b.now&&d()},getUrl:function(){var b=$H.result(this,"url")||$H.result(this.collection,"url");b||$D.error(Error("\u5fc5\u987b\u8bbe\u7f6e\u4e00\u4e2aurl\u5c5e\u6027\u6216\u8005\u51fd\u6570"));
return this.isNew()?b:b.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(b){return b.code&&b.data?b.data:b},clone:function(){return new this.constructor(this._attributes)},isNew:function(){return void 0===this.id},isValid:function(b){return this._validate({},$H.extend(b||{},{validate:!0}))}})});
$Define("CM.Collection",["CM.AbstractDao","CM.AbstractEvents","CM.Model","CM.DataStore"],function(g,b,e){var a=b.derive({model:e,_reset:function(){this.length=0;this._models=[];this._byId={}},_prepareModel:function(a,b){if(a instanceof e)return a;b=b?$H.clone(b):{};b.collection=this;var c;if(b.id&&(c=(c=$S.get(this.model.$ns,{id:b.id}))&&c[0]))return c.set(a,b),c;c=new this.model(a,b);if(!c.validationError)return c;this.trigger("invalid",this,c.validationError,b);return!1},_addReference:function(a){this._byId[a.cid]=
...
this.dao=this.dao||$H.getSingleton(g);b||(b={});b.model&&(this.model=b.model);b.url&&(this.url=b.url);void 0!==b.comparator&&(this.comparator=b.comparator);this._reset();a&&this.reset(a,$H.extend({silent:!0},b))},toJSON:function(a){return $H.map(this._models,function(b){return b.toJSON(a)})},sync:function(a,b,c){return this.dao.sync(a,b,c)},add:function(a,b){b=$H.extend({add:!0,remove:!1,merge:!1},b);return this.set(a,b)},remove:function(a,b){var c=!$H.isArr(a);a=c?[a]:$H.clone(a);b||(b={});var e,
g,m,n;e=0;for(g=a.length;e<g;e++)if(n=a[e]=this.get(a[e]))delete this._byId[n.id],delete this._byId[n.cid],m=this.indexOf(n),this._models.splice(m,1),this.length--,b.silent||(b.index=m,n.trigger("remove",n,this,b)),this._removeReference(n,b);return c?a[0]:a},set:function(a,b){if(a){b=$H.extend({add:!0,remove:!0,merge:!0},b);b.parse&&(a=this.parse(a,b));var c=!$H.isArr(a),g=c?a?[a]:[]:$H.clone(a),k,m,n,l,p,s,t,q=b.at,G=this.model,B=this.comparator&&null==q&&!1!==b.sort,I="string"==typeof this.comparator?
this.comparator:null,w=[],z=[],u={},x=b.add,y=b.merge,r=b.remove,v=!B&&x&&r?[]:!1;k=0;for(m=g.length;k<m;k++){p=g[k]||{};n=p instanceof e?l=p:p[G.prototype.idAttribute||"id"];if(s=this.get(n))r&&(u[s.cid]=!0),y&&(p=p===l?l.attributes:p,b.parse&&(p=s.parse(p,b)),s.set(p,b),B&&(!t&&s.hasChanged(I))&&(t=!0)),g[k]=s;else if(x){b.id=n;l=g[k]=this._prepareModel(p,b);if(!l)continue;w.push(l);this._addReference(l,b)}l=s||l;v&&(l.isNew()||!u[l.id])&&v.push(l);u[l.id]=!0}if(r){k=0;for(m=this.length;k<m;++k)u[(l=
this._models[k]).cid]||z.push(l);z.length&&this.remove(z,b)}if(w.length||v&&v.length)if(B&&(t=!0),this.length+=w.length,null!=q){k=0;for(m=w.length;k<m;k++)this._models.splice(q+k,0,w[k])}else{v&&(this._models.length=0);n=v||w;k=0;for(m=n.length;k<m;k++)this._models.push(n[k])}t&&this.sort({silent:!0});if(!b.silent){k=0;for(m=w.length;k<m;k++)(l=w[k]).trigger("add",l,this,b);(t||v&&v.length)&&this.trigger("sort",this,b)}return c?g[0]:g}},each:function(a){$H.each(this._models,a)},reset:function(a,
b){b||(b={});for(var c=0,e=this._models.length;c<e;c++)this._removeReference(this._models[c],b);b.previousModels=this._models;this._reset();a&&(a=this.add(a,$H.extend({silent:!0},b)));b.silent||this.trigger("reset",this,b);return a},push:function(a,b){return this.add(a,$H.extend({at:this.length},b))},pop:function(a){var b=this.at(this.length-1);this.remove(b,a);return b},unshift:function(a,b){return this.add(a,$H.extend({at:0},b))},shift:function(a){var b=this.at(0);this.remove(b,a);return b},slice:function(){return Array.prototype.slice.apply(this._models,
...
this._models=this.sortBy(this.comparator,this):this._models.sort($H.Function.bind(this.comparator,this));a.silent||this.trigger("sort",this,a);return this},pluck:function(a){return $H.invoke(this._models,"get",a)},getUrl:function(){return this.url},fetch:function(a){var b=this;a=a?$H.clone(a):{};void 0===a.parse&&(a.parse=!0);var c=a.success,e=a.beforeSet;a.success=function(g){e&&!1==e(b,g,a)||(b[a.reset?"reset":a.add?"add":"set"](g,a),c&&c(b,g,a),b.trigger("sync",b,g,a))};return b.sync("read",b,
a)},create:function(a,b){var c=this;b=b?$H.clone(b):{};if(!(a=c._prepareModel(a,b)))return!1;b.now&&c.add(a,b);var e=b.success;b.success=function(a,d){b.now||c.add(a,b);e&&e(a,d,b)};a.save(null,b);return a},parse:function(a){return a.data},clone:function(){return new this.constructor(this._models)}}),c=$H.Array;$H.each("map some every find filter invoke indexOf".split(" "),function(b,f){a.prototype[f]=function(){var a=Array.prototype.slice.call(arguments);a.unshift(this._models);return c[f].apply(c,
a)}});$H.each(["sortBy","groupBy","countBy"],function(b){a.prototype[b]=function(a,e){var g=$H.isFunc(a)?a:function(b){return b.get(a)};return c[b](this._models,g,e)}});return a});
...
{};this._bindElNums={};this.callSuper()},doConfig:function(){this.callSuper();var a=this.modelClass||e;this.model||(this.model=new a(this.data));this.xmodel=this.model},preTmpl:function(){var a=this.tmpl;$H.isArr(a)&&(a=a.join(""));var b=n.test(a),c="#js-"+this.manager.type+" #js-"+this.xtype;if(b){if(b=a.match(l)[1])s.test(a)||(b=b.replace(/([^\s]+)/g,"#$1")),c+=" "+b;a=a.replace(l,"")}c=' id=this._id class="'+c+'"';this.tmpl=a=p.test(a)?a.replace(t,"$1"+c):a.replace(m,"$1 {{bindAttr"+c+"}}")},getTmplFn:function(){var a=
this.tmpl,b=this.constructor;if(!$H.isFunc(a)&&!$H.isFunc(a=b.tmpl))this.preTmpl(),a=b.tmpl=$H.tmpl({tmpl:this.tmpl,ns:"ModelView"});return this.tmpl=a},getHtml:function(){return this.html?this.html:this.html=this.getTmplFn()(this.xmodel,this)},ifBind:function(b,c,f){if(!f&&"el"==this.bindType||f&&"model"==this.bindType)return!1;f=f?this._bindElNums:this._bindModelNums;c=!f[b]&&(c&&(c instanceof e||c instanceof a)||!c);f[b]=1;return c},updateMetaMorph:function(a,b,c){if("append"==c)$("#metamorph-"+
a+"-end").before(b);else{var f=$("#metamorph-"+a+"-start");if(0!=f.length){a="metamorph-"+a+"-end";for(var d=f[0].nextSibling,e;d&&d.id!=a;)e=$(d),d=d.nextSibling,e.remove();void 0!==b&&f.after(b);"remove"==c&&(f.remove(),$(d).remove())}}},wrapMetaMorph:function(a,b){return'<script id="metamorph-'+a+'-start" type="text/x-placeholder">\x3c/script>'+(void 0===b?"":b)+'<script id="metamorph-'+a+'-end" type="text/x-placeholder">\x3c/script>'},get:function(a){return this.xmodel.get(a)},set:function(a,
b){this.xmodel.set(a,b)},update:function(a){this.xmodel.set(a)},getXmodel:function(){return this.xmodel}});g.registerHelper("ModelView",{"if":function(a,b){var c=b.context,f=b.data,d=b.exp;$H.isFunc(a)&&(a=a.call(f));var e;if(a&&!b.inverse||!a&&b.inverse)e=b.fn(f);var g=b.num,h=c.getCid()+"-"+g;c.ifBind(g,f)&&c.listenTo(f,"change:"+d,function(a,f,e){var g;if(e&&!b.inverse||!e&&b.inverse)a={},a[d]=e,g=b.fn(a);c.updateMetaMorph(h,g)});return c.wrapMetaMorph(h,e)},unless:function(a,b){b.inverse=!0;return b.helpers["if"].call(this,
a,b)},each:function(b,c){var f=c.context,d=c.fn,e=j?"":[],g=c.num,h=f.getCid()+"-"+g;if(b){var k;if(b instanceof a)b.each(function(a,b){k=f.wrapMetaMorph(h+"-"+b.uuid,d(b));j?e+=k:e.push(k)}),f.ifBind(g,b)&&(f.listenTo(b,"add",function(a,b,c,e){a=f.wrapMetaMorph(h+"-"+b.uuid,d(b));(e=e.at)?(c=c.at(e-1),$("#metamorph-"+(h+"-"+c.uuid)+"-end").after(a)):$("#metamorph-"+h+"-end").before(a)}),f.listenTo(b,"remove",function(a,b){f.updateMetaMorph(h+"-"+b.uuid,"","remove")}));else if(void 0!==b.length)for(var m=
0,g=b.length;m<g;m++)k=f.wrapMetaMorph(h+"-"+m,d(b[m])),j?e+=k:e.push(k);else for(m in b)k=f.wrapMetaMorph(h+"-"+m,d(b[m])),j?e+=k:e.push(k);return f.wrapMetaMorph(h,j?e:e.join(""))}},getValue:c,parseValue:function(a,b){var c=b.context,f=b.data,d=b.exp,e=g.isEscape,h=b.helpers,j=b.num,k=c.getCid()+"-"+j;c.ifBind(j,f)&&c.listenTo(f,"change:"+d,function(a,b,f){e&&(f=h.escape(f));c.updateMetaMorph(k,f)});e&&(a=h.escape(a));return c.wrapMetaMorph(k,a)},bindAttr:d,input:function(a,b){b.type="input";return"<input "+
d(a,b)+"/>"},textarea:function(a,b){b.type="textarea";return"<textarea "+d(a,b)+">"+b.value+"</textarea>"}});var j=g.getIfPlusJoin(),k=/((\w+)=['"]?)?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/g,m=/[^<]*(<[a-zA-Z]+)/,n=/^[^>]+class=/,l=/class=['"]?([#\w][\s\w\.\?:#-]*)(['"]?)(?!\w*=)/,p=/^[^>]+{{bindAttr/,s=/^[^>]+{{bindAttr((?!}}).)class=/,t=/({{bindAttr)/;return b});
...
_applyArray:function(a,b){var c=this,d=arguments,e=d.callee.caller,g=e.$owner.prototype;0==d.length?(d=e.arguments,d=$H.toArray(d),a=e.$name,b=d.shift()):d=$H.toArray(d,2);return $H.isArr(b)?($H.each(b,function(b,e){g[a].apply(c,[e].concat(d))}),!0):!1},initialize:function(){this.items=[];this.children=[];this.callSuper()},doConfig:function(a){var b=this;if(!b.configed){b.configed=!0;b.initParam=a;"string"==typeof a&&(a={text:a});var c=a||{};$H.extend(b,c,{notCover:function(a,f){var d;if(d=/^{{(((?!}}).)+)}}$/.exec(f))d=
d[1],(b.refModelAttrs||(b.refModelAttrs={}))[d]=a;d=$H.contains(b._customEvents,a);if($H.contains(b._defaultEvents,a))return b.listeners.push({name:a,handler:c[a]}),!0;if(d)return b.on(a,c[a]),!0;if("defItem"==a)return b[a]=$H.extend(b[a],f),!0;if("listener"==a)return b.listeners=b.listeners.concat($H.isArr(f)?f:[f]),!0;if("items"==a)return b.add(f),!0;if("extCls"==a&&b[a])return b[a]+=" "+f,!0;if("xtype"==a)return"View"==b[a]&&(b[a]="string"==typeof f?f:f.$ns),!0}});if(a=c.renderTo){if($H.isFunc(a))a=
a.call(b);else if($H.isStr(a)&&0==a.indexOf(">")){var d=b.parent;a=d.inited&&d.findEl(a.substring(1))}else a=$(a);b.renderTo=a}else b.renderTo=$(document.body);if(a=b.getRefModel()){var d=b.refModelAttrs,g;for(g in d)b[d[g]]=a.get(g)}g=b.xConfig;a=b.modelClass;if(!a&&!(a=b.constructor.modelClass))a=g?e.derive({fields:g}):e,a=b.constructor.modelClass=a;var n={};$H.each(g,function(a){var c=b[a];void 0!==c&&(n[a]=c)});b.xmodel=new a(n);b.bindRefModel()}},getHtml:function(){this.getId();var a,b=this.extCls||
...
b){var c=b.context,d=b.num,e=c.getCid()+"-"+d,g=c.findHtml(a);if(c.ifBind(d))c.on("add",function(b,d){d.match(a)&&(c.updateMetaMorph(e,d.getHtml(),"append"),d.afterRender())});return c.wrapMetaMorph(e,g)}});c=/[^<]*(<[a-zA-Z]+)/;return d});$Define("C.ComponentManager",["CM.AbstractManager","CM.ViewManager"],function(g,b){var e=g.derive({type:"component",initialize:function(){var a=$H.getSingleton(b);this._types=a._types;this._all=a._all}});$CM=new e;return e});
...
hide:function(){!1!=this.callSuper()&&(this.noMask||this.unmask(),this.destroyWhenHide&&this.destroy())},top:function(){this.getEl().css({left:"80px",top:"8px",position:"fixed"})},center:function(){var a=this.getEl(),b=this.width||a.outerWidth(),d=this.height||a.outerHeight(),f=document,b=((f.documentElement.offsetWidth||f.body.offsetWidth)-b)/2,d=((f.documentElement.clientHeight||f.body.clientHeight)-d)/2+(f.documentElement.scrollTop||f.body.scrollTop),d=10>d?window.screen.height/2-200:d;a.css({left:b+
"px",top:d-(this.offsetTop||0)+"px"})},followEl:function(a){a=a||this.parent.getEl();a=$H.position(a[0]);this.getEl().css(a)},mask:function(){e||(e=$('<div class="hui-mask" style="display:none;"></div>').appendTo(document.body));e.css("z-index",1E3*b+998);0==b&&e.show();b++},unmask:function(){b--;0==b?e.hide():e.css("z-index",1E3*(b-1)+998)}});return g});
...
"]");0<e.length&&(e=e[0].index(),this.onItemClick(b,e))}}],doConfig:function(){var b=this;b.callSuper();"h"==b.get("direction")&&b.listen({name:"afterRender add remove",custom:!0,handler:function(){b.layout()}})},parseItem:function(b){b.extCls=(b.extCls||"")+"js-item"},layout:function(){if(this.rendered){var b=this.children.length,e=Math.floor(100/b);this.findEl("> .js-item").each(function(a,c){c.style.width=a<b-1?e+"%":100-e*(b-1)+"%"})}},select:function(b){if(!this.notSelect&&(b="number"==typeof b?
this.children[b]:"string"==typeof b?this.find(b)[0]:b))if(!this.multi&&!b.multi){var e=this.getSelected();e&&this.selectItem(e,!1);this.selectItem(b)}else this.selectItem(b,!b.get("selected"))},getSelected:function(b){var e=[];this.each(function(a,c){if(c.get(c.select?"selected":"isActive"))e.push(b?a:c)});return 0<e.length?this.multi?e:e[0]:null},selectItem:function(b,e){(e=!1!=e)?b.select?b.select():b.active():b.select?b.select(e):b.unactive()},val:function(b){var e=this;if(b){var a=(""+b).split(",");
e.each(function(b,d){$H.contains(a,d.get("value"))?e.selectItem(d,!0):e.selectItem(d,!1)})}else return a=[],e.each(function(b,d){d.get("selected")&&a.push(d.value)}),a.join(",")},onItemClick:function(b,e){this.select(e);this.itemClick&&this.itemClick(this.children[e],e)}});return g});
...
handler:function(){this.showOptions()}}],doConfig:function(b){var e=this;e.callSuper();for(var a=b.options,c=!1,d=0,f=a.length;d<f;d++){var g=a[d];if(g.value==b.value){e.set("text",g.text);c=g.selected=!0;break}}c||delete e.value;e.add({itemClick:function(a){a=a.get("value");e.val(a)},width:e.optionWidth||e.width,items:a})},showOptions:function(){this.children[0].show()},val:function(b){if(b){if(this.get("value")!=b){var e=this.children[0],a=e.find("> [value="+b+"]");0<a.length&&(a=a[0],this.set("value",
b),this.txt(a.get("text")),e.select(a),this.trigger("change"))}}else return this.get("value")}});return g});
...
listeners:[{name:"focus",el:".js-input",handler:function(){this.getEl().addClass("hui-focus")}},{name:"blur",el:".js-input",handler:function(){this.getEl().removeClass("hui-focus")}}],doConfig:function(b){var e=this;"search"==b.type&&(e.icon="search");e.callSuper();b.isTextarea&&e.listeners.push({name:"input propertychange",el:".js-input",handler:function(){var a=e.findEl(".js-input"),b=a[0].scrollHeight;50<=b&&a.css("height",b)}});e.withClear&&e.add({xtype:"Button",radius:"big",icon:"delete",click:function(){this.parent.findEl("input").val("").focus()}})},
parseItem:function(b){"Icon"==b.xtype?this.get("iconPos")||this.set("iconPos","left"):"Button"==b.xtype&&(this.get("btnPos")||this.set("btnPos","right"))},val:function(b){var e=this.findEl("input,textarea");if(b)e.val(b);else return e.val()},focus:function(){this.findEl("input").focus()}});return g});
...
doConfig:function(b){this.callSuper();var e=this.get("text");!e&&0!==e&&this.set("text","&nbsp;");void 0!==this.text&&void 0===this.underline&&this.set("underline",!0);b.click&&void 0===this.hasArrow&&this.set("hasArrow",!0)}});return g});$Define("C.Set","C.AbstractComponent",function(g){g=g.define("Set");g.extend({xConfig:{cls:"set",title:""},tmpl:'<div><h1 class="hui-set-title">{{title}}</h1><div class="hui-set-content">{{placeItem}}</div></div>'});return g});
$Define("C.Field","C.AbstractComponent",function(g){g=g.define("Field");g.extend({xConfig:{cls:"field",noPadding:!1},defItem:{xtype:"RowItem",xrole:"content"},tmpl:'<div {{bindAttr class="noPadding?hui-field-nopadding"}}><div class="hui-field-left">{{placeItem > [xrole=title]}}</div><div class="hui-field-right">{{placeItem > [xrole=content]}}</div></div>',doConfig:function(b){var e=b.title;$H.isSimple(e)&&(e={text:e});e=$H.extend({xtype:"Label",xrole:"title"},e);this.add(e);e=b.content;void 0===e&&
!b.items&&(e="");$H.isSimple(e)&&(e={text:e,underline:!0});e&&(this.noPadding=!0,this.add(e));b=$.extend({},b);delete b.title;delete b.content;this.callSuper([b])}});return g});$Define("C.Form","C.AbstractComponent",function(g){g=g.define("Form");g.extend({xConfig:{cls:"form"},tmpl:'<div><form action=""><div class="hui-form-tips c-txt-error"></div>{{placeItem}}</form></div>'});return g});
...
$Define("C.Tips",["C.AbstractComponent","C.Popup","C.ControlGroup"],function(g,b){var e=g.define("Tips",b);e.extend({xConfig:{cls:"tips",text:"",radius:"normal",tType:"big",theme:"black"},timeout:2E3,tmpl:'<div {{bindAttr class="text:hui-tips-notxt"}}>{{placeItem}}{{#if text}}<span class="hui-tips-txt">{{text}}</span>{{/if}}</div>',doConfig:function(a){"loading"==a.type?$H.extend(this,{text:"\u6b63\u5728\u52a0\u8f7d\u4e2d...",timeout:null,noMask:!0,icon:"loading"}):"miniLoading"==a.type?$H.extend(this,
{showPos:"top",clickHide:!1,destroyWhenHide:!1,timeout:null,delayShow:!1,shadowOverlay:null,theme:null,noMask:!0,tType:"mini",items:{xtype:"Icon",name:"loading-mini",hasBg:!1}}):"topTips"==a.type&&$H.extend(this,{showPos:"top",noMask:!0,tType:"mini"});this.callSuper()}});return e});
...
$Define("C.DatePicker",["C.AbstractComponent","C.Dialog"],function(g,b){function e(a,b,f,e,g){for(a={xtype:"Select",xrole:"dialog-content",name:"dialogSelect",value:a,width:50,cClass:e,optionWidth:100,iconPos:"bottom",extCls:"hui-dp-"+e,options:[],defItem:{showPos:"center"},change:function(){var a=this.parent,b=a.val(!0);if("month"==this.cClass){var b=$H.getDaysInMonth(b),c=a.find(".date > Menu")[0],d=c.find();c.val()>b&&c.val(b);for(c=28;31>c;c++){var f=d[c];c<b?f.show():f.hide(!0)}}b=a.val();a.val(b);
a.trigger("change")}};b<=f;b++)a.options.push({text:"minute"==e&&10>b?"0"+b:b,value:b,hidden:g&&b>g});return a}var a=g.define("DatePicker",b);a.getInstance=function(b){var d,f=b.formator||"default",e=a.instance||(a.instance={});(d=e[f])?(d.host!=b.host&&(d.host=b.host,d.off("change confirm"),b.change&&d.on("change",b.change),b.confirm&&d.on("confirm",b.confirm),b.date&&d.val(b.date)),d.show()):d=e[f]=new a($H.extend(b,{destroyWhenHide:!1}));return d};a.extend({xConfig:{cls:"dp"},extCls:"hui-dialog",
_customEvents:["change","confirm"],doConfig:function(a){var b=this;a=a||{};var f=a.date;$H.isStr(f)&&(f=$H.parseDate(f));for(var f=f||$H.now(),g=a.formator||(a.formator="yyyy-MM-dd HH:mm"),j=$H.formatDate(f,g),k=[],m=$H.getDaysInMonth(f),g=g.match(/[a-zA-Z]+/g),n=j.match(/\d+/g),l=0;l<g.length;l++){var p=g[l],s=parseInt(n[l]);switch(p){case "yyyy":k.push(e(s,s,s+10,"year"));break;case "MM":k.push(e(s,1,12,"month"));break;case "dd":k.push(e(s,1,31,"date",m));break;case "HH":k.push(e(s,0,24,"hour"));
break;case "mm":k.push(e(s,0,60,"minute"))}}$H.extend(a,{contentTitle:j+" \u661f\u671f"+$H.getWeek(f),items:k,okCall:function(){return b.trigger("confirm")}});b.callSuper([a])},val:function(a){var b=this.find("Select"),f=this.formator;if(!a||$H.isBool(a)){for(var e="",g=0;g<b.length;g++)1==g||2==g?e+="-":3==g?e+=" ":4==g&&(e+=":"),e+=b[g].val();b=$H.parseDate(e);return a?b:$H.formatDate(b,f)}var k=e=a;$H.isStr(a)?k=$H.parseDate(a,f):e=$H.formatDate(a,f);a=e.match(/\d+/g);for(g=0;g<b.length;g++)b[g].val(a[g]);
this.set("contentTitle",e+" \u661f\u671f"+$H.getWeek(k))}});return a});
...
this;b.callSuper();b.itemXtype&&((b.defItem||(b.defItem={})).xtype=b.itemXtype);var e=b.model,a=!1;e.each(function(c,d){b.addListItem(d);a=!0});a||b.set("isEmpty",!0);b.listenTo(e,{add:function(a,d){b.addListItem(d)},remove:function(a,d){b.removeListItem(d)},reset:function(){b.removeListItem("emptyAll")}});b.hasPullRefresh=b.hasPullRefresh&&window.iScroll;b.hasPullRefresh&&(b.listen({name:"afterRender",handler:function(){var a=this,b=a.getEl(),e=b.find(".hui-list-pulldown");a.scroller=new window.iScroll(b[0],
{useTransition:!0,topOffset:50,onRefresh:function(){e.hasClass("hui-pd-refresh")&&(e.removeClass("hui-pd-refresh hui-pd-release"),a.set("pdText","\u4e0b\u62c9\u53ef\u5237\u65b0"))},onScrollMove:function(){5<this.y&&!e.hasClass("hui-pd-release")?(e.addClass("hui-pd-release"),a.set("pdText","\u677e\u5f00\u53ef\u5237\u65b0"),this.minScrollY=0):5>this.y&&e.hasClass("hui-pd-release")&&(e.removeClass("hui-pd-release"),a.set("pdText","\u4e0b\u62c9\u53ef\u5237\u65b0"),this.minScrollY=-50)},onScrollEnd:function(){e.hasClass("hui-pd-release")&&
(e.addClass("hui-pd-refresh"),a.set("pdText","\u6b63\u5728\u5237\u65b0"),a.refresh())}})}}),b.listenTo(b.model,"sync",function(){b.set("pdTime",$H.formatDate($H.now(),"HH:mm"));setTimeout(function(){b.refreshScroller()},0)}),b.listen({name:"afterShow",handler:function(){b.refreshScroller()}}),b.listen({name:"click",method:"delegate",selector:".hui-list-more",handler:function(){b.getMore()}}))},addListItem:function(b){this.set("isEmpty",!1);this.add({model:b});this.refreshScroller()},removeListItem:function(b){"emptyAll"==
