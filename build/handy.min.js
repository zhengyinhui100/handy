...
b,n,s);else d[j](h,b,s);else if(n)d[j](b,n,s);else d[j](b,s);c.push(a)},unlisten:function(a){var e=a.type,b=a.el||this.getEl(),c="delegate"==a.method?"undelegate":"unbind",d=a.selector,j;$H.Browser.mobile()&&"click"==e&&(e="touchend");for(var h=this._listeners.length-1;0<=h;h--){var n=this._listeners[h];if(n.handler==a.handler){j=n.delegation;this._listeners.splice(h,1);break}}if(!a.notEl)if(d)b[c](d,e,j);else b[c](e,j)},initListeners:function(){if(!this.listened){this.listened=!0;var a=this._listeners;
...
c){c=!1!=c;"dot"==this.markType?(a.selected=c,a.getEl().parent()[!1==c?"removeClass":"addClass"]("hui-item-mark")):"active"==this.markType?b.prototype.selectItem.call(this,a,c):a.selected=c}});return d});
