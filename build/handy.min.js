...
(function(){var e=window.handy,c=window.$,b=window.handy=window.$=function(){};b.version="1.0.0";b.expando="handy"+(b.version+Math.random()).replace(/\D/g,"");b.add=function(a,d,f){f||(f=d,d=null);if(!d||!b.Loader){b.base||(b.base={});var j=[];if(d)if("string"==typeof d)j.push(b.base.Object.namespace(d));else for(var c=0;c<d.length;c++)j.push(b.base.Object.namespace(d[c]));j.push(b);d=f.apply(window,j);b.base[a]=b[a]=d;if(0<="Browser,Events,Function,Object,String,Template,Util".indexOf(a)){for(var h in d)"undefined"!=
typeof b[h]&&("console"in window&&!Function[h])&&(console.log(b[h]),console.log(a+"\u547d\u540d\u51b2\u7a81:"+h)),b[h]=d[h];"Events"==a&&(b._eventCache={})}}else b.Loader.require(d,function(){Array.prototype.push.call(arguments,b);b.base[a]=b[a]=f.apply(window,arguments)})};b.noConflict=function(a){window.$===b&&(window.$=c);a&&window.handy===b&&(window.handy=e);return b};b.noop=function(){}})();
handy.add("Json",function(){function e(a){j.lastIndex=0;j.test(a)&&(a=a.replace(j,function(a){var d=g[a];return"string"===typeof d?d:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));return'"'+a+'"'}function c(b,j){var g,h,k,l,m=d,r,q=j[b];q&&("object"===typeof q&&"function"===typeof q.toJSON)&&(q=q.toJSON(b));"function"===typeof a&&(q=a.call(j,b,q));switch(typeof q){case "string":return e(q);case "number":return isFinite(q)?String(q):"null";case "boolean":case "null":return String(q);case "object":if(!q)return"null";
d+=f;r=[];if("[object Array]"===Object.prototype.toString.apply(q)){l=q.length;for(g=0;g<l;g+=1)r[g]=c(g,q)||"null";k=0===r.length?"[]":d?"[\n"+d+r.join(",\n"+d)+"\n"+m+"]":"["+r.join(",")+"]";d=m;return k}if(a&&"object"===typeof a){l=a.length;for(g=0;g<l;g+=1)"string"===typeof a[g]&&(h=a[g],(k=c(h,q))&&r.push(e(h)+(d?": ":":")+k))}else for(h in q)Object.prototype.hasOwnProperty.call(q,h)&&(k=c(h,q))&&r.push(e(h)+(d?": ":":")+k);k=0===r.length?"{}":d?"{\n"+d+r.join(",\n"+d)+"\n"+m+"}":"{"+r.join(",")+
"}";d=m;return k}}var b="JSON"in window,a,d,f,j=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},h=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,s=/(?:^|:|,)(?:\s*\[)+/g;
return{stringify:function(j,g,h,e){if(b&&!e)return JSON.stringify.apply(null,arguments);var k;f=d="";if("number"===typeof h)for(k=0;k<h;k+=1)f+=" ";else"string"===typeof h&&(f=h);if((a=g)&&"function"!==typeof g&&("object"!==typeof g||"number"!==typeof g.length))$D.error(Error("Json.stringify:\u66ff\u6362\u53c2\u6570\u53ea\u80fd\u662f\u51fd\u6570\u6216\u8005\u6570\u7ec4"));else return c("",{"":j})},parse:function(a,d,f){function j(a,f){var b,c,g=a[f];if(g&&"object"===typeof g)for(b in g)Object.prototype.hasOwnProperty.call(g,
b)&&(c=j(g,b),void 0!==c?g[b]=c:delete g[b]);return d.call(a,f,g)}if(b&&!f)return JSON.parse.apply(null,arguments);var c;a=String(a);h.lastIndex=0;h.test(a)&&(a=a.replace(h,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(k.test(a.replace(l,"@").replace(m,"]").replace(s,"")))return c=eval("("+a+")"),"function"===typeof d?j({"":c},""):c;$D.error(new SyntaxError("JSON.parse"))}}});
handy.add("Object",function(e){var c;c=(c=window.navigator.userAgent.match(/MSIE ([\d.]+)/))&&9>parseInt(c[0])?function(a,d,f){var b=[];if(a.length){d=d||0;for(f=f||a.length;d<f;d++)b.push(a[d])}return b}:function(a,d,f){return Array.prototype.slice.call(a,d||0,f||a.length)};var b={_alias:{B:"handy.base",C:"handy.component",M:"handy.module",CM:"handy.common"},namespace:function(a,d){var f=null,j,c,h,e;a=b.alias(a);c=a.split(".");f=c[0];f=(h=2==arguments.length)?eval("(function(){if (typeof "+f+' == "undefined"){'+
...
function(){var a,j;a=this.constructor==d?this:arguments.callee;if(j=a.initialize){for(var c in a)"object"==typeof a[c]&&(a[c]=b.clone(a[c]));return j.apply(a,arguments)}};d.$isClass=!0;d.prototype.callSuper=function(a,d){a&&(!a.$isClass&&void 0!=a.length)&&(d=a,a=null);var c=arguments.callee.caller,h=c.$owner.superProto;a=a?a.prototype:h||this.constructor.superProto;c=c.$name;if(a&&(c=a[c],b.isFunction(c)))return d?c.apply(this,d):c.call(this)};a&&this.namespace(a,d);return d},extend:function(a,d,
f){var c=f?f.notCover:!1,g=f?f.cover:null;f=f?f.notClone:!1;a=a||{};var h=a.constructor,e=h.$isClass,l;for(l in d)if((!g||b.contains(g,l))&&d.hasOwnProperty(l)){var m=a.hasOwnProperty(l),s=!0===c?m:!1;b.isArray(c)?s=b.contains(c,l)&&m:b.isFunction(c)&&(s=c(l));s||(m=f?d[l]:b.clone(d[l]),e&&b.isFunction(m)&&(m.$name=l,m.$owner=h),a[l]=m)}return a},mix:function(a,d,f,c){a.superProto||(a.superProto={});for(var g in d)a.superProto[g]=b.isFunction(d[g])?a.superProto[g]?function(a,b){return function(){b.apply(this,
arguments);d[a].apply(this,arguments)}}(g,a.superProto[g]):d[g]:d[g],a[g]||(a[g]=d[g]);f&&b.extend(a,f);d.toString!=d.constructor.prototype.toString&&(a.superProto.toString=function(){d.toString.apply(a,arguments)});c&&(a.prototype&&d.prototype)&&b.inherit(a,d,null,c);return a},inherit:function(a,d,f,c,g){var h=function(){};h.prototype=d.prototype;g=g||{notCover:!0};b.extend(a,d,g);a.prototype=new h;a.prototype.constructor=a;a.superClass=d;a.superProto=d.prototype;if(d._onInherit)try{d._onInherit(a)}catch(k){e.Debug.error(k)}c&&
...
j&&(f=j.getVariable("$version").split(" ")[1])}else if(navigator.plugins&&0<navigator.plugins.length&&(j=navigator.plugins["Shockwave Flash"])){var g=j.description.split(" ");a=0;for(var h=g.length;a<h;a++)if(0<parseInt(g[a])){f=g[a];break}}}catch(k){}c.flash=f?f:null;return b});
handy.add("Debug",["handy.base.Json","handy.base.Browser"],function(e,c,b){var a={level:0,LOG_LEVEL:1,DEBUG_LEVEL:2,INFO_LEVEL:3,WARN_LEVEL:4,ERROR_LEVEL:5,showInPage:!("console"in window)||!!c.mobile(),out:function(d,f,c){c=c||"log";if(f||a.showInPage){f=b.expando+"debugDiv";var g=top.document,h=g.getElementById(f);h?h.style.display="block":(h=g.createElement("DIV"),h.id=f,h.innerHTML=['<a href="javascript:void(0)" onclick="this.parentNode.style.display=\'none\'">\u5173\u95ed</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="this.parentNode.getElementsByTagName(\'DIV\')[0].innerHTML=\'\';">\u6e05\u7a7a</a>',
...
'<div style="padding-top:5px;height:90%;overflow:auto;"></div>',h.style.position="fixed",h.style.width=g.body.offsetWidth-20+"px",h.style.left=0,h.style.top=0,h.style.right=0,h.style.height="150px",h.style.backgroundColor="#aaa",h.style.fontSize="12px",h.style.padding="10px",h.style.zIndex=9999999999,h.style.opacity=0.8,h.style.filter="alpha(opacity=80)",g.body.appendChild(h));f=h.getElementsByTagName("DIV")[0];g=b.Json.stringify(d,null,"&nbsp;&nbsp;&nbsp;&nbsp;",!0).replace(/\n/g,"<br/>");f.innerHTML+=
c+" : "+g+"<br/>";f.scrollTop=f.scrollHeight}try{console[c](d)}catch(e){}},log:function(d,b){a.level>a.LOG_LEVEL||a.out(d,!!b,"log")},info:function(d,b){this.level>a.INFO_LEVEL||a.out(d,!!b,"info")},warn:function(d,b){a.level>a.WARN_LEVEL||a.out(d,!!b,"warn")},error:function(d,b){if(!(a.level>a.ERROR_LEVEL)&&(a.out(d,!!b,"error"),d instanceof Error))throw d;},time:function(d,b,c){a.level>a.INFO_LEVEL||(d?("boolean"==typeof b&&(c=b,b=""),a.out((b||"")+((new Date).getTime()-(a.lastTime||0)),!!c)):a.lastTime=
(new Date).getTime())},debug:function(d){if(!(a.level>a.DEBUG_LEVEL)&&!1!==d)debugger}};return a});handy.add("Function",function(e){return{bind:function(c,b,a){var d=Array.prototype.slice.call(arguments,2);return function(){Array.prototype.push.apply(d,arguments);return c.apply(b,d)}},intercept:function(c,b,a,d){return e.Object.isFunction(c)&&e.Object.isFunction(b)?function(){var f=a||this,j={},g=arguments;j.scope=d;j.target=f;j.method=c;return!1!=b.apply(j,g)?c.apply(f,g):!1}:c}}});
handy.add("Loader",["handy.base.Debug","handy.base.Object","handy.base.Function"],function(e,c,b,a){function d(a){function d(a){return/\.(css|js)$/.test(a)?s[a]&&"loaded"==s[a].status:p.urlMap&&p.urlMap[a]?p.urlMap[a].chkExist():c.namespace(a)}if("string"==typeof a)return d(a);for(var b=[],f=0,j=a.length;f<j;f++){var g=d(a[f]);if(g)b.push(g);else return!1}return b}function f(a,d){function b(){b.isCalled||(b.isCalled=!0,clearTimeout(h),d())}if("SCRIPT"===a.nodeName){var f=a,c=b;f.onload=f.onerror=
f.onreadystatechange=function(){/loaded|complete|undefined/.test(f.readyState)&&(f.onload=f.onerror=f.onreadystatechange=null,k.removeChild(f),f=null,setTimeout(c,0))}}else{var g=b;window.hasOwnProperty("attachEvent")?a.attachEvent("onload",g):setTimeout(function(){j(a,g)},0)}var h=setTimeout(function(){e.error("Time is out:"+a.src);b()},p.timeout)}function j(a,d){if(!d.isCalled){var b;if(l)a.sheet&&(b=!0);else if(a.sheet)try{a.sheet.cssRules&&(b=!0)}catch(f){if("SecurityError"===f.name||"NS_ERROR_DOM_SECURITY_ERR"===
f.name)b=!0}setTimeout(function(){b?d():j(a,d)},1)}}function g(a){p.showLoading(!1);s[a].status="loaded";p.traceLog&&e.info("Loader Response: "+a);h()}function h(){for(var a=m.length-1;0<=a;a--){var b=m[a],f=d(b.deps);if(f){m.splice(a,1);b.callback.apply(null,f);h();break}}}var k=document.head||document.getElementsByTagName("head")[0]||document.documentElement,l=navigator.userAgent.indexOf("AppleWebKit"),m=[],s={},p={traceLog:!1,timeout:15E3,skinName:"skin",showLoading:function(){},define:function(a,
d,b){2==arguments.length&&(b=d,d=[]);p.require(d,function(){var d;if("function"==typeof b)try{d=b.apply(null,arguments),p.traceLog&&e.info("Loader define: "+a)}catch(f){e.error("Loader "+a+":factory define error:"+f.message,f);return}else d=b;c.namespace(a,d);var j=typeof d;if("object"==j||"Function"==j)d.$ns=a})},require:function(c,j){for(var h="string"==typeof c?[c]:c,l=[],u=[],t=!0,r=0,q=h.length;r<q;r++){var n=h[r],v=d(n);v?u.push(v):(l.push(n),t&&(t=!1,m.push({deps:h,callback:j})),p.traceLog&&
e.info("Resource not found: "+n))}if(0==l.length)return j&&j.apply(null,u),0==u.length?u[0]:u;t=!1;h=0;for(u=l.length;h<u;h++)if(r=l[h],!s[r]){t=r;n=p.urlMap&&p.urlMap[t]&&p.urlMap[t].url;if(!n){q="";t=a.Object.alias(t);n=p.rootPath;if("string"==typeof n)q=n;else if("object"==typeof n)for(v in v=void 0,n)0==t.indexOf(v)&&(q=n[v],t=t.replace(v,""));else q="";n=/.css$/.test(t)?0==t.indexOf("/")?t:"/css/"+t:/.js$/.test(t)?t:t.replace(/\./g,"/")+".js";0!=n.indexOf("/")&&(n="/"+n);n=q+n}t=!0;s[r]={id:r,
status:"loading"};q=b.bind(g,null,r);if(/.css$/.test(n))a:{r=n;n=k.getElementsByTagName("link");for(v=0;v<n.length;v++){var A=n[v].href;!p.skinNode&&0<=A.indexOf(p.skinName)&&(p.skinNode=n[v]);if(0<=A.indexOf(r)||0<=r.indexOf(A))break a}n=document.createElement("link");n.rel="stylesheet";n.href=r;f(n,q);k.insertBefore(n,p.skinNode);p.traceLog&&e.info("Loader request:"+r)}else r=n,n=document.createElement("script"),n.async="async",n.src=r,n.type="text/javascript",f(n,q),k.appendChild(n),p.traceLog&&
e.info("Loader request:"+r)}t&&p.showLoading(!0)}};return p});
handy.add("Events",function(){var e=Array.prototype;return{_eventCache:{},_parseEvents:function(c,b,a){var d=/\s+/,f=e.slice.call(arguments,2);if("object"==typeof b){for(var j in b)this[c].apply(this,[j,b[j]].concat(f));return!0}if(d.test(b)){d=b.split(d);j=0;for(var g=d.length;j<g;j++)this[c].apply(this,[d[j]].concat(f));return!0}return!1},on:function(c,b,a,d){var f=this;if(!f._parseEvents("on",c,b,a,d)){var j=f._eventCache,g=j[c];g||(g=j[c]=[]);g.push({times:d,handler:b,context:a,delegation:function(){if(!0!=
...
this.isSuspend=!0},resume:function(){if(!this.isSuspend)return!1;this.isSuspend=!1},trigger:function(c,b){function a(a){if(a)for(var b=0,f=a.length;b<f;b++){var c=a[b],h=c.delegation;"number"==typeof c.times&&(1<c.times?c.times--:d.off(k,c.handler));g=h.apply(null,j)}}var d=this,f=$HO.toArray(arguments);f.unshift("trigger");if(!d._parseEvents.apply(d,f)){var f=d._eventCache,j=e.slice.call(arguments,1),g,h;if(0<c.indexOf("."))h=f[c],a(h);else for(var k in f)if(h=c.indexOf("."),k.split(".")[0]==c||
0==h&&0<=k.indexOf(c))h=f[k],a(h);a(f.all);return g}}}});
...
d[j]).slice(-f)));return a},parse:function(b,a){for(var d=(a||"yyyy-MM-dd HH:mm:ss").match(/[a-zA-Z]+/g),f=b.match(/\d+/g),c=new e,g=0;g<f.length;g++){var h=d[g],k=parseInt(f[g]);switch(h){case "yyyy":c.setFullYear(k);break;case "MM":c.setMonth(k-1);break;case "dd":c.setDate(k);break;case "HH":c.setHours(k);break;case "mm":c.setMinutes(k);break;case "ss":c.setSeconds(k);break;case "SS":c.setMilliseconds(k)}}return c},parseObject:function(b){return new e(b.year+1900,b.month,b.date,b.hours,b.minutes,
b.seconds)}};return c});
...
handy.add("Collection","B.Object",function(e){function c(a){return a}function b(a){return function(b){return b[a]}}function a(a){return function(b){if(b===a)return!0;for(var c in a)if(a[c]!==b[c])return!1;return!0}}return{map:function(a,b,c){var g=[];if(null==a)return g;var h=Array.prototype.map;if(h&&a.map===h)return a.map(b,c);e.each(a,function(a,d){g.push(b.call(c,d,a))});return g},pluck:function(a,f){return this.map(a,b(f))},some:function(a,b,c){var g=!1;if(null==a||!b)return g;var h=Array.prototype.some;
if(h&&a.some===h)return a.some(b,c);$HO.each(a,function(a,d,h){if(g||(g=b.call(c,d,a,h)))return!1});return!!g},every:function(a,b,c){var g=!0;if(null==a||!b)return g;var h=Array.prototype.every;if(h&&a.every===h)return a.every(b,c);$HO.each(a,function(a,d,h){if(!(g=b.call(c,d,a,h)))return!1});return!!g},find:function(a,b,c){var g;this.some(a,function(a,d,e){if(b.call(c,a,d,e))return g=a,!0});return g},filter:function(a,b,c){var g=[];if(null==a)return g;var h=Array.prototype.filter;if(h&&a.filter===
h)return a.filter(b,c);$HO.each(a,function(a,d,h){b.call(c,d,a,h)&&g.push(d)});return g},where:function(b,f){return this.filter(b,a(f))},findWhere:function(b,f){return this.find(b,a(f))},invoke:function(a,b){var c=Array.prototype.slice.call(arguments,2),g=e.isFunction(b);return this.map(a,function(a){return(g?b:a[b]).apply(a,c)})},sortBy:function(a,f,j){var g=f;f=null==g?c:$HO.isFunction(g)?g:b(g);return this.pluck(this.map(a,function(a,b,d){return{value:a,index:b,criteria:f.call(j,a,b,d)}}).sort(function(a,
...
b.split(d.closeTag);1==f.length?c+=d._parseHtml(f[0]):(c+=d._parseScript(f[0]),f[1]&&(c+=d._parseHtml(f[1])))});c+="return "+(a?"$r;":'$r.join("");');return new Function("$data",c)},tmpl:function(a,b){var g,h,k;if("string"==typeof a)g=a;else if(g=a.tmpl,k=a.id)if(c[k])h=c[k];else{var l=document.getElementById(k);l&&(g=(l.value||l.innerHTML).replace(/\s/g,""))}if(!h){if(!g){e.Debug.error("\u6a21\u677f\u672a\u5b9a\u4e49");return}h=d._compile(g);k&&(c[k]=h)}return b?h(b):h}};return d});
handy.add("HashChange",["handy.base.Debug","handy.base.Util"],function(e,c,b){function a(a){if(a==l)return!1;var b=k.contentWindow.document;b.open();b.write("<!doctype html><html><body>"+a+"</body></html>");b.close();l=a;e.log("set:"+k.contentWindow.document.body.innerText)}function d(){var b=c.getHash(),d=k.contentWindow.document.body.innerText;b!=l?(a(b),f(b)):d!=l&&(e.log("update:"+k.contentWindow.document.body.innerText),c.setHash(d))}function f(a){var b=p.listeners,d;for(d in b)b[d](a)}var j,
g=0,h=document,k,l,m=h.documentMode,s="onhashchange"in window&&(void 0===m||7<m),p={delay:50,listen:function(e,l){if(!j&&!j)if(j=!0,p.listeners={},s)$(window).on("hashchange",function(){f(c.getHash())});else k=$('<iframe id="fff" tabindex="-1" style="display:none" width=0 height=0 title="empty" />').appendTo(h.body)[0],$(k).one("load",function(){a(c.getHash());setInterval(d,p.delay)});if(l in p.listeners)$D.error(Error("Duplicate name"));else return l=l||b.expando+ ++g,p.listeners[l]=e,l},unListen:function(a){for(var b in p.listeners)(!a||
...
equalTo:"\u8bf7\u8f93\u5165\u76f8\u540c\u7684{name}",min:"{name}\u4e0d\u80fd\u5c0f\u4e8e{0}",max:"{name}\u4e0d\u80fd\u5927\u4e8e{0}",range:"{name}\u8981\u5728{0}\u5230{1}\u4e4b\u95f4",maxlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u8d85\u8fc7{0}",minlength:"{name}\u957f\u5ea6\u4e0d\u80fd\u5c11\u4e8e{0}",rangelength:"{name}\u957f\u5ea6\u8981\u5728{0}\u5230{1}\u4e4b\u95f4"},valid:function(a,d){var f=d.rules,c;for(c in f){var g=f[c],h=("function"==typeof g?g:b[c])(a,g);if(!h)return f=d.error||b.error,c=d.messages&&
d.messages[c]||b.messages[c],c=c.replace(/\{([^\}]+)\}/g,function(a,b){return g[b]||0==b&&g||d[b]||g||""}),f&&f(c),h}return!0},required:function(a){return 0<e.trim(""+a).length},email:function(a){return/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a)},
...
a.css({visibility:"hidden"}):a.hide();this.trigger("hide");this.afterHide()},afterHide:function(){this.trigger("afterHide")},enable:function(){this.resume();this.getEl().removeClass("hui-disable").find("input,textarea,select").removeAttr("disabled")},disable:function(){this.suspend();this.getEl().addClass("hui-disable").find("input,textarea,select").attr("disabled","disabled")},listen:function(a){var b=this,d=a.name,c=a.context,e=a.handler;if(a.custom)b.on(d,e,c);else{var l=b._listeners,m=a.el,s=
a.method||"bind",p=a.selector,w=a.data,y=a.delegation=function(){if(!0!=b.isSuspend)return e.apply(c||b,arguments)};$H.Browser.mobile()&&"click"==d&&(d="touchend");m=m?"string"==typeof m?b.find(m):m:b.getEl();if(p)if(w)m[s](p,d,w,y);else m[s](p,d,y);else if(w)m[s](d,w,y);else m[s](d,y);l.push(a)}},unlisten:function(a){var b=a.name,d=a.handler;if(a.custom)this.off(b,d);else{var c=a.el,e="delegate"==a.method?"undelegate":"unbind";a=a.selector;var l;$H.Browser.mobile()&&"click"==b&&(b="touchend");for(var c=
c?"string"==typeof c?this.find(c):c:this.getEl(),m=this._listeners.length-1;0<=m;m--){var s=this._listeners[m];if(s.handler==d){l=s.delegation;this._listeners.splice(m,1);break}}if(a)c[e](a,b,l);else c[e](b,l)}},initListeners:function(){if(this.listened)return!1;this.listened=!0;var a=this._listeners;this._listeners=[];for(var b=a.length-1;0<=b;b--)this.listen(a[b]);this.callChild()},clearListeners:function(){for(var a=this._listeners,b=a.length-1;0<=b;b--)this.unlisten(a[b]);this.off("all");this.callChild()},
suspend:function(){if(this.isSuspend)return!1;this.isSuspend=!0;this.callChild()},resume:function(){if(!this.isSuspend)return!1;this.isSuspend=!1;this.callChild()},each:function(a,b){for(var d=this.children,c=d.length,e,l=0;l<c;){e=d[l];e=b?a.apply(e,b):a(l,e);if(!1===e)break;c==d.length?l++:c=d.length}},match:function(a,b){if("*"==a)return!0;var d=b||this,c,e,l;a=a.replace(/^([^\[]+)/,'[xtype="$1"]');for(var m=/\[([^=|\!]+)(=|\!=)([^=]+)\]/g;c=m.exec(a);)if(e=c[1],l=c[2],c=eval(c[3]),"="===l?d[e]!=
c:d[e]==c)return!1;return!0},find:function(a,b){var d=this;if(0!=a.indexOf("$"))return d.getEl().find(a);b=b||[];if(0<a.indexOf(","))return $HO.each(a.split(","),function(a,c){b=b.concat(d.find(c))}),b;var c=1==a.indexOf(">"),e=a.replace(/^\$>?\s?/,""),l=e.search(/\s|>/),m;0<l&&(m=e.substring(l),e=e.substring(0,l));d.each(function(d,g){g.match(e)&&(m?g.find("$"+m,b):b.push(g));c||g.find(a,b)});return b},parents:function(a){if(a&&0!=a.indexOf("$"))return this.getEl().parents(a);for(var b=this;b.parent;)if(b=
b.parent,a&&this.match(a,b))return b;return a||b===this?null:b},index:function(){var a=this,b=a.parent;if(b){var d;b.each(function(b,c){if(c==a)return d=b,!1});return d}return null},callChild:function(a,b){0!=this.children.length&&(a&&"string"!=typeof a&&(b=a,a=null),a=a||arguments.callee.caller.$name,this.each(function(d,c){b?c[a].apply(c,b):c[a].call(c)}))},add:function(a){this.children.push(a);a.parent=this},remove:function(a){for(var b=this.children,d=!1,c=0,e=b.length;c<e;c++)b[c]==a&&(b.splice(c,
1),a.destroy(),d=!0);return d},addItem:function(a){var b=this.settings,d=b.items;d?$HO.isArray(d)||(b.items=[d]):b.items=[];b.items.push(a)},parseItem:function(){},parseItems:function(){var a=this.settings.items;if(a)for(var a=a.length?a:[a],b=0,d=a.length;b<d;b++){var c=a[b];this.defItem&&$HO.extend(c,this.defItem,{notCover:!0});this.parseItem(c);var e=this.manager.getClass(c.xtype);e?(c.renderTo||(c.autoRender=!1),c=new e(c),this.add(c)):$D.error("xtype:"+c.xtype+"\u672a\u627e\u5230")}},beforeUpdate:function(){return this.trigger("beforeUpdate")},
...
a.collection);a.parse&&(d=this.parse(d,a)||{});d=$HO.extend(d,$H.Util.result(this,"defaults"),{notCover:!0});this.set(d,a);this.changed={}},toJson:function(){return $HO.clone(this.attributes)},get:function(b){return this.attributes[b]},escape:function(b){return $H.String.escapeHTML(this.get(b))},has:function(b){b=this.get(b);return null!=b&&void 0!=b},set:function(b,a,d){var c;"object"===typeof b?(c=b,d=a):(c={})[b]=a;d||(d={});if(!this._validate(c,d))return!1;var e=d.unset;b=d.silent;var g=[],h=
this._changing;this._changing=!0;h||(this._previousAttributes=$H.Object.clone(this.attributes),this.changed={});var k=this.attributes,l=this._previousAttributes;this.idAttribute in c&&(this.id=c[this.idAttribute]);for(var m in c)a=c[m],$HO.equals(k[m],a)||g.push(m),$HO.equals(l[m],a)?delete this.changed[m]:this.changed[m]=a,e?delete k[m]:k[m]=a;if(!b){g.length&&(this._pending=d);a=0;for(c=g.length;a<c;a++)this.trigger("change:"+g[a],this,k[g[a]],d)}if(h)return this;if(!b)for(;this._pending;)d=this._pending,
this._pending=!1,this.trigger("change",this,d);this._changing=this._pending=!1;return this},unset:function(b,a){a=a||{};a.unset=!0;return this.set(b,void 0,a)},clear:function(b){var a={},d;for(d in this.attributes)a[d]=void 0;b=b||{};b.unset=!0;return this.set(a,b)},hasChanged:function(b){var a=this.changed;return null==b?!$HO.isEmpty(a):$HO.contains(a,b)},changedAttrbutes:function(b){if(!b)return this.hasChanged()?$HO.clone(this.changed):!1;var a,d=!1,c=this._changing?this._previousAttributes:this.attributes,
e;for(e in b)if(!$HO.equals(c[e],a=b[e]))(d||(d={}))[e]=a;return d},previous:function(b){return null==b||!this._previousAttributes?null:this._previousAttributes[b]},fetch:function(b){var a=this;b=b?$HO.clone(b):{};void 0===b.parse&&(b.parse=!0);var d=b.success;b.success=function(c){if(!a.set(a.parse(c,b),b))return!1;d&&d(a,c,b);a.trigger("sync",a,c,b)};c(a,b);return a.sync("read",a,b)},save:function(b,a,d){var f,e=this.attributes;null==b||"object"===typeof b?(f=b,d=a):(f={})[b]=a;d=$HO.extend({validate:!0},
d);if(f&&!d.wait){if(!this.set(f,d))return!1}else if(!this._validate(f,d))return!1;f&&d.wait&&(this.attributes=$HO.extend({},e,f));void 0===d.parse&&(d.parse=!0);var g=this,h=d.success;d.success=function(a){g.attributes=e;var b=g.parse(a,d);d.wait&&(b=$HO.extend(f||{},b));if($HO.isObject(b)&&!g.set(b,d))return!1;h&&h(g,a,d);g.trigger("sync",g,a,d)};c(this,d);b=this.isNew()?"create":d.patch?"patch":"update";"patch"===b&&(d.oAttrs=f);b=this.sync(b,this,d);f&&d.wait&&(this.attributes=e);return b},destroy:function(b){b=
...
$Define("C.Collection","C.Model",function(e){var c=$HO.createClass();$HO.extend(c.prototype,$H.Events);$HO.extend(c.prototype,{_reset:function(){this.length=0;this.models=[];this._byId={}},_prepareModel:function(b,a){if(b instanceof e)return b;a=a?$HO.clone(a):{};a.collection=this;var d=new this.model(b,a);if(!d.validationError)return d;this.trigger("invalid",this,d.validationError,a);return!1},_addReference:function(b){this._byId[b.cid]=b;null!=b.id&&(this._byId[b.id]=b);b.collection||(b.collection=
...
a.comparator);this._reset();this.initialize.apply(this,arguments);b&&this.reset(b,$HO.extend({silent:!0},a))},toJSON:function(b){return $H.Collection.map(this,function(a){return a.toJSON(b)})},add:function(b,a){$HO.extend(a,{add:!0,remove:!1,merge:!1});return this.set(b,a)},remove:function(b,a){var d=!$HO.isArray(b);b=d?[b]:$HO.clone(b);a||(a={});var c,e,g,h;c=0;for(e=b.length;c<e;c++)if(h=b[c]=this.get(b[c]))delete this._byId[h.id],delete this._byId[h.cid],g=this.indexOf(h),this.models.splice(g,
1),this.length--,a.silent||(a.index=g,h.trigger("remove",h,this,a)),this._removeReference(h,a);return d?b[0]:b},set:function(b,a){a=$H.Util.extend(a,{add:!0,remove:!0,merge:!0});a.parse&&(b=this.parse(b,a));var c=!$HO.isArray(b),f=c?b?[b]:[]:$HO.clone(b),j,g,h,k,l,m,s=a.at,p=this.model,w=this.comparator&&null==s&&!1!==a.sort,y="string"==typeof this.comparator?this.comparator:null,x=[],z=[],u={},t=a.add,r=a.merge,q=a.remove,n=!w&&t&&q?[]:!1;j=0;for(g=f.length;j<g;j++){l=f[j]||{};h=l instanceof e?k=
l:l[p.prototype.idAttribute||"id"];if(h=this.get(h))q&&(u[h.cid]=!0),r&&(l=l===k?k.attributes:l,a.parse&&(l=h.parse(l,a)),h.set(l,a),w&&(!m&&h.hasChanged(y))&&(m=!0)),f[j]=h;else if(t){k=f[j]=this._prepareModel(l,a);if(!k)continue;x.push(k);this._addReference(k,a)}k=h||k;n&&(k.isNew()||!u[k.id])&&n.push(k);u[k.id]=!0}if(q){j=0;for(g=this.length;j<g;++j)u[(k=this.models[j]).cid]||z.push(k);z.length&&this.remove(z,a)}if(x.length||n&&n.length)if(w&&(m=!0),this.length+=x.length,null!=s){j=0;for(g=x.length;j<
g;j++)this.models.splice(s+j,0,x[j])}else{n&&(this.models.length=0);l=n||x;j=0;for(g=l.length;j<g;j++)this.models.push(l[j])}m&&this.sort({silent:!0});if(!a.silent){j=0;for(g=x.length;j<g;j++)(k=x[j]).trigger("add",k,this,a);(m||n&&n.length)&&this.trigger("sort",this,a)}return c?f[0]:f},reset:function(b,a){a||(a={});for(var c=0,f=this.models.length;c<f;c++)this._removeReference(this.models[c],a);a.previousModels=this.models;this._reset();b=this.add(b,$HO.extend({silent:!0},a));a.silent||this.trigger("reset",
...
$Define("M.History","handy.base.HashChange",function(e){var c=$HO.createClass(),b=0;$HO.extend(c.prototype,{initialize:function(a,b){"function"==typeof a&&(b=a,a=null);this.error=b||$H.noop;this.key=a||"handy";this.states=[];e.listen($H.Function.bind(this.stateChange,this))},stateChange:function(){var a=this.getHashParam(),b=a.hKey,c=this.currentKey,e=this.states,g=e[c];if(b==c&&$HO.equals(a.param,g.param))return!1;(e=e[b])?a=e.onStateChange(e.param,!0):($D.warn("hisory state not found"),a=this.error("stateNotFound",
a));!0!=a?(a={hKey:c,param:g.param},this.saveHash(a)):this.currentKey=b},saveState:function(a){var c=this.currentKey=this.key+ ++b;this.states.push(c);this.states[c]=a;this.saveHash({hKey:c,param:a.param})},saveHash:function(a){$HU.setHash("#"+$H.Json.stringify(a))},getHashParam:function(){try{var a=$HU.getHash().replace("#","");return $H.Json.parse(a)}catch(b){$H.Debug.warn("History.getCurrentState:parse hash error:"+b.message)}},getCurrentState:function(){try{var a=this.getHashParam();return this.states[a.hKey]}catch(b){$H.Debug.warn("History.getCurrentState:parse hash error:"+
b.message)}},getPreState:function(){try{for(var a=this.getHashParam().hKey,b=this.states,c=b.length,e=0;e++;e<c)if(b[e]==a)return 0<e?b[b[--e]]:null}catch(g){$H.Debug.error("History.getPreState error:"+g.message,g)}},back:function(){var a=this.getPreState();if(a)a.onStateChange(a.param)}});return c});
